...
const get_container_end_slot_changes = dirty => ({
  virtualData: dirty & /*virtualData*/ 512,
});
const get_container_end_slot_context = ctx => ({
  virtualData: /*virtualData*/ ctx[9],
});
...
function create_fragment(ctx) {
  ...
  let div1_levels = [
    {
      class: (div1_class_value = uniqueClasses(
        `${/*containerClasses*/ ctx[1]}${
          /*className*/ ctx[0] ? ` ${/*className*/ ctx[0]}` : ""
        }`
      )),
    },
    /*restProps*/ ctx[3],
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (dirty & /*swiperParams*/ 4)
        show_if_2 = needsNavigation(/*swiperParams*/ ctx[2]);
      ...
      if (dirty & /*swiperParams*/ 4)
        show_if_1 = needsScrollbar(/*swiperParams*/ ctx[2]);
      ...
      if (dirty & /*swiperParams*/ 4)
        show_if = needsPagination(/*swiperParams*/ ctx[2]);
      ...
      set_attributes(
        ...
        (div1_data = get_spread_update(div1_levels, [
          (!current ||
            (dirty & /*containerClasses, className*/ 3 &&
              div1_class_value !==
                (div1_class_value = uniqueClasses(
                  `${/*containerClasses*/ ctx[1]}${
                    /*className*/ ctx[0] ? ` ${/*className*/ ctx[0]}` : ""
                  }`
