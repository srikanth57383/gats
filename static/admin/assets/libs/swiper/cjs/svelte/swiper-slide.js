  ...
  return {
    c() {
      ...
      attr(
        div,
        "data-swiper-zoom",
        (div_data_swiper_zoom_value =
          typeof (/*zoom*/ ctx[0]) === "number" ? /*zoom*/ ctx[0] : undefined)
      );
    },
    m(target, anchor) {
  ...
  let div_levels = [
    {
      class: (div_class_value = uniqueClasses(
        `${/*slideClasses*/ ctx[3]}${
          /*className*/ ctx[2] ? ` ${/*className*/ ctx[2]}` : ""
        }`
      )),
    },
    {
    ...
    p(ctx, [dirty]) {
      ...
      set_attributes(
        ...
        (div_data = get_spread_update(div_levels, [
          (!current ||
            (dirty & /*slideClasses, className*/ 12 &&
              div_class_value !==
                (div_class_value = uniqueClasses(
                  `${/*slideClasses*/ ctx[3]}${
                    /*className*/ ctx[2] ? ` ${/*className*/ ctx[2]}` : ""
                  }`
