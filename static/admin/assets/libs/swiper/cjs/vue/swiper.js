...
var Swiper = {
  ...
  setup: function setup(props, _ref) {
    ...
    if (swiperParams.loop) {
      swiperRef.value.loopedSlides = (0, _loop.calcLoopedSlides)(
        slidesRef.value,
        swiperParams
      );
    }
    ...
    return function () {
      var _getChildren = (0, _getChildren2.getChildren)(
          originalSlots,
          slidesRef,
          oldSlidesRef
        ),
      ...
      return (0, _vue.h)(
        ...
        [
          ...
          (0, _utils.needsNavigation)(props) && [
            (0, _vue.h)("div", {
              ref: prevElRef,
          ...
          (0, _utils.needsScrollbar)(props) &&
            (0, _vue.h)("div", {
              ref: scrollbarElRef,
              class: "swiper-scrollbar",
            }),
          (0, _utils.needsPagination)(props) &&
            (0, _vue.h)("div", {
              ref: paginationElRef,
