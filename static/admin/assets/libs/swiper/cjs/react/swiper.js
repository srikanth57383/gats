...
var Swiper = /*#__PURE__*/ (0, _react.forwardRef)(function (
  ...
  if (!swiperElRef.current) {
    ...
    if (swiperParams.loop) {
      swiperRef.current.loopedSlides = (0, _loop.calcLoopedSlides)(
        slides,
        swiperParams
      );
    }
  ...
  function renderSlides() {
    if (swiperParams.virtual) {
      return (0, _virtual.renderVirtual)(
        swiperRef.current,
        slides,
        virtualData
      );
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    _extends(
      {
        ref: swiperElRef,
        className: (0, _utils.uniqueClasses)(
    ...
    (0, _utils.needsNavigation)(swiperParams) &&
    ...
    (0, _utils.needsScrollbar)(swiperParams) &&
      /*#__PURE__*/ _react.default.createElement("div", {
        ref: scrollbarElRef,
        className: "swiper-scrollbar",
      }),
    (0, _utils.needsPagination)(swiperParams) &&
      /*#__PURE__*/ _react.default.createElement("div", {
        ref: paginationElRef,
