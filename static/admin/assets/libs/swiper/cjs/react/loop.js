...
function calcLoopedSlides(slides, swiperParams) {
  ...
  if (swiperParams.breakpoints) {
    var breakpoint = _core.default.prototype.getBreakpoint(
...
function renderLoop(swiper, slides, swiperParams) {
  ...
  function duplicateSlide(child, index, position) {
    return /*#__PURE__*/ _react.default.cloneElement(child, {
      ...
      className:
        (child.props.className || "") + " " + swiperParams.slideDuplicateClass,
    });
  }
    ...
    if (blankSlidesNum !== swiperParams.slidesPerGroup) {
      for (var i = 0; i < blankSlidesNum; i += 1) {
        var blankSlide = /*#__PURE__*/ _react.default.createElement("div", {
          className:
            swiperParams.slideClass + " " + swiperParams.slideBlankClass,
        });
