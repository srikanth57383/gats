...
function slidePrev(e, t, a) {
  ...
  return (
    ...
    void 0 !== h && (c = o.indexOf(h)) < 0 && (c = i.activeIndex - 1),
    i.slideTo(c, e, t, a)
  );
}
          ...
          if (!s.isTouched || !s.isMoved)
            if (
              ...
              if (
                ...
                var h = !0;
                l.is(s.formElements) && (h = !1),
                  a.activeElement &&
                    $(a.activeElement).is(s.formElements) &&
                    a.activeElement !== l[0] &&
      ...
      (t.mount = function (e) {
        ...
        var i = (function () {
          if (e && e.shadowRoot && e.shadowRoot.querySelector) {
            var i = $(e.shadowRoot.querySelector("." + t.params.wrapperClass));
            return (
        ...
        if (0 === i.length && t.params.createElements) {
          var s = getDocument().createElement("div");
          (i = $(s)),
...
var Virtual = {
    update: function (e) {
      ...
      if (
        ...
        return (
          t.slidesGrid !== h && E !== f && t.slides.css(m, E + "px"),
    ...
    in: function (e) {
      ...
      (x.$slideEl ||
        (g.params.virtual && g.params.virtual.enabled && g.virtual
          ? (x.$slideEl = g.$wrapperEl.children(
              "." + g.params.slideActiveClass
            ))
          : (x.$slideEl = g.slides.eq(g.activeIndex)),
      ...
      x.$imageEl &&
        ...
        e
          ? ((f = x.$slideEl[0].offsetWidth),
            (m = x.$slideEl[0].offsetHeight),
            (i = x.$slideEl.offset().left + b.scrollX + f / 2 - t),
            (s = x.$slideEl.offset().top + b.scrollY + m / 2 - a),
    ...
    init: function () {
      ...
      if (
        ...
        e.params.hashNavigation.watchState &&
          $(a).on("hashchange", e.hashNavigation.onHashCange);
      }
    },
    destroy: function () {
      var e = getWindow();
      this.params.hashNavigation.watchState &&
        $(e).off("hashchange", this.hashNavigation.onHashCange);
    },
  },
  HashNavigation$1 = {
