...
SwiperSlideDirective.ctorParameters = () => [{ type: TemplateRef }];
...
class SwiperComponent {
  ...
  get zoomContainerClass() {
    return typeof this.zoom !== "boolean"
...
SwiperComponent.propDecorators = {
  ...
  s_beforeSlideChangeStart: [
    { type: Output, args: ["beforeSlideChangeStart"] },
  ],
  ...
  s_slideChangeTransitionEnd: [
    { type: Output, args: ["slideChangeTransitionEnd"] },
  ],
  s_slideChangeTransitionStart: [
    { type: Output, args: ["slideChangeTransitionStart"] },
  ],
  s_slideNextTransitionEnd: [
    { type: Output, args: ["slideNextTransitionEnd"] },
  ],
  s_slideNextTransitionStart: [
    { type: Output, args: ["slideNextTransitionStart"] },
  ],
  s_slidePrevTransitionEnd: [
    { type: Output, args: ["slidePrevTransitionEnd"] },
  ],
  s_slidePrevTransitionStart: [
    { type: Output, args: ["slidePrevTransitionStart"] },
  ],
  s_slideResetTransitionStart: [
    { type: Output, args: ["slideResetTransitionStart"] },
  ],
  s_slideResetTransitionEnd: [
    { type: Output, args: ["slideResetTransitionEnd"] },
  ],
  ...
  s_slidesGridLengthChange: [
    { type: Output, args: ["slidesGridLengthChange"] },
  ],
  ...
  scrollbarElRef: [
    { type: ViewChild, args: ["scrollbarElRef", { static: false }] },
  ],
  paginationElRef: [
    { type: ViewChild, args: ["paginationElRef", { static: false }] },
  ],
  slidesEl: [
    {
      ...
      args: [
        ...
        { descendants: true, emitDistinctChangesOnly: true },
      ],
    },
  ],
