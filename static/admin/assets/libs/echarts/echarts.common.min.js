...
!(function (t, e) {
  ...
  function At(t, e, i, n, r, o) {
    ...
    for (var c = 0, d = 0, f = 0; d < s; d++) {
      var p = 1 << d;
      p & r ||
        ((c += (f % 2 ? -1 : 1) * t[i][d] * At(t, e - 1, h, u, r | p, o)), f++);
    }
    return (o[a] = c);
  }
  function Dt(t, e) {
  ...
  (fe.updateTransform = function () {
    ...
    if (i || e) {
      (n = n || ee()),
        i ? this.getLocalTransform(n) : he(n),
      ...
      if (-1 !== o && a + 1 === r.length) {
        ...
        switch (s) {
          ...
          case "rgb":
            return 3 !== l.length
              ? void Pe(e, 0, 0, 0, 1)
              : (Pe(e, Te(l[0]), Te(l[1]), Te(l[2]), u), Ee(t, e), e);
          case "hsla":
            return 4 !== l.length
              ? void Pe(e, 0, 0, 0, 1)
  ...
  function We(t, e, i) {
    if (e && e.length && 0 <= t && t <= 1) {
      ...
      return i ? { color: u, leftIndex: r, rightIndex: o, value: n } : u;
    }
  }
  var Ge = We;
  function Ze(t, e) {
  ...
  function ei(t, e, i, n, r, o, a, s, l) {
    var u = t.length;
    if (1 === l)
      for (var h = 0; h < u; h++) s[h] = ii(t[h], e[h], i[h], n[h], r, o, a);
    else {
      var c = t[0].length;
      for (h = 0; h < u; h++)
        for (var d = 0; d < c; d++)
          s[h][d] = ii(t[h][d], e[h][d], i[h][d], n[h][d], r, o, a);
    }
  }
  ...
  function oi(t, e, i, n, o, r) {
    ...
    if (u) {
      ...
      n.sort(function (t, e) {
        ...
        (h = n[u - 1].time);
      for (var g = [], m = [], v = n[0].value, y = !0, _ = 0; _ < u; _++) {
        g.push(n[_].time / h);
        var x = n[_].value;
        if (
        ...
        var P = new ye({
          ...
          onframe: function (t, e) {
            ...
            if (e < 0) i = 0;
              ...
              for (i = Math.min(A + 1, u - 1); 0 <= i && !(g[i] <= e); i--);
              i = Math.min(i, u - 2);
            } else {
              for (i = A; i < u && !(g[i] > e); i++);
              i = Math.min(i - 1, u - 2);
  ...
  function di(t, e, i, n, r, o, a, s) {
      ...
      (function t(e, i, n, r, o, a, s) {
        ...
        for (var h in r)
          r.hasOwnProperty(h) &&
            (null != n[h]
              ? N(r[h]) && !L(r[h])
                ? t(e, i ? i + "." + h : h, n[h], r[h], o, a, s)
                : (s ? ((l[h] = n[h]), fi(e, i, h, r[h])) : (l[h] = r[h]), u++)
              : null == r[h] || s || fi(e, i, h, r[h]));
        0 < u &&
          e
            .animate(i, !1)
            .when(null == o ? 500 : o, l)
    ...
    u || (o && o());
    for (var c = 0; c < l.length; c++) l[c].done(h).start(r, a);
  }
  function fi(t, e, i, n) {
    if (e) {
      var r = {};
    ...
    animate: function (t, e) {
      ...
      if (t) {
        var a = t.split("."),
          s = r;
        n = "shape" === a[0];
        for (var l = 0, u = a.length; l < u; l++) s = s && s[a[l]];
        s && (i = s);
      } else i = r;
      if (i) {
        var h = r.animators,
            ...
            ? (function (t, e, i, n) {
                ...
                for (;;) {
                  ...
                  do {
                    ...
                    if (0 !== (u = Ai(v[o], p, a, n, 0, g))) {
                      for (r = 0; r < u; r++) p[s + r] = p[a + r];
                      if (((s += u), (a += u), 0 === (n -= u))) {
                        h = !0;
                        break;
                      }
  ...
  ji.prototype = {
    ...
    clear: function (t, e) {
      ...
      s &&
        ...
        this.ctxBack.drawImage(n, 0, 0, o / u, a / u)),
        r.clearRect(0, 0, o, a),
        e &&
          "transparent" !== e &&
          (e.colorStops
  ...
  function xn(t, e, i) {
    for (
      ...
      if (a) o.push({ tokens: [l] });
        ...
        var u = (o[o.length - 1] || (o[0] = { tokens: [] })).tokens,
          h = u.length;
  ...
  function bn(t, e) {
    ...
    u < 0 && ((s += u), (u = -u)),
      ...
      "number" == typeof c
        ...
        : (i = n = r = o = 0),
      u < i + n && ((i *= u / (a = i + n)), (n *= u / a)),
      u < r + o && ((r *= u / (a = r + o)), (o *= u / a)),
      h < n + r && ((n *= h / (a = n + r)), (r *= h / a)),
      h < i + o && ((i *= h / (a = i + o)), (o *= h / a)),
      t.moveTo(s + i, l),
      t.lineTo(s + u - n, l),
    ...
    n.rich
      ...
      : (function (t, e, i, n, r, o) {
          var a,
            s = zn(n),
            l = !1,
            u = e.__attrCachedBy === Ni.PLAIN_TEXT;
          o !== Ri
            ? (o && ((a = o.style), (l = !s && u && a)),
              (e.__attrCachedBy = s ? Ni.NONE : Ni.PLAIN_TEXT))
            : u && (e.__attrCachedBy = Ni.NONE);
          var h = n.font || Sn;
          (l && h === (a.font || Sn)) || (e.font = h);
  ...
  function On(t, e, i, n, r, o, a, s) {
    ...
    var c = i.textPadding;
    c && ((a = Wn(a, s, c)), (h -= i.height / 2 - c[2] - i.textHeight / 2)),
    ...
    d &&
      (Bn(e, "lineWidth", p),
      Bn(e, "strokeStyle", d),
      e.strokeText(i.text, a, h)),
      f && (Bn(e, "fillStyle", f), e.fillText(i.text, a, h));
  }
  function zn(t) {
    return !!(
      ...
      brush: function (t, e) {
        ...
        if (r && tn(r)) {
          ...
          if (
            ...
            var h = i.sx || 0,
              c = i.sy || 0;
            t.drawImage(r, h, c, i.sWidth, i.sHeight, o, a, s, l);
          } else if (i.sx && i.sy) {
            var d = s - (h = i.sx),
              f = l - (c = i.sy);
  ...
  var hr = ur.prototype;
  hr.stopPropagation = hr.stopImmediatePropagation = hr.preventDefault = J;
  var cr = {
        ...
        if ("dataIndex" !== e && "dataIndexInside" !== e) {
          ...
          if (
            !(
              ...
              null == t ||
              ("index" === r && "none" === t) ||
              (u && u.includeMainTypes && x(u.includeMainTypes, n) < 0)
            )
          ) {
            var o = { mainType: n };
            ("index" === r && "all" === t) || (o[r] = t);
            var a = s.queryComponents(o);
            (h[n + "Models"] = a), (h[n + "Model"] = a[0]);
          }
        } else h[e] = t;
      }),
      h
  ...
  var Ro = [],
    Bo = [];
  function Vo(t, e, i, n, r, o, a, s, l, u) {
    var h,
      c = wo,
      d = _o,
      f = c(t, i, r, a, Ro);
    for (
      ...
      var p = d(t, i, r, a, Ro[h]);
      (l[0] = To(p, l[0])), (u[0] = Ao(p, u[0]));
    }
    for (f = c(e, n, o, s, Bo), h = 0; h < f; h++) {
      var g = d(e, n, o, s, Bo[h]);
      (l[1] = To(g, l[1])), (u[1] = Ao(g, u[1]));
    }
    (l[0] = To(t, l[0])),
      (u[0] = Ao(t, u[0])),
      (l[0] = To(a, l[0])),
  ...
  function ta(t, e, i, n, r, o, a) {
    ...
    var u = (l = (e - n) / (t - i)) * o - a + (t * n - i * e) / (t - i);
    return (u * u) / (l * l + 1) <= ((s / 2) * s) / 2;
  }
  function ea(t, e, i, n, r, o, a, s, l, u, h) {
    if (0 === l) return !1;
    var c = l;
    return (
      !(
        (e + c < h && n + c < h && o + c < h && s + c < h) ||
        (h < e - c && h < n - c && h < o - c && h < s - c) ||
        (t + c < u && i + c < u && r + c < u && a + c < u) ||
        (u < t - c && u < i - c && u < r - c && u < a - c)
      ) &&
      (function (t, e, i, n, r, o, a, s, l, u, h) {
        var c,
          d,
          f,
          p,
        ...
        return (
          h && ((h[0] = _o(t, i, r, a, c)), (h[1] = _o(e, n, o, s, c))), lo(v)
        );
      })(t, e, i, n, r, o, a, s, u, h, null) <=
        c / 2
    );
  }
    ...
    return (
      ...
      (function (t, e, i, n, r, o, a, s, l) {
        ...
        for (var d = 0; d < 1; d += 0.05) {
          (go[0] = So(t, i, r, d)),
            (go[1] = So(e, n, o, d)),
            (m = vt(po, go)) < c && ((u = d), (c = m));
        }
        c = 1 / 0;
        for (var f = 0; f < 32 && !(h < ho); f++) {
          var p = u - h,
            g = u + h;
        ...
        return l && ((l[0] = So(t, i, r, u)), (l[1] = So(e, n, o, u))), lo(c);
  ...
  (Jo.prototype = {
    ...
    _dashedLineTo: function (t, e) {
      var i,
        ...
        g = a.length;
      for (
        o < 0 && (o = r + o), f -= (o %= r) * (h /= d), p -= o * (c /= d);
        (0 < h && f <= t) ||
        (h < 0 && t <= f) ||
        (0 === h && ((0 < c && p <= e) || (c < 0 && e <= p)));

      )
        (f += h * (i = a[(n = this._dashIdx)])),
          (p += c * i),
          (this._dashIdx = (n + 1) % g),
          (0 < h && f < l) ||
            (h < 0 && l < f) ||
      ...
      (h = f - t), (c = p - e), (this._dashOffset = -$o(h * h + c * c));
    },
  ...
  var ca = [-1, -1, -1],
    da = [-1, -1];
  function fa(t, e, i, n, r, o, a, s, l, u) {
    if (
      (e < u && n < u && o < u && s < u) ||
      (u < e && u < n && u < o && u < s)
    )
    ...
    for (var d, f, p = 0, g = -1, m = 0; m < c; m++) {
      ...
      _o(t, i, r, a, v) < l ||
        (g < 0 &&
          ...
          da[1] < da[0] &&
            1 < g &&
            (void 0, (h = da[0]), (da[0] = da[1]), (da[1] = h)),
          (d = _o(e, n, o, s, da[0])),
  ...
  function pa(t, e, i, n, r, o, a, s) {
    ...
    var l = (function (t, e, i, n, r) {
      var o = t - 2 * e + i,
        ...
        l = 0;
      if (vo(o)) {
        if (yo(a)) 0 <= (h = -s / a) && h <= 1 && (r[l++] = h);
      } else {
        var u = a * a - 4 * o * s;
        if (vo(u)) 0 <= (h = -a / (2 * o)) && h <= 1 && (r[l++] = h);
        else if (0 < u) {
          var h,
            c = lo(u),
            d = (-a - c) / (2 * o);
          0 <= (h = (-a + c) / (2 * o)) && h <= 1 && (r[l++] = h),
            0 <= d && d <= 1 && (r[l++] = d);
        }
      }
      return l;
    ...
    var u = Io(e, n, o);
    if (0 <= u && u <= 1) {
      for (var h = 0, c = So(e, n, o, u), d = 0; d < l; d++) {
        var f = 0 === ca[d] || 1 === ca[d] ? 0.5 : 1;
        So(t, i, r, ca[d]) < a ||
          (ca[d] < u ? (h += c < e ? f : -f) : (h += o < c ? f : -f));
      }
      return h;
    }
  ...
  function ga(t, e, i, n, r, o, a, s) {
    ...
    if (u % ua < 1e-4) {
      r = ua;
      var h = o ? 1 : -1;
      return a >= ca[(n = 0)] + t && a <= ca[1] + t ? h : 0;
    }
    if (o) {
      l = n;
      (n = ra(r)), (r = ra(l));
  ...
  function ma(t, e, i, n, r) {
    for (var o = 0, a = 0, s = 0, l = 0, u = 0, h = 0; h < t.length; ) {
      var c = t[h++];
      switch (
        (c === la.M && 1 < h && (i || (o += sa(a, s, l, u, n, r))),
        1 === h && ((l = a = t[h]), (u = s = t[h + 1])),
        c)
      ) {
        case la.M:
          (a = l = t[h++]), (s = u = t[h++]);
        ...
        case la.L:
          if (i) {
            if (ta(a, s, t[h], t[h + 1], e, n, r)) return !0;
          } else o += sa(a, s, t[h], t[h + 1], n, r) || 0;
          (a = t[h++]), (s = t[h++]);
          break;
        case la.C:
          if (i) {
            if (
              ea(a, s, t[h++], t[h++], t[h++], t[h++], t[h], t[h + 1], e, n, r)
            )
              return !0;
          } else
            o +=
              fa(a, s, t[h++], t[h++], t[h++], t[h++], t[h], t[h + 1], n, r) ||
              0;
          (a = t[h++]), (s = t[h++]);
          break;
        case la.Q:
          if (i) {
            if (ia(a, s, t[h++], t[h++], t[h], t[h + 1], e, n, r)) return !0;
          } else o += pa(a, s, t[h++], t[h++], t[h], t[h + 1], n, r) || 0;
          (a = t[h++]), (s = t[h++]);
          break;
        case la.A:
          var d = t[h++],
        ...
        case la.R:
          ...
          if (i) {
            if (
              ...
              return !0;
          } else (o += sa(_, u, _, x, n, r)), (o += sa(l, x, l, u, n, r));
          break;
        case la.Z:
          if (i) {
            if (ta(a, s, l, u, e, n, r)) return !0;
          } else o += sa(a, s, l, u, n, r);
          (a = l), (s = u);
      }
    }
    return (
  ...
  function Oa(t, e, i, n, r, o, a, s, l, u, h) {
    var c = l * (ka / 180),
    ...
    var i = (function (t) {
      ...
      for (
        ...
        for (var m = 0; m < p; ) {
          ...
          switch (d) {
            case "l":
              (i += f[m++]), (n += f[m++]), (h = s.L), a.addData(h, i, n);
              break;
            case "L":
              (i = f[m++]), (n = f[m++]), (h = s.L), a.addData(h, i, n);
              break;
            ...
            case "M":
              ...
              break;
            case "h":
              (i += f[m++]), (h = s.L), a.addData(h, i, n);
              break;
            case "H":
              (i = f[m++]), (h = s.L), a.addData(h, i, n);
              break;
            case "v":
              (n += f[m++]), (h = s.L), a.addData(h, i, n);
              break;
            case "V":
              (n = f[m++]), (h = s.L), a.addData(h, i, n);
              break;
            case "C":
              (h = s.C),
                a.addData(h, f[m++], f[m++], f[m++], f[m++], f[m++], f[m++]),
                (i = f[m - 2]),
                (n = f[m - 1]);
              break;
            case "c":
        ...
        ("z" !== d && "Z" !== d) || ((h = s.Z), a.addData(h), (i = r), (n = o)),
          (e = h);
      }
      return a.toStatic(), a;
    })(t);
          ...
          (n = (function (t, e) {
            ...
            for (o = 0; o < a; o++) {
              ...
              var p = d * d,
                g = d * p;
              n.push([
                Za(s[0], f[0], l[0], u[0], d, p, g),
                Za(s[1], f[1], l[1], u[1], d, p, g),
              ]);
            }
            return n;
          })(n, i)),
  ...
  (us.prototype = { constructor: us }),
    w(us, rs),
    (hs.prototype.incremental = !0),
    (hs.prototype.clearDisplaybles = function () {
      (this._displayables = []),
        (this._temporaryDisplayables = []),
        (this._cursor = 0),
        this.dirty(),
    ...
    (hs.prototype.addDisplayable = function (t, e) {
      e ? this._temporaryDisplayables.push(t) : this._displayables.push(t),
        this.dirty();
    }),
    (hs.prototype.addDisplayables = function (t, e) {
      e = e || !1;
      for (var i = 0; i < t.length; i++) this.addDisplayable(t[i], e);
    }),
    (hs.prototype.eachPendingDisplayable = function (t) {
    ...
    (hs.prototype.brush = function (t, e) {
  ...
  (hs.prototype.getBoundingRect = function () {
    ...
    (hs.prototype.contain = function (t, e) {
      var i = this.transformCoordToLocal(t, e);
  ...
  function Ys(t, e, i, n, r, o, a) {
    ...
    (d || f) &&
      ...
      null == s &&
        (s = z(r.defaultText) ? r.defaultText(u, r) : r.defaultText));
    var p = d ? s : null,
      g = f
        ? W(l ? l.getFormattedLabel(u, "emphasis", null, h, c) : null, s)
        : null;
  ...
  function el(t, e, i, n, r, o) {
    if (
      ...
      var a = t ? "Update" : "",
        ...
        u = n.getShallow("animationDelay" + a);
      "function" == typeof u &&
        (u = u(
          r,
  ...
  var dl = (Object.freeze || Object)({
      ...
      linePolygonIntersect: function (t, e, i, n, r) {
        for (var o = 0, a = r[r.length - 1]; o < r.length; o++) {
          var s = r[o];
          if (hl(t, e, i, n, s[0], s[1], a[0], a[1])) return !0;
          a = s;
        }
      },
      lineLineIntersect: hl,
      Group: Si,
      Image: Yn,
      Text: Ba,
      Circle: Fa,
  ...
  function ql(t, e, i) {
    ...
    for (var s = 0; s < n; s++)
      for (var l = 0; l < r.length; l++) {
        var u = e[s][r[l]];
        t = t.replace(Yl(jl[l], s), i ? Xl(u) : u);
      }
    return t;
  }
  function $l(t, e) {
  ...
  var iu = (Object.freeze || Object)({
      ...
      getTextRect: function (t, e, i, n, r, o, a, s) {
        return un(t, e, i, n, r, s, o, a);
      },
      windowOpen: eu,
    }),
    nu = D,
    ru = ["left", "right", "top", "bottom", "width", "height"],
    ou = [
      ["width", "left", "right"],
      ["height", "top", "bottom"],
    ];
  function au(h, c, d, f, p) {
    var g = 0,
      m = 0;
    ...
    c.eachChild(function (t, e) {
      ...
      if ("horizontal" === h) {
        ...
        var u = o.height + (s ? -s.y + o.y : 0);
        v =
          p < (n = m + u) || t.newline
            ? ((g += v + d), (m = 0), (n = u), o.width)
            : Math.max(v, o.width);
      }
      t.newline ||
        ((r[0] = g),
  ...
  function lu(t, e, i) {
    ...
    switch (
      ...
      isNaN(h) && (h = r - l - c - a),
      null != f &&
        (isNaN(u) && isNaN(h) && (n / r < f ? (u = 0.8 * n) : (h = 0.8 * r)),
        isNaN(u) && (u = f * h),
        isNaN(h) && (h = u / f)),
      isNaN(o) && (o = n - s - u - d),
      isNaN(a) && (a = r - l - h - c),
  ...
  function uu(t, e, i, n, r) {
    ...
    if (o || a) {
      ...
      e = lu(A({ width: l.width, height: l.height }, e), i, n);
      var h = t.position,
        c = o ? e.x - l.x : 0,
        d = a ? e.y - l.y : 0;
  ...
  function hu(l, u, t) {
    ...
    function n(t, e) {
      ...
      if (
        ...
        nu(t, function (t) {
          c(u, t) && (i[t] = r[t] = u[t]), d(i, t) && n++, d(r, t) && o++;
        }),
        h[e])
      )
        return (
          d(u, t[1]) ? (r[t[2]] = null) : d(u, t[2]) && (r[t[1]] = null), r
        );
      if (2 !== o && n) {
        if (2 <= n) return i;
  ...
  eo(vu, { registerWhenExtend: !0 }),
    (pu = {}),
    ((fu = vu).registerSubTypeDefaulter = function (t, e) {
      (t = qr(t)), (pu[t.main] = e);
    }),
    (fu.determineSubType = function (t, e) {
      ...
      if (!i) {
        var n = qr(t).main;
        fu.hasSubTypes(t) && pu[n] && (i = pu[n](e));
      }
      return i;
    }),
    (gu = function (t) {
      var e = [];
      D(vu.getClassesByMainType(t), function (t) {
    ...
    (vu.topologicalTravel = function (t, e, i, n) {
      if (t.length) {
        var r = (function (e) {
            var r = {},
              o = [];
  ...
  var _u = "";
  "undefined" != typeof navigator && (_u = navigator.platform || "");
  var xu = {
      color: [
        "#c23531",
        "#2f4554",
      ...
      textStyle: {
        fontFamily: _u.match(/^Win/) ? "Microsoft YaHei" : "sans-serif",
        fontSize: 12,
        fontStyle: "normal",
        fontWeight: "normal",
      },
  ...
  var bu = {
      clearColorPalette: function () {
        (wu(this).colorIdx = 0), (wu(this).colorNameMap = {});
      },
      getColorFromPalette: function (t, e, i) {
        ...
        if ((l = l || a) && l.length) {
          var u = l[r];
          return t && (o[t] = u), (n.colorIdx = (r + 1) % l.length), u;
        }
      },
    },
    Su = "original",
  ...
  function Pu(t) {
    (this.fromDataset = t.fromDataset),
      (this.data = t.data || (t.sourceFormat === Cu ? {} : [])),
      (this.sourceFormat = t.sourceFormat || Tu),
      (this.seriesLayoutBy = t.seriesLayoutBy || Du),
  ...
  (Pu.seriesDataToSource = function (t) {
    return new Pu({ data: t, sourceFormat: B(t) ? Au : Su, fromDataset: !1 });
  }),
    Qr(Pu);
  var Lu = { Must: 1, Might: 2, Not: 3 },
    Ou = Hr();
  function zu(t) {
    var e = t.option,
      i = e.data,
    ...
    var h = (function (t, e, i, n, r) {
      if (!t) return { dimensionsDefine: Eu(r) };
      var o, a;
      if (e === Mu)
        "auto" === n || null == n
          ? Nu(
          ...
          (o = r ? r.length : i === ku ? t.length : t[0] ? t[0].length : null);
      else if (e === Iu)
        r =
          r ||
          (function (t) {
  ...
  function Ru(i, t, e) {
    ...
    var d = h.get(c) || h.set(c, { categoryWayDim: r, valueWayDim: 0 });
    function f(t, e, i) {
  ...
  function Bu(t, l, u) {
    ...
    (c !== Iu && c !== Cu) ||
      D(d, function (t, e) {
        "name" === (N(t) ? t.name : t) && (h = e);
      });
    var i = (function () {
      for (var t = {}, e = {}, i = [], n = 0, r = Math.min(5, u); n < r; n++) {
        var o = Fu(l.data, c, l.seriesLayoutBy, d, l.startIndex, n);
        i.push(o);
        var a = o === Lu.Not;
        if (
          (a && null == t.v && n !== h && (t.v = n),
          (null != t.n && t.n !== t.v && (a || i[t.n] !== Lu.Not)) || (t.n = n),
          s(t) && i[t.n] !== Lu.Not)
        )
          return t;
        a ||
          (o === Lu.Might && null == e.v && n !== h && (e.v = n),
  ...
  function Fu(t, e, i, n, r, o) {
    var a, s, l;
    if (B(t)) return Lu.Not;
    if (n) {
      var u = n[o];
      N(u) ? ((s = u.name), (l = u.type)) : E(u) && (s = u);
    }
    if (null != l) return "ordinal" === l ? Lu.Must : Lu.Not;
    if (e === Mu)
      if (i === ku) {
        for (var h = t[o], c = 0; c < (h || []).length && c < 5; c++)
          if (null != (a = g(h[r + c]))) return a;
      } else
      ...
      if (!s) return Lu.Not;
      if (!(h = t[s]) || B(h)) return Lu.Not;
      for (c = 0; c < h.length && c < 5; c++)
        if (null != (a = g(h[c]))) return a;
    } else if (e === Su)
      for (c = 0; c < t.length && c < 5; c++) {
        var f,
          p = Er((f = t[c]));
        if (!O(p)) return Lu.Not;
  ...
  var Hu = "\0_ec_inner",
    Wu = _l.extend({
      ...
      setOption: function (t, e) {
        X(!(Hu in t), "please use chart.getOption()"),
      ...
      mergeOption: function (n) {
        ...
        !(function (t) {
          ...
          vu.topologicalTravel(
            i,
            vu.getAllClassMainTypes(),
            function (a, t) {
              var e = Lr(n[a]),
                i = Nr(u.get(a), e);
              Rr(i),
                ...
                D(
                  ...
                  function (t, e) {
                    ...
                    if ((X(N(n) || i, "Empty component definition"), n)) {
                      var r = vu.getClass(a, t.keyInfo.subType, !0);
                    ...
                    (u.get(a)[e] = i), (l[a][e] = i.option);
                  },
                  this
                ),
                "series" === a && Gu(this, u.get("series"));
            },
            this
          ),
      ...
      findComponents: function (t) {
        ...
        return (o = Zu(u, t)), t.filter ? I(o, t.filter) : o;
      },
      ...
      restoreData: function (i) {
        ...
        n.each(function (t, e) {
          ...
          vu.topologicalTravel(r, vu.getAllClassMainTypes(), function (e, t) {
  ...
  th.prototype = {
    ...
    mountOption: function (t) {
      ...
      return (
        (this._timelineOptions = Ku(e.timelineOptions, $u)),
        (this._mediaList = Ku(e.mediaList, $u)),
        (this._mediaDefault = $u(e.mediaDefault)),
        (this._currentMediaIndices = []),
        $u(t ? e.baseOption : this._newBaseOption)
      );
    },
    ...
    getMediaOption: function (t) {
      ...
      return (
        ...
        o.length &&
          ...
          (a = Ku(o, function (t) {
            return $u(-1 === t ? r.option : n[t].option);
          })),
  ...
  function uh(t) {
    t && (sh(t), lh(t, "label"), t.emphasis && lh(t.emphasis, "label"));
  }
  function hh(t) {
    return O(t) ? t : t ? [t] : [];
  }
        ...
        (function (t) {
          if (nh(t)) {
            oh(t),
              ...
              (i = t.markPoint) && (oh(i), uh(i)),
              (n = t.markLine) && (oh(n), uh(n));
            var e = t.markArea;
            e && uh(e);
            var i,
              n,
            ...
            if ("graph" === t.type) {
              ...
              if (o && !B(o)) for (var a = 0; a < o.length; a++) uh(o[a]);
              D(t.categories, function (t) {
                sh(t);
              });
            }
            if (r && !B(r)) for (a = 0; a < r.length; a++) uh(r[a]);
            if ((i = t.markPoint) && i.data) {
              var s = i.data;
              for (a = 0; a < s.length; a++) uh(s[a]);
            }
            if ((n = t.markLine) && n.data) {
              var l = n.data;
              for (a = 0; a < l.length; a++)
                O(l[a]) ? (uh(l[a][0]), uh(l[a][1])) : uh(l[a]);
            }
            "gauge" === t.type
              ? (lh(t, "axisLabel"), lh(t, "title"), lh(t, "detail"))
              : "treemap" === t.type
              ? (ah(t.breadcrumb, "itemStyle"),
    ...
    t && i.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"),
      ih(i, function (t) {
        ih(hh(e[t]), function (t) {
          t && (lh(t, "axisLabel"), lh(t.axisPointer, "label"));
        });
      }),
      ih(hh(e.parallel), function (t) {
        var e = t && t.parallelAxisDefault;
        lh(e, "axisLabel"), lh(e && e.axisPointer, "label");
      }),
      ...
      ih(hh(e.timeline), function (t) {
        uh(t), ah(t, "label"), ah(t, "itemStyle"), ah(t, "controlStyle", !0);
        var e = t.data;
        O(e) &&
          D(e, function (t) {
            N(t) && (ah(t, "label"), ah(t, "itemStyle"));
          });
      }),
    ...
    D(m, function (h, c) {
      var d = [],
        ...
        e = p.map(t, function (t, e, i) {
          var n,
            r,
            o = p.get(h.stackedDimension, i);
          if (isNaN(o)) return f;
          g ? (r = p.getRawIndex(i)) : (n = p.get(h.stackedByDimension, i));
  ...
  function yh(t, e) {
    Pu.isInstance(t) || (t = Pu.seriesDataToSource(t)), (this._source = t);
    var i = (this._data = t.data),
      n = t.sourceFormat;
    n === Au && ((this._offset = 0), (this._dimSize = e), (this._data = i)),
      k(this, xh[n === Mu ? n + "_" + t.seriesLayoutBy : n]);
  }
  var _h = yh.prototype;
  _h.pure = !1;
  var xh = {
    arrayRows_column: {
      pure: (_h.persistent = !0),
      count: function () {
    ...
    objectRows: { pure: !0, count: wh, getItem: bh, appendData: Sh },
    keyedColumns: {
      pure: !0,
      count: function () {
    ...
    original: { count: wh, getItem: bh, appendData: Sh },
    typedArray: {
      persistent: !(_h.getSource = function () {
        return this._source;
      }),
      pure: !0,
      count: function () {
  ...
  var Ch = {
    arrayRows: Th,
    objectRows: function (t, e, i, n) {
      return Ah(t[e], this._dimensionInfos[e]);
    },
    keyedColumns: Th,
    original: function (t, e, i, n) {
      ...
      return (
        ...
        Ah(r instanceof Array ? r[n] : r, this._dimensionInfos[e])
      );
    },
  ...
  function Th(t, e, i, n) {
    return Ah(t[n], this._dimensionInfos[e]);
  }
  function Ah(t, e) {
    var i = e && e.type;
    if ("ordinal" !== i)
  ...
  function Dh(t, e, i) {
    if (t) {
      ...
      if (null != n) {
        ...
        return s && ((r = s.name), (o = s.index)), Mh[a](n, e, o, r);
      }
    }
  }
  function kh(t, e, i) {
    if (t) {
      ...
      if (n === Su || n === Iu) {
        ...
        return n !== Su || N(r) || (r = null), r ? r[i] : void 0;
      }
    }
  }
  var Ph = /\{@(.+?)\}/g,
    Lh = {
      ...
      getFormattedLabel: function (n, t, e, i, r) {
        ...
        return "function" == typeof l
          ...
          : "string" == typeof l
          ? ql(l, s).replace(Ph, function (t, e) {
              var i = e.length;
              return (
                "[" === e.charAt(0) &&
                  "]" === e.charAt(i - 1) &&
  ...
  Eh.perform = function (t) {
    ...
    if (
      ...
      if (!n && (o || d < f)) {
        ...
        if (O(p)) for (var g = 0; g < p.length; g++) Uh(this, p[g], d, f, l, u);
        else Uh(this, p, d, f, l, u);
      }
      this._dueIndex = f;
    ...
    Wh = (Hh = {
      reset: function (t, e, i, n) {
        (Rh = t),
          ...
          (Vh = n),
          (Fh = Math.ceil(Vh / Bh)),
          (Hh.next = 1 < Bh && 0 < Vh ? Zh : Gh);
      },
    });
  function Gh() {
    return Rh < Nh ? Rh++ : null;
  }
  function Zh() {
    var t = (Rh % Fh) * Bh + Math.ceil(Rh / Fh),
      e = Nh <= Rh ? null : t < Vh ? t : Rh;
    return Rh++, e;
  }
  function Uh(t, e, i, n, r, o) {
    Wh.reset(i, n, r, o),
      (t._callingProgress = e),
      t._callingProgress(
        { start: i, end: n, count: n - i, next: Wh.next },
        t.context
      );
  }
  (Eh.dirty = function () {
    ...
    (Eh.getUpstream = function () {
      return this._upstream;
    }),
    (Eh.getDownstream = function () {
      return this._downstream;
    }),
    (Eh.setOutputEnd = function (t) {
    ...
    Yh = vu.extend({
      ...
      init: function (t, e, i, n) {
        (this.seriesIndex = this.componentIndex),
          (this.dataTask = Oh({ count: qh, reset: $h })),
      ...
      mergeOption: function (t, e) {
        ...
        var i = this.layoutMode;
        i && hu(this.option, t, i), zu(this);
        var n = this.getInitialData(t, e);
        Qh(n, this),
          this.dataTask.dirty(),
          (this.dataTask.context.data = n),
          (Xh(this).dataBeforeProcessed = n),
          jh(this);
      },
      ...
      getRawData: function () {
        return Xh(this).dataBeforeProcessed;
      },
      getBaseAxis: function () {
        var t = this.coordinateSystem;
        return t && t.getBaseAxis && t.getBaseAxis();
      },
      formatTooltip: function (r, h, t, c) {
        var d = this,
          e = "html" === (c = c || "html") ? "<br/>" : "\n",
          f = "richText" === c,
          p = {},
        ...
        var l = (1 < n || (s && !n)
            ...
            : i(n ? Dh(m, r, o[0]) : s ? a[0] : a)
          ).content,
          u = d.seriesIndex + "at" + g,
          y = $l({ color: v, type: "item", renderMode: c, markerId: u });
        (p[u] = v), ++g;
        var _ = m.getName(r),
          x = this.name;
        Br(this) || (x = ""), (x = x ? Xl(x) + (h ? ": " : e) : "");
        var w = "string" == typeof y ? y : y.content;
        return {
          html: h ? w + x + l : x + w + (_ ? Xl(_) + ": " + l : l),
          markers: p,
        };
      },
      isAnimationEnabled: function () {
      ...
      getColorFromPalette: function (t, e, i) {
        var n = this.ecModel,
          r = bu.getColorFromPalette.call(this, t, e, i);
  ...
  function ac() {
    (this.group = new Si()),
      ...
      (this.renderTask = Oh({ plan: hc, reset: cc })),
  ...
  var sc = (ac.prototype = {
    ...
    highlight: function (t, e, i, n) {
      uc(t.getData(), n, "emphasis");
    },
    downplay: function (t, e, i, n) {
      uc(t.getData(), n, "normal");
    },
    remove: function (t, e) {
      ...
      D(
        ...
        function (t) {
          ...
          t.reset &&
            (function (n, r, t, o, a) {
              ...
              function l(t) {
                var e = t.uid,
                  i =
                    s.get(e) ||
                    s.set(e, Oh({ plan: Pc, reset: Lc, count: Ec }));
                (i.context = {
                  model: t,
                  ecModel: o,
                  api: a,
            ...
            t.overallReset &&
              (function (n, t, e, i, r) {
                var o = (e.overallTask = e.overallTask || Oh({ reset: Tc }));
                o.context = {
                  ecModel: i,
                  api: r,
                ...
                function c(t) {
                  var e = t.uid,
                    i = a.get(e);
                  i ||
                    ((i = a.set(e, Oh({ reset: Ac, onDirty: kc }))), o.dirty()),
                    (i.context = {
                      model: t,
                      overallProgress: u,
                      modifyOutputEnd: h,
  ...
  function ed(t, e, i, n) {
    ...
    var h = e.style;
    null != r.fill && h.set(l, nd(r.fill, i)),
      null != r.stroke && h.set(u, nd(r.stroke, i)),
      D(
        [
          "lineWidth",
          "opacity",
    ...
    sd = function (t, e, i) {
      ...
      return (
        D(
          ...
          function (t) {
            var e = t.type;
            "geoJson" === e && (e = t.type = "geoJSON"), (0, ud[e])(t);
          }
        ),
        ad.set(t, n)
      );
    ...
    (bd.setOption = function (t, e, i) {
      if (!this._disposed) {
        ...
        if (
          ...
          var r = new th(this._api),
            o = this._theme,
            a = (this._model = new Wu());
  ...
  function Cd(e, i, n, r, t) {
    ...
    } else cd(e._componentsViews.concat(e._chartsViews), u);
    function u(t) {
  ...
  function Ad(e, t) {
    ...
    cd(
      l,
      function (t) {
        ((h = (h = r.action(t, this._model, this._api)) || k({}, t)).type =
          o.event || h.type),
          c.push(h),
      ...
      "none" === s ||
        ...
        (this[vd]
          ...
          : Md[s].call(this, e)),
      (h = u ? { type: o.event || i, escapeConnect: n, batch: c } : c[0]),
      (this[md] = !1),
        ...
        (t.resize = function () {
          var t = ln(o.text, s),
            ...
            i =
              ...
              (o.showSpinner ? 0 : t / 2),
            n = r.getHeight() / 2;
          o.showSpinner && u.setShape({ cx: i, cy: n }),
  ...
  function Lf(t, e, i, n, r) {
    var o = bf[e.type],
      ...
      l = t[s][a];
    if (l && l.length < i) {
      for (var u = new o(Math.min(r - a * i, i)), h = 0; h < l.length; h++)
        u[h] = l[h];
      t[s][a] = u;
    }
  ...
  (Pf.type = "list"),
    ...
    (Pf.initData = function (t, e, i) {
      (Pu.isInstance(t) || L(t)) && (t = new yh(t, this.dimensions.length)),
        (this._rawData = t),
        (this._storage = {}),
        (this._indices = null),
        (this._nameList = e || []),
        ...
        (this.defaultDimValueGetter =
          Ch[this._rawData.getSource().sourceFormat]),
        (this._dimValueGetter = i = i || this.defaultDimValueGetter),
        (this._dimValueGetterArrayRows = Ch.arrayRows),
        (this._rawExtent = {}),
    ...
    (Pf.appendValues = function (t, e) {
      for (
        ...
        a[(v = r[h])] || (a[v] = Hf()),
          n[v] || (n[v] = []),
          Lf(n, this._dimensionInfos[v], i, u, l),
      ...
      if (this._count) {
        ...
        for (
          ...
          if (0 === s) c = e.call(i, h);
            ...
            for (var p = 0; p < s; p++) a[p] = this._getFast(u, d);
            (a[p] = h), (c = e.apply(i, a));
          }
          c && (o[l++] = d);
        }
    ...
    (Pf.downSample = function (t, e, i, n) {
      for (
        ...
        var _ = i(a),
          x = this.getRawIndex(Math.min(p + n(a, _) || 0, u - 1)),
          w = x % h;
        (l[Math.floor(x / h)][w] = _) < c[0] && (c[0] = _),
          _ > c[1] && (c[1] = _),
          (d[f++] = x);
      }
  ...
  function Gf(t, e, i) {
    Pu.isInstance(e) || (e = Pu.seriesDataToSource(e)),
      (i = i || {}),
      (t = (t || []).slice());
    for (
      ...
      var u = (n[s] = k({}, N(n[s]) ? n[s] : { name: n[s] })),
        h = u.name,
        c = (l[s] = new _f());
      null != h &&
        null == r.get(h) &&
        ((c.name = c.displayName = h), r.set(h, s)),
  ...
  function Qf(t, e, i) {
    (i = i || {}), Pu.isInstance(t) || (t = Pu.seriesDataToSource(t));
    var n,
    ...
    var s,
      ...
      u = Uf(t, {
        ...
        encodeDefaulter: i.useEncodeDefaulter ? T(Ru, n, e) : null,
      });
    a &&
      D(u, function (t, e) {
        var i = t.coordDim,
    ...
    cp = Jf.extend({
      ...
      getTicks: function (t) {
        var e = this._interval,
          ...
          o = [];
        if (!e) return o;
        i[0] < n[0] && (t ? o.push(hp(n[0] - e, r)) : o.push(i[0]));
        for (
          var a = n[0];
          a <= n[1] && (o.push(a), (a = hp(a + e, r)) !== o[o.length - 1]);

        )
          if (1e4 < o.length) return [];
        var s = o.length ? o[o.length - 1] : n[1];
        return i[1] > s && (t ? o.push(hp(s + e, r)) : o.push(i[1])), o;
      },
      getMinorTicks: function (t) {
        for (
          ...
          for (
            var o = e[r], a = e[r - 1], s = 0, l = [], u = (o - a) / t;
            s < t - 1;
      ...
      niceExtent: function (t) {
        ...
        t.fixMin || (e[0] = hp(Math.floor(e[0] / r) * r)),
          t.fixMax || (e[1] = hp(Math.ceil(e[1] / r) * r));
      },
    });
  cp.create = function () {
    return new cp();
        ...
        return (
          D(d, function (t, i) {
            ...
            var u,
              h = 0;
            D(e, function (t, e) {
              t.width || (t.width = l), (h += (u = t).width * (1 + o));
            }),
              u && (h -= u.width * o);
            var c = -h / 2;
            D(e, function (t, e) {
            ...
            progress: function (t, e) {
              ...
              for (; null != (i = t.next()); )
                (l[y] = e.get(g, i)),
                  ...
                  (o[u] = v ? d.x + d.width : s[0]),
                  (r[u++] = s[0]),
                  (o[u] = v ? s[1] : d.y + d.height),
                  (r[u++] = s[1]),
                  (a[h++] = i);
              e.setLayout({
                largePoints: r,
    ...
    Ap = cp.extend({
      ...
      niceTicks: function (t, e, i) {
        ...
        var a = Dp.length,
          ...
          l = Dp[Math.min(s, a - 1)],
          u = l[1];
        "year" === l[0] && (u *= Vl(r / u / t, !0));
        var h = this.getSetting("useUTC")
            ? 0
            : 60 * new Date(+n[0] || +n[1]).getTimezoneOffset() * 1e3,
          c = [
            Math.round(Mp((n[0] - h) / u) * u + h),
            Math.round(Ip((n[1] - h) / u) * u + h),
          ];
        up(c, n),
          (this._stepLvl = l),
          (this._interval = u),
  ...
  function Fp(t, e) {
    ...
    return { extent: [a, s], fixMin: u, fixMax: h };
  }
  function Hp(t, e) {
    var i = Fp(t, e),
      n = i.extent,
      ...
      (function (t) {
        ...
        for (var i = t.features, n = 0; n < i.length; n++)
          for (
            ...
            var l = o[s];
            if ("Polygon" === r.type) o[s] = ug(l, a[s], e);
  ...
  (Ag._updateCommon = function (i, t, e, n) {
    ...
    r.attr("rotation", ((m || 0) * Math.PI) / 180 || 0),
      u && r.attr("position", [Cl(u[0], e[0]), Cl(u[1], e[1])]),
      f && r.attr("cursor", f),
    ...
    l || a.removeAll(),
      r
        ...
        .update(function (t, e) {
          ...
          Vg(r, n, t, o)
            ? (i
                ? (i.updateData(r, t, h), il(i, { position: n }, s))
                : (i = new u(r, t)).attr("position", n),
              a.add(i),
  ...
  function Qg(t, e, i, n, r, o, a, s, l, u) {
    return "none" !== u && u
      ? function (t, e, i, n, r, o, a, s, l, u, h) {
  ...
  function im(t, e, i) {
    ...
    (o -= u / 2),
      ...
      (o = Math.floor(o)),
      (s = Math.round(s));
    var h = new Ja({ shape: { x: o, y: a, width: s, height: l } });
    return (
      e &&
        ((h.shape[r ? "width" : "height"] = 0),
        nl(h, { shape: { width: s, height: l } }, i)),
      h
    );
  }
  function nm(t, e, i) {
  ...
  ac.extend({
    ...
    _updateAnimation: function (t, e, i, n, r, o) {
      ...
      if (
        (r &&
          ((h = sm(u.current, i, r)),
          (c = sm(u.stackedOnCurrent, i, r)),
          (d = sm(u.next, i, r)),
          (f = sm(u.stackedOnNext, i, r))),
        3e3 < om(h, d) || (s && 3e3 < om(c, f)))
      )
        return (
          a.setShape({ points: d }),
              ...
              progress: function (t, e) {
                for (
                  ...
                  if (1 === p) {
                    ...
                    u = a[0] = e.get(f[0], r);
                    var h = (a[1] = e.get(f[1], r));
                    l = !isNaN(u) && !isNaN(h) && c.dataToPoint(a, null, s);
                  }
                  d
  ...
  function xm(o, t, a, e) {
    D(wm, function (r) {
      ...
      vu.registerSubTypeDefaulter(o + "Axis", T(a, o));
  }
  ...
  function Am(t, e, i, n) {
    ...
    if (s) {
      if (null != l) Dm(o[l]) && (r = o[l]);
        ...
        for (var u in o)
          if (o.hasOwnProperty(u) && Dm(o[u]) && !n[h(o[u])]) {
            r = o[u];
            break;
          }
      r && (n[h(r)] = !0);
                  ...
                  for (var _ = 0; _ < r; _ += y) {
                    var x = v(n ? n[_] : a[0] + _),
                      ...
                      b =
                        ...
                        (f = c.height),
                        (p =
                          d * Math.abs(Math.cos(h)) +
                          Math.abs(f * Math.sin(h))),
                        (g =
                          d * Math.abs(Math.sin(h)) +
                          Math.abs(f * Math.cos(h))),
                        new bi(c.x, c.y, p, g));
                    s ? s.union(b) : (s = b);
                  }
                  return s;
      ...
      axisLine: function () {
        ...
        if (t.get("axisLine.show")) {
          ...
          if (("number" == typeof u && (u = [u, u]), null != l)) {
            ...
            D(
              [
                { rotate: o.rotation + Math.PI / 2, offset: u[0], r: 0 },
                {
              ...
              function (t, e) {
                if ("none" !== l[e] && null != l[e]) {
                  var i = ig(l[e], -h / 2, -c / 2, h, c, s.stroke, !0),
                    n = t.r + t.offset,
                    r = [
      ...
      axisTickLabel: function () {
        ...
        !(function (t, e, i) {
          ...
          (function (u, h, c) {
            var d = h.axis;
            if (
              !H(c.axisLabelShow, h.get("axisLabel.show")) ||
              d.scale.isBlank()
            )
              return;
            ...
            return (
              D(t, function (t, e) {
                ...
                m &&
                  m[i] &&
                  m[i].textStyle &&
                  (o = new _l(m[i].textStyle, f, h.ecModel));
                var a = o.getTextColor() || h.get("axisLine.lineStyle.color"),
          ...
          (function (t, e, i) {
            ...
            for (
              ...
              for (
                var h = Wm(o[u], t._transform, s, l, "minorticks_" + u), c = 0;
                c < h.length;
                c++
              )
                t.group.add(h[c]);
      ...
      axisName: function () {
        ...
        if (i) {
          ...
          var f = s.getFont(),
            ...
            v =
              null != g && null != m
                ? tu(i, m, f, g, { minChar: 2, placeholder: p.placeholder })
                : i,
            y = e.get("tooltip", !0),
            _ = e.mainType,
      ...
      _splitLine: function (t, e) {
        ...
        if (!i.scale.isBlank()) {
          ...
          for (
            ...
            s
              ? ((h[0] = p), (h[1] = a.y), (c[0] = p), (c[1] = a.y + a.height))
              : ((h[0] = a.x), (h[1] = p), (c[0] = a.x + a.width), (c[1] = p));
            var g = l++ % o.length,
              m = u[f].tickValue;
            this._axisGroup.add(
              new es({
        ...
        if (a.length)
          for (
            ...
            for (var c = 0; c < a[h].length; c++) {
              var d = i.toGlobalCoord(a[h][c].coord);
              o
                ? ((s[0] = d),
                  (s[1] = r.y),
                  (l[0] = d),
    ...
    sv = ws({
      ...
      buildPath: function (t, e) {
        ...
        (h ? u - l < 2 * Math.PI : l - u < 2 * Math.PI) &&
          ...
          t.arc(c * s + i, d * s + n, a, -Math.PI + l, l, !h)),
          t.arc(i, n, o, l, u, !h),
          t.moveTo(f * o + i, p * o + n),
          t.arc(f * s + i, p * s + n, a, u - 2 * Math.PI, u - Math.PI, !h),
  ...
  k(_l.prototype, av),
    ff({
      ...
      _renderNormal: function (s, t, e) {
        ...
        h.diff(c)
          .add(function (t) {
            var e = h.getItemModel(t),
              i = mv[d.type](h, t, e);
            if ((y && m(t), h.hasValue(t))) {
              if (p) if (dv[d.type](g, i)) return void u.remove(n);
              var n = fv[d.type](t, i, l, f, !1, v);
              h.setItemGraphicEl(t, n),
                u.add(n),
                yv(n, h, t, e, i, s, l, "polar" === d.type);
            }
          })
          .update(function (t, e) {
            ...
            if (h.hasValue(t)) {
              if (p) if (dv[d.type](g, n)) return void u.remove(a);
              a
                ? il(a, { shape: n }, f, t)
                : (a = fv[d.type](t, n, l, f, !0, v)),
                h.setItemGraphicEl(t, a),
                u.add(a),
                yv(a, h, t, i, n, s, l, "polar" === d.type);
            } else u.remove(a);
          })
          .remove(function (t) {
        ...
        u.add(n), (this._backgroundEls = w), (this._data = h);
      },
      ...
      polar: function (t, e, i, n, r, o) {
        ...
        if (((s.name = "item"), n)) {
          ...
          (s.shape[l] = i ? 0 : e.startAngle),
            (u[l] = e[l]),
            dl[r ? "updateProps" : "initProps"](s, { shape: u }, n, t);
        }
        return s;
      },
    };
  ...
  function yv(t, e, i, n, r, o, a, s) {
    ...
    s || t.setShape("r", c.get("barBorderRadius") || 0),
      t.useStyle(
        A(
          { stroke: vv(r) ? "none" : h, fill: vv(r) ? "none" : l, opacity: u },
          c.getBarItemStyle()
        )
      );
  ...
  function xv(t, e, i) {
    ...
    if (t.get("showBackground", !0)) {
      var u = n.getLayout("largeBackgroundPoints"),
        h = [];
      h[1 - o] = n.getLayout("backgroundStart");
      var c = new _v({
        shape: { points: u },
        incremental: !!i,
        __startPoint: h,
  ...
  var Iv = df({
    ...
    getInitialData: function (t, e) {
      ...
      })(this, { coordDimensions: ["value"], encodeDefaulter: T(Bu, this) });
    },
  ...
  (Dv.updateData = function (t, e, i) {
    var n = this.childAt(0),
      ...
      u = k({}, l);
    u.label = null;
    var h = a.getShallow("animationTypeUpdate");
    i
      ? (n.setShape(u),
    ...
    (Dv._updateLabel = function (t, e, i) {
      ...
      if (!s || isNaN(s.x) || isNaN(s.y))
        ...
        var u = {
          ...
          h = { x: s.x, y: s.y };
        i
          ? (il(n, { shape: u }, o, e), il(r, { style: h }, o, e))
          : (n.attr({ shape: u }), r.attr({ style: h })),
      ...
      if (!n || n.from !== this.uid) {
        ...
        if (
          (r
            ...
            .execute(),
          s && 0 < r.count() && (l ? "scale" !== u : "transition" !== h))
        ) {
          for (
  ...
  var kv = Math.PI / 180;
  function Pv(r, t, e, i, n, o, a, s, l, u) {
    function h(t, e, i) {
    ...
    for (var f, p = 0, g = r.length, m = [], v = [], y = 0; y < g; y++) {
      if ("outer" === r[y].position && "labelLine" === r[y].labelAlignTo) {
        var _ = r[y].x - u;
        (r[y].linePoints[1][0] += _), (r[y].x = u);
      }
      (f = r[y].y - p) < 0 && h(y, g, -f), (p = r[y].y + r[y].height);
    }
    a - p < 0 && c(g - 1, p - a);
    ...
    N.each(function (t) {
      ...
      !B &&
        ...
        (function (t, e, i, n, r, o, a, s) {
          ...
          for (
            Pv(u, e, i, n, 1, 0, o, 0, s, c),
              Pv(l, e, i, n, -1, 0, o, 0, s, h),
              d = 0;
            d < t.length;
            d++
          ) {
          ...
          h.each(function (t) {
            ...
            l.each(function (t) {
              var e,
                ...
                r = null != i && h.getItemVisual(i, "borderColor", !0);
              if (((n && r) || (e = l.getItemModel(t)), !n)) {
                ...
                null != i && h.setItemVisual(i, "color", o);
              }
              if (!r) {
                var a = e.get("itemStyle.borderColor");
                null != i && h.setItemVisual(i, "borderColor", a);
              }
            });
        },
      })
      ...
      T(function (t, e, T, i) {
        e.eachSeriesByType(t, function (t) {
          var r = t.getData(),
            ...
            o = (function (t, e) {
              return lu(t.getBoxLayoutParams(), {
                width: e.getWidth(),
                height: e.getHeight(),
              });
            })(t, T),
    ...
    findDataIndex: function (t, e) {
      for (
        ...
        var l = 2 * s,
          u = n[l] - o / 2,
          h = n[1 + l] - a / 2;
        if (u <= t && h <= e && t <= u + o && e <= h + a) return s;
      }
      return -1;
    },
  });
  ...
  (Fv.isPersistent = function () {
    ...
    (Fv.incrementalPrepareUpdate = function (t) {
      this.group.removeAll(),
        ...
        2e6 < t.count()
          ? (this._incremental || (this._incremental = new hs({ silent: !0 })),
        ...
        function (t, e) {
          ...
          i &&
            ...
            (function (t, e, i) {
              ...
              "merge" === o
                ? r
                  ? (m(r, n, !0), hu(r, n, { ignoreSize: !0 }), du(i, r))
                  : (t[e] = n)
                : "replace" === o
                ? (t[e] = n)
                : "remove" === o && r && (t[e] = null);
  ...
  cf({
        ...
        D(t, function (t) {
          ...
          var s = (function (e) {
            return (
              (e = k({}, e)),
              D(
                ["id", "parentId", "$action", "hv", "bounding"].concat(ru),
                function (t) {
                  delete e[t];
                }
              ),
    ...
    _relocate: function (t, e) {
      for (
        ...
        var l = i[s];
        if ((h = r.get(l.id)) && h.isGroup) {
          var u = (c = h.parent) === n;
          (h.__ecGraphicWidth =
            Cl(h.__ecGraphicWidthOption, u ? o : c.__ecGraphicWidth) || 0),
            (h.__ecGraphicHeight =
              Cl(h.__ecGraphicHeightOption, u ? a : c.__ecGraphicHeight) || 0);
        }
      }
        ...
        var a = (function (l, t) {
            ...
            return (
              Yv(t.seriesModels, function (e, t) {
                var i,
                  n,
                  r = e.getData().mapDimension(h, !0);
                if (e.getAxisTooltipData) {
                  var o = e.getAxisTooltipData(r, l, u);
  ...
  $r(
    ((cy.prototype = {
      ...
      createPointerEl: function (t, e, i, n) {
        var r = e.pointer;
        if (r) {
          var o = (ly(t).pointerEl = new dl[r.type](uy(e.pointer)));
          t.add(o);
        }
      },
      ...
      _renderHandle: function (t) {
        if (!this._dragging && this.updateHandleTransform) {
          ...
          this._handle ||
            ((e = !0),
            (r = this._handle = ul(o.get("icon"), {
              cursor: "move",
              draggable: !0,
              onmousemove: function (t) {
                Wt(t.event);
              },
              onmousedown: hy(this._onHandleDragMove, this, 0, 0),
              drift: hy(this._onHandleDragMove, this),
              ondragend: hy(this._onHandleDragEnd, this),
            })),
            n.add(r)),
            gy(r, i, !1);
          r.setStyle(
  ...
  cf({
        ...
        function (t) {
          Ly(t.dataByAxis, function (s) {
            var l = d.getComponent(s.axisDim + "Axis", s.axisIndex),
              ...
              h = [];
            if (l && null != u) {
              var c = vy(u, l.axis, d, s.seriesDataIndices, s.valueLabelOpt);
    ...
    _showTooltipContent: function (i, t, n, e, r, o, a, s, l) {
      if (((this._ticket = ""), i.get("showContent") && i.get("show"))) {
        ...
        a = a || i.get("position");
        var c = t;
        if (h && "string" == typeof h) c = ql(h, n, !0);
        else if ("function" == typeof h) {
          var d = Py(function (t, e) {
            t === this._ticket &&
              (u.setContent(e, l, i),
              this._updatePosition(i, a, r, o, u, n, s));
          }, this);
    ...
    _updatePosition: function (t, e, i, n, r, o, a) {
      ...
      if (
        ...
        (i = (p = (function (t, e, i, n, r, o, a) {
          ...
          null != a && (r < e + u + a ? (e -= u + a) : (e += a));
          return [t, e];
        })(i, n, r, s, l, h ? null : 20, c ? null : 20))[0]),
          (n = p[1]);
      }
      h && (i -= Ry(h) ? u[0] / 2 : "right" === h ? u[0] : 0),
        c && (n -= Ry(c) ? u[1] / 2 : "bottom" === c ? u[1] : 0),
        t.get("confine") &&
  ...
  var Gy = T,
    ...
    Xy = cf({
      ...
      render: function (t, e, i) {
        ...
        if (
          ...
          var l = t.getBoxLayoutParams(),
            ...
            f = lu(A({ width: d.width, height: d.height }, l), u, h);
              ...
              if (this.newlineDisabled || ("" !== s && "\n" !== s)) {
                ...
                if (!p.get(s))
                  if (t) {
                    ...
                    this._createItem(s, a, o, h, r, l, u, i, n, g)
      ...
      _createItem: function (t, e, i, n, r, o, a, s, l, u) {
        var h = n.get("itemWidth"),
          ...
          w = x.parentModel,
          b = ig((r = _ || r), 0, 0, h, c, m ? s : d, null == p || p);
        if (
      ...
      layoutInner: function (t, e, i, n, r, o) {
        ...
        su(t.get("orient"), a, t.get("itemGap"), i.width, i.height);
        var l = a.getBoundingRect(),
          u = [-l.x, -l.y];
        if (r) {
          su("horizontal", s, t.get("selectorItemGap", !0));
  ...
  rf(gd.PROCESSOR.SERIES_FILTER, function (t) {
    ...
    vu.registerSubTypeDefaulter("legend", function () {
      return "plain";
    });
  var Ky = Fy.extend({
    type: "legend.scroll",
  ...
  function Qy(t, e, i) {
    var n = [1, 1];
    (n[t.getOrient().index] = 0), hu(e, i, { type: "box", ignoreSize: n });
  }
  var Jy = Si,
    t_ = ["width", "height"],
    e_ = ["x", "y"],
    i_ = Xy.extend({
      ...
      renderInner: function (t, r, e, o, i, n, a) {
        ...
        var l = this._controllerGroup,
          u = r.get("pageIconSize", !0);
        O(u) || (u = [u, u]), c("pagePrev", 0);
      ...
      layoutInner: function (t, e, i, n, r, o) {
        var a = this.getSelectorGroup(),
          ...
          h = t_[1 - s],
          c = e_[1 - s];
        r && su("horizontal", a, t.get("selectorItemGap", !0));
      ...
      _layoutContentAndController: function (t, e, i, n, r, o, a) {
        ...
        su(
          ...
          su("horizontal", u, t.get("pageButtonItemGap", !0));
        var h = s.getBoundingRect(),
          c = u.getBoundingRect(),
  ...
  function l_(t, e, i, n, r, o) {
    ...
    (a[r] = e.get(i, u)), (a[o] = e.get(s, u));
    var h = e.get(n, u),
      c = Dl(e.get(n, u));
    return 0 <= (c = Math.min(c, 20)) && (a[o] = +a[o].toFixed(c)), [a, h];
  }
  var u_ = T,
    h_ = { min: u_(l_, "min"), max: u_(l_, "max"), average: u_(l_, "average") };
  function c_(t, e) {
    var i = t.getData(),
    ...
    if (
      ...
      var r = n.dimensions,
        o = d_(e, i, n, t);
      if ((e = b(e)).type && h_[e.type] && o.baseAxis && o.valueAxis) {
        var a = s_(r, o.baseAxis.dim),
          s = s_(r, o.valueAxis.dim),
          l = h_[e.type](i, o.baseDataDim, o.valueDataDim, a, s);
        ...
        for (
          ...
          h_[u[h]] && (u[h] = g_(i, i.mapDimension(r[h]), u[h]));
        e.coord = u;
      }
    }
    return e;
  ...
  function v_(s, l, u) {
    ...
    s.each(function (t) {
      var e,
        i = s.getItemModel(t),
        n = Cl(i.get("x"), u.getWidth()),
        r = Cl(i.get("y"), u.getHeight());
      if (isNaN(n) || isNaN(r)) {
        if (l.getMarkerPosition)
          e = l.getMarkerPosition(s.getValues(s.dimensions, t));
        else if (h) {
          var o = s.get(h.dimensions[0], t),
            a = s.get(h.dimensions[1], t);
          e = h.dataToPoint([o, a]);
        }
      } else e = [n, r];
      ...
      h.setData(d),
        ...
        d.each(function (t) {
          var e = d.getItemModel(t),
            ...
            s = z(r);
          if (o || a || s) {
            var l = h.getRawValue(t),
              u = h.getDataParams(t);
            o && (i = i(l, u)), a && (n = n(l, u)), s && (r = r(l, u));
          }
          d.setItemVisual(t, {
            symbol: i,
            symbolSize: n,
        ...
        (a.__keep = !0),
        (a.group.silent = h.get("silent") || t.get("silent"));
    },
  }),
    nf(function (t) {
    ...
    if (t || e || !i.ignore) {
      ...
      if (this.__dirty || o.__dirty) {
        ...
        if (!i.ignore) {
          ...
          switch (i.__position) {
            case "end":
              (d = [u[0] * v + l[0], u[1] * y + l[1]]),
                (f = 0.8 < u[0] ? "left" : u[0] < -0.8 ? "right" : "center"),
                (p = 0.8 < u[1] ? "top" : u[1] < -0.8 ? "bottom" : "middle");
              break;
            case "start":
              (d = [-u[0] * v + s[0], -u[1] * y + s[1]]),
                (f = 0.8 < u[0] ? "right" : u[0] < -0.8 ? "left" : "center"),
                (p = 0.8 < u[1] ? "bottom" : u[1] < -0.8 ? "top" : "middle");
              break;
            case "insideStartTop":
            case "insideStart":
            case "insideStartBottom":
    ...
    (T_._updateCommonStl = function (t, e, i) {
      ...
      if (!i || t.hasItemOption) {
        ...
        (o = u.getModel("lineStyle").getLineStyle()),
          (a = u.getModel("emphasis.lineStyle").getLineStyle()),
          (s = u.getModel("label")),
      ...
      r.useStyle(
        A({ strokeNoScale: !0, fill: "none", stroke: h, opacity: c }, o)
      ),
        (r.hoverStyle = a),
        D(
          b_,
  ...
  m_.extend({
      ...
      a.setData(u),
        u.each(function (n) {
          ...
          D(G_, function (t) {
            ...
            u.setItemLayout(n, { points: t, allClipped: r }),
            u.setItemVisual(n, { color: s.getVisual("color") });
        }),
        u
          .diff(l.__data)
          .add(function (t) {
    ...
    vu.registerSubTypeDefaulter("dataZoom", function () {
      return "slider";
    });
  ...
  function K_(t, e, i, n, r, o) {
    ...
    var u = r || 0,
      h = i.slice();
    l.sign < 0 ? (h[0] += u) : (h[1] -= u), (e[n] = J_(e[n], h));
    var c = Q_(e, n);
    return (
      null != r &&
    ...
    calculateDataWindow: function (r) {
      ...
      ex(["start", "end"], function (t, e) {
        var i = r[t],
          n = r[t + "Value"];
        "percent" === l[e]
          ? (null == i && (i = u[e]), (n = s.parse(Il(i, u, a))))
          : ((o = !0), (i = Il((n = null == n ? a[e] : s.parse(n)), a, u))),
          (c[e] = n),
          (h[e] = i);
      }),
        ix(c),
            ...
            h.length &&
              ("weakFilter" === r
                ? u.filterSelf(function (t) {
                    for (var e, i, n, r = 0; r < h.length; r++) {
                      var o = u.get(h[r], t),
                        a = !isNaN(o),
                        s = o < c[0],
                        l = o > c[1];
              ...
              D(
                ...
                function (t) {
                  if (!(l || (!0 !== s && x(vx, t.get("type")) < 0))) {
                    var e,
                      i = u.getComponent(o.axis, a).axis,
                      n = (function (t) {
                        return {
                          x: "y",
                          y: "x",
      ...
      zoom: function (t, e, i, n) {
        ...
        if (a) {
          ...
          var h = this.dataZoomModel
            ...
            .getMinMaxSpan();
          return (
            K_(0, o, [0, 100], 0, h.minSpan, h.maxSpan),
            (this._range = o),
        ...
        D(u, function (t, e) {
          ...
          (function (t, e, i) {
            var n = e.getBoxLayoutParams(),
              ...
              a = lu(n, o, r);
            su(e.get("orient"), t, e.get("itemGap"), a.width, a.height),
              uu(t, n, o, r);
          })(f, h, d),
          f.add(Wy(f.getBoundingRect(), h)),
      ...
      if ("function" != typeof MouseEvent || v.browser.ie || v.browser.edge)
        if (window.navigator.msSaveOrOpenBlob) {
          for (
            ...
            l[s] = a.charCodeAt(s);
          var u = new Blob([l]);
          window.navigator.msSaveOrOpenBlob(u, n + "." + r);
        } else {
          var h = i.get("lang"),
            c =
            ...
            return (
              D(t, function (t, e) {
                ...
                for (var a = [r.join(rw)], s = 0; s < o[0].length; s++) {
                  for (var l = [], u = 0; u < o.length; u++) l.push(o[u][s]);
                  a.push(l.join(rw));
                }
                h.push(a.join("\n"));
              }),
              ...
              if (o) {
                ...
                a = isNaN(s[0])
                  ? ((u = !0),
                    ...
                    n[r].value)
                  : (n[r] = []);
                for (var h = 0; h < s.length; h++) a.push(+s[h]);
  ...
  (uw.defaultOption = {
    ...
    (uw.prototype.onclick = function (t, e) {
      var i = e.getDom(),
        n = this.model;
      ...
      Ht(m, "click", _),
        Ht(v, "click", function () {
          var t;
          try {
            t = "function" == typeof h ? h(s, e.getOption()) : lw(l.value, f);
          } catch (t) {
    ...
    (uw.prototype.remove = function (t, e) {
      this._dom && e.getDom().removeChild(this._dom);
    }),
    (uw.prototype.dispose = function (t, e) {
      this.remove(t, e);
    }),
    Ux("dataView", uw),
    of(
  ...
  function Ww(t, e, i, n, r, o, a, s) {
    ...
    cw(r.split(""), function (t) {
      ...
      (l.range = e(Hw(u[0][0], u[1][0], u[0][1], u[1][1]))),
      Dw(i, n),
      zw(i, { isEnd: !1 });
  }
  ...
  function jw(t, e, i, n) {
    ...
    if (
      ...
      if (o) {
        var u = Qw[qw(t._brushType, a)];
        (o.__brushOption.range = u.getCreatingRange(Uw(t, o, t._track))),
          n && (Cw(t, o), u.updateCommon(t, o)),
          Tw(t, o),
          (r = { isEnd: n });
      }
  ...
  (ub.setOutputRanges = function (t, e) {
    ...
    (ub.matchOutputRanges = function (t, n, r) {
      nb(
        t,
        function (i) {
    ...
    (ub.setInputRanges = function (t, r) {
      nb(
        t,
        function (t) {
  ...
  ax.extend({ type: "dataZoom.select" }),
    ux.extend({ type: "dataZoom.select" });
          ...
          if ((null != o && (o += ""), o)) {
            ...
            var c,
              ...
              m =
                ...
                g.family +
                '"';
            i = i || un(o, m, f, p, r.textPadding, r.textLineHeight);
            var v = this.transform;
            if ((v && !n && (uS.copy(e), uS.applyTransform(v), (e = uS)), n))
              (c = e.x), (d = e.y);
            else {
        ...
        for (var e = [], i = t.data, n = t.len(), r = 0; r < n; ) {
          ...
          switch (i[r++]) {
            ...
            case _S.A:
              ...
              var w = DS(s + u * MS(c + d)),
                b = DS(l + h * SS(c + d));
              e.push("A", DS(u), DS(h), bS(f * TS), +y, +p, w, b);
              break;
            case _S.Z:
              o = "Z";
              break;
    ...
    HS = function (t, e) {
      ...
      if ((null != o && (o += ""), Gn(o, i))) {
        ...
        var s = a.style,
          ...
          u = a.__computedFont;
        l !== a.__styleFont &&
          ((s.font = a.__styleFont = l), (u = a.__computedFont = s.font));
        var h = i.textPadding,
          c = i.textLineHeight,
          d = t.__textCotentBlock;
        (d && !t.__dirtyText) ||
          (d = t.__textCotentBlock = yn(o, u, h, c, i.truncate));
        var f = d.outerHeight,
          p = d.lineHeight;
        Rn(BS, t, i, e);
        var g = BS.baseX,
    ...
    (ZS.prototype = {
      diff: function (l, u, t) {
        ...
        if (p[0].newPos + 1 >= c && d <= i + 1) {
          for (var n = [], r = 0; r < u.length; r++) n.push(r);
          ...
          for (var t = -1 * f; t <= f; t += 2) {
            ...
            if (o || a) {
              if (
                ...
                (r = h.extractCommon(e, u, l, t)),
                e.newPos + 1 >= c && d <= r + 1)
              )
                return US(h, e.components, u, l);
              p[t] = e;
            } else p[t] = void 0;
          }
          var s;
  ...
  (oM.prototype = {
    ...
    _paintList: function (t) {
      ...
      for (e = 0; e < c.length; e++) {
        ...
        if ((p = c[e]).added)
          for (d = 0; d < p.count; d++) {
            (u = rM((s = a[p.indices[d]]))), (f = nM(s));
            h ? tM(n, u, h) : eM(n, u),
              u ? tM(n, f, u) : h ? tM(n, f, h) : eM(n, f),
              tM(n, f, u),
              (h = f || u || h),
    ...
    (t.registerLayout = af),
    (t.registerVisual = sf),
    (t.registerLoading = uf),
    (t.extendComponentModel = hf),
