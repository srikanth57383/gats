...
!(function (t, e) {
  ...
  bt.prototype = {
    ...
    _dragStart: function (t) {
      ...
      e &&
        ...
        (this._x = t.offsetX),
        (this._y = t.offsetY),
        this.dispatchToElement(St(e, t), "dragstart", t.event));
    },
    _drag: function (t) {
      ...
      if (e) {
        ...
        (this._x = i),
          (this._y = n),
          e.drift(r, o, t),
          this.dispatchToElement(St(e, t), "drag", t.event);
        var a = this.findHover(i, n, e).target,
          s = this._dropTarget;
        e !== (this._dropTarget = a) &&
          (s &&
            a !== s &&
            this.dispatchToElement(St(s, t), "dragleave", t.event),
          a &&
            a !== s &&
            this.dispatchToElement(St(a, t), "dragenter", t.event));
      }
    },
    _dragEnd: function (t) {
      var e = this._draggingTarget;
      e && (e.dragging = !1),
        this.dispatchToElement(St(e, t), "dragend", t.event),
        this._dropTarget &&
          this.dispatchToElement(St(this._dropTarget, t), "drop", t.event),
  ...
  It.prototype = {
    ...
    off: function (t, e) {
      ...
      if (e) {
        if (i[t]) {
          for (var n = [], r = 0, o = i[t].length; r < o; r++)
    ...
    trigger: function (t) {
      ...
      if (e) {
        ...
        for (var o = e.length, a = 0; a < o; ) {
          var s = e[a];
          if (i && i.filter && null != s.query && !i.filter(t, s.query)) a++;
          else {
            switch (r) {
              case 1:
                s.h.call(s.ctx);
    ...
    triggerWithContext: function (t) {
      ...
      if (e) {
        ...
        for (var o = n[n.length - 1], a = e.length, s = 0; s < a; ) {
          var l = e[s];
  ...
  function At(t, e, i, n, r, o) {
    ...
    if (1 === e) {
      var l = Math.round(Math.log(((1 << s) - 1) & ~r) / Tt);
      return t[i][l];
    }
    ...
    for (var c = 0, d = 0, f = 0; d < s; d++) {
      var p = 1 << d;
      p & r ||
        ((c += (f % 2 ? -1 : 1) * t[i][d] * At(t, e - 1, u, h, r | p, o)), f++);
    }
    return (o[a] = c);
  }
  function Dt(t, e) {
      ...
      for (var o = [], a = 0; a < 8; a++)
        for (var s = 0; s < 8; s++)
          null == o[s] && (o[s] = 0),
            (o[s] +=
              ((((a + s) % 2 ? -1 : 1) *
                At(i, 7, 0 === a ? 1 : 0, 1 << a, 1 << s, n)) /
                r) *
              e[a]);
      return function (t, e, i) {
        var n = e * o[6] + i * o[7] + 1;
        (t[0] = (e * o[0] + i * o[1] + o[2]) / n),
          (t[1] = (e * o[3] + i * o[4] + o[5]) / n);
      };
    }
  }
  var kt = "___zrEVENTSAVED",
    Pt = [];
  function Lt(t, e, i, n, r) {
    if (e.getBoundingClientRect && v.domSupported && !Ot(e)) {
      var o = e[kt] || (e[kt] = {}),
        a = (function (t, e, i) {
          for (
            ...
            s.push(d, f),
              (a = a && o && d === o[c] && f === o[1 + c]),
              l.push(t[h].offsetLeft, t[h].offsetTop);
          }
          return a && r
            ? r
            : ((e.srcCoords = s), (e[n] = i ? Dt(l, s) : Dt(s, l)));
        })(
          (function (t, e) {
            var i = e.markers;
            if (i) return i;
            i = e.markers = [];
            for (
              var n = ["left", "right"], r = ["top", "bottom"], o = 0;
              o < 4;
              o++
            ) {
  ...
  var zt = "undefined" != typeof window && !!window.addEventListener,
  ...
  function Bt(t, e, i) {
    if (v.domSupported && t.getBoundingClientRect) {
      ...
      if (Lt(Nt, t, n, r)) return (i.zrX = Nt[0]), void (i.zrY = Nt[1]);
    }
    i.zrX = i.zrY = 0;
  }
  function Vt(t) {
  ...
  function Ht(t, e, i, n) {
    zt ? t.addEventListener(e, i, n) : t.attachEvent("on" + e, i);
  }
  var Wt = zt
    ? function (t) {
  ...
  ($t.prototype = {
    ...
    mousemove: function (t) {
      ...
      var a = (this._hovered = n ? { x: e, y: i } : this.findHover(e, i)),
        s = a.target,
        l = this.proxy;
    ...
    dispatchToElement: function (t, e, i) {
      ...
      if (!n || !n.silent) {
        for (
          ...
          n &&
          (n[r] && (o.cancelBubble = n[r].call(n, o)),
          n.trigger(e, o),
          (n = n.parent),
          !o.cancelBubble);
    ...
    findHover: function (t, e, i) {
      for (
        ...
        if (
          ...
          !n[o].ignore &&
          (a = Qt(n[o], t, e)) &&
          (r.topTarget || (r.topTarget = n[o]), a !== Yt)
        ) {
          r.target = n[o];
          break;
        }
    ...
    processGesture: function (t, e) {
      this._gestureMgr || (this._gestureMgr = new Zt());
      ...
      function (a) {
        $t.prototype[a] = function (t) {
          var e,
            ...
            o = Jt(this, n, r);
          if (
            (("mouseup" === a && o) || (i = (e = this.findHover(n, r)).target),
            "mousedown" === a)
          )
            (this._downEl = i),
              (this._downPoint = [t.zrX, t.zrY]),
              (this._upEl = i);
          else if ("mouseup" === a) this._upEl = i;
          else if ("click" === a) {
            if (
              this._downEl !== this._upEl ||
              !this._downPoint ||
              4 < gt(this._downPoint, [t.zrX, t.zrY])
            )
              return;
    ...
    S($t, It),
    S($t, bt);
  var te = "undefined" == typeof Float32Array ? Array : Float32Array;
  function ee() {
    var t = new te(6);
    return ie(t), t;
  }
  ...
  function re(t, e, i) {
    ...
    return (
      (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = a), (t[4] = s), (t[5] = l), t
    );
  }
  function oe(t, e, i) {
    return (
  ...
  var de = function (t) {
    ...
    fe = de.prototype;
  (fe.transform = null),
    (fe.needLocalTransform = function () {
      return (
        ce(this.rotation) ||
        ce(this.position[0]) ||
        ce(this.position[1]) ||
  ...
  (fe.updateTransform = function () {
    ...
    if (i || e) {
      (n = n || ee()),
        i ? this.getLocalTransform(n) : ue(n),
        e && (i ? re(n, t.transform, n) : ne(n, t.transform)),
        (this.transform = n);
      var r = this.globalScaleRatio;
      if (null != r && 1 !== r) {
        this.getGlobalScale(pe);
        var o = pe[0] < 0 ? -1 : 1,
          a = pe[1] < 0 ? -1 : 1,
          s = ((pe[0] - o) * r + o) / pe[0] || 0,
          l = ((pe[1] - a) * r + a) / pe[1] || 0;
      ...
      (this.invTransform = this.invTransform || ee()), le(this.invTransform, n);
    } else n && ue(n);
  }),
    (fe.getLocalTransform = function (t) {
      return de.getLocalTransform(this, t);
    }),
    (fe.setTransform = function (t) {
    ...
    (fe.restoreTransform = function (t) {
      var e = t.dpr || 1;
      t.setTransform(e, 0, 0, e, 0, 0);
    });
  var ge = [],
    me = ee();
  (fe.setLocalTransform = function (t) {
    if (t) {
      var e = t[0] * t[0] + t[1] * t[1],
        i = t[2] * t[2] + t[3] * t[3],
        n = this.position,
        r = this.scale;
      ce(e - 1) && (e = Math.sqrt(e)),
        ce(i - 1) && (i = Math.sqrt(i)),
        t[0] < 0 && (e = -e),
        t[3] < 0 && (i = -i),
        (n[0] = t[4]),
        (n[1] = t[5]),
    ...
    (fe.decomposeTransform = function () {
      if (this.transform) {
        var t = this.parent,
          e = this.transform;
        t && t.transform && (re(ge, t.invTransform, e), (e = ge));
        var i = this.origin;
        i &&
          (i[0] || i[1]) &&
          ((me[4] = i[0]),
    ...
    (fe.transformCoordToLocal = function (t, e) {
      var i = [t, e],
        n = this.invTransform;
      return n && yt(i, i, n), i;
    }),
    (fe.transformCoordToGlobal = function (t, e) {
      var i = [t, e],
        n = this.transform;
      return n && yt(i, i, n), i;
    }),
    (de.getLocalTransform = function (t, e) {
      ue((e = e || []));
      var i = t.origin,
        n = t.scale || [1, 1],
        r = t.rotation || 0,
    ...
    step: function (t, e) {
      if (
        ...
        if (!(i < 0)) {
          i = Math.min(i, 1);
          var n = this.easing,
            r = "string" == typeof n ? ve[n] : n,
            o = "function" == typeof r ? r(i) : i;
          return (
            this.fire("frame", o),
            1 === i
              ? this.loop
  ...
  var xe = _e.prototype;
  (xe.insert = function (t) {
    var e = new be(t);
    return this.insertEntry(e), e;
  }),
    (xe.insertEntry = function (t) {
      this.head
  ...
  var Oe = new we(20),
    ze = null;
  function Ee(t, e) {
    ze && Le(ze, e), (ze = Oe.put(t, ze || e.slice()));
  }
  function Ne(t, e) {
    if (t) {
      e = e || [];
      ...
      if (r in Me) return Le(e, Me[r]), Ee(t, e), e;
      if ("#" === r.charAt(0))
        return 4 === r.length
          ? 0 <= (n = parseInt(r.substr(1), 16)) && n <= 4095
            ? (Pe(
                e,
                ((3840 & n) >> 4) | ((3840 & n) >> 8),
                (240 & n) | ((240 & n) >> 4),
            ...
            : void Pe(e, 0, 0, 0, 1)
          : 7 === r.length
          ? 0 <= (n = parseInt(r.substr(1), 16)) && n <= 16777215
            ? (Pe(e, (16711680 & n) >> 16, (65280 & n) >> 8, 255 & n, 1),
              Ee(t, e),
              e)
            : void Pe(e, 0, 0, 0, 1)
          : void 0;
      ...
      if (-1 !== o && a + 1 === r.length) {
        ...
        switch (s) {
          case "rgba":
            if (4 !== l.length) return void Pe(e, 0, 0, 0, 1);
            h = Ae(l.pop());
          case "rgb":
            return 3 !== l.length
              ? void Pe(e, 0, 0, 0, 1)
              : (Pe(e, Te(l[0]), Te(l[1]), Te(l[2]), h), Ee(t, e), e);
          case "hsla":
            return 4 !== l.length
              ? void Pe(e, 0, 0, 0, 1)
              : ((l[3] = Ae(l[3])), Re(l, e), Ee(t, e), e);
          case "hsl":
            return 3 !== l.length
              ? void Pe(e, 0, 0, 0, 1)
              : (Re(l, e), Ee(t, e), e);
  ...
  function Be(t, e) {
    ...
    if (i) {
      ...
      return Ue(i, 4 === i.length ? "rgba" : "rgb");
    }
  }
  function Ve(t) {
    var e = Ne(t);
  ...
  function We(t, e, i) {
    if (e && e.length && 0 <= t && t <= 1) {
      ...
      return i ? { color: h, leftIndex: r, rightIndex: o, value: n } : h;
    }
  }
  var Ge = We;
  function Ze(t, e) {
    if ((t = Ne(t)) && null != e) return (t[3] = Ce(e)), Ue(t, "rgba");
  }
  function Ue(t, e) {
    if (t && t.length) {
      var i = t[0] + "," + t[1] + "," + t[2];
  ...
  function Qe(t, e, i, n, r) {
    var o = t.length;
    if (1 === r) for (var a = 0; a < o; a++) n[a] = $e(t[a], e[a], i);
    else {
      var s = o && t[0].length;
      for (a = 0; a < o; a++)
        for (var l = 0; l < s; l++) n[a][l] = $e(t[a][l], e[a][l], i);
    }
  }
  function Je(t, e, i) {
    var n = t.length,
    ...
    if (n !== r)
      if (r < n) t.length = r;
      else for (var o = n; o < r; o++) t.push(1 === i ? e[o] : Ye.call(e[o]));
  ...
  function ti(t, e, i) {
    ...
    if (1 === i) {
      ...
      var o = t[0].length;
      for (r = 0; r < n; r++)
        for (var a = 0; a < o; a++) if (t[r][a] !== e[r][a]) return !1;
    }
    return !0;
  }
  function ei(t, e, i, n, r, o, a, s, l) {
    var h = t.length;
    if (1 === l)
      for (var u = 0; u < h; u++) s[u] = ii(t[u], e[u], i[u], n[u], r, o, a);
    else {
      var c = t[0].length;
      for (u = 0; u < h; u++)
        for (var d = 0; d < c; d++)
          s[u][d] = ii(t[u][d], e[u][d], i[u][d], n[u][d], r, o, a);
    }
  }
  function ii(t, e, i, n, r, o, a) {
    var s = 0.5 * (i - t),
      l = 0.5 * (n - e);
    return (
      (2 * (e - i) + s + l) * a + (-3 * (e - i) - 2 * s - l) * o + s * r + e
    );
  }
  function ni(t) {
    if (L(t)) {
      var e = t.length;
      if (L(t[0])) {
        for (var i = [], n = 0; n < e; n++) i.push(Ye.call(t[n]));
        return i;
      }
      return Ye.call(t);
    }
  ...
  function oi(t, e, i, n, o, r) {
    ...
    if (h) {
      ...
      n.sort(function (t, e) {
        ...
        (u = n[h - 1].time);
      for (var g = [], m = [], v = n[0].value, y = !0, _ = 0; _ < h; _++) {
        g.push(n[_].time / u);
        var x = n[_].value;
        if (
          ((c && ti(x, v, p)) || (!c && x === v) || (y = !1),
          "string" == typeof (v = x))
        ) {
          var w = Ne(x);
          w ? ((x = w), (d = !0)) : (f = !0);
      ...
      if (r || !y) {
        var b = m[h - 1];
        for (_ = 0; _ < h - 1; _++)
          c ? Je(m[_], b, p) : !isNaN(m[_]) || isNaN(b) || f || d || (m[_] = b);
        c && Je(a(t._target, o), b, p);
        var S,
          M,
          I,
          C,
        ...
        var P = new ye({
          ...
          onframe: function (t, e) {
            ...
            if (e < 0) i = 0;
              ...
              for (i = Math.min(A + 1, h - 1); 0 <= i && !(g[i] <= e); i--);
              i = Math.min(i, h - 2);
            } else {
              for (i = A; i < h && !(g[i] > e); i++);
              i = Math.min(i - 1, h - 2);
            ...
            if (0 != n)
              if (((S = (e - g[i]) / n), l))
                if (
                  ...
                  ei(M, I, C, T, S, S * S, S * S * S, a(t, o), p);
                else {
                  if (d)
                    (r = ei(M, I, C, T, S, S * S, S * S * S, k, 1)),
                      (r = ri(k));
                  else {
                    if (f) return Ke(I, C, S);
                    r = ii(M, I, C, T, S, S * S, S * S * S);
                  }
                  s(t, o, r);
                }
              else if (c) Qe(m[i], m[i + 1], S, a(t, o), p);
              else {
                var r;
                if (d) Qe(m[i], m[i + 1], S, k, 1), (r = ri(k));
                else {
                  if (f) return Ke(m[i], m[i + 1], S);
                  r = $e(m[i], m[i + 1], S);
                }
                s(t, o, r);
              }
      ...
      for (var n in e)
        if (e.hasOwnProperty(n)) {
          if (!i[n]) {
            ...
            if (null == r) continue;
            0 !== t && i[n].push({ time: 0, value: ni(r) });
          }
    ...
    start: function (t, e) {
      ...
      for (var a in this._tracks)
        if (this._tracks.hasOwnProperty(a)) {
          var s = oi(this, t, i, this._tracks[a], a, e);
          s &&
      ...
      if (n) {
        ...
        n.onframe = function (t, e) {
          l(t, e);
          for (var i = 0; i < r._onframeList.length; i++)
            r._onframeList[i](t, e);
        };
      }
  ...
  "undefined" != typeof window &&
    (si = Math.max(window.devicePixelRatio || 1, 1));
  var li = si,
    hi = function () {};
  function ui() {
    this.animators = [];
      ...
      (function t(e, i, n, r, o, a, s) {
        ...
        for (var u in r)
          r.hasOwnProperty(u) &&
            (null != n[u]
              ? N(r[u]) && !L(r[u])
                ? t(e, i ? i + "." + u : u, n[u], r[u], o, a, s)
                : (s ? ((l[u] = n[u]), fi(e, i, u, r[u])) : (l[u] = r[u]), h++)
              : null == r[u] || s || fi(e, i, u, r[u]));
        0 < h &&
          e
            .animate(i, !1)
            .when(null == o ? 500 : o, l)
    ...
    animate: function (t, e) {
      ...
      if (t) {
        var a = t.split("."),
          s = r;
        n = "shape" === a[0];
        for (var l = 0, h = a.length; l < h; l++) s = s && s[a[l]];
        s && (i = s);
      } else i = r;
      if (i) {
        var u = r.animators,
      ...
      ci('Property "' + t + '" is not existed in element ' + r.id);
    },
  ...
  (bi.prototype = {
    ...
    union: function (t) {
      var e = xi(t.x, this.x),
        i = xi(t.y, this.y);
      (this.width = wi(t.x + t.width, this.x + this.width) - e),
        (this.height = wi(t.y + t.height, this.y + this.height) - i),
        (this.x = e),
        (this.y = i);
    },
    applyTransform:
      ...
      function (t) {
        if (t) {
          (gi[0] = vi[0] = this.x),
            (gi[1] = yi[1] = this.y),
            (mi[0] = yi[0] = this.x + this.width),
            (mi[1] = vi[1] = this.y + this.height),
            _i(gi, gi, t),
            _i(mi, mi, t),
            _i(vi, vi, t),
            _i(yi, yi, t),
            (this.x = xi(gi[0], mi[0], vi[0], yi[0])),
            (this.y = xi(gi[1], mi[1], vi[1], yi[1]));
          var e = wi(gi[0], mi[0], vi[0], yi[0]),
    ...
    calculateTransform: function (t) {
      var e = t.width / this.width,
        ...
        n = ee();
      return (
        oe(n, n, [-this.x, -this.y]), se(n, n, [e, i]), oe(n, n, [t.x, t.y]), n
      );
    },
    ...
    (bi.create = function (t) {
      return new bi(t.x, t.y, t.width, t.height);
    });
  var Si = function (t) {
    for (var e in ((t = t || {}), pi.call(this, t), t))
  ...
  (Si.prototype = {
    ...
    _doAdd: function (t) {
      ...
      e &&
        e !== t.__storage &&
        (e.addToStorage(t), t instanceof Si && t.addChildrenToStorage(e)),
        i && i.refresh();
    },
    remove: function (t) {
      var e = this.__zr,
      ...
      return (
        r < 0 ||
          ...
          i &&
            (i.delFromStorage(t),
            t instanceof Si && t.delChildrenFromStorage(i)),
          e && e.refresh()),
        this
      );
    },
    removeAll: function () {
      ...
      for (e = 0; e < i.length; e++)
        (t = i[e]),
          n &&
            (n.delFromStorage(t),
            t instanceof Si && t.delChildrenFromStorage(n)),
          (t.parent = null);
    ...
    addChildrenToStorage: function (t) {
      for (var e = 0; e < this._children.length; e++) {
        ...
        t.addToStorage(i), i instanceof Si && i.addChildrenToStorage(t);
      }
    },
    delChildrenFromStorage: function (t) {
      for (var e = 0; e < this._children.length; e++) {
        var i = this._children[e];
        t.delFromStorage(i), i instanceof Si && i.delChildrenFromStorage(t);
      }
    },
    dirty: function () {
  ...
  function Ai(t, e, i, n, r, o) {
    var a = 0,
      ...
      l = 1;
    if (0 < o(t, e[i + r])) {
      for (s = n - r; l < s && 0 < o(t, e[i + r + l]); )
        (l = 1 + ((a = l) << 1)) <= 0 && (l = s);
      s < l && (l = s), (a += r), (l += r);
    } else {
      for (s = r + 1; l < s && o(t, e[i + r - l]) <= 0; )
        (l = 1 + ((a = l) << 1)) <= 0 && (l = s);
      s < l && (l = s);
      var h = a;
      (a = r - l), (l = r - h);
  ...
  function ki(p, g) {
    ...
    function e(t) {
      var e = a[t],
        ...
        r = s[t + 1];
      (s[t] = i + r),
        t === l - 3 && ((a[t + 1] = a[t + 2]), (s[t + 1] = s[t + 2])),
        l--;
      var o = Di(p[n], p, e, i, 0, g);
      (e += o),
        0 !== (i -= o) &&
          0 !== (r = Ai(p[e + i - 1], p, n, r, r - 1, g)) &&
          (i <= r
            ? (function (t, e, i, n) {
                var r = 0;
                ...
                var o = 0,
                  ...
                  s = t;
                if (((p[s++] = p[a++]), 0 == --n)) {
                  for (r = 0; r < e; r++) p[s + r] = v[o + r];
                  return;
                }
                if (1 === e) {
                  for (r = 0; r < n; r++) p[s + r] = p[a + r];
                  return (p[s + n] = v[o]);
                }
                var l,
                  h,
                ...
                for (;;) {
                  ...
                  if (u) break;
                  do {
                    if (0 !== (l = Di(p[a], v, o, e, 0, g))) {
                      for (r = 0; r < l; r++) p[s + r] = v[o + r];
                      if (((s += l), (o += l), (e -= l) <= 1)) {
                        u = !0;
                        break;
                      }
                    ...
                    if (0 !== (h = Ai(v[o], p, a, n, 0, g))) {
                      for (r = 0; r < h; r++) p[s + r] = p[a + r];
                      if (((s += h), (a += h), 0 === (n -= h))) {
                        u = !0;
                        break;
                      }
            ...
            : (function (t, e, i, n) {
                ...
                for (;;) {
                  ...
                  if (f) break;
                  do {
                    if (0 !== (c = e - Di(v[a], p, t, e, e - 1, g))) {
                      for (
                        e -= c, h = (s -= c) + 1, l = (o -= c) + 1, r = c - 1;
                        0 <= r;
                        r--
                      )
                        p[h + r] = p[l + r];
                    ...
                    if (0 !== (d = n - Ai(p[o], v, 0, n, n - 1, g))) {
                      for (
                        n -= d, h = (s -= d) + 1, l = (a -= d) + 1, r = 0;
                        r < d;
                        r++
                      )
                        p[h + r] = v[l + r];
  ...
  function Pi(t, e, i, n) {
    ...
    if (!(r < 2)) {
      var o = 0;
      if (r < Mi) Ti(t, i, n, i + (o = Ci(t, i, n, e)), e);
      else {
        var a = new ki(t, e),
          s = (function (t) {
            for (var e = 0; Mi <= t; ) (e |= 1 & t), (t >>= 1);
            return t + e;
          })(r);
        do {
          if ((o = Ci(t, i, n, e)) < s) {
  ...
  Oi.prototype = {
    ...
    updateDisplayList: function (t) {
      ...
      (i.length = this._displayListLen), v.canvasSupported && Pi(i, Li);
    },
    ...
    addRoot: function (t) {
      t.__storage !== this &&
        (t instanceof Si && t.addChildrenToStorage(this),
        this.addToStorage(t),
        this._roots.push(t));
    },
    delRoot: function (t) {
      if (null == t) {
        for (var e = 0; e < this._roots.length; e++) {
          var i = this._roots[e];
          i instanceof Si && i.delChildrenFromStorage(this);
        }
        return (
          (this._roots = []),
          (this._displayList = []),
      ...
      if (t instanceof Array) {
        ...
        0 <= r &&
          ...
          t instanceof Si && t.delChildrenFromStorage(this));
      }
    },
  ...
  var zi = {
    ...
    Ei = function (t, e, i) {
      return zi.hasOwnProperty(e) ? i * t.dpr : i;
    },
    Ni = { NONE: 0, STYLE_BIND: 1, PLAIN_TEXT: 2 },
    Ri = 9,
    Bi = [
      ["shadowBlur", 0],
      ["shadowOffsetX", 0],
  ...
  function Fi(t, e, i) {
    ...
    return (
      ...
      (o = isNaN(o) ? 0 : o),
      (a = isNaN(a) ? 0 : a),
      t.createLinearGradient(n, o, r, a)
    );
  }
  function Hi(t, e, i) {
    var n = i.width,
  ...
  Vi.prototype = {
    ...
    bind: function (t, e, i) {
      var n = this,
        r = i && i.style,
        o = !r || t.__attrCachedBy !== Ni.STYLE_BIND;
      t.__attrCachedBy = Ni.STYLE_BIND;
      for (var a = 0; a < Bi.length; a++) {
        var s = Bi[a],
          l = s[0];
        (!o && n[l] === r[l]) || (t[l] = Ei(t, l, n[l] || s[1]));
      }
      if (
        ((!o && n.fill === r.fill) || (t.fillStyle = n.fill),
        (!o && n.stroke === r.stroke) || (t.strokeStyle = n.stroke),
        (!o && n.opacity === r.opacity) ||
    ...
    getGradient: function (t, e, i) {
      for (
        var n = ("radial" === e.type ? Hi : Fi)(t, e, i),
          r = e.colorStops,
          o = 0;
        o < r.length;
        o++
      )
        n.addColorStop(r[o].offset, r[o].color);
      return n;
    },
  };
  for (var Wi = Vi.prototype, Gi = 0; Gi < Bi.length; Gi++) {
    var Zi = Bi[Gi];
  ...
  function ji(t, e, i) {
    var n;
    (i = i || li),
      "string" == typeof t ? (n = Yi(t, e, i)) : N(t) && (t = (n = t).id),
      (this.id = t);
  ...
  ji.prototype = {
    constructor: ji,
    __dirty: !0,
    __used: !(Ui.prototype.getCanvasPattern = function (t) {
    ...
    createBackBuffer: function () {
      var t = this.dpr;
      (this.domBack = Yi("back-" + this.id, this.painter, t)),
    ...
    clear: function (t, e) {
      ...
      s &&
        ...
        this.ctxBack.drawImage(n, 0, 0, o / h, a / h)),
        r.clearRect(0, 0, o, a),
        e &&
          "transparent" !== e &&
          (e.colorStops
            ? ((i =
                e.__canvasGradient ||
                Vi.getGradient(r, e, { x: 0, y: 0, width: o, height: a })),
              (e.__canvasGradient = i))
            : e.image && (i = Ui.prototype.getCanvasPattern.call(e, r)),
          r.save(),
          (r.fillStyle = i || e),
          r.fillRect(0, 0, o, a),
          r.restore());
  ...
  function Qi(t, e, i, n, r) {
    if (t) {
      ...
      var o = $i.get(t),
        a = { hostEl: i, cb: n, cbPayload: r };
      return (
        o
          ? tn((e = o.image)) || o.pending.push(a)
          : (((e = new Image()).onload = e.onerror = Ji),
            $i.put(t, (e.__cachedImgObj = { image: e, pending: [a] })),
  ...
  function ln(t, e) {
    ...
    for (
      ...
      a = Math.max(((n = o[s]), (r = e), sn.measureText(n, r)).width, a);
    return rn < nn && ((nn = 0), (en = {})), nn++, (en[i] = a);
  }
  function hn(t, e, i, n, r, o, a, s) {
    return a
      ? (function (t, e, i, n, r, o, a, s) {
          var l = _n(t, {
              rich: a,
  ...
  function fn(t, e, i, n, r) {
    ...
    var o = (t + "").split("\n");
    r = pn(e, i, n, r);
    for (var a = 0, s = o.length; a < s; a++) o[a] = gn(o[a], r);
    return o.join("\n");
  }
  function pn(t, e, i, n) {
    (n = k({}, n)).font = e;
    i = W(i, "...");
    n.maxIterations = W(n.maxIterations, 2);
    var r = (n.minChar = W(n.minChar, 0));
    n.cnCharWidth = ln("国", e);
    var o = (n.ascCharWidth = ln("a", e));
    n.placeholder = W(n.placeholder, "");
    for (var a = (t = Math.max(0, t - 1)), s = 0; s < r && o <= a; s++) a -= o;
    var l = ln(i, e);
    return (
      a < l && ((i = ""), (l = 0)),
      (a = t - l),
  ...
  function gn(t, e) {
    ...
    for (var a = 0; ; a++) {
      ...
      var s =
        0 === a
          ? mn(t, r, e.ascCharWidth, e.cnCharWidth)
          : 0 < o
          ? Math.floor((t.length * r) / o)
          : 0;
      o = ln((t = t.substr(0, s)), n);
    }
  ...
  function yn(t, e, i, n, r) {
    ...
    if ((i && (l += i[0] + i[2]), t && r)) {
      ...
      if (null != u && u < l) (t = ""), (a = []);
        ...
        for (
          var d = pn(c - (i ? i[1] + i[3] : 0), e, r.ellipsis, {
              minChar: r.minChar,
  ...
  function _n(t, e) {
    ...
    for (var n, r = (on.lastIndex = 0); null != (n = on.exec(t)); ) {
      var o = n.index;
      r < o && xn(i, t.substring(r, o)), xn(i, n[2], n[1]), (r = on.lastIndex);
    }
    r < t.length && xn(i, t.substring(r, t.length));
    var a = i.lines,
      s = 0,
      l = 0,
      h = [],
    ...
    for (var p = 0; p < a.length; p++) {
      for (var g = a[p], m = 0, v = 0, y = 0; y < g.tokens.length; y++) {
        var _ = ((D = g.tokens[y]).styleName && e.rich[D.styleName]) || {},
          ...
          b = (D.textHeight = W(_.textHeight, vn(w)));
        if (
          (x && (b += x[0] + x[2]),
          (D.height = b),
          (D.lineHeight = G(_.textLineHeight, e.textLineHeight, b)),
          (D.textAlign = (_ && _.textAlign) || e.textAlign),
          (D.textVerticalAlign = (_ && _.textVerticalAlign) || "middle"),
          null != f && s + D.lineHeight > f)
        )
          return { lines: [], width: 0, height: 0 };
        D.textWidth = ln(D.text, w);
        var S = _.textWidth,
          M = null == S || "auto" === S;
        if ("string" == typeof S && "%" === S.charAt(S.length - 1))
          (D.percentWidth = S), h.push(D), (S = 0);
        else {
          if (M) {
            S = D.textWidth;
            var I = _.textBackgroundColor,
              C = I && I.image;
            C && tn((C = Ki(C))) && (S = Math.max(S, (C.width * b) / C.height));
          }
          var T = x ? x[1] + x[3] : 0;
          S += T;
          var A = null != d ? d - v : null;
          null != A &&
            A < S &&
            (!M || A < T
              ? ((D.text = ""), (D.textWidth = S = 0))
              : ((D.text = fn(D.text, A - T, w, c.ellipsis, {
                  minChar: c.minChar,
                })),
                (D.textWidth = ln(D.text, w)),
                (S = D.textWidth + T)));
        }
        (v += D.width = S), _ && (m = Math.max(m, D.lineHeight));
      }
      (g.width = v), (s += g.lineHeight = m), (l = Math.max(l, v));
    }
    (i.outerWidth = i.width = W(e.textWidth, l)),
      (i.outerHeight = i.height = W(e.textHeight, s)),
    ...
    h < 0 && ((s += h), (h = -h)),
      ...
      "number" == typeof c
        ...
        ? 1 === c.length
          ...
          : 3 === c.length
          ? ((i = c[0]), (n = o = c[1]), (r = c[2]))
          : ((i = c[0]), (n = c[1]), (r = c[2]), (o = c[3]))
        : (i = n = r = o = 0),
      h < i + n && ((i *= h / (a = i + n)), (n *= h / a)),
      h < r + o && ((r *= h / (a = r + o)), (o *= h / a)),
      u < n + r && ((n *= u / (a = n + r)), (r *= u / a)),
      u < i + o && ((i *= u / (a = i + o)), (o *= u / a)),
      t.moveTo(s + i, l),
      t.lineTo(s + h - n, l),
      ...
      t.lineTo(s + o, l + u),
      0 !== o && t.arc(s + o, l + u - o, o, Math.PI / 2, Math.PI),
      t.lineTo(s, l + i),
      0 !== i && t.arc(s + i, l + i, i, Math.PI, 1.5 * Math.PI);
  }
  sn.measureText = function (t, e) {
    var i = _();
    return (i.font = e || an), i.measureText(t);
  };
  var Sn = an,
  ...
  function kn(t) {
    if (t) {
      ...
      var e = t.textAlign;
      "middle" === e && (e = "center"),
        (t.textAlign = null == e || Mn[e] ? e : "left");
      var i = t.textVerticalAlign || t.textBaseline;
      "center" === i && (i = "middle"),
        (t.textVerticalAlign = null == i || In[i] ? i : "top"),
  ...
  function Pn(t, e, i, n, r, o) {
    n.rich
      ? (function (t, e, i, n, r, o) {
          o !== Ri && (e.__attrCachedBy = Ni.NONE);
          var a = t.__textCotentBlock;
          (a && !t.__dirtyText) || (a = t.__textCotentBlock = _n(i, n));
          !(function (t, e, i, n, r) {
            var o = i.width,
              a = i.outerWidth,
              s = i.outerHeight,
            ...
            for (var _ = 0; _ < i.lines.length; _++) {
              for (
                var x,
                  ...
                  A = y,
                  D = S - 1;
                C < S && (!(x = b[C]).textAlign || "left" === x.textAlign);

              )
                On(t, e, x, n, M, v, T, "left"),
                  (I -= x.width),
                  (T += x.width),
                  C++;
              for (; 0 <= D && "right" === (x = b[D]).textAlign; )
                On(t, e, x, n, M, v, A, "right"),
                  (I -= x.width),
                  (A -= x.width),
                  D--;
              for (T += (o - (T - m) - (y - A) - I) / 2; C <= D; )
                (x = b[C]),
                  On(t, e, x, n, M, v, T + x.width / 2, "center"),
                  (T += x.width),
                  C++;
              v += M;
            }
      ...
      : (function (t, e, i, n, r, o) {
          var a,
            s = zn(n),
            l = !1,
            h = e.__attrCachedBy === Ni.PLAIN_TEXT;
          o !== Ri
            ? (o && ((a = o.style), (l = !s && h && a)),
              (e.__attrCachedBy = s ? Ni.NONE : Ni.PLAIN_TEXT))
            : h && (e.__attrCachedBy = Ni.NONE);
          var u = n.font || Sn;
          (l && u === (a.font || Sn)) || (e.font = u);
          ...
          (p && !t.__dirtyText) ||
            (p = t.__textCotentBlock = yn(i, c, d, f, n.truncate));
          var g = p.outerHeight,
            m = p.lines,
            v = p.lineHeight,
            y = Rn(An, t, n, r),
          ...
          if (s || d) {
            ...
            d && (C += d[1] + d[3]);
            var T = un(_, C, w);
            s && En(t, e, n, T, S, C, g), d && ((M = Wn(_, w, d)), (I += d[0]));
          }
          (e.textAlign = w),
          ...
          for (var A = 0; A < Cn.length; A++) {
            var D = Cn[A],
              ...
              P = D[1],
              L = n[k];
            (l && L === a[k]) || (e[P] = Ei(e, P, L || D[2]));
          }
          I += v / 2;
          var O = n.textStrokeWidth,
            z = l ? a.textStrokeWidth : null,
            E = !l || O !== z,
            N = !l || E || n.textStroke !== a.textStroke,
            R = Vn(n.textStroke, O),
            B = Fn(n.textFill);
          R && (E && (e.lineWidth = O), N && (e.strokeStyle = R));
          B && ((l && n.textFill === a.textFill) || (e.fillStyle = B));
          if (1 === m.length)
            R && e.strokeText(m[0], M, I), B && e.fillText(m[0], M, I);
          else
            for (A = 0; A < m.length; A++)
              R && e.strokeText(m[A], M, I),
                B && e.fillText(m[A], M, I),
                (I += v);
        })(t, e, i, n, r, o);
  }
  function Ln(t, e, i, n, r) {
    if (i && e.textRotation) {
      ...
      "center" === o
        ...
        : o && ((n = o[0] + i.x), (r = o[1] + i.y)),
        t.translate(n, r),
        t.rotate(-e.textRotation),
        t.translate(-n, -r);
    }
  }
  function On(t, e, i, n, r, o, a, s) {
    ...
    "top" === h
      ...
      !i.isLineHolder &&
        ...
        En(
          ...
          e,
          l,
          "right" === s ? a - i.width : "center" === s ? a - i.width / 2 : a,
          u - i.height / 2,
          i.width,
          i.height
        );
    var c = i.textPadding;
    c && ((a = Wn(a, s, c)), (u -= i.height / 2 - c[2] - i.textHeight / 2)),
      Bn(e, "shadowBlur", G(l.textShadowBlur, n.textShadowBlur, 0)),
      Bn(
        e,
        "shadowColor",
        l.textShadowColor || n.textShadowColor || "transparent"
      ),
      Bn(e, "shadowOffsetX", G(l.textShadowOffsetX, n.textShadowOffsetX, 0)),
      Bn(e, "shadowOffsetY", G(l.textShadowOffsetY, n.textShadowOffsetY, 0)),
      Bn(e, "textAlign", s),
      Bn(e, "textBaseline", "middle"),
      Bn(e, "font", i.font || Sn);
    var d = Vn(l.textStroke || n.textStroke, p),
      f = Fn(l.textFill || n.textFill),
      p = W(l.textStrokeWidth, n.textStrokeWidth);
    d &&
      (Bn(e, "lineWidth", p),
      Bn(e, "strokeStyle", d),
      e.strokeText(i.text, a, u)),
      f && (Bn(e, "fillStyle", f), e.fillText(i.text, a, u));
  }
  function zn(t) {
    return !!(
  ...
  function En(t, e, i, n, r, o, a) {
    var s = i.textBackgroundColor,
      ...
      u = E(s);
    if (
      (Bn(e, "shadowBlur", i.textBoxShadowBlur || 0),
      Bn(e, "shadowColor", i.textBoxShadowColor || "transparent"),
      Bn(e, "shadowOffsetX", i.textBoxShadowOffsetX || 0),
      Bn(e, "shadowOffsetY", i.textBoxShadowOffsetY || 0),
      u || (l && h))
    ) {
      e.beginPath();
      var c = i.textBorderRadius;
      c ? bn(e, { x: n, y: r, width: o, height: a, r: c }) : e.rect(n, r, o, a),
        e.closePath();
    }
    if (u)
      ...
      var f = s.image;
      (f = Qi(f, null, t, Nn, s)) && tn(f) && e.drawImage(f, n, r, o, a);
    }
    if (l && h)
      if (
        (Bn(e, "lineWidth", l),
  ...
  function Rn(t, e, i, n) {
    ...
    if (n) {
      ...
      if (l instanceof Array)
        (r = n.x + Hn(l[0], n.width)), (o = n.y + Hn(l[1], n.height));
      else {
        var h =
          e && e.calculateTextPosition
            ? e.calculateTextPosition(Tn, i, n)
            : dn(Tn, i, n);
        (r = h.x),
          (o = h.y),
          (a = a || h.textAlign),
  ...
  function Xn(t) {
    ...
    (this.style = new Vi(t.style, this)),
      (this._rect = null),
  ...
  (Xn.prototype = {
    ...
    type: "displayable",
    __dirty: !0,
    invisible: !(Zn.prototype = {
      constructor: Zn,
      drawRectText: function (t, e) {
        var i = this.style;
        (e = i.textRect || e), this.__dirty && Dn(i);
        var n = i.text;
        if ((null != n && (n += ""), Gn(n, i))) {
          t.save();
          ...
          i.transformText
            ? this.setTransform(t)
            : r && (Un.copy(e), Un.applyTransform(r), (e = Un)),
            Pn(this, t, n, i, e, Ri),
            t.restore();
        }
      },
    ...
    attrKV: function (t, e) {
      "style" !== t ? pi.prototype.attrKV.call(this, t, e) : this.style.set(e);
    },
    setStyle: function (t, e) {
      return this.style.set(t, e), this.dirty(!1), this;
    },
    useStyle: function (t) {
      return (this.style = new Vi(t, this)), this.dirty(!1), this;
    },
    ...
    (Yn.prototype = {
      ...
      brush: function (t, e) {
        var i = this.style,
          n = i.image;
        i.bind(t, this, e);
        var r = (this._image = Qi(n, this._image, this, this.onload));
        if (r && tn(r)) {
          var o = i.x || 0,
            a = i.y || 0,
            s = i.width,
  ...
  var $n = new bi(0, 0, 0, 0),
    Kn = new bi(0, 0, 0, 0);
  function Qn(t, e, i) {
    this.type = "canvas";
    var n = !t.nodeName || "CANVAS" === t.nodeName.toUpperCase();
    (this._opts = i = k({}, i || {})),
      (this.dpr = i.devicePixelRatio || li),
  ...
  Qn.prototype = {
    ...
    refreshHover: function () {
      var t = this._hoverElements,
        ...
        i = this._hoverlayer;
      if ((i && i.clear(), e)) {
        Pi(t, this.storage.displayableSortFunc);
        var n = {};
    ...
    _doPaintList: function (t, e) {
      ...
      for (var o = !0, a = 0; a < i.length; a++) {
        ...
        for (var g = u; g < s.__endIndex; g++) {
          var m = t[g];
          if (
            (this._doPaintEl(m, s, e, h), (m.__dirty = m.__dirtyText = !1), c)
          )
    ...
    _doPaintEl: function (t, e, i, n) {
      ...
      if (
        ...
        (!t.culling ||
          !(function (t, e, i) {
            return (
              $n.copy(t.getBoundingRect()),
              t.transform && $n.applyTransform(t.transform),
              (Kn.width = e),
              (Kn.height = i),
              !$n.intersect(Kn)
            );
        ...
        (s &&
          ...
          (n.prevEl = t).afterBrush && t.afterBrush(r);
      }
    },
    getLayer: function (t, e) {
      ...
      return (
        i ||
          (((i = new ji("zr_" + t, this, this.dpr)).zlevel = t),
          (i.__builtin__ = !0),
          this._layerConfig[t]
    ...
    insertLayer: function (t, e) {
      var i = this._layers,
        ...
        a = -1,
        s = this._domRoot;
      if (i[t]) ci("ZLevel " + t + " has been used already");
      else if (
        (function (t) {
          return (
            !!t &&
        ...
        if (0 < r && t > n[0]) {
          for (a = 0; a < r - 1 && !(n[a] < t && n[a + 1] > t); a++);
          o = i[n[a]];
        }
        if ((n.splice(a + 1, 0, t), !(i[t] = e).virtual))
          if (o) {
            var l = o.dom;
            l.nextSibling
            ...
            s.firstChild
              ...
              : s.appendChild(e.dom);
      } else ci("Layer of zlevel " + t + " is not valid");
    },
    ...
    eachBuiltinLayer: function (t, e) {
      ...
      for (r = 0; r < o.length; r++)
        (n = o[r]), (i = this._layers[n]).__builtin__ && t.call(e, i, n);
    },
    ...
    _updateLayerStatus: function (t) {
      ...
      for (i = 0; i < t.length; i++) {
        ...
        n !== l && ((n = l), (o = 0)),
          ...
          s.__builtin__ ||
            ci("ZLevel " + l + " has been used by unkown layer " + s.id),
          s !== r &&
            ((s.__used = !0),
    ...
    configLayer: function (t, e) {
      if (e) {
        ...
        for (var n = 0; n < this._zlevelList.length; n++) {
          var r = this._zlevelList[n];
          if (r === t || r === t + 0.01) m(this._layers[r], i[t], !0);
        }
      }
    },
    delLayer: function (t) {
    ...
    resize: function (e, i) {
      if (this._domRoot.style) {
        ...
        if (
          ...
          for (var r in ((t.style.width = e + "px"),
          (t.style.height = i + "px"),
          this._layers))
            this._layers.hasOwnProperty(r) && this._layers[r].resize(e, i);
        ...
        (this._width = e), (this._height = i), this.getLayer(jn).resize(e, i);
      }
      return this;
    },
    ...
    getRenderedCanvas: function (t) {
      ...
      var e = new ji("image", this, t.pixelRatio || this.dpr);
      if (
        (e.initContext(),
        ...
        for (
          var o = {}, a = this.storage.getDisplayList(!0), s = 0;
          s < a.length;
          s++
        ) {
          var l = a[s];
    ...
    pathToImage: function (t, e) {
      ...
      (t.position = [u - r.x, d - r.y]),
        ...
        t.updateTransform(),
        t && t.brush(n);
      var v = new Yn({ style: { x: 0, y: 0, image: i } });
      return (
  ...
  (Jn.prototype = {
    ...
    _update: function () {
      ...
      for (a = 0; a < n; )
        i[a]._needsRemove ? ((i[a] = i[n - 1]), i.pop(), n--) : a++;
      n = r.length;
      for (a = 0; a < n; a++) o[a].fire(r[a]);
      (this._time = t),
        this.onframe(e),
    ...
    _startLoop: function () {
      ...
      (this._running = !0),
        qi(function t() {
          e._running && (qi(t), e._paused || e._update());
        });
    },
    start: function () {
    ...
    animate: function (t, e) {
      var i = new ai(t, (e = e || {}).loop, e.getter, e.setter);
  ...
  var tr,
    ...
    ir = v.domSupported,
    nr =
      ((er = { pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1 }),
      {
        mouse: (tr = [
          "click",
          "dblclick",
        ...
        pointer: P(tr, function (t) {
          var e = t.replace("mouse", "pointer");
          return er.hasOwnProperty(e) ? e : t;
        }),
      }),
    rr = {
  ...
  var ur = hr.prototype;
  ur.stopPropagation = ur.stopImmediatePropagation = ur.preventDefault = J;
  var cr = {
    ...
    mousemove: function (t) {
      ...
      !e || (t.zrX === e[0] && t.zrY === e[1]) || vr(this, !0),
        this.trigger("mousemove", t);
    },
    mouseup: function (t) {
      (t = Ft(this.dom, t)), vr(this, !1), this.trigger("mouseup", t);
    },
    mouseout: function (t) {
      (t = Ft(this.dom, t)),
        this._pointerCapturing && (t.zrEventControl = "no_globalout");
      var e = t.toElement || t.relatedTarget;
      (t.zrIsToLocalDOM = lr(this, e)), this.trigger("mouseout", t);
    },
    touchstart: function (t) {
      sr((t = Ft(this.dom, t))),
        (this._lastTouchMoment = new Date()),
        this.handler.processGesture(t, "start"),
        cr.mousemove.call(this, t),
        cr.mousedown.call(this, t);
    },
    ...
    touchend: function (t) {
      sr((t = Ft(this.dom, t))),
        ...
        cr.mouseup.call(this, t),
        +new Date() - this._lastTouchMoment < 300 && cr.click.call(this, t);
    },
    pointerdown: function (t) {
      cr.mousedown.call(this, t);
    },
    pointermove: function (t) {
      ar(t) || cr.mousemove.call(this, t);
    },
    pointerup: function (t) {
      cr.mouseup.call(this, t);
    },
    pointerout: function (t) {
      ar(t) || cr.mouseout.call(this, t);
    },
  };
  D(["click", "mousewheel", "dblclick", "contextmenu"], function (e) {
    cr[e] = function (t) {
      (t = Ft(this.dom, t)), this.trigger(e, t);
    };
  });
  var dr = {
    pointermove: function (t) {
      ar(t) || dr.mousemove.call(this, t);
    },
    pointerup: function (t) {
  ...
  function fr(i, n) {
    ...
    v.pointerEventsSupported
      ? D(nr.pointer, function (e) {
          gr(n, e, function (t) {
            r[e].call(i, t);
          });
        })
      : (v.touchEventsSupported &&
          D(nr.touch, function (e) {
            gr(n, e, function (t) {
              r[e].call(i, t),
                (function (t) {
                  (t.touching = !0),
        ...
        D(nr.mouse, function (e) {
          gr(n, e, function (t) {
            (t = Vt(t)), n.touching || r[e].call(i, t);
          });
        }));
  }
  function pr(i, n) {
    ...
    v.pointerEventsSupported
      ? D(rr.pointer, t)
      : v.touchEventsSupported || D(rr.mouse, t);
  }
  function gr(t, e, i, n) {
    (t.mounted[e] = i), (t.listenerOpts[e] = n), Ht(t.domTarget, or(e), i, n);
  }
  function mr(t) {
    var e,
      i,
    ...
    for (var a in o)
      o.hasOwnProperty(a) &&
        ...
        (n = o[a]),
        (r = t.listenerOpts[a]),
        zt ? e.removeEventListener(i, n, r) : e.detachEvent("on" + i, n));
    t.mounted = {};
  }
  function vr(t, e) {
    if (((t._mayPointerCapture = null), ir && t._pointerCapturing ^ e)) {
  ...
  function _r(t, e) {
    It.call(this),
      (this.dom = t),
      (this.painterRoot = e),
      (this._localHandlerScope = new yr(t, cr)),
      ir && (this._globalHandlerScope = new yr(document, dr)),
      (this._pointerCapturing = !1),
      (this._mayPointerCapture = null),
      fr(this, this._localHandlerScope);
  }
  var xr = _r.prototype;
  (xr.dispose = function () {
    mr(this._localHandlerScope), ir && mr(this._globalHandlerScope);
  }),
    (xr.setCursor = function (t) {
      this.dom.style && (this.dom.style.cursor = t || "default");
    }),
    S(_r, It);
  var wr = !v.canvasSupported,
    br = { canvas: Qn },
    Sr = {};
  function Mr(t, e) {
    var i = new Cr(n(), t, e);
  ...
  var Cr = function (t, e, i) {
    ...
    if (wr) {
      ...
      o = "vml";
    } else (o && br[o]) || (o = "canvas");
    var a = new br[o](e, r, i, t);
    (this.storage = r), (this.painter = a);
    var s = v.node || v.worker ? null : new _r(a.getViewportRoot(), a.root);
    (this.handler = new $t(r, a, s, a.root)),
      (this.animation = new Jn({ stage: { update: C(this.flush, this) } })),
  ...
  var Tr = (Object.freeze || Object)({
      version: "4.3.2",
      init: Mr,
      dispose: function (t) {
        if (t) t.dispose();
        else {
          for (var e in Sr) Sr.hasOwnProperty(e) && Sr[e].dispose();
          Sr = {};
        }
        return this;
      },
  ...
  function Er(t) {
    return !Dr(t) || kr(t) || t instanceof Date ? t : t.value;
  }
  function Nr(t, r) {
    r = (r || []).slice();
    ...
    return (
      Ar(r, function (t, e) {
        if (Dr(t)) {
          for (var i = 0; i < o.length; i++)
            if (!o[i].option && null != t.id && o[i].exist.id === t.id + "")
              return (o[i].option = t), void (r[e] = null);
      ...
      Ar(r, function (t, e) {
        if (Dr(t)) {
          for (var i = 0; i < o.length; i++) {
            var n = o[i].exist;
            if (!o[i].option && !Vr(n) && null == t.id) {
              o[i].option = t;
              break;
            }
          }
          i >= o.length && o.push({ option: t });
        }
      }),
      o
    );
  ...
  function Rr(t) {
    ...
    Ar(t, function (t, e) {
      ...
      Ar(t, function (t, e) {
        var i = t.option;
        X(
          !i || null == i.id || !a.get(i.id) || a.get(i.id) === t,
          "id duplicates: " + (i && i.id)
        ),
          i && null != i.id && a.set(i.id, t),
          t.keyInfo || (t.keyInfo = {});
      }),
      Ar(t, function (t, e) {
        var i = t.exist,
        ...
        if (Dr(n)) {
          if (
            ((r.name = null != n.name ? n.name + "" : i ? i.name : Pr + e), i)
          )
            r.id = i.id;
  ...
  function Hr() {
    var e = "__\0ec_inner_" + Wr++ + "_" + Math.random().toFixed(5);
    return function (t) {
      return t[e] || (t[e] = {});
    };
  }
        ...
        if ("dataIndex" !== e && "dataIndexInside" !== e) {
          ...
          if (
            !(
              ...
              null == t ||
              ("index" === r && "none" === t) ||
              (h && h.includeMainTypes && x(h.includeMainTypes, n) < 0)
            )
          ) {
            var o = { mainType: n };
            ("index" === r && "all" === t) || (o[r] = t);
            var a = s.queryComponents(o);
            (u[n + "Models"] = a), (u[n + "Model"] = a[0]);
          }
        } else u[e] = t;
      }),
      u
  ...
  function qr(t) {
    var e = { main: "", sub: "" };
    return (
      t && ((t = t.split(Yr)), (e.main = t[0] || ""), (e.sub = t[1] || "")), e
    );
  }
  function $r(t) {
  ...
  var Kr = 0;
  function Qr(t) {
    var e = ["__\0is_clz", Kr++, Math.random().toFixed(3)].join("_");
    (t.prototype[e] = !0),
  ...
  function io(s) {
    ...
    return function (t, e, i) {
      for (var n = {}, r = 0; r < s.length; r++) {
        var o = s[r][1];
        if (!((e && 0 <= x(e, o)) || (i && x(i, o) < 0))) {
          var a = t.getShallow(o);
          null != a && (n[s[r][0]] = a);
        }
      }
      return n;
  ...
  function No(t, e, i, n, r, o) {
    (r[0] = To(t, i)), (r[1] = To(e, n)), (o[0] = Ao(t, i)), (o[1] = Ao(e, n));
  }
  var Ro = [],
    Bo = [];
  function Vo(t, e, i, n, r, o, a, s, l, h) {
    var u,
      c = wo,
      d = _o,
      f = c(t, i, r, a, Ro);
    for (
      ...
      var p = d(t, i, r, a, Ro[u]);
      (l[0] = To(p, l[0])), (h[0] = Ao(p, h[0]));
    }
    for (f = c(e, n, o, s, Bo), u = 0; u < f; u++) {
      var g = d(e, n, o, s, Bo[u]);
      (l[1] = To(g, l[1])), (h[1] = Ao(g, h[1]));
    }
    (l[0] = To(t, l[0])),
      (h[0] = Ao(t, h[0])),
      (l[0] = To(a, l[0])),
  ...
  var Ho = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
    Wo = [],
    Go = [],
    Zo = [],
    Uo = [],
    ...
    $o = Math.sqrt,
    Ko = Math.abs,
    Qo = "undefined" != typeof Float32Array,
    Jo = function (t) {
      (this._saveData = !t),
        this._saveData && (this.data = []),
        (this._ctx = null);
    };
  function ta(t, e, i, n, r, o, a) {
    if (0 === r) return !1;
    var s = r,
      l = 0;
    if (
    ...
    var h = (l = (e - n) / (t - i)) * o - a + (t * n - i * e) / (t - i);
    return (h * h) / (l * l + 1) <= ((s / 2) * s) / 2;
  }
  function ea(t, e, i, n, r, o, a, s, l, h, u) {
    if (0 === l) return !1;
    var c = l;
    return (
      !(
        (e + c < u && n + c < u && o + c < u && s + c < u) ||
        (u < e - c && u < n - c && u < o - c && u < s - c) ||
        (t + c < h && i + c < h && r + c < h && a + c < h) ||
        (h < t - c && h < i - c && h < r - c && h < a - c)
      ) &&
      (function (t, e, i, n, r, o, a, s, l, h, u) {
        var c,
          d,
          f,
          p,
        ...
        for (var y = 0; y < 1; y += 0.05)
          (go[0] = _o(t, i, r, a, y)),
            (go[1] = _o(e, n, o, s, y)),
            (p = vt(po, go)) < v && ((c = y), (v = p));
        v = 1 / 0;
        for (var _ = 0; _ < 32 && !(m < uo); _++)
          (d = c - m),
            (f = c + m),
            (go[0] = _o(t, i, r, a, d)),
            (go[1] = _o(e, n, o, s, d)),
        ...
        return (
          u && ((u[0] = _o(t, i, r, a, c)), (u[1] = _o(e, n, o, s, c))), lo(v)
        );
      })(t, e, i, n, r, o, a, s, h, u, null) <=
        c / 2
    );
  }
  function ia(t, e, i, n, r, o, a, s, l) {
    if (0 === a) return !1;
    var h = a;
    return (
      !(
      ...
      (function (t, e, i, n, r, o, a, s, l) {
        ...
        for (var d = 0; d < 1; d += 0.05) {
          (go[0] = So(t, i, r, d)),
            (go[1] = So(e, n, o, d)),
            (m = vt(po, go)) < c && ((h = d), (c = m));
        }
        c = 1 / 0;
        for (var f = 0; f < 32 && !(u < uo); f++) {
          var p = h - u,
            g = h + u;
          (go[0] = So(t, i, r, p)), (go[1] = So(e, n, o, p));
          var m = vt(go, po);
          if (0 <= p && m < c) (h = p), (c = m);
          else {
            (mo[0] = So(t, i, r, g)), (mo[1] = So(e, n, o, g));
            var v = vt(mo, po);
            g <= 1 && v < c ? ((h = g), (c = v)) : (u *= 0.5);
          }
        }
        return l && ((l[0] = So(t, i, r, h)), (l[1] = So(e, n, o, h))), lo(c);
      })(t, e, i, n, r, o, s, l, null) <=
        h / 2
    );
  }
  (Jo.prototype = {
    ...
    setScale: function (t, e, i) {
      (i = i || 0),
        (this._ux = Ko(i / li / t) || 0),
        (this._uy = Ko(i / li / e) || 0);
    },
    getContext: function () {
      return this._ctx;
    },
    ...
    lineTo: function (t, e) {
      var i =
        Ko(t - this._xi) > this._ux ||
        Ko(e - this._yi) > this._uy ||
        this._len < 5;
      return (
        this.addData(Ho.L, t, e),
        this._ctx &&
          i &&
          (this._needsDash()
    ...
    bezierCurveTo: function (t, e, i, n, r, o) {
      return (
        this.addData(Ho.C, t, e, i, n, r, o),
        this._ctx &&
          (this._needsDash()
            ? this._dashedBezierTo(t, e, i, n, r, o)
            : this._ctx.bezierCurveTo(t, e, i, n, r, o)),
        (this._xi = r),
        (this._yi = o),
        this
      );
    ...
    arc: function (t, e, i, n, r, o) {
      return (
        this.addData(Ho.A, t, e, i, i, n, r - n, 0, o ? 0 : 1),
    ...
    _dashedLineTo: function (t, e) {
      var i,
        ...
        g = a.length;
      for (
        o < 0 && (o = r + o), f -= (o %= r) * (u /= d), p -= o * (c /= d);
        (0 < u && f <= t) ||
        (u < 0 && t <= f) ||
        (0 === u && ((0 < c && p <= e) || (c < 0 && e <= p)));

      )
        (f += u * (i = a[(n = this._dashIdx)])),
          (p += c * i),
          (this._dashIdx = (n + 1) % g),
          (0 < u && f < l) ||
            (u < 0 && l < f) ||
      ...
      (u = f - t), (c = p - e), (this._dashOffset = -$o(u * u + c * c));
    },
    _dashedBezierTo: function (t, e, i, n, r, o) {
      ...
      for (d < 0 && (d = c + d), d %= c, a = 0; a < 1; a += 0.1)
        (s = v(g, t, i, r, a + 0.1) - v(g, t, i, r, a)),
          (l = v(m, e, n, o, a + 0.1) - v(m, e, n, o, a)),
          (y += $o(s * s + l * l));
      for (; _ < x && !(d < (w += f[_])); _++);
      for (a = (w - d) / y; a <= 1; )
        (h = v(g, t, i, r, a)),
    ...
    toStatic: function () {
      var t = this.data;
      t instanceof Array &&
        ((t.length = this._len), Qo && (this.data = new Float32Array(t)));
    },
    getBoundingRect: function () {
      (Wo[0] = Wo[1] = Zo[0] = Zo[1] = Number.MAX_VALUE),
        (Go[0] = Go[1] = Uo[0] = Uo[1] = -Number.MAX_VALUE);
      for (
        var t,
          e,
          i,
        ...
        var x = p[_++];
        switch ((1 === _ && ((v = g = p[_]), (y = m = p[_ + 1])), x)) {
          case Ho.M:
            (g = v = p[_++]),
              (m = y = p[_++]),
              (Zo[0] = v),
            ...
            break;
          case Ho.L:
            No(g, m, p[_], p[_ + 1], Zo, Uo), (g = p[_++]), (m = p[_++]);
            break;
          case Ho.C:
            Vo(g, m, p[_++], p[_++], p[_++], p[_++], p[_], p[_ + 1], Zo, Uo),
              (g = p[_++]),
              (m = p[_++]);
            break;
          case Ho.Q:
          ...
          case Ho.A:
            ...
            _ += 1;
            var T = 1 - p[_++];
            1 === _ && ((v = jo(I) * S + w), (y = qo(I) * M + b)),
              Fo(w, b, S, M, I, C, T, Zo, Uo),
              (g = jo(C) * S + w),
              (m = qo(C) * M + b);
            break;
          case Ho.R:
        ...
        _t(Wo, Wo, Zo), xt(Go, Go, Uo);
      }
      return (
        0 === _ && (Wo[0] = Wo[1] = Go[0] = Go[1] = 0),
        new bi(Wo[0], Wo[1], Go[0] - Wo[0], Go[1] - Wo[1])
      );
    },
      ...
      for (
        ...
        switch ((1 === c && ((e = n = s[c]), (i = r = s[c + 1])), d)) {
          ...
          case Ho.L:
            (o = s[c++]),
              (a = s[c++]),
              (Ko(o - n) > l || Ko(a - r) > h || c === u - 1) &&
                (t.lineTo(o, a), (n = o), (r = a));
            break;
          case Ho.C:
  ...
  var na = 2 * Math.PI;
  function ra(t) {
    return (t %= na) < 0 && (t += na), t;
  }
  var oa = 2 * Math.PI;
  function aa(t, e, i, n, r, o, a, s, l) {
    if (0 === a) return !1;
    var h = a;
    (s -= t), (l -= e);
    var u = Math.sqrt(s * s + l * l);
    if (i < u - h || u + h < i) return !1;
    if (Math.abs(n - r) % oa < 1e-4) return !0;
    if (o) {
      var c = n;
      (n = ra(r)), (r = ra(c));
    } else (n = ra(n)), (r = ra(r));
    ...
    return (
      d < 0 && (d += oa), (n <= d && d <= r) || (n <= d + oa && d + oa <= r)
    );
  }
  function sa(t, e, i, n, r, o) {
    ...
    var a = n < e ? 1 : -1,
      s = (o - e) / (n - e);
    (1 != s && 0 != s) || (a = n < e ? 0.5 : -0.5);
    var l = s * (i - t) + t;
    return l === r ? 1 / 0 : r < l ? a : 0;
  }
  var la = Jo.CMD,
    ha = 2 * Math.PI,
    ua = 1e-4;
  var ca = [-1, -1, -1],
    da = [-1, -1];
  function fa(t, e, i, n, r, o, a, s, l, h) {
    if (
      (e < h && n < h && o < h && s < h) ||
      (h < e && h < n && h < o && h < s)
    )
        ...
        if (vo(u) && vo(c)) {
          ...
          if (vo(p)) {
            ...
            0 <=
              (M =
                (-s -
                  ((y = y < 0 ? -so(-y, fo) : so(y, fo)) +
                    (_ = _ < 0 ? -so(-_, fo) : so(_, fo)))) /
                (3 * a)) &&
              M <= 1 &&
              (o[f++] = M);
          } else {
            var x = (2 * u * s - 3 * a * c) / (2 * lo(u * u * u)),
              w = Math.acos(x) / 3,
              b = lo(u),
              S = Math.cos(w),
              M = (-s - 2 * b * S) / (3 * a),
              I =
                ((m = (-s + b * (S + co * Math.sin(w))) / (3 * a)),
                (-s + b * (S - co * Math.sin(w))) / (3 * a));
            0 <= M && M <= 1 && (o[f++] = M),
              0 <= m && m <= 1 && (o[f++] = m),
              0 <= I && I <= 1 && (o[f++] = I);
          }
    ...
    for (var d, f, p = 0, g = -1, m = 0; m < c; m++) {
      ...
      _o(t, i, r, a, v) < l ||
        (g < 0 &&
          ...
          da[1] < da[0] &&
            1 < g &&
            (void 0, (u = da[0]), (da[0] = da[1]), (da[1] = u)),
          (d = _o(e, n, o, s, da[0])),
          1 < g && (f = _o(e, n, o, s, da[1]))),
        2 === g
          ? v < da[0]
            ? (p += d < e ? y : -y)
            : v < da[1]
  ...
  function pa(t, e, i, n, r, o, a, s) {
    ...
    var l = (function (t, e, i, n, r) {
      var o = t - 2 * e + i,
        ...
        l = 0;
      if (vo(o)) {
        if (yo(a)) 0 <= (u = -s / a) && u <= 1 && (r[l++] = u);
      } else {
        var h = a * a - 4 * o * s;
        if (vo(h)) 0 <= (u = -a / (2 * o)) && u <= 1 && (r[l++] = u);
        else if (0 < h) {
          var u,
            c = lo(h),
            d = (-a - c) / (2 * o);
          0 <= (u = (-a + c) / (2 * o)) && u <= 1 && (r[l++] = u),
            0 <= d && d <= 1 && (r[l++] = d);
        }
      }
      return l;
    ...
    var h = Io(e, n, o);
    if (0 <= h && h <= 1) {
      for (var u = 0, c = So(e, n, o, h), d = 0; d < l; d++) {
        var f = 0 === ca[d] || 1 === ca[d] ? 0.5 : 1;
        So(t, i, r, ca[d]) < a ||
          (ca[d] < h ? (u += c < e ? f : -f) : (u += o < c ? f : -f));
      }
      return u;
    }
    f = 0 === ca[0] || 1 === ca[0] ? 0.5 : 1;
    return So(t, i, r, ca[0]) < a ? 0 : o < e ? f : -f;
  }
  function ga(t, e, i, n, r, o, a, s) {
    ...
    if (h % ha < 1e-4) {
      r = ha;
      var u = o ? 1 : -1;
      return a >= ca[(n = 0)] + t && a <= ca[1] + t ? u : 0;
    }
    if (o) {
      l = n;
      (n = ra(r)), (r = ra(l));
  ...
  function ma(t, e, i, n, r) {
    for (var o = 0, a = 0, s = 0, l = 0, h = 0, u = 0; u < t.length; ) {
      ...
      switch (
        ...
        case la.L:
          if (i) {
            if (ta(a, s, t[u], t[u + 1], e, n, r)) return !0;
          } else o += sa(a, s, t[u], t[u + 1], n, r) || 0;
          (a = t[u++]), (s = t[u++]);
          break;
        case la.C:
          if (i) {
            if (
              ea(a, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], e, n, r)
            )
              return !0;
          } else
            o +=
              fa(a, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], n, r) ||
              0;
          (a = t[u++]), (s = t[u++]);
          break;
        case la.Q:
          if (i) {
            if (ia(a, s, t[u++], t[u++], t[u], t[u + 1], e, n, r)) return !0;
          } else o += pa(a, s, t[u++], t[u++], t[u], t[u + 1], n, r) || 0;
          (a = t[u++]), (s = t[u++]);
          break;
        case la.A:
          var d = t[u++],
          ...
          var y = 1 - t[u++],
            _ = Math.cos(m) * p + d,
            x = Math.sin(m) * g + f;
          1 < u ? (o += sa(a, s, _, x, n, r)) : ((l = _), (h = x));
          var w = ((n - d) * g) / p + d;
          if (i) {
            if (aa(d, f, g, m, m + v, y, e, w, r)) return !0;
          } else o += ga(d, f, g, m, m + v, y, w, r);
        ...
        case la.R:
          ...
          if (i) {
            if (
              ...
              return !0;
          } else (o += sa(_, h, _, x, n, r)), (o += sa(l, x, l, h, n, r));
          break;
        case la.Z:
          if (i) {
            if (ta(a, s, l, h, e, n, r)) return !0;
          } else o += sa(a, s, l, h, n, r);
          (a = l), (s = h);
      }
    }
    return (
      i ||
        (function (t, e) {
          return Math.abs(t - e) < ua;
        })(s, h) ||
        (o += sa(a, s, l, h, n, r) || 0),
      0 !== o
    );
  }
  var va = Ui.prototype.getCanvasPattern,
    ya = Math.abs,
    _a = new Jo(!0);
  function xa(t) {
    Xn.call(this, t), (this.path = null);
  }
  (xa.prototype = {
    constructor: xa,
    type: "path",
    ...
    brush: function (t, e) {
      ...
      h
        ...
        : c && (t.fillStyle = va.call(s, t)),
        u
          ? (t.strokeStyle = this._strokeGradient)
          : d && (t.strokeStyle = va.call(l, t));
      var f = n.lineDash,
        p = n.lineDashOffset,
        g = !!t.setLineDash,
        m = this.getGlobalScale();
      if (
        (r.setScale(m[0], m[1], this.segmentIgnoreThreshold),
    ...
    attrKV: function (t, e) {
      "shape" === t
        ...
        : Xn.prototype.attrKV.call(this, t, e);
    },
    setShape: function (t, e) {
      var i = this.shape;
      if (i) {
        if (N(t)) for (var n in t) t.hasOwnProperty(n) && (i[n] = t[n]);
        else i[t] = e;
        this.dirty(!0);
      }
      return this;
    ...
    getLineScale: function () {
      ...
      return t && 1e-10 < ya(t[0] - 1) && 1e-10 < ya(t[3] - 1)
        ? Math.sqrt(ya(t[0] * t[3] - t[2] * t[1]))
        : 1;
    },
  }),
    (xa.extend = function (r) {
      function t(t) {
        xa.call(this, t), r.style && this.style.extendFrom(r.style, !1);
        var e = r.shape;
        if (e) {
      ...
      for (var e in (w(t, xa), r))
        "style" !== e && "shape" !== e && (t.prototype[e] = r[e]);
      return t;
    }),
    w(xa, Xn);
  function wa(t) {
  ...
  var ba = Jo.CMD,
    ...
    Ca = function (t, e) {
      var i,
        ...
        d = ba.A,
        f = ba.Q;
      for (o = r = 0; r < s.length; ) {
        switch (((i = s[r++]), (o = r), (n = 0), i)) {
          case l:
          case u:
            n = 1;
            break;
          ...
          case d:
            var p = e[4],
              g = e[5],
              m = Ma(e[0] * e[0] + e[1] * e[1]),
              v = Ma(e[2] * e[2] + e[3] * e[3]),
              y = Ia(-e[1] / v, e[0] / m);
            (s[r] *= m),
              (s[r++] += p),
              (s[r] *= v),
    ...
    ka = Math.PI,
    Pa = function (t, e) {
      return (t[0] * e[0] + t[1] * e[1]) / (wa(t) * wa(e));
    },
    La = function (t, e) {
      return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(Pa(t, e));
    };
  function Oa(t, e, i, n, r, o, a, s, l, h, u) {
    var c = l * (ka / 180),
      d = (Da(c) * (t - i)) / 2 + (Aa(c) * (e - n)) / 2,
      f = (-1 * Aa(c) * (t - i)) / 2 + (Da(c) * (e - n)) / 2,
      p = (d * d) / (a * a) + (f * f) / (s * s);
    1 < p && ((a *= Ta(p)), (s *= Ta(p)));
    var g =
        (r === o ? -1 : 1) *
      ...
      m = (g * a * f) / s,
      v = (g * -s * d) / a,
      y = (t + i) / 2 + Da(c) * m - Aa(c) * v,
      _ = (e + n) / 2 + Aa(c) * m + Da(c) * v,
      x = La([1, 0], [(d - m) / a, (f - v) / s]),
      w = [(d - m) / a, (f - v) / s],
      b = [(-1 * d - m) / a, (-1 * f - v) / s],
      S = La(w, b);
    Pa(w, b) <= -1 && (S = ka),
      ...
      0 === o && 0 < S && (S -= 2 * ka),
      1 === o && S < 0 && (S += 2 * ka),
      u.addData(h, y, _, a, s, x, S, c, o);
  }
  var za = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi,
    Ea = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g;
  function Na(t, e) {
    var i = (function (t) {
      if (!t) return new Jo();
      for (
        ...
        for (var m = 0; m < p; ) {
          ...
          switch (d) {
            case "l":
              (i += f[m++]), (n += f[m++]), (u = s.L), a.addData(u, i, n);
              break;
            case "L":
              (i = f[m++]), (n = f[m++]), (u = s.L), a.addData(u, i, n);
              break;
            ...
            case "M":
              ...
              break;
            case "h":
              (i += f[m++]), (u = s.L), a.addData(u, i, n);
              break;
            case "H":
              (i = f[m++]), (u = s.L), a.addData(u, i, n);
              break;
            case "v":
              (n += f[m++]), (u = s.L), a.addData(u, i, n);
              break;
            case "V":
              (n = f[m++]), (u = s.L), a.addData(u, i, n);
              break;
            case "C":
              (u = s.C),
                a.addData(u, f[m++], f[m++], f[m++], f[m++], f[m++], f[m++]),
                (i = f[m - 2]),
                (n = f[m - 1]);
              break;
            case "c":
        ...
        ("z" !== d && "Z" !== d) || ((u = s.Z), a.addData(u), (i = r), (n = o)),
          (e = u);
      }
      return a.toStatic(), a;
    })(t);
  ...
  (Ba.prototype = {
    ...
    brush: function (t, e) {
      ...
      null != n && (n += ""),
        Gn(n, i)
          ? (this.setTransform(t),
            Pn(this, t, n, i, null, e),
            this.restoreTransform(t))
          : (t.__attrCachedBy = Ni.NONE);
    },
    getBoundingRect: function () {
      var t = this.style;
      if ((this.__dirty && Dn(t), !this._rect)) {
        var e = t.text;
        null != e ? (e += "") : (e = "");
        var i = hn(
          t.text + "",
        ...
        if (
          ((i.x += t.x || 0),
          (i.y += t.y || 0),
          Vn(t.textStroke, t.textStrokeWidth))
        ) {
      ...
      ? function () {
          ...
          if (e)
            for (var n = 0; n < e.length; n++) {
              ...
              if (
                o &&
                (("sector" === a && o.startAngle === o.endAngle) ||
                  ("rect" === a && (!o.width || !o.height)))
              ) {
                for (var s = 0; s < Ha.length; s++)
                  (Ha[s][2] = i[Ha[s][0]]), (i[Ha[s][0]] = Ha[s][1]);
                t = !0;
                break;
              }
            }
          if ((l.apply(this, arguments), t))
            for (s = 0; s < Ha.length; s++) i[Ha[s][0]] = Ha[s][2];
        }
      : l;
  }
  var Fa = xa.extend({
  ...
  function Ua(t, e, i) {
    ...
    if (n && 2 <= n.length) {
      if (r && "spline" !== r) {
        var o = (function (t, e, i, n) {
          ...
          if (n) {
            ...
            for (var d = 0, f = t.length; d < f; d++)
              _t(a, a, t[d]), xt(s, s, t[d]);
            _t(a, a, n[0]), xt(s, s, n[1]);
          }
          for (d = 0, f = t.length; d < f; d++) {
            var p = t[d];
            if (i) (r = t[d ? d - 1 : f - 1]), (o = t[(d + 1) % f]);
            else {
              if (0 === d || d === f - 1) {
                l.push(rt(t[d]));
                continue;
            ...
            var g = pt(p, r),
              m = pt(p, o),
              v = g + m;
            0 !== v && ((g /= v), (m /= v)), dt(u, h, -g), dt(c, h, m);
            var y = ot([], p, u),
              _ = ot([], p, c);
            n && (xt(y, y, a), _t(y, y, s), xt(_, _, a), _t(_, _, s)),
              l.push(y),
              l.push(_);
          }
        ...
        for (var a = n.length, s = 0; s < (i ? a : a - 1); s++) {
          var l = o[2 * s],
            h = o[2 * s + 1],
            u = n[(s + 1) % a];
        ...
        "spline" === r &&
          (n = (function (t, e) {
            for (var i = t.length, n = [], r = 0, o = 1; o < i; o++)
              r += pt(t[o - 1], t[o]);
            var a = r / 2;
            a = a < i ? i : a;
            for (o = 0; o < a; o++) {
              ...
              var p = d * d,
                g = d * p;
              n.push([
                Za(s[0], f[0], l[0], h[0], d, p, g),
                Za(s[1], f[1], l[1], h[1], d, p, g),
              ]);
            }
            return n;
          })(n, i)),
  ...
  function qa(t, e, i) {
    if (e) {
      var n = e.x1,
        ...
        o = e.y1,
        a = e.y2;
      (t.x1 = n), (t.x2 = r), (t.y1 = o), (t.y2 = a);
      var s = i && i.lineWidth;
      s &&
        (ja(2 * n) === ja(2 * r) && (t.x1 = t.x2 = Ka(n, s, !0)),
        ja(2 * o) === ja(2 * a) && (t.y1 = t.y2 = Ka(o, s, !0)));
    }
  }
  function $a(t, e, i) {
    if (e) {
      var n = e.x,
        ...
        o = e.width,
        a = e.height;
      (t.x = n), (t.y = r), (t.width = o), (t.height = a);
      var s = i && i.lineWidth;
      s &&
        ((t.x = Ka(n, s, !0)),
        (t.y = Ka(r, s, !0)),
        (t.width = Math.max(Ka(n + o, s, !1) - t.x, 0 === o ? 0 : 1)),
        (t.height = Math.max(Ka(r + a, s, !1) - t.y, 0 === a ? 0 : 1)));
    }
  }
  function Ka(t, e, i) {
    if (!e) return t;
    var n = ja(2 * t);
    return (n + ja(e)) % 2 == 0 ? n / 2 : (n + (i ? 1 : -1)) / 2;
  }
  var Qa = {},
    Ja = xa.extend({
      type: "rect",
      ...
      buildPath: function (t, e) {
        ...
        this.subPixelOptimize
          ? ($a(Qa, e, this.style),
            ...
            (Qa.r = e.r),
            (e = Qa))
          : ((i = e.x), (n = e.y), (r = e.width), (o = e.height)),
          e.r ? bn(t, e) : t.rect(i, n, r, o),
          t.closePath();
      },
    }),
    ts = {},
    es = xa.extend({
      ...
      buildPath: function (t, e) {
        var i, n, r, o;
        o = this.subPixelOptimize
          ? (qa(ts, e, this.style),
            (i = ts.x1),
            (n = ts.y1),
            (r = ts.x2),
            ts.y2)
          : ((i = e.x1), (n = e.y1), (r = e.x2), e.y2);
        var a = e.percent;
        0 !== a &&
          (t.moveTo(i, n),
          a < 1 && ((r = i * (1 - a) + r * a), (o = n * (1 - a) + o * a)),
          t.lineTo(r, o));
      },
      pointAt: function (t) {
        var e = this.shape;
  ...
  function ns(t, e, i) {
    ...
    return null === n || null === r
      ? [
          (i ? xo : _o)(t.x1, t.cpx1, t.cpx2, t.x2, e),
          (i ? xo : _o)(t.y1, t.cpy1, t.cpy2, t.y2, e),
        ]
      : [
          (i ? Mo : So)(t.x1, t.cpx1, t.x2, e),
          (i ? Mo : So)(t.y1, t.cpy1, t.y2, e),
        ];
  }
  function rs(t) {
    this.colorStops = t || [];
  ...
  var os = xa.extend({
    ...
    ss = xa.extend({
      ...
      getBoundingRect: function () {
        return this._updatePathDirty(), xa.prototype.getBoundingRect.call(this);
      },
    });
  rs.prototype = {
    constructor: rs,
  ...
  (ls.prototype = { constructor: ls }), w(ls, rs);
  ...
  (hs.prototype = { constructor: hs }),
    w(hs, rs),
    (us.prototype.incremental = !0),
    (us.prototype.clearDisplaybles = function () {
      (this._displayables = []),
        (this._temporaryDisplayables = []),
        (this._cursor = 0),
        this.dirty(),
    ...
    (us.prototype.addDisplayable = function (t, e) {
      e ? this._temporaryDisplayables.push(t) : this._displayables.push(t),
        this.dirty();
    }),
    (us.prototype.addDisplayables = function (t, e) {
      e = e || !1;
      for (var i = 0; i < t.length; i++) this.addDisplayable(t[i], e);
    }),
    (us.prototype.eachPendingDisplayable = function (t) {
    ...
    (us.prototype.brush = function (t, e) {
  ...
  var cs = [];
  (us.prototype.getBoundingRect = function () {
    if (!this._rect) {
      for (
        var t = new bi(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0;
        e < this._displayables.length;
        e++
      ) {
        var i = this._displayables[e],
          n = i.getBoundingRect().clone();
        i.needLocalTransform() && n.applyTransform(i.getLocalTransform(cs)),
          t.union(n);
      }
      this._rect = t;
    }
    ...
    (us.prototype.contain = function (t, e) {
      var i = this.transformCoordToLocal(t, e);
  ...
  function Ss(t) {
    if (xs.hasOwnProperty(t)) return xs[t];
  }
  function Ms(t, e, i, n) {
    var r = Ra(t, e);
    return (
      i && ("center" === n && (i = Cs(i, r.getBoundingRect())), As(r, i)), r
    );
  }
  function Is(t, i, n) {
    var r = new Yn({
  ...
  function zs(t, e, i) {
    !ks(e[i]) &&
      ...
      (t[i] = (function (t) {
        if ("string" != typeof t) return t;
        var e = Ps.get(t);
        return e || ((e = Be(t, -0.1)), Ls < 1e4 && (Ps.set(t, e), Ls++)), e;
      })(t[i]));
  }
  function Es(t) {
    ...
    if (e && ((t.__highlighted = !1), !t.isGroup))
      if ("layer" === e) t.__zr && t.__zr.removeHover(t);
        ...
        n && (Js(i), t.setStyle(n), Qs(i));
        var r = t.__cachedNormalZ2;
        null != r && t.z2 - r === gs && (t.z2 = r);
      }
  }
  function Ns(t, e, i) {
    var n,
      r = vs,
      o = vs;
    t.__highlighted && ((r = ms), (n = !0)),
      e(t, i),
      t.__highlighted && ((o = ms), (n = !0)),
      t.isGroup &&
  ...
  function Rs(t, e) {
    (e = t.__hoverStl = !1 !== e && (t.hoverStyle || e || {})),
      (t.__hoverStlDirty = !0),
      t.__highlighted && ((t.__cachedNormalStl = null), Es(t), Os(t));
  }
  function Bs(t) {
    Ws(this, t) || this.__highByOuter || Ns(this, Os);
  }
  function Vs(t) {
    Ws(this, t) || this.__highByOuter || Ns(this, Es);
  }
  function Fs(t) {
    (this.__highByOuter |= 1 << (t || 0)), Ns(this, Os);
  }
  function Hs(t) {
    (this.__highByOuter &= ~(1 << (t || 0))) || Ns(this, Es);
  }
  function Ws(t, e) {
  ...
  function Zs(t, e) {
    ...
    if (
      ...
      var n = i ? "off" : "on";
      t[n]("mouseover", Bs)[n]("mouseout", Vs),
        t[n]("emphasis", Fs)[n]("normal", Hs),
  ...
  function Xs(t) {
    var e = _s[t];
    return null == e && ys <= 32 && (e = _s[t] = ys++), e;
  }
  function Ys(t, e, i, n, r, o, a) {
    var s,
      l = (r = r || ps).labelFetcher,
      h = r.labelDataIndex,
      u = r.labelDimIndex,
      c = r.labelProp,
      d = i.getShallow("show"),
      f = n.getShallow("show");
    (d || f) &&
      (l && (s = l.getFormattedLabel(h, "normal", null, u, c)),
      null == s &&
        (s = z(r.defaultText) ? r.defaultText(h, r) : r.defaultText));
    var p = d ? s : null,
      g = f
        ? W(l ? l.getFormattedLabel(h, "emphasis", null, u, c) : null, s)
        : null;
    (null == p && null == g) || (js(t, i, o, r), js(e, n, a, r, !0)),
      (t.text = p),
      (e.text = g);
  }
  function js(t, e, i, n, r) {
    return qs(t, e, n, r), i && k(t, i), t;
  }
  function qs(t, e, i, n) {
    if ((i = i || ps).isRectText) {
      var r;
      i.getTextPosition
      ...
      null != o && (o *= Math.PI / 180),
        (t.textRotation = o),
        (t.textDistance = W(e.getShallow("distance"), n ? null : 5));
    }
    var a,
      s = e.ecModel,
  ...
  function $s(t, e, i, n, r, o) {
    (i = (!r && i) || ps),
      (t.textFill = Ks(e.getShallow("color"), n) || i.color),
      (t.textStroke =
        Ks(e.getShallow("textBorderColor"), n) || i.textBorderColor),
      (t.textStrokeWidth = W(
        e.getShallow("textBorderWidth"),
        i.textBorderWidth
      )),
      r ||
        (o && ((t.insideRollbackOpt = n), Qs(t)),
      ...
      (o && n.disableBox) ||
        ((t.textBackgroundColor = Ks(e.getShallow("backgroundColor"), n)),
        (t.textPadding = e.getShallow("padding")),
        (t.textBorderColor = Ks(e.getShallow("borderColor"), n)),
    ...
    if (n && null == t.textFill) {
      var r = n.autoColor,
        ...
        s =
          !1 !== a &&
          (!0 === a ||
            (o && i && "string" == typeof i && 0 <= i.indexOf("inside"))),
        l = !s && null != r;
      (s || l) &&
        (e = {
          textFill: t.textFill,
  ...
  function el(t, e, i, n, r, o) {
    if (
      ("function" == typeof r && ((o = r), (r = null)),
      n && n.isAnimationEnabled())
    ) {
      var a = t ? "Update" : "",
        s = n.getShallow("animationDuration" + a),
        l = n.getShallow("animationEasing" + a),
        h = n.getShallow("animationDelay" + a);
      "function" == typeof h &&
        (h = h(
          r,
        ...
        0 < s
          ? e.animateTo(i, s, h || 0, l, o, !!o)
          : (e.stopAnimation(), e.attr(i), o && o());
  ...
  function rl(t, e) {
    for (var i = ie([]); t && t !== e; )
      re(i, t.getLocalTransform(), i), (t = t.parent);
    return i;
  }
  function ol(t, e, i) {
    return (
      e && !L(e) && (e = de.getLocalTransform(e)),
      i && (e = le([], e)),
      yt([], t, e)
    );
  }
    ...
    if (t && e) {
      ...
      e.traverse(function (t) {
        if (!t.isGroup && t.anid) {
          ...
          if (e) {
            var i = a(t);
            t.attr(a(e)), il(t, i, n, t.dataIndex);
          }
        }
      });
    }
    function a(t) {
      var e = { position: rt(t.position), rotation: t.rotation };
  ...
  function ll(t, n) {
    return P(t, function (t) {
      var e = t[0];
      (e = ds(e, n.x)), (e = fs(e, n.x + n.width));
      var i = t[1];
      return (i = ds(i, n.y)), [e, (i = fs(i, n.y + n.height))];
    });
  }
  function hl(t, e, i) {
    var n = ((e = k({ rectHover: !0 }, e)).style = { strokeNoScale: !0 });
    if (((i = i || { x: -1, y: -1, width: 2, height: 2 }), t))
      return 0 === t.indexOf("image://")
        ? ((n.image = t.slice(8)), A(n, i), new Yn(e))
        : Ms(t.replace("path://", ""), e, i, "center");
  }
  function ul(t, e, i, n, r, o, a, s) {
    var l = i - t,
      h = n - e,
      u = a - r,
      c = s - o,
  ...
  var dl = (Object.freeze || Object)({
      ...
      subPixelOptimizeLine: function (t) {
        return qa(t.shape, t.shape, t.style), t;
      },
      subPixelOptimizeRect: function (t) {
        return $a(t.shape, t.shape, t.style), t;
      },
      subPixelOptimize: Ds,
      setElementHoverStyle: Rs,
      setHoverStyle: Gs,
      setAsHighDownDispatcher: Zs,
      isHighDownDispatcher: Us,
      getHighlightDigit: Xs,
      setLabelStyle: Ys,
      modifyLabelStyle: function (t, e, i) {
        var n = t.style;
        e && (Js(n), t.setStyle(e), Qs(n)),
          (n = t.__hoverStl),
          i && n && (Js(n), k(n, i), Qs(n));
      },
      setTextStyle: js,
      setText: function (t, e, i) {
        var n,
          r = { isRectText: !0 };
        !1 === i ? (n = !0) : (r.autoColor = i), qs(t, e, r, n);
      },
      getFont: tl,
      updateProps: il,
      initProps: nl,
      ...
      clipRectByRect: function (t, e) {
        var i = ds(t.x, e.x),
          n = fs(t.x + t.width, e.x + e.width),
          r = ds(t.y, e.y),
          o = fs(t.y + t.height, e.y + e.height);
        if (i <= n && r <= o)
      ...
      linePolygonIntersect: function (t, e, i, n, r) {
        for (var o = 0, a = r[r.length - 1]; o < r.length; o++) {
          var s = r[o];
          if (ul(t, e, i, n, s[0], s[1], a[0], a[1])) return !0;
          a = s;
        }
      },
      lineLineIntersect: ul,
      Group: Si,
      Image: Yn,
      Text: Ba,
      Circle: Fa,
    ...
    pl = {
      getTextColor: function (t) {
        var e = this.ecModel;
        return this.getShallow("color") || (!t && e ? e.get(fl) : null);
      },
      getFont: function () {
        return tl(
          {
  ...
  (_l.prototype = {
    ...
    get: function (t, e) {
      return null == t
        ? this.option
        : xl(this.option, this.parsePath(t), !e && wl(this, t));
    },
    ...
    getModel: function (t, e) {
      var i;
      return new _l(
        null == t ? this.option : xl(this.option, (t = this.parsePath(t))),
        (e = e || ((i = wl(this, t)) && i.getModel(t))),
        this.ecModel
      );
    },
    isEmpty: function () {
  ...
  var bl = 0;
  function Sl(t) {
    return [t || "", bl++, Math.random().toFixed(5)].join("_");
  }
  var Ml = 1e-4;
  function Il(t, e, i, n) {
    var r = e[1] - e[0],
  ...
  function Ll(t, e, i) {
    ...
    for (
      ...
      for (
        var u = Number.NEGATIVE_INFINITY, c = null, d = 0, f = h.length;
        d < f;
        ++d
      )
        h[d] > u && ((u = h[d]), (c = d));
  ...
  var El = /^(?:(\d{4})(?:[-\/](\d{1,2})(?:[-\/](\d{1,2})(?:[T ](\d{1,2})(?::(\d\d)(?::(\d\d)(?:[.,](\d+))?)?)?(Z|[\+\-]\d\d:?\d\d)?)?)?)?)?$/;
  function Nl(t) {
  ...
  var Fl = (Object.freeze || Object)({
    ...
    getPercentWithPrecision: Ll,
    MAX_SAFE_INTEGER: 9007199254740991,
    remRadian: Ol,
    isRadianAroundZero: zl,
    parseDate: Nl,
    quantity: Rl,
    quantityExponent: Bl,
    nice: Vl,
    ...
    reformIntervals: function (t) {
      ...
      for (var e = -1 / 0, i = 1, n = 0; n < t.length; ) {
        for (var r = t[n].interval, o = t[n].close, a = 0; a < 2; a++)
          r[a] <= e && ((r[a] = e), (o[a] = a ? 1 : 1 - i)),
            (e = r[a]),
            (i = o[a]);
        r[0] === r[1] && o[0] * o[1] != 1 ? t.splice(n, 1) : n++;
      }
      return t;
    },
  ...
  function ql(t, e, i) {
    ...
    for (var r = e[0].$vars || [], o = 0; o < r.length; o++) {
      var a = jl[o];
      t = t.replace(Yl(a), Yl(a, 0));
    }
    for (var s = 0; s < n; s++)
      for (var l = 0; l < r.length; l++) {
        var h = e[s][r[l]];
        t = t.replace(Yl(jl[l], s), i ? Xl(h) : h);
      }
    return t;
  }
  function $l(t, e) {
    var i = (t = E(t) ? { color: t, extraCssText: e } : t || {}).color,
      n = t.type,
  ...
  var ih = (Object.freeze || Object)({
      addCommas: Hl,
      toCamelCase: Wl,
      normalizeCssArray: Gl,
      encodeHTML: Xl,
      formatTpl: ql,
      formatTplSimple: function (i, t, n) {
        return (
          D(t, function (t, e) {
            i = i.replace("{" + e + "}", n ? Xl(t) : t);
          }),
          i
        );
      },
      ...
      getTextRect: function (t, e, i, n, r, o, a, s) {
        return hn(t, e, i, n, r, s, o, a);
      },
      windowOpen: eh,
    }),
    nh = D,
    rh = ["left", "right", "top", "bottom", "width", "height"],
    oh = [
      ["width", "left", "right"],
      ["height", "top", "bottom"],
    ];
  function ah(u, c, d, f, p) {
    var g = 0,
      m = 0;
    ...
    c.eachChild(function (t, e) {
      var i,
        ...
        o = t.getBoundingRect(),
        a = c.childAt(e + 1),
        s = a && a.getBoundingRect();
      if ("horizontal" === u) {
        var l = o.width + (s ? -s.x + o.x : 0);
        v =
          f < (i = g + l) || t.newline
            ? ((g = 0), (i = l), (m += v + d), o.height)
            : Math.max(v, o.height);
      } else {
        var h = o.height + (s ? -s.y + o.y : 0);
        v =
          p < (n = m + h) || t.newline
            ? ((g += v + d), (m = 0), (n = h), o.width)
            : Math.max(v, o.width);
      }
      t.newline ||
        ((r[0] = g),
        (r[1] = m),
        "horizontal" === u ? (g = i + d) : (m = n + d));
    });
  }
  var sh = ah;
  T(ah, "vertical"), T(ah, "horizontal");
  function lh(t, e, i) {
    i = Gl(i || 0);
    var n = e.width,
      r = e.height,
    ...
    switch (
      ...
      isNaN(u) && (u = r - l - c - a),
      null != f &&
        (isNaN(h) && isNaN(u) && (n / r < f ? (h = 0.8 * n) : (u = 0.8 * r)),
        isNaN(h) && (h = f * u),
        isNaN(u) && (u = h / f)),
      isNaN(o) && (o = n - s - h - d),
      isNaN(a) && (a = r - l - u - c),
  ...
  function uh(l, h, t) {
    ...
    function n(t, e) {
      ...
      if (
        ...
        nh(t, function (t) {
          c(h, t) && (i[t] = r[t] = h[t]), d(i, t) && n++, d(r, t) && o++;
        }),
        u[e])
      )
        return (
          d(h, t[1]) ? (r[t[2]] = null) : d(h, t[2]) && (r[t[1]] = null), r
        );
      if (2 !== o && n) {
        if (2 <= n) return i;
  ...
  var fh,
    ...
    vh = _l.extend({
      ...
      $constructor: function (t, e, i, n) {
        _l.call(this, t, e, i, n), (this.uid = Sl("ec_cpt_model"));
      },
      ...
      getDefaultOption: function () {
        ...
        if (!t.defaultOption) {
          ...
          for (var r = {}, o = e.length - 1; 0 <= o; o--) r = m(r, e[o], !0);
          t.defaultOption = r;
        }
  ...
  eo(vh, { registerWhenExtend: !0 }),
    (ph = {}),
    ((fh = vh).registerSubTypeDefaulter = function (t, e) {
      (t = qr(t)), (ph[t.main] = e);
    }),
    (fh.determineSubType = function (t, e) {
      var i = e.type;
      if (!i) {
        var n = qr(t).main;
        fh.hasSubTypes(t) && ph[n] && (i = ph[n](e));
      }
      return i;
    }),
    (gh = function (t) {
      var e = [];
      D(vh.getClassesByMainType(t), function (t) {
    ...
    (vh.topologicalTravel = function (t, e, i, n) {
      if (t.length) {
        var r = (function (e) {
            var r = {},
              o = [];
            return (
              D(e, function (i) {
                var n = yh(r, i),
                  ...
                  })((n.originalDeps = gh(i)), e);
                (n.entryCount = t.length),
                  0 === n.entryCount && o.push(i),
                  D(t, function (t) {
        ...
        for (
          ...
          var l = a.pop(),
            h = o[l],
            u = !!s[l];
          u && (i.call(n, l, h.originalDeps.slice()), delete s[l]),
            D(h.successor, u ? d : c);
        }
        D(s, function () {
      ...
      function c(t) {
        o[t].entryCount--, 0 === o[t].entryCount && a.push(t);
      }
      function d(t) {
        (s[t] = !0), c(t);
      }
  ...
  var _h = "";
  "undefined" != typeof navigator && (_h = navigator.platform || "");
  var xh = {
      color: [
        "#c23531",
        "#2f4554",
      ...
      textStyle: {
        fontFamily: _h.match(/^Win/) ? "Microsoft YaHei" : "sans-serif",
        fontSize: 12,
        fontStyle: "normal",
        fontWeight: "normal",
      },
  ...
  var bh = {
      clearColorPalette: function () {
        (wh(this).colorIdx = 0), (wh(this).colorNameMap = {});
      },
      getColorFromPalette: function (t, e, i) {
        var n = wh((e = e || this)),
          r = n.colorIdx || 0,
          o = (n.colorNameMap = n.colorNameMap || {});
        if (o.hasOwnProperty(t)) return o[t];
        var a = Lr(this.get("color", !0)),
  ...
  function Ph(t) {
    (this.fromDataset = t.fromDataset),
      (this.data = t.data || (t.sourceFormat === Ch ? {} : [])),
      (this.sourceFormat = t.sourceFormat || Th),
      (this.seriesLayoutBy = t.seriesLayoutBy || Dh),
  ...
  (Ph.seriesDataToSource = function (t) {
    return new Ph({ data: t, sourceFormat: B(t) ? Ah : Sh, fromDataset: !1 });
  }),
    Qr(Ph);
  var Lh = { Must: 1, Might: 2, Not: 3 },
    Oh = Hr();
  function zh(t) {
    var e = t.option,
      i = e.data,
    ...
    if (l) {
      ...
      (i = h.source),
        (n = Oh(l).sourceFormat),
        (r = !0),
        (o = o || h.seriesLayoutBy),
        null == a && (a = h.sourceHeader),
        (s = s || h.dimensions);
    }
    var u = (function (t, e, i, n, r) {
      if (!t) return { dimensionsDefine: Eh(r) };
      var o, a;
      if (e === Mh)
        "auto" === n || null == n
          ? Nh(
          ...
          (o = r ? r.length : i === kh ? t.length : t[0] ? t[0].length : null);
      else if (e === Ih)
        r =
          r ||
          (function (t) {
  ...
  function Eh(t) {
    if (t) {
      ...
      return P(t, function (t, e) {
        if (null == (t = k({}, N(t) ? t : { name: t })).name) return t;
  ...
  function Nh(t, e, i, n) {
    if ((null == n && (n = 1 / 0), e === kh))
      for (var r = 0; r < i.length && r < n; r++) t(i[r] ? i[r][0] : null, r);
    else {
      var o = i[0] || [];
      for (r = 0; r < o.length && r < n; r++) t(o[r], r);
    }
  }
  function Rh(i, t, e) {
    var o = {},
    ...
    D((i = i.slice()), function (t, e) {
      N(t) || (i[e] = { name: t }),
        "ordinal" === t.type && null == a && (r = p(i[(a = e)])),
        (o[t.name] = []);
    });
    var d = u.get(c) || u.set(c, { categoryWayDim: r, valueWayDim: 0 });
    function f(t, e, i) {
    ...
    return (
      D(i, function (t, e) {
        ...
        if (null == a) {
          var r = d.valueWayDim;
          f(o[i], r, n), f(l, r, n), (d.valueWayDim += n);
        } else if (a === e) f(o[i], 0, n), f(s, 0, n);
        else {
          r = d.categoryWayDim;
          f(o[i], r, n), f(l, r, n), (d.categoryWayDim += n);
        }
      }),
      s.length && (o.itemName = s),
      l.length && (o.seriesName = l),
      o
    );
  }
  function Bh(t, l, h) {
    ...
    (c !== Ih && c !== Ch) ||
      D(d, function (t, e) {
        "name" === (N(t) ? t.name : t) && (u = e);
      });
    var i = (function () {
      for (var t = {}, e = {}, i = [], n = 0, r = Math.min(5, h); n < r; n++) {
        var o = Fh(l.data, c, l.seriesLayoutBy, d, l.startIndex, n);
        i.push(o);
        var a = o === Lh.Not;
        if (
          (a && null == t.v && n !== u && (t.v = n),
          (null != t.n && t.n !== t.v && (a || i[t.n] !== Lh.Not)) || (t.n = n),
          s(t) && i[t.n] !== Lh.Not)
        )
          return t;
        a ||
          (o === Lh.Might && null == e.v && n !== u && (e.v = n),
  ...
  function Fh(t, e, i, n, r, o) {
    var a, s, l;
    if (B(t)) return Lh.Not;
    if (n) {
      var h = n[o];
      N(h) ? ((s = h.name), (l = h.type)) : E(h) && (s = h);
    }
    if (null != l) return "ordinal" === l ? Lh.Must : Lh.Not;
    if (e === Mh)
      if (i === kh) {
        for (var u = t[o], c = 0; c < (u || []).length && c < 5; c++)
          if (null != (a = g(u[r + c]))) return a;
      } else
        for (c = 0; c < t.length && c < 5; c++) {
          var d = t[r + c];
          if (d && null != (a = g(d[o]))) return a;
        }
    else if (e === Ih) {
      if (!s) return Lh.Not;
      for (c = 0; c < t.length && c < 5; c++) {
        if ((f = t[c]) && null != (a = g(f[s]))) return a;
      }
    } else if (e === Ch) {
      if (!s) return Lh.Not;
      if (!(u = t[s]) || B(u)) return Lh.Not;
      for (c = 0; c < u.length && c < 5; c++)
        if (null != (a = g(u[c]))) return a;
    } else if (e === Sh)
      for (c = 0; c < t.length && c < 5; c++) {
        var f,
          p = Er((f = t[c]));
        if (!O(p)) return Lh.Not;
        if (null != (a = g(p[o]))) return a;
      }
    function g(t) {
      var e = E(t);
  ...
  var Hh = "\0_ec_inner",
    Wh = _l.extend({
      init: function (t, e, i, n) {
        (i = i || {}),
          (this.option = null),
          (this._theme = new _l(i)),
          (this._optionManager = n);
      },
      setOption: function (t, e) {
        X(!(Hh in t), "please use chart.getOption()"),
        ...
        !(function (t) {
          ...
          D(n, function (t, e) {
            null != t &&
              (vh.hasClass(e)
                ? e && i.push(e)
                : (l[e] = null == l[e] ? b(t) : m(l[e], t, !0)));
          }),
          vh.topologicalTravel(
            i,
            vh.getAllClassMainTypes(),
            function (a, t) {
              var e = Lr(n[a]),
                i = Nr(h.get(a), e);
              Rr(i),
                D(i, function (t, e) {
                  var i = t.option;
                  N(i) &&
                    ((t.keyInfo.mainType = a),
                    (t.keyInfo.subType = (function (t, e, i) {
                      return e.type
                        ? e.type
                        : i
                        ? i.subType
                        : vh.determineSubType(t, e);
                    })(a, i, t.exist)));
                });
              var s = (function (e, t) {
                O(t) || (t = t ? [t] : []);
                ...
                D(
                  ...
                  function (t, e) {
                    ...
                    if ((X(N(n) || i, "Empty component definition"), n)) {
                      var r = vh.getClass(a, t.keyInfo.subType, !0);
                      if (i && i.constructor === r)
                        ...
                        k((i = new r(n, this, this, o)), o),
                          i.init(n, this, this, o),
                          i.optionUpdated(null, !0);
                      }
                    } else i.mergeOption({}, this), i.optionUpdated({}, !1);
                    (h.get(a)[e] = i), (l[a][e] = i.option);
                  },
                  this
                ),
                "series" === a && Gh(this, h.get("series"));
            },
            this
          ),
          (this._seriesIndicesMap = Q(
      ...
      getOption: function () {
        ...
        return (
          D(n, function (t, e) {
            if (vh.hasClass(e)) {
              for (var i = (t = Lr(t)).length - 1; 0 <= i; i--)
                Vr(t[i]) && t.splice(i, 1);
              n[e] = t;
            }
          }),
      ...
      queryComponents: function (t) {
        ...
        if (null != n)
          ...
          var l = O(o);
          i = I(a, function (t) {
            return (l && 0 <= x(o, t.name)) || (!l && t.name === o);
          });
        } else i = a.slice();
        return Zh(i, t);
      },
      ...
      restoreData: function (i) {
        ...
        Gh(this, n.get("series"));
        var r = [];
        n.each(function (t, e) {
          r.push(e);
        }),
          vh.topologicalTravel(r, vh.getAllClassMainTypes(), function (e, t) {
  ...
  function eu(t, e, i) {
    var o = { width: e, height: i, aspectratio: e / i },
      a = !0;
    return (
      D(t, function (t, e) {
        var i = e.match(Jh);
  ...
  tu.prototype = {
      ...
      var i = this._optionBackup,
        n = function (t, i, n) {
          ...
          if (t.media) {
            ...
            var l = t.media;
            qh(l, function (t) {
              t && t.option && (t.query ? a.push(t) : (e = e || t));
            });
          }
          r = r || t;
          ...
          return (
            ...
            { baseOption: r, timelineOptions: o, mediaDefault: e, mediaList: a }
          );
        }.call(this, t, e, !i);
    ...
    mountOption: function (t) {
      ...
      return (
        (this._timelineOptions = Kh(e.timelineOptions, $h)),
        (this._mediaList = Kh(e.mediaList, $h)),
        (this._mediaDefault = $h(e.mediaDefault)),
        (this._currentMediaIndices = []),
        $h(t ? e.baseOption : this._newBaseOption)
      );
    },
    ...
    getMediaOption: function (t) {
      var e = this._api.getWidth(),
        ...
        o = [],
        a = [];
      if (!n.length && !r) return a;
      for (var s = 0, l = n.length; s < l; s++)
        eu(n[s].query, e, i) && o.push(s);
      return (
        !o.length && r && (o = [-1]),
        o.length &&
          !(function (t, e) {
          ...
          (a = Kh(o, function (t) {
            return $h(-1 === t ? r.option : n[t].option);
          })),
    ...
    if (e)
      for (var i = 0, n = ru.length; i < n; i++) {
        ...
        o &&
          o[r] &&
          ((t[r] = t[r] || {}),
          t[r].normal ? m(t[r].normal, o[r]) : (t[r].normal = o[r]),
          (o[r] = null)),
          a &&
            a[r] &&
            ((t[r] = t[r] || {}),
            t[r].emphasis ? m(t[r].emphasis, a[r]) : (t[r].emphasis = a[r]),
            (a[r] = null));
      }
  }
  function au(t, e, i) {
    if (t && t[e] && (t[e].normal || t[e].emphasis)) {
      var n = t[e].normal,
        r = t[e].emphasis;
      n &&
        (i ? ((t[e].normal = t[e].emphasis = null), A(t[e], n)) : (t[e] = n)),
  ...
  function du(e, t) {
        ...
        (function (t) {
          if (nu(t)) {
            ou(t),
              ...
              t.emphasis &&
                (lu(t.emphasis, "label"),
                lu(t.emphasis, "upperLabel"),
                lu(t.emphasis, "edgeLabel")),
              (i = t.markPoint) && (ou(i), hu(i)),
              (n = t.markLine) && (ou(n), hu(n));
            var e = t.markArea;
            e && hu(e);
            var i,
              n,
            ...
            if ("graph" === t.type) {
              ...
              if (o && !B(o)) for (var a = 0; a < o.length; a++) hu(o[a]);
              D(t.categories, function (t) {
                su(t);
              });
            }
            if (r && !B(r)) for (a = 0; a < r.length; a++) hu(r[a]);
            if ((i = t.markPoint) && i.data) {
              var s = i.data;
              for (a = 0; a < s.length; a++) hu(s[a]);
            }
            if ((n = t.markLine) && n.data) {
              var l = n.data;
              for (a = 0; a < l.length; a++)
                O(l[a]) ? (hu(l[a][0]), hu(l[a][1])) : hu(l[a]);
            }
            "gauge" === t.type
              ? (lu(t, "axisLabel"), lu(t, "title"), lu(t, "detail"))
              : "treemap" === t.type
              ? (au(t.breadcrumb, "itemStyle"),
    ...
    t && i.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"),
      iu(i, function (t) {
        iu(uu(e[t]), function (t) {
          t && (lu(t, "axisLabel"), lu(t.axisPointer, "label"));
        });
      }),
      iu(uu(e.parallel), function (t) {
        var e = t && t.parallelAxisDefault;
        lu(e, "axisLabel"), lu(e && e.axisPointer, "label");
      }),
      iu(uu(e.calendar), function (t) {
        au(t, "itemStyle"),
          lu(t, "dayLabel"),
          lu(t, "monthLabel"),
          lu(t, "yearLabel");
      }),
      iu(uu(e.radar), function (t) {
        lu(t, "name");
      }),
      iu(uu(e.geo), function (t) {
        nu(t) &&
          (hu(t),
          iu(uu(t.regions), function (t) {
            hu(t);
          }));
      }),
      iu(uu(e.timeline), function (t) {
        hu(t), au(t, "label"), au(t, "itemStyle"), au(t, "controlStyle", !0);
        var e = t.data;
        O(e) &&
          D(e, function (t) {
            N(t) && (au(t, "label"), au(t, "itemStyle"));
          });
      }),
      iu(uu(e.toolbox), function (t) {
        au(t, "iconStyle"),
          iu(t.feature, function (t) {
            au(t, "iconStyle");
          });
      }),
      lu(cu(e.axisPointer), "label"),
      lu(cu(e.tooltip).axisPointer, "label");
  }
  function fu(e) {
    D(pu, function (t) {
    ...
    D(m, function (u, c) {
      var d = [],
        ...
        e = p.map(t, function (t, e, i) {
          var n,
            r,
            o = p.get(u.stackedDimension, i);
          if (isNaN(o)) return f;
          g ? (r = p.getRawIndex(i)) : (n = p.get(u.stackedByDimension, i));
          for (var a = NaN, s = c - 1; 0 <= s; s--) {
            var l = m[s];
            if (
              (g || (r = l.data.rawIndexOf(l.stackedByDimension, n)), 0 <= r)
            ) {
          ...
          return (d[0] = o), (d[1] = a), d;
        });
      p.hostModel.setData(e), (u.data = e);
    });
  }
  function yu(t, e) {
    Ph.isInstance(t) || (t = Ph.seriesDataToSource(t)), (this._source = t);
    var i = (this._data = t.data),
      n = t.sourceFormat;
    n === Ah && ((this._offset = 0), (this._dimSize = e), (this._data = i)),
      k(this, xu[n === Mh ? n + "_" + t.seriesLayoutBy : n]);
  }
  var _u = yu.prototype;
  _u.pure = !1;
  var xu = {
    arrayRows_column: {
      pure: (_u.persistent = !0),
      count: function () {
    ...
    objectRows: { pure: !0, count: wu, getItem: bu, appendData: Su },
    keyedColumns: {
      pure: !0,
      count: function () {
      ...
      appendData: function (t) {
        var r = this._data;
        D(t, function (t, e) {
          for (var i = r[e] || (r[e] = []), n = 0; n < (t || []).length; n++)
            i.push(t[n]);
        });
      },
    },
    original: { count: wu, getItem: bu, appendData: Su },
    typedArray: {
      persistent: !(_u.getSource = function () {
        return this._source;
      }),
      pure: !0,
      count: function () {
  ...
  var Cu = {
    arrayRows: Tu,
    objectRows: function (t, e, i, n) {
      return Au(t[e], this._dimensionInfos[e]);
    },
    keyedColumns: Tu,
    original: function (t, e, i, n) {
      ...
      return (
        ...
        Au(r instanceof Array ? r[n] : r, this._dimensionInfos[e])
      );
    },
  ...
  function Tu(t, e, i, n) {
    return Au(t[n], this._dimensionInfos[e]);
  }
  function Au(t, e) {
    var i = e && e.type;
    if ("ordinal" !== i)
  ...
  function Du(t, e, i) {
    if (t) {
      ...
      if (null != n) {
        ...
        return s && ((r = s.name), (o = s.index)), Mu[a](n, e, o, r);
      }
    }
  }
  function ku(t, e, i) {
    if (t) {
      ...
      if (n === Sh || n === Ih) {
        ...
        return n !== Sh || N(r) || (r = null), r ? r[i] : void 0;
      }
    }
  }
  var Pu = /\{@(.+?)\}/g,
    Lu = {
      ...
      getFormattedLabel: function (n, t, e, i, r) {
        ...
        return "function" == typeof l
          ...
          : "string" == typeof l
          ? ql(l, s).replace(Pu, function (t, e) {
              var i = e.length;
              return (
                "[" === e.charAt(0) &&
                  "]" === e.charAt(i - 1) &&
  ...
  Eu.perform = function (t) {
    ...
    if (
      ...
      if (!n && (o || d < f)) {
        ...
        if (O(p)) for (var g = 0; g < p.length; g++) Uu(this, p[g], d, f, l, h);
        else Uu(this, p, d, f, l, h);
      }
      this._dueIndex = f;
    ...
    Wu = (Hu = {
      reset: function (t, e, i, n) {
        (Ru = t),
          ...
          (Vu = n),
          (Fu = Math.ceil(Vu / Bu)),
          (Hu.next = 1 < Bu && 0 < Vu ? Zu : Gu);
      },
    });
  function Gu() {
    return Ru < Nu ? Ru++ : null;
  }
  function Zu() {
    var t = (Ru % Fu) * Bu + Math.ceil(Ru / Fu),
      e = Nu <= Ru ? null : t < Vu ? t : Ru;
    return Ru++, e;
  }
  function Uu(t, e, i, n, r, o) {
    Wu.reset(i, n, r, o),
      (t._callingProgress = e),
      t._callingProgress(
        { start: i, end: n, count: n - i, next: Wu.next },
        t.context
      );
  }
  (Eu.dirty = function () {
    ...
    (Eu.getUpstream = function () {
      return this._upstream;
    }),
    (Eu.getDownstream = function () {
      return this._downstream;
    }),
    (Eu.setOutputEnd = function (t) {
    ...
    Yu = vh.extend({
      ...
      init: function (t, e, i, n) {
        (this.seriesIndex = this.componentIndex),
          (this.dataTask = Ou({ count: qu, reset: $u })),
      ...
      getRawData: function () {
        return Xu(this).dataBeforeProcessed;
      },
      ...
      formatTooltip: function (r, u, t, c) {
        var d = this,
          ...
          g = 0;
        function i(t) {
          return { renderMode: c, content: Xl(Hl(t)), style: p };
        }
        var m = this.getData(),
          o = m.mapDimension("defaultedTooltip", !0),
          n = o.length,
          a = this.getRawValue(r),
          s = O(a),
          v = m.getItemVisual(r, "color");
        N(v) && v.colorStops && (v = (v.colorStops[0] || {}).color),
          (v = v || "transparent");
        var l = (1 < n || (s && !n)
            ? (function (t) {
                var l = M(
                ...
                function e(t, e) {
                  ...
                  if (i && !1 !== i.otherDims.tooltip) {
                    var n = i.type,
                      ...
                      a = "string" == typeof o ? o : o.content,
                      s =
                        (l ? a + Xl(i.displayName || "-") + ": " : "") +
                        Xl(
                          "ordinal" === n
                            ? t + ""
                            : "time" === n
            ...
            : i(n ? Du(m, r, o[0]) : s ? a[0] : a)
          ).content,
          h = d.seriesIndex + "at" + g,
          y = $l({ color: v, type: "item", renderMode: c, markerId: h });
        (p[h] = v), ++g;
        var _ = m.getName(r),
          x = this.name;
        Br(this) || (x = ""), (x = x ? Xl(x) + (u ? ": " : e) : "");
        var w = "string" == typeof y ? y : y.content;
        return {
          html: u ? w + x + l : x + w + (_ ? Xl(_) + ": " + l : l),
          markers: p,
        };
      },
      isAnimationEnabled: function () {
      ...
      getColorFromPalette: function (t, e, i) {
        var n = this.ecModel,
          r = bh.getColorFromPalette.call(this, t, e, i);
  ...
  S(Yu, Lu), S(Yu, bh);
  var ec = function () {
    (this.group = new Si()), (this.uid = Sl("viewComponent"));
  };
  ec.prototype = {
    constructor: ec,
    init: function (t, e) {},
  ...
  var ic = ec.prototype;
  (ic.updateView = ic.updateLayout = ic.updateVisual = function (
    t,
    e,
    i,
    n
  ...
  function nc() {
    ...
    return function (t) {
      var e = s(t),
        ...
        o = (e.large = i && i.large),
        a = (e.progressiveRender = i && i.progressiveRender);
      return !!(n ^ o || r ^ a) && "reset";
    };
  }
  var rc = Hr(),
    oc = nc();
  function ac() {
    (this.group = new Si()),
      (this.uid = Sl("viewChart")),
      (this.renderTask = Ou({ plan: uc, reset: cc })),
  ...
  var sc = (ac.prototype = {
    ...
    highlight: function (t, e, i, n) {
      hc(t.getData(), n, "emphasis");
    },
    downplay: function (t, e, i, n) {
      hc(t.getData(), n, "normal");
    },
    remove: function (t, e) {
  ...
  function lc(t, e, i) {
    if (t && (t.trigger(e, i), t.isGroup && !Us(t)))
      for (var n = 0, r = t.childCount(); n < r; n++) lc(t.childAt(n), e, i);
  }
  function hc(e, t, i) {
    var n = Fr(e, t),
      r = t && null != t.highlightKey ? Xs(t.highlightKey) : null;
    null != n
      ? D(Lr(n), function (t) {
          lc(e.getItemGraphicEl(t), i, r);
        })
  ...
  function cc(t) {
    var e = t.model,
      ...
      a = t.view,
      s = r && rc(r).updateMethod,
      l = o ? "incrementalPrepareRender" : s && a[s] ? s : "render";
    return "render" !== l && a[l](e, i, n, r), dc[l];
  }
  (sc.updateView = sc.updateLayout = sc.updateVisual = function (t, e, i, n) {
    this.render(t, e, i, n);
  }),
    $r(ac),
    eo(ac, { registerWhenExtend: !0 }),
    (ac.markUpdateMethod = function (t, e) {
      rc(t).updateMethod = e;
    });
  var dc = {
  ...
  function mc(t, i, n) {
    ...
    function e() {
      ...
      (l = null),
        (o = r - (e ? h : u) - t),
        clearTimeout(c),
        e ? (c = setTimeout(d, t)) : 0 <= o ? d() : (c = setTimeout(d, -o)),
        (h = r);
    }
    return (
      (e.clear = function () {
  ...
  var _c = {
      ...
      reset: function (e, t) {
        var i = e.getData(),
          o = (e.visualColorAccessPath || "itemStyle.color").split("."),
          n = e.get(o),
          r = !z(n) || n instanceof rs ? null : n;
        (n && !r) ||
            ...
            dataEach: i.hasItemOption
              ? function (t, e) {
                  ...
                  null != n && t.setItemVisual(e, "color", n),
                    null != r && t.setItemVisual(e, "borderColor", r);
                }
              : null,
          };
        }
    ...
    wc = function (t, e) {
      ...
      if (o.get("show"))
        if (o.get("description"))
          t.setAttribute("aria-label", o.get("description"));
        else {
          var u = 0;
          ...
          if (!(u < 1)) {
            ...
            i = r
              ? p(g("general.withTitle"), { title: r })
              : g("general.withoutTitle");
            var f = [];
            (i += p(
              g(1 < u ? "series.multiple.prefix" : "series.single.prefix"),
              { seriesCount: u }
            )),
              e.eachSeries(function (t, e) {
                if (e < d) {
                  ...
                  i = p((i = g(n ? r + "withName" : r + "withoutName")), {
                    ...
                    seriesType: (function (t) {
                      return xc.series.typeNames[t] || "自定义图";
                    })(t.subType),
                  });
                  var o = t.getData();
                  (window.data = o).count() > c
                    ? (i += p(g("data.partialData"), { displayCnt: c }))
                    : (i += g("data.allData"));
                  for (var a = [], s = 0; s < o.count(); s++)
                    if (s < c) {
                      var l = o.getName(s),
                        h = Du(o, s);
                      a.push(
                  ...
                  (i +=
                    a.join(g("data.separator.middle")) +
      ...
      function g(t) {
        var e = o.get(t);
        if (null != e) return e;
        for (var i = t.split("."), n = xc.aria, r = 0; r < i.length; ++r)
          n = n[i[r]];
        return n;
      }
    },
          ...
          if (r) {
            ...
            i &&
              i.each(function (t, e) {
                ...
                (i.skip =
                  !n.performRawSeries && h.isSeriesFiltered(t.context.model)),
                  Cc(t, u),
                  (d |= t.perform(i));
              });
        }
  ...
  (Mc.restoreData = function (t, e) {
    ...
    (Mc.getPerformArgs = function (t, e) {
      if (t.__pipeline) {
    ...
    (Mc.getPipeline = function (t) {
      return this._pipelineMap.get(t);
    }),
    (Mc.updateStreamModes = function (t, e) {
      var i = this._pipelineMap.get(t.uid),
        ...
        a = "mod" === t.get("progressiveChunkMode") ? n : null;
    ...
    (Mc.restorePipelines = function (t) {
      var n = this,
        r = (n._pipelineMap = Q());
          ...
          t.reset &&
            (function (n, r, t, o, a) {
              ...
              r.createOnAllSeries
                ? o.eachRawSeries(l)
                : e
                ? o.eachRawSeriesByType(e, l)
                : i && i(o, a).each(l);
              function l(t) {
                var e = t.uid,
                  i =
                    s.get(e) ||
                    s.set(e, Ou({ plan: Pc, reset: Lc, count: Ec }));
                (i.context = {
                  model: t,
                  ecModel: o,
                  api: a,
            ...
            t.overallReset &&
              (function (n, t, e, i, r) {
                var o = (e.overallTask = e.overallTask || Ou({ reset: Tc }));
                o.context = {
                  ecModel: i,
                  api: r,
                ...
                var a = (o.agentStubMap = o.agentStubMap || Q()),
                  s = t.seriesType,
                  l = t.getTargetSeries,
                  h = !0,
                  u = t.modifyOutputEnd;
                ...
                function c(t) {
                  var e = t.uid,
                    i = a.get(e);
                  i ||
                    ((i = a.set(e, Ou({ reset: Ac, onDirty: kc }))), o.dirty()),
                    (i.context = {
                      model: t,
                      overallProgress: h,
                      modifyOutputEnd: u,
                ...
                a.each(function (t, e) {
                  d.get(e) || (t.dispose(), o.dirty(), a.removeKey(e));
                });
              })(this, t, e, n, r);
        },
        this
    ...
    (Mc.prepareView = function (t, e, i, n) {
      var r = t.renderTask,
        o = r.context;
      (o.model = e),
        (o.ecModel = i),
    ...
    (Mc.performDataProcessorTasks = function (t, e) {
      Ic(this, this._dataProcessorHandlers, t, e, { block: !0 });
    }),
    (Mc.performVisualTasks = function (t, e, i) {
      Ic(this, this._visualHandlers, t, e, i);
    }),
    (Mc.performSeriesTasks = function (t) {
      var e;
      t.eachSeries(function (t) {
  ...
  var Cc = (Mc.updatePayload = function (t, e) {
  ...
  function Nc(t, e, i) {
    ...
    r.head || (r.head = i),
      ...
      ((r.tail = i).__idxInPipeline = r.count++),
      (i.__pipeline = r);
  }
  Sc.wrapStageHandler = function (t, e) {
    return (
      z(t) &&
        (t = {
          overallReset: t,
  ...
  Fc(Bc, Wh),
    Fc(Vc, Xh),
    (Bc.eachSeriesByType = Bc.eachRawSeriesByType = function (t) {
      Rc = t;
    }),
    (Bc.eachComponent = function (t) {
      "series" === t.mainType && t.subType && (Rc = t.subType);
    });
  function Hc() {
    return {
      axisLine: { lineStyle: { color: Zc } },
      axisTick: { lineStyle: { color: Zc } },
      axisLabel: { textStyle: { color: Zc } },
      splitLine: { lineStyle: { type: "dashed", color: "#aaa" } },
      splitArea: { areaStyle: { color: Zc } },
    };
  }
  var Wc = [
      "#37A2DA",
    ...
    Xc = {
      ...
      legend: { textStyle: { color: Zc } },
      textStyle: { color: Zc },
      title: { textStyle: { color: Zc } },
      toolbox: { iconStyle: { normal: { borderColor: Zc } } },
      dataZoom: { textStyle: { color: Zc } },
      visualMap: { textStyle: { color: Zc } },
      timeline: {
        lineStyle: { color: Zc },
        itemStyle: { normal: { color: Uc[1] } },
        label: { normal: { textStyle: { color: Zc } } },
        controlStyle: { normal: { color: Zc, borderColor: Zc } },
      },
      timeAxis: Hc(),
      logAxis: Hc(),
      valueAxis: Hc(),
      ...
      line: { symbol: "circle" },
      graph: { color: Uc },
      gauge: { title: { textStyle: { color: Zc } } },
      candlestick: {
        itemStyle: {
          normal: {
            color: "#FD1050",
  ...
  (Xc.categoryAxis.splitLine.show = !1),
    vh.extend({
      type: "dataset",
      defaultOption: {
        seriesLayoutBy: Dh,
  ...
  var Yc = xa.extend({
      ...
      buildPath: function (t, e) {
        var i = e.cx,
          ...
          s = 0.5522848 * o;
        t.moveTo(i - r, n),
          t.bezierCurveTo(i - r, n - s, i - a, n - o, i, n - o),
          t.bezierCurveTo(i + a, n - o, i + r, n - s, i + r, n),
          t.bezierCurveTo(i + r, n + s, i + a, n + o, i, n + o),
          t.bezierCurveTo(i - a, n + o, i - r, n + s, i - r, n),
          t.closePath();
      },
  ...
  var $c = {
      g: function (t, e) {
        var i = new Si();
        return Qc(e, i), ed(t, i, this._defs), i;
      },
      rect: function (t, e) {
        var i = new Ja();
        return (
      ...
      polygon: function (t, e) {
        ...
        i = i && Jc(i);
        var n = new Xa({ shape: { points: i || [] } });
        return Qc(e, n), ed(t, n, this._defs), n;
      },
      polyline: function (t, e) {
        var i = new xa();
        Qc(e, i), ed(t, i, this._defs);
        var n = t.getAttribute("points");
        return (n = n && Jc(n)), new Ya({ shape: { points: n || [] } });
      },
      image: function (t, e) {
        var i = new Yn();
        return (
      ...
      text: function (t, e) {
        ...
        var a = new Si();
        return Qc(e, a), ed(t, a, this._defs), a;
      },
      tspan: function (t, e) {
  ...
  function Qc(t, e) {
    t &&
      ...
      A(e.__inheritedStyle, t.__inheritedStyle));
  }
  function Jc(t) {
    for (var e = Y(t).split(jc), i = [], n = 0; n < e.length; n += 2) {
  ...
  function ed(t, e, i, n) {
    ...
    if (
      ...
      ((function (t, e) {
        ...
        if (i) {
          ...
          var n = null,
            r = [];
          i.replace(rd, function (t, e, i) {
            r.push(e, i);
          });
          for (var o = r.length - 1; 0 < o; o -= 2) {
            var a = r[o],
              s = r[o - 1];
            switch (((n = n || ee()), s)) {
              case "translate":
                (a = Y(a).split(jc)),
                  oe(n, n, [parseFloat(a[0]), parseFloat(a[1] || 0)]);
                break;
              case "scale":
                (a = Y(a).split(jc)),
                  se(n, n, [parseFloat(a[0]), parseFloat(a[1] || a[0])]);
                break;
              case "rotate":
                (a = Y(a).split(jc)), ae(n, n, parseFloat(a[0]));
                break;
              case "skew":
                (a = Y(a).split(jc)),
      ...
      k(
        ...
        (function (t) {
          ...
          var n,
            r = {};
          od.lastIndex = 0;
          for (; null != (n = od.exec(e)); ) r[n[1]] = n[2];
          for (var o in td)
            td.hasOwnProperty(o) && null != r[o] && (i[td[o]] = r[o]);
          return i;
        })(t)
      ),
      !n)
    ...
    e.style = e.style || new Vi();
    var u = e.style;
    null != r.fill && u.set(l, nd(r.fill, i)),
      null != r.stroke && u.set(h, nd(r.stroke, i)),
      D(
        [
          "lineWidth",
          "opacity",
      ...
      r.lineDash && (e.style.lineDash = Y(r.lineDash).split(jc)),
      u[h] && "none" !== u[h] && (e[h] = !0),
      (e.__inheritedStyle = r);
  }
  var id = /url\(\s*#(.*?)\)/;
  function nd(t, e) {
    var i = e && t && t.match(id);
    return i ? e[Y(i[1])] : t;
  }
  var rd = /(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.e,]*)\)/g;
  var od = /([^\s:;]+)\s*:\s*([^:;]+)/g;
  var ad = Q(),
    sd = function (t, e, i) {
      var n;
      return (
        D(
          ...
          function (t) {
            var e = t.type;
            "geoJson" === e && (e = t.type = "geoJSON"), (0, hd[e])(t);
          }
        ),
        ad.set(t, n)
      );
    ...
    md = "__flagInMainProcess",
    vd = "__optionUpdated",
    yd = /^[a-zA-Z0-9_]+$/;
  function _d(n, r) {
    return function (t, e, i) {
      (!r && this._disposed) ||
        ((t = t && t.toLowerCase()), It.prototype[n].call(this, t, e, i));
    };
  }
  function xd() {
    It.call(this);
  ...
  function wd(t, e, i) {
    ...
    (this._throttledZrFlush = mc(C(n.flush, n), 17)),
      (e = b(e)) && mu(e, !0),
      (this._theme = e),
      (this._chartsViews = []),
      (this._chartsMap = {}),
    ...
    Pi(Zd, o),
      Pi(Hd, o),
      (this._scheduler = new Sc(this, r, Hd, Zd)),
      It.call(this, (this._ecEventProcessor = new Bd())),
      (this._messageCenter = new xd()),
      this._initEvents(),
  ...
  (xd.prototype.on = _d("on", !0)),
    (xd.prototype.off = _d("off", !0)),
    (xd.prototype.one = _d("one", !0)),
    S(xd, It);
  var bd = wd.prototype;
  function Sd(t, e, i) {
    if (!this._disposed) {
  ...
  (bd._onframe = function () {
    ...
    (bd.setOption = function (t, e, i) {
      if (!this._disposed) {
        var n;
        if (
          (fd(e) && ((i = e.lazyUpdate), (n = e.silent), (e = e.notMerge)),
          (this[md] = !0),
          !this._model || e)
        ) {
          var r = new tu(this._api),
            o = this._theme,
            a = (this._model = new Wh());
          (a.scheduler = this._scheduler), a.init(null, null, o, r);
        }
        this._model.setOption(t, Wd),
          i
            ? ((this[vd] = { silent: n }), (this[md] = !1))
            : (Id(this),
              Md.update.call(this),
              this._zr.flush(),
              (this[vd] = !1),
    ...
    (bd.setTheme = function () {
      console.error("ECharts#setTheme() is DEPRECATED in ECharts 3.0");
    }),
    (bd.getModel = function () {
      return this._model;
    }),
    (bd.getOption = function () {
    ...
    (bd.getDevicePixelRatio = function () {
      return this._zr.painter.dpr || window.devicePixelRatio || 1;
    }),
    (bd.getRenderedCanvas = function (t) {
    ...
    (bd.getConnectedDataURL = function (r) {
      if (!this._disposed && v.canvasSupported) {
        ...
        if (jd[a]) {
          ...
          var t = (c *= i) - (h *= i),
            e = (d *= i) - (u *= i),
            n = y(),
            p = Mr(n, { renderer: o ? "svg" : "canvas" });
          if ((p.resize({ width: t, height: e }), o)) {
            var g = "";
            return (
              cd(f, function (t) {
                var e = t.left - h,
              ...
              r.connectedBackgroundColor &&
                p.painter.setBackgroundColor(r.connectedBackgroundColor),
          ...
          return (
            ...
            cd(f, function (t) {
              var e = new Yn({
                style: { x: t.left * i - h, y: t.top * i - u, image: t.dom },
              });
              p.add(e);
            }),
            p.refreshImmediately(),
            n.toDataURL("image/" + ((r && r.type) || "png"))
          );
        }
        return this.getDataURL(r);
      }
    }),
    (bd.convertToPixel = T(Sd, "convertToPixel")),
    (bd.convertFromPixel = T(Sd, "convertFromPixel")),
    (bd.containPixel = function (t, r) {
      var o;
      if (!this._disposed)
        return (
          D(
              ...
              0 <= n.indexOf("Models") &&
                D(
                  ...
                  function (t) {
                    ...
                    if (e && e.containPoint) o |= !!e.containPoint(r);
                    else if ("seriesModels" === n) {
                      var i = this._chartsMap[t.__viewId];
                      i && i.containPoint && (o |= i.containPoint(r, t));
                    }
                  },
                  this
                );
    ...
    (bd.getVisual = function (t, e) {
      var i = (t = Gr(this._model, t, {
    ...
    (bd.getViewOfComponentModel = function (t) {
      return this._componentsMap[t.__viewId];
    }),
    (bd.getViewOfSeriesModel = function (t) {
      return this._chartsMap[t.__viewId];
    });
  var Md = {
    prepareAndUpdate: function (t) {
      Id(this), Md.update.call(this, t);
    },
    update: function (t) {
      var e = this._model,
        i = this._api,
      ...
      if (e) {
        ...
        if (v.canvasSupported) n.setBackgroundColor(a);
        else {
          var s = Ne(a);
          (a = Ue(s, "rgb")), 0 === s[3] && (a = "transparent");
        }
        Ed(e, i);
      }
    },
    updateTransform: function (r) {
      ...
      if (o) {
        ...
        o.eachComponent(function (t, e) {
          var i = a.getViewOfComponentModel(e);
          if (i && i.__alive)
            if (i.updateTransform) {
              var n = i.updateTransform(e, o, s, r);
              n && n.update && l.push(i);
            } else l.push(i);
        });
        var n = Q();
        o.eachSeries(function (t) {
          ...
          if (e.updateTransform) {
            var i = e.updateTransform(t, o, s, r);
            i && i.update && n.set(t.uid, 1);
          } else n.set(t.uid, 1);
        }),
          Ld(o),
          this._scheduler.performVisualTasks(o, r, {
            setDirty: !0,
            dirtyMap: n,
          }),
          zd(a, o, s, r, n),
    ...
    updateView: function (t) {
      var e = this._model;
      e &&
        (ac.markUpdateMethod(t, "updateView"),
        Ld(e),
        this._scheduler.performVisualTasks(e, t, { setDirty: !0 }),
        Od(this, this._model, this._api, t),
        Ed(e, this._api));
    },
    updateVisual: function (t) {
      Md.update.call(this, t);
    },
  ...
  function Cd(e, i, n, r, t) {
        ...
        o &&
          o.eachComponent(
            ...
            function (t) {
              (l && null != l.get(t.id)) ||
                h(
                  e["series" === r ? "_chartsMap" : "_componentsMap"][
                    t.__viewId
                  ]
                );
            },
    ...
    } else cd(e._componentsViews.concat(e._chartsViews), h);
    function h(t) {
  ...
  function Ad(e, t) {
    var i = e.type,
      ...
      s = a.pop();
    (a = null != a[0] && pd(a[0])), (this[md] = !0);
    var l = [e],
      h = !1;
    e.batch &&
      ((h = !0),
      (l = P(e.batch, function (t) {
        return ((t = A(k({}, t), e)).batch = null), t;
      })));
    var u,
      c = [],
    ...
    cd(
      l,
      function (t) {
        ((u = (u = r.action(t, this._model, this._api)) || k({}, t)).type =
          o.event || u.type),
          c.push(u),
          d ? Cd(this, s, t, "series") : a && Cd(this, s, t, a.main, a.sub);
      },
      this
    ),
      "none" === s ||
        ...
        a ||
        (this[vd]
          ? (Id(this), Md.update.call(this, e), (this[vd] = !1))
          : Md[s].call(this, e)),
      (u = h ? { type: o.event || i, escapeConnect: n, batch: c } : c[0]),
      (this[md] = !1),
      t || this._messageCenter.trigger(u.type, u);
  }
  function Dd(t) {
  ...
  function Pd(t, e, r, o) {
    for (
      var a = "component" === e,
        s = a ? t._componentsViews : t._chartsViews,
        l = a ? t._componentsMap : t._chartsMap,
        h = t._zr,
        u = t._api,
        i = 0;
      i < s.length;
    ...
    function n(t) {
      ...
      if (!i) {
        var n = pd(t.type);
        (i = new (a ? ec.getClass(n.main, n.sub) : ac.getClass(n.sub))()).init(
          r,
          u
        ),
          (l[e] = i),
  ...
  function Od(t, e, i, n) {
    !(function (t, i, n, r, e) {
      cd(e || t._componentsViews, function (t) {
        var e = t.__model;
        t.render(e, i, n, r), Rd(e, t);
      });
    })(t, e, i, n),
  ...
  function zd(n, t, e, r, o) {
    ...
    t.eachSeries(function (t) {
      ...
      var i = e.renderTask;
      s.updatePayload(i, r),
        o && o.get(t.uid) && i.dirty(),
        (a |= i.perform(s.getPerformArgs(i))),
  ...
  (bd.resize = function (t) {
    ...
    (bd.showLoading = function (t, e) {
      if (
        ...
        var i = Xd[t](this._api, e),
          n = this._zr;
        (this._loadingFX = i), n.add(i);
      }
    }),
    (bd.hideLoading = function () {
      this._disposed ||
        (this._loadingFX && this._zr.remove(this._loadingFX),
        (this._loadingFX = null));
    }),
    (bd.makeActionFromEvent = function (t) {
      var e = k({}, t);
      return (e.type = Fd[t.type]), e;
    }),
    (bd.dispatchAction = function (t, e) {
      this._disposed ||
        (fd(e) || (e = { silent: !!e }),
        Vd[t.type] &&
          this._model &&
          (this[md]
            ...
            : (Ad.call(this, t, e.silent),
              e.flush
                ? this._zr.flush(!0)
                : !1 !== e.flush &&
                  v.browser.weChat &&
                  this._throttledZrFlush(),
              Dd.call(this, e.silent),
              kd.call(this, e.silent))));
    }),
    (bd.appendData = function (t) {
      if (!this._disposed) {
        var e = t.seriesIndex;
  ...
  (bd._initEvents = function () {
    cd(
      ...
      function (h) {
        function t(t) {
          ...
          if (e) {
            var o = e.componentType,
              a = e.componentIndex;
            ("markLine" !== o && "markPoint" !== o && "markArea" !== o) ||
              ((o = "series"), (a = e.seriesIndex));
            var s = o && null != a && i.getComponent(o, a),
              l =
                s &&
                this["series" === s.mainType ? "_chartsMap" : "_componentsMap"][
                  s.__viewId
                ];
            (e.event = t),
              (e.type = h),
    ...
    (bd.dispose = function () {
      if (!this._disposed) {
        (this._disposed = !0), Ur(this.getDom(), Kd, "");
        var e = this._api,
          i = this._model;
        cd(this._componentsViews, function (t) {
          t.dispose(i, e);
        }),
        ...
        if (E(t)) {
          ...
          D(t, function (t, e) {
            for (var i = !1, n = 0; n < u.length; n++) {
              var r = u[n],
                o = e.lastIndexOf(r);
              if (0 < o && o === e.length - r.length) {
                var a = e.slice(0, o);
                "data" !== a &&
                  ((s.mainType = a), (s[r.toLowerCase()] = t), (i = !0));
              }
            }
            c.hasOwnProperty(e) && ((l[e] = t), (i = !0)), i || (h[e] = t);
          });
        }
        return { cptQuery: s, dataQuery: l, otherQuery: h };
      },
  ...
  function of(t, e, i) {
    ...
    var n = fd(t) ? t.type : [t, (t = { event: e })][0];
    (t.event = (t.event || n).toLowerCase()),
      (e = t.event),
      ud(yd.test(n) && yd.test(e)),
      Vd[n] || (Vd[n] = { action: i, actionInfo: t }),
      (Fd[e] = n);
  }
  function af(t, e) {
    lf(Zd, t, e, 1e3, "layout");
  }
  function sf(t, e) {
    lf(Zd, t, e, 3e3, "visual");
  }
  function lf(t, e, i, n, r) {
    (dd(e) || fd(e)) && ((i = e), (e = n));
    var o = Sc.wrapStageHandler(i, r);
  ...
  sf(2e3, _c),
    ...
    rf(900, function (t) {
      ...
      t.eachSeries(function (t) {
        ...
        if (e) {
          ...
          if (
            !r.stackedDimension ||
            (!r.isStackedByIndex && !r.stackedByDimension)
          )
            return;
          i.length &&
    ...
    hf("default", function (r, o) {
      ...
      var t = new Si(),
        a = new Ja({ style: { fill: o.maskColor }, zlevel: o.zlevel, z: 1e4 });
      t.add(a);
      var s = o.fontSize + " sans-serif",
        l = new Ja({
          style: {
            fill: "none",
            text: o.text,
            ...
            textPosition: "right",
            textDistance: 10,
            textFill: o.textColor,
          },
          zlevel: o.zlevel,
          z: 10001,
        });
      if ((t.add(l), o.showSpinner)) {
        var h = new as({
          shape: {
            startAngle: -bc / 2,
            endAngle: -bc / 2 + 0.1,
        ...
        h
          .animateShape(!0)
          .when(1e3, { endAngle: (3 * bc) / 2 })
          .start("circularInOut"),
          h
            .animateShape(!0)
            .when(1e3, { startAngle: (3 * bc) / 2 })
            .delay(300)
            .start("circularInOut"),
          t.add(h);
      }
      return (
        (t.resize = function () {
          var t = ln(o.text, s),
            ...
            i =
              (r.getWidth() - 2 * e - (o.showSpinner && t ? 10 : 0) - t) / 2 -
              (o.showSpinner ? 0 : t / 2),
            n = r.getHeight() / 2;
          o.showSpinner && h.setShape({ cx: i, cy: n }),
    ...
    of({ type: "highlight", event: "highlight", update: "highlight" }, J),
    of({ type: "downplay", event: "downplay", update: "downplay" }, J),
    ef("light", Gc),
    ef("dark", Xc);
  function pf(t) {
    return t;
  ...
  function gf(t, e, i, n, r) {
    (this._old = t),
      (this._new = e),
      (this._oldKeyGetter = i || pf),
      (this._newKeyGetter = n || pf),
      (this.context = r);
  }
  ...
  gf.prototype = {
    ...
    execute: function () {
      var t = this._old,
        ...
        r = [];
      for (
        mf(t, {}, n, "_oldKeyGetter", this),
          mf(e, i, r, "_newKeyGetter", this),
          o = 0;
        o < t.length;
        o++
      ) {
        if (null != (s = i[(a = n[o])]))
          (h = s.length)
            ? (1 === h && (i[a] = null), (s = s.shift()))
            : (i[a] = null),
            this._update && this._update(s, o);
        else this._remove && this._remove(o);
      }
  ...
  var vf = Q(["tooltip", "label", "itemName", "itemId", "seriesName"]);
  function yf(t, e) {
    return t.hasOwnProperty(e) || (t[e] = []), t[e];
  }
  function _f(t) {
    null != t && k(this, t), (this.otherDims = {});
  }
  var xf = N,
    wf = "undefined",
    bf = {
      float: typeof Float64Array == wf ? Array : Float64Array,
      int: typeof Int32Array == wf ? Array : Int32Array,
      ordinal: Array,
      number: Array,
      time: Array,
    },
    Sf = typeof Uint32Array == wf ? Array : Uint32Array,
    Mf = typeof Int32Array == wf ? Array : Int32Array,
    If = typeof Uint16Array == wf ? Array : Uint16Array;
  function Cf(t) {
    return 65535 < t._rawCount ? Sf : If;
  }
  var Tf = [
      "hasItemOption",
      "_nameList",
    ...
    Af = ["_extent", "_approximateExtent", "_rawExtent"];
  function Df(e, i) {
    D(Tf.concat(i.__wrappedMethods || []), function (t) {
      i.hasOwnProperty(t) && (e[t] = i[t]);
    }),
  ...
  var kf = function (t, e) {
      ...
      for (var i = {}, n = [], r = {}, o = 0; o < t.length; o++) {
        var a = t[o];
        E(a) ? (a = new _f({ name: a })) : a instanceof _f || (a = new _f(a));
        var s = a.name;
        (a.type = a.type || "float"),
          a.coordDim || ((a.coordDim = s), (a.coordDimIndex = 0)),
            ...
            if (e) {
              ...
              (yf(o, e)[i] = t),
                r.isExtraCoord ||
                  ...
                  (yf(h.encode, e)[i] = r.index)),
                r.defaultTooltip && l.push(t);
            }
  ...
  function Lf(t, e, i, n, r) {
    var o = bf[e.type],
      ...
      l = t[s][a];
    if (l && l.length < i) {
      for (var h = new o(Math.min(r - a * i, i)), u = 0; u < l.length; u++)
        h[u] = l[u];
      t[s][a] = h;
    }
    for (var c = n * i; c < r; c += i) t[s].push(new o(Math.min(r - c, i)));
  }
  function Of(r) {
    var o = r._invertedIndicesMap;
    D(o, function (t, e) {
      var i = r._dimensionInfos[e].ordinalMeta;
      if (i) {
        t = o[e] = new Mf(i.categories.length);
  ...
  function Vf(t, e) {
    var i = t.dimensions,
      n = new kf(P(i, t.getDimensionInfo, t), t.hostModel);
    Df(n, t);
    for (var r = (n._storage = {}), o = t._storage, a = 0; a < i.length; a++) {
      var s = i[a];
      o[s] &&
        (0 <= x(e, s)
          ? ((r[s] = Ff(o[s])), (n._rawExtent[s] = Hf()), (n._extent[s] = null))
          : (r[s] = o[s]));
    }
    return n;
  }
  ...
  (Pf.type = "list"),
    ...
    (Pf.getDimensionInfo = function (t) {
      return this._dimensionInfos[this.getDimension(t)];
    }),
    (Pf.getDimensionsOnCoord = function () {
      return this._dimensionsSummary.dataDimsOnCoord.slice();
    }),
    (Pf.mapDimension = function (t, e) {
      var i = this._dimensionsSummary;
      if (null == e) return i.encodeFirstDimNotExtra[t];
      var n = i.encode[t];
      return !0 === e ? (n || []).slice() : n && n[e];
    }),
    (Pf.initData = function (t, e, i) {
      (Ph.isInstance(t) || L(t)) && (t = new yu(t, this.dimensions.length)),
        (this._rawData = t),
        (this._storage = {}),
        (this._indices = null),
        (this._nameList = e || []),
        ...
        (this.defaultDimValueGetter =
          Cu[this._rawData.getSource().sourceFormat]),
        (this._dimValueGetter = i = i || this.defaultDimValueGetter),
        (this._dimValueGetterArrayRows = Cu.arrayRows),
        (this._rawExtent = {}),
        this._initDataFromProvider(0, t.count()),
        t.pure && (this.hasItemOption = !1);
    }),
    (Pf.getProvider = function () {
    ...
    (Pf.appendValues = function (t, e) {
      for (
        ...
        a[(v = r[u])] || (a[v] = Hf()),
          n[v] || (n[v] = []),
          Lf(n, this._dimensionInfos[v], i, h, l),
      ...
      (this._rawCount = this._count = l), (this._extent = {}), Of(this);
    }),
    (Pf._initDataFromProvider = function (t, e) {
      if (!(e <= t)) {
        for (
          var i,
            n = this._chunkSize,
          ...
          0 === g.otherDims.itemName && (i = this._nameDimIdx = p),
            ...
            o[w] || (o[w] = []),
            Lf(o, g, n, f, e),
            (this._chunkCount = o[w].length);
        }
        for (var m = new Array(s), v = t; v < e; v++) {
          m = r.getItem(v, m);
          for (var y = Math.floor(v / n), _ = v % n, x = 0; x < s; x++) {
            var w,
              b = o[(w = a[x])][y],
              S = this._dimValueGetter(m, w, v, x);
            b[_] = S;
            var M = c[w];
    ...
    (Pf.getIndices = function () {
      ...
      if (t) {
        ...
        var r = new (e = Cf(this))(this.count());
    ...
    (Pf.getDataExtent = function (t) {
      ...
      for (var o = (n = i)[0], a = n[1], s = 0; s < r; s++) {
        var l = this._getFast(t, this.getRawIndex(s));
        l < o && (o = l), a < l && (a = l);
      }
      return (n = [o, a]), (this._extent[t] = n);
    }),
    (Pf.getApproximateExtent = function (t) {
      return (
        (t = this.getDimension(t)),
        this._approximateExtent[t] || this.getDataExtent(t)
      );
    }),
    (Pf.setApproximateExtent = function (t, e) {
      (e = this.getDimension(e)), (this._approximateExtent[e] = t.slice());
    }),
    (Pf.getCalculationInfo = function (t) {
      return this._calculationInfo[t];
    }),
    (Pf.setCalculationInfo = function (t, e) {
      xf(t) ? k(this._calculationInfo, t) : (this._calculationInfo[t] = e);
    }),
    (Pf.getSum = function (t) {
      var e = 0;
      if (this._storage[t])
    ...
    (Pf.indicesOfNearest = function (t, e, i) {
      var n = [];
      if (!this._storage[t]) return n;
      null == i && (i = 1 / 0);
      for (var r = 1 / 0, o = -1, a = 0, s = 0, l = this.count(); s < l; s++) {
        var h = e - this.get(t, s),
          u = Math.abs(h);
        u <= i &&
          ((u < r || (u === r && 0 <= h && o < 0)) &&
            ((r = u), (o = h), (a = 0)),
    ...
    (Pf.getName = function (t) {
      var e = this.getRawIndex(t);
      return this._nameList[e] || zf(this, this._nameDimIdx, e) || "";
    }),
    (Pf.getId = function (t) {
      return Rf(this, this.getRawIndex(t));
    }),
    (Pf.each = function (t, e, i, n) {
      if (this._count) {
        "function" == typeof t && ((n = i), (i = e), (e = t), (t = [])),
          (i = i || n || this);
        for (
          var r = (t = P(Bf(t), this.getDimension, this)).length, o = 0;
          o < this.count();
          o++
        )
          switch (r) {
    ...
    (Pf.filterSelf = function (t, e, i, n) {
      if (this._count) {
        "function" == typeof t && ((n = i), (i = e), (e = t), (t = [])),
          (i = i || n || this),
          (t = P(Bf(t), this.getDimension, this));
        for (
          var r = this.count(),
            o = new (Cf(this))(r),
            a = [],
          ...
          if (0 === s) c = e.call(i, u);
            ...
            for (var p = 0; p < s; p++) a[p] = this._getFast(h, d);
            (a[p] = u), (c = e.apply(i, a));
          }
          c && (o[l++] = d);
        }
        return (
          ...
          (this._count = l),
          (this._extent = {}),
          (this.getRawIndex = this._indices ? Nf : Ef),
          this
        );
      }
    }),
    (Pf.selectRange = function (t) {
      if (this._count) {
        var e = [];
          ...
          if (!u)
            if (1 === n)
              for (m = 0; m < r; m++) {
                ...
                ((l <= (w = this._getFast(s, S)) && w <= h) || isNaN(w)) &&
                  (o[a++] = S);
              }
            else
              for (m = 0; m < r; m++) {
    ...
    (Pf.map = function (t, e, i, n) {
      i = i || n || this;
      var r = Vf(this, (t = P(Bf(t), this.getDimension, this)));
      (r._indices = this._indices), (r.getRawIndex = r._indices ? Nf : Ef);
      for (
        var o = r._storage,
          a = [],
          s = this._chunkSize,
    ...
    (Pf.downSample = function (t, e, i, n) {
      for (
        var r = Vf(this, [t]),
          o = r._storage,
          a = [],
        ...
        var _ = i(a),
          x = this.getRawIndex(Math.min(p + n(a, _) || 0, h - 1)),
          w = x % u;
        (l[Math.floor(x / u)][w] = _) < c[0] && (c[0] = _),
          _ > c[1] && (c[1] = _),
          (d[f++] = x);
      }
      return (r._count = f), (r._indices = d), (r.getRawIndex = Nf), r;
    }),
    (Pf.getItemModel = function (t) {
      var e = this.hostModel;
      return new _l(this.getRawDataItem(t), e, e && e.ecModel);
    }),
    (Pf.diff = function (e) {
      var i = this;
      return new gf(
    ...
    (Pf.getVisual = function (t) {
      var e = this._visual;
      return e && e[t];
    }),
    (Pf.setVisual = function (t, e) {
      if (xf(t))
        for (var i in t) t.hasOwnProperty(i) && this.setVisual(i, t[i]);
      else (this._visual = this._visual || {}), (this._visual[t] = e);
    }),
    (Pf.setLayout = function (t, e) {
      if (xf(t))
        for (var i in t) t.hasOwnProperty(i) && this.setLayout(i, t[i]);
      else this._layout[t] = e;
    }),
    (Pf.getLayout = function (t) {
      return this._layout[t];
    }),
    (Pf.getItemLayout = function (t) {
      return this._itemLayouts[t];
    }),
    (Pf.setItemLayout = function (t, e, i) {
      this._itemLayouts[t] = i ? k(this._itemLayouts[t] || {}, e) : e;
    }),
    (Pf.clearItemLayouts = function () {
      this._itemLayouts.length = 0;
    }),
    (Pf.getItemVisual = function (t, e, i) {
      var n = this._itemVisuals[t],
        r = n && n[e];
      return null != r || i ? r : this.getVisual(e);
    }),
    (Pf.setItemVisual = function (t, e, i) {
      var n = this._itemVisuals[t] || {},
        r = this.hasItemVisual;
      if (((this._itemVisuals[t] = n), xf(e)))
        for (var o in e) e.hasOwnProperty(o) && ((n[o] = e[o]), (r[o] = !0));
      else (n[e] = i), (r[e] = !0);
    }),
    (Pf.clearAllVisual = function () {
  ...
  function Gf(t, e, i) {
    Ph.isInstance(e) || (e = Ph.seriesDataToSource(e)),
      (i = i || {}),
      (t = (t || []).slice());
    for (
      ...
      var h = (n[s] = k({}, N(n[s]) ? n[s] : { name: n[s] })),
        u = h.name,
        c = (l[s] = new _f());
      null != u &&
        null == r.get(u) &&
        ((c.name = c.displayName = u), r.set(u, s)),
        null != h.type && (c.type = h.type),
        null != h.displayName && (c.displayName = h.displayName);
    }
    var d = i.encodeDef;
    !d && i.encodeDefaulter && (d = i.encodeDefaulter(e, a)),
      (d = Q(d)).each(function (t, i) {
        if (1 === (t = Lr(t).slice()).length && !E(t[0]) && t[0] < 0)
          d.set(i, !1);
        else {
          var n = d.set(i, []);
          D(t, function (t, e) {
            E(t) && (t = r.get(t)),
              null != t && t < a && ((n[e] = t), p(l[t], i, e));
          });
        }
      });
    var f = 0;
    ...
    D(t, function (r, t) {
      ...
      if (!1 !== (i = d.get(o))) {
        var i;
        if (!(i = Lr(i)).length)
          for (var n = 0; n < ((a && a.length) || 1); n++) {
            for (; f < l.length && null != l[f].coordDim; ) f++;
            f < l.length && i.push(f++);
          }
        D(i, function (t, e) {
          var i = l[t];
          if ((p(A(i, r), o, e), null == i.name && a)) {
            var n = a[e];
            N(n) || (n = { name: n }),
    ...
    var g = i.generateCoord,
      ...
      v = null != m;
    m = g ? m || 1 : 0;
    for (var y, _, x = g || "value", w = 0; w < a; w++) {
      null == (c = l[w] = l[w] || new _f()).coordDim &&
        ((c.coordDim = Zf(x, o, v)),
        (c.coordDimIndex = 0),
        (!g || m <= 0) && (c.isExtraCoord = !0),
        m--),
        null == c.name && (c.name = Zf(c.coordDim, r)),
        null == c.type &&
          ((y = e),
          (_ = w),
          c.name,
  ...
  (Pf.setItemGraphicEl = function (t, e) {
    var i = this.hostModel;
    e &&
      ((e.dataIndex = t),
      (e.dataType = this.dataType),
      (e.seriesIndex = i && i.seriesIndex),
      "group" === e.type && e.traverse(Wf, e)),
      (this._graphicEls[t] = e);
  }),
    (Pf.getItemGraphicEl = function (t) {
      return this._graphicEls[t];
    }),
    (Pf.eachItemGraphicEl = function (i, n) {
      D(this._graphicEls, function (t, e) {
        t && i && i.call(n, t, e);
      });
    }),
    (Pf.cloneShallow = function (t) {
      if (!t) {
        var e = P(this.dimensions, this.getDimensionInfo, this);
        t = new kf(e, this.hostModel);
      }
      if (((t._storage = this._storage), Df(t, this), this._indices)) {
        var i = this._indices.constructor;
        t._indices = new i(this._indices);
      } else t._indices = null;
      return (t.getRawIndex = t._indices ? Nf : Ef), t;
    }),
    (Pf.wrapMethod = function (t, e) {
      var i = this[t];
      "function" == typeof i &&
    ...
    (Pf.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"]),
    (Pf.CHANGABLE_METHODS = ["filterSelf", "selectRange"]);
  var Uf = function (t, e) {
    return Gf((e = e || {}).coordDimensions || [], t, {
  ...
  var Yf = {
    cartesian2d: function (t, e, i, n) {
      ...
      (e.coordSysDims = ["x", "y"]),
        i.set("x", r),
        i.set("y", o),
        jf(r) && (n.set("x", r), (e.firstCategoryDimIndex = 0)),
        jf(o) &&
          (n.set("y", o),
    ...
    singleAxis: function (t, e, i, n) {
      ...
      (e.coordSysDims = ["single"]),
        i.set("single", r),
        jf(r) && (n.set("single", r), (e.firstCategoryDimIndex = 0));
    },
    polar: function (t, e, i, n) {
      ...
      (e.coordSysDims = ["radius", "angle"]),
        i.set("radius", o),
        i.set("angle", a),
        jf(o) && (n.set("radius", o), (e.firstCategoryDimIndex = 0)),
        jf(a) &&
          (n.set("angle", a),
      ...
      D(e.parallelAxisIndex, function (t, e) {
        ...
        o.set(n, i),
          jf(i) &&
            ...
            (a.set(n, i), (r.firstCategoryDimIndex = e));
      });
    },
  };
  function jf(t) {
  ...
  function Kf(t, e) {
    return $f(t, e) ? t.getCalculationInfo("stackResultDimension") : e;
  }
  function Qf(t, e, i) {
    (i = i || {}), Ph.isInstance(t) || (t = Ph.seriesDataToSource(t));
    var n,
    ...
    var s,
      ...
      h = Uf(t, {
        ...
        encodeDefaulter: i.useEncodeDefaulter ? T(Rh, n, e) : null,
      });
    a &&
      D(h, function (t, e) {
        var i = t.coordDim,
    ...
    var d =
      null != s &&
      (function (t) {
        if (t.sourceFormat === Sh) {
          var e = (function (t) {
            var e = 0;
            for (; e < t.length && null == t[e]; ) e++;
            return t[e];
          })(t.data || []);
          return null != e && !O(Er(e));
        }
      })(t)
        ? function (t, e, i, n) {
  ...
  (Jf.prototype.parse = function (t) {
    return t;
  }),
    (Jf.prototype.getSetting = function (t) {
      return this._setting[t];
    }),
    (Jf.prototype.contain = function (t) {
      var e = this._extent;
      return t >= e[0] && t <= e[1];
    }),
    (Jf.prototype.normalize = function (t) {
      var e = this._extent;
      return e[1] === e[0] ? 0.5 : (t - e[0]) / (e[1] - e[0]);
    }),
    (Jf.prototype.scale = function (t) {
      var e = this._extent;
      return t * (e[1] - e[0]) + e[0];
    }),
    (Jf.prototype.unionExtent = function (t) {
      var e = this._extent;
      t[0] < e[0] && (e[0] = t[0]), t[1] > e[1] && (e[1] = t[1]);
    }),
    (Jf.prototype.unionExtentFromData = function (t, e) {
      this.unionExtent(t.getApproximateExtent(e));
    }),
    (Jf.prototype.getExtent = function () {
      return this._extent.slice();
    }),
    (Jf.prototype.setExtent = function (t, e) {
      var i = this._extent;
      isNaN(t) || (i[0] = t), isNaN(e) || (i[1] = e);
    }),
    (Jf.prototype.isBlank = function () {
      return this._isBlank;
    }),
    (Jf.prototype.setBlank = function (t) {
      this._isBlank = t;
    }),
    (Jf.prototype.getLabel = null),
    $r(Jf),
    eo(Jf, { registerWhenExtend: !0 }),
    (tp.createByAxisModel = function (t) {
      var e = t.option,
        i = e.data,
        n = i && P(i, np);
      return new tp({
  ...
  (ep.getOrdinal = function (t) {
    return ip(this).get(t);
  }),
    (ep.parseAndCollect = function (t) {
      var e,
        i = this._needCollect;
  ...
  var rp = Jf.prototype,
    op = Jf.extend({
      ...
      contain: function (t) {
        return (
          (t = this.parse(t)),
          rp.contain.call(this, t) && null != this._ordinalMeta.categories[t]
        );
      },
      normalize: function (t) {
        return rp.normalize.call(this, this.parse(t));
      },
      scale: function (t) {
        return Math.round(rp.scale.call(this, t));
      },
      getTicks: function () {
  ...
  var up = Tl,
    cp = Jf.extend({
      ...
      unionExtent: function (t) {
        ...
        t[0] < e[0] && (e[0] = t[0]),
          t[1] > e[1] && (e[1] = t[1]),
          cp.prototype.setExtent.call(this, e[0], e[1]);
      },
      ...
      getTicks: function (t) {
        var e = this._interval,
          ...
          o = [];
        if (!e) return o;
        i[0] < n[0] && (t ? o.push(up(n[0] - e, r)) : o.push(i[0]));
        for (
          var a = n[0];
          a <= n[1] && (o.push(a), (a = up(a + e, r)) !== o[o.length - 1]);

        )
          if (1e4 < o.length) return [];
        var s = o.length ? o[o.length - 1] : n[1];
        return i[1] > s && (t ? o.push(up(s + e, r)) : o.push(i[1])), o;
      },
      getMinorTicks: function (t) {
        for (
          ...
          for (
            var o = e[r], a = e[r - 1], s = 0, l = [], h = (o - a) / t;
            s < t - 1;

          ) {
            var u = Tl(a + (s + 1) * h);
            u > n[0] && u < n[1] && l.push(u), s++;
          }
          i.push(l);
        }
        return i;
      ...
      niceTicks: function (t, e, i) {
        ...
        if (isFinite(r)) {
          ...
          var o = (function (t, e, i, n) {
            var r = {},
              o = t[1] - t[0],
              a = (r.interval = Vl(o / e, !0));
            null != i && a < i && (a = r.interval = i),
              null != n && n < a && (a = r.interval = n);
            var s = (r.intervalPrecision = sp(a));
            return (
              hp(
                (r.niceTickExtent = [
                  ap(Math.ceil(t[0] / a) * a, s),
                  ap(Math.floor(t[1] / a) * a, s),
                ]),
                t
              ),
              r
      ...
      niceExtent: function (t) {
        ...
        t.fixMin || (e[0] = up(Math.floor(e[0] / r) * r)),
          t.fixMax || (e[1] = up(Math.ceil(e[1] / r) * r));
      },
    });
  cp.create = function () {
    return new cp();
  ...
  var dp = "__ec_stack_",
    fp = "undefined" != typeof Float32Array ? Float32Array : Array;
  function pp(t) {
    return t.get("stack") || dp + t.seriesIndex;
  }
  function gp(t) {
  ...
  function vp(t) {
        ...
        for (var i in l)
          if (l.hasOwnProperty(i)) {
            ...
            if (n) {
              ...
              for (var r = null, o = 1; o < n.length; ++o) {
                var a = n[o] - n[o - 1];
    ...
    return (
      D(t, function (t) {
        ...
        var u = Cl(t.get("barWidth"), e),
          c = Cl(t.get("barMaxWidth"), e),
          d = Cl(t.get("barMinWidth") || 1, e),
          f = t.get("barGap"),
            ...
            (l = Math.max(l, 0)),
              D(e, function (t) {
                ...
                if (t.width) {
                  ...
                  var n = l;
                  e && e < n && (n = Math.min(e, a)),
                    i && n < i && (n = i),
                    n !== l && ((t.width = n), (a -= n + o * n), s--);
                }
              }),
              (l = (a - r) / (s + (s - 1) * o)),
              (l = Math.max(l, 0));
  ...
  function yp(t, e, i) {
    if (t && e) {
      var n = t[gp(e)];
      return null != n && null != i && (n = n[pp(i)]), n;
    }
  }
  var _p = {
    seriesType: "bar",
            ...
            progress: function (t, e) {
              ...
              for (; null != (i = t.next()); )
                (l[y] = e.get(g, i)),
                  ...
                  (o[h] = v ? d.x + d.width : s[0]),
                  (r[h++] = s[0]),
                  (o[h] = v ? s[1] : d.y + d.height),
                  (r[h++] = s[1]),
                  (a[u++] = i);
              e.setLayout({
                largePoints: r,
  ...
  var Sp = cp.prototype,
    ...
    Ap = cp.extend({
      ...
      getLabel: function (t) {
        var e = this._stepLvl,
          i = new Date(t);
        return Ql(e[0], i, this.getSetting("useUTC"));
      },
      niceExtent: function (t) {
        var e = this._extent;
        if (
          (e[0] === e[1] && ((e[0] -= Tp), (e[1] += Tp)),
          e[1] === -1 / 0 && e[0] === 1 / 0)
        ) {
          var i = new Date();
        ...
        t.fixMin || (e[0] = Tl(Ip(e[0] / n) * n)),
          t.fixMax || (e[1] = Tl(Mp(e[1] / n) * n));
      },
      niceTicks: function (t, e, i) {
        t = t || 10;
        var n = this._extent,
        ...
        var a = Dp.length,
          ...
          l = Dp[Math.min(s, a - 1)],
          h = l[1];
        "year" === l[0] && (h *= Vl(r / h / t, !0));
        var u = this.getSetting("useUTC")
            ? 0
            : 60 * new Date(+n[0] || +n[1]).getTimezoneOffset() * 1e3,
          c = [
            Math.round(Mp((n[0] - u) / h) * h + u),
            Math.round(Ip((n[1] - u) / h) * h + u),
          ];
        hp(c, n),
          (this._stepLvl = l),
          (this._interval = h),
  ...
  D(["contain", "normalize"], function (e) {
    Ap.prototype[e] = function (t) {
      return Sp[e].call(this, this.parse(t));
    };
  });
  var Dp = [
    ["hh:mm:ss", 1e3],
  ...
  Ap.create = function (t) {
    return new Ap({ useUTC: t.ecModel.get("useUTC") });
  };
  var kp = Jf.prototype,
    Pp = cp.prototype,
    Lp = kl,
    ...
    Bp = Jf.extend({
      ...
      $constructor: function () {
        Jf.apply(this, arguments), (this._originalScale = new cp());
      },
      getTicks: function (t) {
        var i = this._originalScale,
          ...
          r = i.getExtent();
        return P(
          Pp.getTicks.call(this, t),
          function (t) {
            var e = Tl(Np(this.base, t));
            return (
              (e = t === n[0] && i.__fixMin ? Vp(e, r[0]) : e),
              (e = t === n[1] && i.__fixMax ? Vp(e, r[1]) : e)
            );
          },
          this
        );
      },
      getMinorTicks: Pp.getMinorTicks,
      getLabel: Pp.getLabel,
      scale: function (t) {
        return (t = kp.scale.call(this, t)), Np(this.base, t);
      },
      setExtent: function (t, e) {
        var i = this.base;
        (t = Rp(t) / Rp(i)), (e = Rp(e) / Rp(i)), Pp.setExtent.call(this, t, e);
      },
      getExtent: function () {
        var t = this.base,
          e = kp.getExtent.call(this);
        (e[0] = Np(t, e[0])), (e[1] = Np(t, e[1]));
        var i = this._originalScale,
          n = i.getExtent();
        return (
          i.__fixMin && (e[0] = Vp(e[0], n[0])),
          i.__fixMax && (e[1] = Vp(e[1], n[1])),
          e
        );
      },
      unionExtent: function (t) {
      ...
      niceTicks: function (t) {
        ...
        if (!(i == 1 / 0 || i <= 0)) {
          ...
          for (
            ...
            n *= 10;
          var r = [Tl(Ep(e[0] / n) * n), Tl(zp(e[1] / n) * n)];
          (this._interval = n), (this._niceExtent = r);
        }
      },
      niceExtent: function (t) {
        Pp.niceExtent.call(this, t);
  ...
  function Fp(t, e) {
    ...
    "ordinal" === o
      ...
      : (O((n = e.get("boundaryGap"))) || (n = [n || 0, n || 0]),
      ...
      "dataMin" === a
        ? (a = l[0])
        : "function" == typeof a && (a = a({ min: l[0], max: l[1] })),
      "dataMax" === s
        ? (s = l[1])
        : "function" == typeof s && (s = s({ min: l[0], max: l[1] }));
    var h = null != a,
      u = null != s;
    null == a && (a = "ordinal" === o ? (i ? 0 : NaN) : l[0] - n[0] * r),
      null == s && (s = "ordinal" === o ? (i ? i - 1 : NaN) : l[1] + n[1] * r),
      (null != a && isFinite(a)) || (a = NaN),
      (null != s && isFinite(s)) || (s = NaN),
      t.setBlank(
        F(a) ||
          F(s) ||
          ("ordinal" === o && !t.getOrdinalMeta().categories.length)
      ),
      e.getNeedCrossZero() &&
        (0 < a && 0 < s && !h && (a = 0), a < 0 && s < 0 && !u && (s = 0));
    var c = e.ecModel;
    if (c && "time" === o) {
      var d,
        f = mp("bar", c);
        ...
        var p = vp(f),
          g = (function (t, e, i, n) {
            ...
            var h = s + l,
              u = e - t,
              c = u / (1 - (s + l) / o) - u;
            return { min: (t -= (s / h) * c), max: (e += (l / h) * c) };
          })(a, s, e, p);
        (a = g.min), (s = g.max);
      }
    }
    return { extent: [a, s], fixMin: h, fixMax: u };
  }
  function Hp(t, e) {
    var i = Fp(t, e),
      n = i.extent,
    ...
    if ((e = e || t.get("type")))
      switch (e) {
        ...
        case "value":
          return new cp();
        default:
          return (Jf.getClass(e) || cp).create(t);
      }
  }
  function Gp(i) {
    var e,
    ...
    return "string" == typeof n
      ...
      : "function" == typeof n
      ? function (t, e) {
          return null != r && (e = t - r), n(Zp(i, t), e);
        }
      : function (t) {
  ...
  function Xp(t) {
    return "category" === t.type && 0 === Up(t.getLabelModel());
  }
  D(["contain", "normalize"], function (e) {
    Bp.prototype[e] = function (t) {
      return (t = Rp(t) / Rp(this.base)), kp[e].call(this, t);
    };
  }),
    (Bp.create = function () {
      return new Bp();
  ...
  var tg = ws({
    ...
    buildPath: function (t, e, i) {
      ...
      if ("none" !== n) {
        var r = Jp[n];
        (r = r || Jp[(n = "rect")]),
          Qp[n](e.x, e.y, e.width, e.height, r.shape),
  ...
  function ig(t, e, i, n, r, o, a) {
    ...
    return (
      ...
      ((s =
        0 === t.indexOf("image://")
          ? Is(t.slice(8), new bi(e, i, n, r), a ? "center" : "cover")
          : 0 === t.indexOf("path://")
          ? Ms(t.slice(7), {}, new bi(e, i, n, r), a ? "center" : "cover")
          : new tg({
  ...
  var ng = {
    isDimensionStacked: $f,
    enableDataStack: qf,
    getStackedDimension: Kf,
  };
  var rg = (Object.freeze || Object)({
      createList: function (t) {
        return Qf(t.getSource(), t);
      },
      getLayoutRect: lh,
      dataStack: ng,
      createScale: function (t, e) {
        var i = e;
        _l.isInstance(e) || S((i = new _l(e)), Yp);
        var n = Wp(i);
        return n.setExtent(t[0], t[1]), Hp(n, i), n;
      },
      mixinAxisModelCommonMethods: function (t) {
        S(t, Yp);
      },
      completeDimensions: Gf,
      createDimensions: Uf,
      createSymbol: ig,
    }),
    og = 1e-8;
  ...
  function sg(t, e, i) {
    ...
    for (var o = 1; o < t.length; o++) {
      var a = t[o];
      (n += sa(r[0], r[1], a[0], a[1], e, i)), (r = a);
    }
    var s = t[0];
    return (
      (ag(r[0], s[0]) && ag(r[1], s[1])) ||
        (n += sa(r[0], r[1], s[0], s[1], e, i)),
      0 !== n
    );
  }
  function lg(t, e, i) {
  ...
  function hg(t, e, i) {
    for (var n = [], r = e[0], o = e[1], a = 0; a < t.length; a += 2) {
  ...
  lg.prototype = {
    ...
    getBoundingRect: function () {
      ...
      for (
        ...
        if ("polygon" === a[s].type)
          Eo(a[s].exterior, r, o), _t(i, i, r), xt(n, n, o);
      }
      return (
        0 === s && (i[0] = i[1] = n[0] = n[1] = 0),
        (this._rect = new bi(i[0], i[1], n[0] - i[0], n[1] - i[1]))
      );
    },
    contain: function (t) {
    ...
    cloneShallow: function (t) {
      null == t && (t = this.name);
      var e = new lg(t, this.geometries, this.center);
      ...
      (function (t) {
        ...
        for (var i = t.features, n = 0; n < i.length; n++)
          for (
            ...
            var l = o[s];
            if ("Polygon" === r.type) o[s] = hg(l, a[s], e);
      ...
      P(
        ...
        function (t) {
          var e = t.properties,
            ...
            r = [];
          "Polygon" === i.type &&
            r.push({ type: "polygon", exterior: n[0], interiors: n.slice(1) }),
            "MultiPolygon" === i.type &&
              D(n, function (t) {
                t[0] &&
                  r.push({
    ...
    return "category" === t.type
      ? (function (t, e) {
          ...
          if (z(o)) i = _g(t, o, !0);
            ...
            var s = pg(t, t.getLabelModel());
            (n = s.labelCategoryInterval),
              (i = P(s.labels, function (t) {
                return t.tickValue;
              }));
          } else i = yg(t, (n = o), !0);
          return vg(r, o, { ticks: i, tickCategoryInterval: n });
        })(t, e)
        ...
        labels: z(r)
          ...
          : yg(
              ...
              (i =
                "auto" === r
                  ? (function (t) {
                      var e = cg(t).autoInterval;
                      return null != e
                        ? e
                        : (cg(t).autoInterval = t.calculateCategoryInterval());
                    })(t)
                  : r)
            ),
  ...
  function _g(t, i, n) {
    var r = t.scale,
      ...
      a = [];
    return (
      D(r.getTicks(), function (t) {
        var e = r.getLabel(t);
        i(t, e) &&
          a.push(n ? t : { formattedLabel: o(t), rawLabel: e, tickValue: t });
      }),
      a
    );
  }
  ...
  xg.prototype = {
    ...
    dataToCoord: function (t, e) {
      ...
      return (
        (t = n.normalize(t)),
        this.onBand && "ordinal" === n.type && bg((i = i.slice()), n.count()),
        Il(t, wg, i, e)
      );
    },
      ...
      return (
        (function (t, e, i, n) {
          ...
          if (1 === r) (e[0].coord = s[0]), (o = e[1] = { coord: s[0] });
            ...
            (a = 1 + u[1] - e[r - 1].tickValue),
              (o = { coord: e[r - 1].coord + h * a }),
              e.push(o);
          }
          var c = s[0] > s[1];
          d(e[0].coord, s[0]) && (n ? (e[0].coord = s[0]) : e.shift());
          n && d(s[0], e[0].coord) && e.unshift({ coord: s[0] });
          d(s[1], o.coord) && (n ? (o.coord = s[1]) : e.pop());
          n && d(o.coord, s[1]) && e.push({ coord: s[1] });
          function d(t, e) {
            return (t = Tl(t)), (e = Tl(e)), c ? e < t : t < e;
          }
    ...
    calculateCategoryInterval: function () {
      return (function (t) {
        ...
        var s = 1;
        40 < a && (s = Math.max(1, Math.floor(a / 40)));
        for (
          var l = o[0],
  ...
  function Tg(t, e, i) {
    Si.call(this), this.updateData(t, e, i);
  }
  D(
    [
      "extendShape",
    ...
    Yu.extend({
      ...
      getInitialData: function (t, e) {
        return Qf(this.getSource(), this, { useEncodeDefaulter: !0 });
      },
      defaultOption: {
        zlevel: 0,
        z: 2,
  ...
  var Ag = Tg.prototype,
    Dg = (Tg.getSymbolSize = function (t, e) {
  ...
  (Ag._createSymbol = function (t, e, i, n, r) {
    this.removeAll();
    var o = ig(t, -1, -1, 2, 2, e.getItemVisual(i, "color"), r);
    o.attr({ z2: 100, culling: !0, scale: kg(n) }),
      (o.drift = Pg),
      (this._symbolType = t),
      this.add(o);
  }),
    ...
    (Ag.updateData = function (t, e, i) {
      ...
      var n = t.getItemVisual(e, "symbol") || "circle",
        r = t.hostModel,
        o = Dg(t, e),
        a = n !== this._symbolType;
      if (a) {
        var s = t.getItemVisual(e, "symbolKeepAspect");
        this._createSymbol(n, t, e, o, s);
      } else {
        ((l = this.childAt(0)).silent = !1), il(l, { scale: kg(o) }, r, e);
      }
  ...
  function Rg(t) {
    (this.group = new Si()), (this._symbolCtor = t || Tg);
  }
  (Ag._updateCommon = function (i, t, e, n) {
    var r = this.childAt(0),
      o = i.hostModel,
      a = i.getItemVisual(t, "color");
    "image" !== r.type
      ? r.useStyle({ strokeNoScale: !0 })
      : r.setStyle({
          opacity: 1,
          shadowBlur: null,
          shadowOffsetX: null,
    ...
    if (!n || i.hasItemOption) {
      ...
      (s = p.getModel(Lg).getItemStyle(["color"])),
        (l = p.getModel(Og).getItemStyle()),
        (h = p.getShallow("symbolOffset")),
        (u = p.getModel(zg)),
        (c = p.getModel(Eg)),
    ...
    r.attr("rotation", ((m || 0) * Math.PI) / 180 || 0),
      h && r.attr("position", [Cl(h[0], e[0]), Cl(h[1], e[1])]),
      f && r.attr("cursor", f),
      r.setColor(a, n && n.symbolInnerColor),
      r.setStyle(s);
    ...
    var y = i.getItemVisual(t, "liftZ"),
      _ = r.__z2Origin;
    null != y
      ? null == _ && ((r.__z2Origin = r.z2), (r.z2 += y))
    ...
    Ys(g, l, u, c, {
      ...
      defaultText: function (t, e) {
        return x ? i.getName(t) : Cg(i, t);
      },
      isRectText: !0,
      autoColor: a,
    }),
      (r.__symbolOriginalScale = kg(e)),
      (r.hoverStyle = l),
      (r.highDownOnUpdate = d && o.isAnimationEnabled() ? Ng : null),
      Gs(r);
  }),
  ...
  function Fg(t) {
    return null == t || N(t) || (t = { isIgnore: t }), t || {};
  }
  function Hg(t) {
    var e = t.hostModel;
    return {
  ...
  (Bg.updateData = function (r, o) {
    ...
    l || a.removeAll(),
      r
        ...
        .add(function (t) {
          ...
          if (Vg(r, e, t, o)) {
            var i = new h(r, t, u);
            i.attr("position", e), r.setItemGraphicEl(t, i), a.add(i);
          }
        })
        .update(function (t, e) {
          ...
          Vg(r, n, t, o)
            ? (i
                ? (i.updateData(r, t, u), il(i, { position: n }, s))
                : (i = new h(r, t)).attr("position", n),
              a.add(i),
    ...
    (Bg.isPersistent = function () {
      return !0;
    }),
    (Bg.updateLayout = function () {
      var n = this._data;
      n &&
    ...
    (Bg.incrementalPrepareUpdate = function (t) {
      (this._seriesScope = Hg(t)), (this._data = null), this.group.removeAll();
    }),
    (Bg.incrementalUpdate = function (t, e, i) {
      function n(t) {
  ...
  function Qg(t, e, i, n, r, o, a, s, l, h) {
    return "none" !== h && h
      ? function (t, e, i, n, r, o, a, s, l, h, u) {
          for (var c = 0, d = i, f = 0; f < n; f++) {
            ...
            if (d === i) t[0 < o ? "moveTo" : "lineTo"](p[0], p[1]);
            else if (0 < l) {
              var g = e[c],
                m = "y" === h ? 1 : 0,
                v = (p[m] - g[m]) * l;
              Yg(qg, g),
                ...
                Yg($g, p),
                ($g[m] = p[m] - v),
                t.bezierCurveTo(qg[0], qg[1], $g[0], $g[1], p[0], p[1]);
      ...
      : function (t, e, i, n, r, o, a, s, l, h, u) {
          for (var c = 0, d = i, f = 0; f < n; f++) {
            ...
            if (d === i) t[0 < o ? "moveTo" : "lineTo"](p[0], p[1]), Yg(qg, p);
            else if (0 < l) {
              var g = d + o,
                m = e[g];
              if (u) for (; m && Kg(e[g]); ) m = e[(g += o)];
              var v = 0.5,
                y = e[c];
              if (!(m = e[g]) || Kg(m)) Yg($g, p);
              else {
                var _, x;
                if (
                  (Kg(m) && !u && (m = p), st(jg, m, y), "x" === h || "y" === h)
                ) {
                  var w = "x" === h ? 0 : 1;
                  (_ = Math.abs(p[w] - y[w])), (x = Math.abs(p[w] - m[w]));
                } else (_ = gt(p, y)), (x = gt(p, m));
                Xg($g, p, jg, -l * (1 - (v = x / (x + _))));
              }
              Zg(qg, qg, s),
                Ug(qg, qg, a),
                Zg($g, $g, s),
    ...
    em = xa.extend({
      ...
      buildPath: function (t, e) {
        var i = e.points,
          ...
          o = i.length,
          a = e.smoothMonotone,
          s = Jg(i, e.smoothConstraint),
          l = Jg(n, e.smoothConstraint);
        if (e.connectNulls) {
          for (; 0 < o && Kg(i[o - 1]); o--);
          for (; r < o && Kg(i[r]); r++);
        }
  ...
  function im(t, e, i) {
    ...
    (o -= h / 2),
      ...
      (o = Math.floor(o)),
      (s = Math.round(s));
    var u = new Ja({ shape: { x: o, y: a, width: s, height: l } });
    return (
      e &&
        ((u.shape[r ? "width" : "height"] = 0),
        nl(u, { shape: { width: s, height: l } }, i)),
      u
    );
  }
  function nm(t, e, i) {
    ...
    return (
      e &&
        ...
        nl(r, { shape: { endAngle: n.endAngle } }, i)),
      r
    );
  }
  function rm(t, e) {
        ...
        (!r ||
          !(function (t, e) {
            ...
            for (
              ...
              if (1.5 * Tg.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > n)
                return !1;
            return !0;
          })(o, e))
      ) {
  ...
  function hm(t, e, i) {
    if ("cartesian2d" !== t.type) return nm(t, e, i);
    var n = t.getBaseAxis().isHorizontal(),
      r = im(t, e, i);
    if (!i.get("clip", !0)) {
      var o = r.shape,
        a = Math.max(o.width, o.height);
      n ? ((o.y -= a), (o.height += 2 * a)) : ((o.x -= a), (o.width += 2 * a));
    }
    return r;
  }
  ac.extend({
    ...
    render: function (t, e, i) {
      ...
      n &&
        ...
        d && u.type === n.type && S === this._step
          ? (m && !f
              ? (f = this._newPolygon(l, y, n, g))
              : f && !m && (p.remove(f), (f = this._polygon = null)),
            p.setClipPath(hm(n, !1, t)),
            _ && c.updateData(o, { isIgnore: x, clipShape: b }),
            o.eachItemGraphicEl(function (t) {
              t.stopAnimation(!0);
            }),
            (rm(this._stackedOnPoints, y) && rm(this._points, l)) ||
              (g
                ? this._updateAnimation(o, y, n, i, S, v)
                : (S && ((l = sm(l, n, S)), (y = sm(y, n, S))),
                  d.setShape({ points: l }),
          ...
          : (_ && c.updateData(o, { isIgnore: x, clipShape: b }),
            ...
            p.setClipPath(hm(n, !0, t)));
      var M =
        (function (t, e) {
          var i = t.getVisual("visualMeta");
          if (i && i.length && t.count() && "cartesian2d" === e.type) {
            for (var n, r, o = i.length - 1; 0 <= o; o--) {
              var a = i[o].dimension,
                s = t.dimensions[a],
            ...
            if (r) {
              ...
              var m = new ls(0, 0, 0, 0, u, !0);
              return (m[n] = f), (m[n + "2"] = p), m;
            }
          }
        })(o, n) || o.getVisual("color");
      d.useStyle(
        A(a.getLineStyle(), { fill: "none", stroke: M, lineJoin: "bevel" })
      );
      var I = t.get("smooth");
      if (
        ((I = am(t.get("smooth"))),
        ...
        var C = o.getCalculationInfo("stackedOnSeries"),
          T = 0;
        f.useStyle(
          A(s.getAreaStyle(), { fill: M, opacity: 0.7, lineJoin: "bevel" })
        ),
          C && (T = am(C.get("smooth"))),
          f.setShape({
            smooth: I,
    ...
    highlight: function (t, e, i, n) {
      ...
      if (!(o instanceof Array) && null != o && 0 <= o) {
        ...
        a.highlight();
      } else ac.prototype.highlight.call(this, t, e, i, n);
    },
    downplay: function (t, e, i, n) {
      var r = t.getData(),
        o = Fr(r, n);
      if (null != o && 0 <= o) {
        ...
        a &&
          (a.__temp
            ...
            : a.downplay());
      } else ac.prototype.downplay.call(this, t, e, i, n);
    },
    ...
    _newPolygon: function (t, e) {
      ...
      return (
        ...
        (i = new em({ shape: { points: t, stackedOnPoints: e }, silent: !0 })),
    ...
    _updateAnimation: function (t, e, i, n, r, o) {
      ...
      if (
        (r &&
          ((u = sm(h.current, i, r)),
          (c = sm(h.stackedOnCurrent, i, r)),
          (d = sm(h.next, i, r)),
          (f = sm(h.stackedOnNext, i, r))),
        3e3 < om(u, d) || (s && 3e3 < om(c, f)))
      )
        return (
          a.setShape({ points: d }),
          void (s && s.setShape({ points: d, stackedOnPoints: f }))
        );
      (a.shape.__points = h.current),
        (a.shape.points = u),
        il(a, { shape: { points: d } }, l),
        s &&
          (s.setShape({ points: u, stackedOnPoints: c }),
          il(s, { shape: { points: d, stackedOnPoints: f } }, l));
  ...
  function um(t, a, s) {
    return {
      seriesType: t,
      performRawSeries: !0,
      reset: function (h, t, e) {
        var i = h.getData(),
          u = h.get("symbol"),
          c = h.get("symbolSize"),
          n = h.get("symbolKeepAspect"),
          d = h.get("symbolRotate"),
          f = z(u),
          p = z(c),
          g = z(d),
          m = f || p || g,
          ...
          return {
            dataEach:
              i.hasItemOption || m
                ? function (t, e) {
                    if (m) {
                      var i = h.getRawValue(e),
                        n = h.getDataParams(e);
                      f && t.setItemVisual(e, "symbol", u(i, n)),
                    ...
                    if (t.hasItemOption) {
                      var r = t.getItemModel(e),
                        ...
                        a = r.getShallow("symbolSize", !0),
                        s = r.getShallow("symbolRotate", !0),
                        l = r.getShallow("symbolKeepAspect", !0);
                      null != o && t.setItemVisual(e, "symbol", o),
                        null != a && t.setItemVisual(e, "symbolSize", a),
              ...
              progress: function (t, e) {
                for (
                  ...
                  if (1 === p) {
                    ...
                    h = a[0] = e.get(f[0], r);
                    var u = (a[1] = e.get(f[1], r));
                    l = !isNaN(h) && !isNaN(u) && c.dataToPoint(a, null, s);
                  }
                  d
                    ? ((n[o++] = l ? l[0] : NaN), (n[o++] = l ? l[1] : NaN))
                    : e.setItemLayout(r, (l && l.slice()) || [NaN, NaN]);
                }
  ...
  (gm.prototype = {
    ...
    getAxes: function () {
      return P(this._dimList, pm, this);
    },
    ...
    (mm.prototype = {
      ...
      getArea: function () {
        var t = this.getAxis("x").getGlobalExtent(),
          ...
          i = Math.min(t[0], t[1]),
          n = Math.min(e[0], e[1]);
        return new bi(i, n, Math.max(t[0], t[1]) - i, Math.max(e[0], e[1]) - n);
      },
    }),
    w(mm, gm);
  function vm(t, e, i, n, r) {
    xg.call(this, t, e, i),
      (this.type = n || "value"),
  ...
  (_m.categoryAxis = m(
    ...
    (_m.logAxis = A({ scale: !0, logBase: 10 }, _m.valueAxis));
  function xm(o, t, a, e) {
    D(wm, function (r) {
      t.extend({
        type: o + "Axis." + r,
        ...
        optionUpdated: function () {
          "category" === this.option.type &&
            (this.__ordinalMeta = tp.createByAxisModel(this));
        },
        ...
        defaultOption: p([{}, _m[r + "Axis"], e], !0),
      });
    }),
      vh.registerSubTypeDefaulter(o + "Axis", T(a, o));
  }
  var wm = ["value", "category", "time", "log"],
    bm = vh.extend({
      type: "cartesian2dAxis",
      axis: null,
      init: function () {
        bm.superApply(this, "init", arguments), this.resetRange();
      },
      mergeOption: function () {
        bm.superApply(this, "mergeOption", arguments), this.resetRange();
      },
      restoreData: function () {
        bm.superApply(this, "restoreData", arguments), this.resetRange();
      },
  ...
  function Am(t, e, i, n) {
    ...
    if (s) {
      if (null != l) Dm(o[l]) && (r = o[l]);
      else
        for (var h in o)
          if (o.hasOwnProperty(h) && Dm(o[h]) && !n[u(o[h])]) {
            r = o[h];
            break;
          }
      r && (n[u(r)] = !0);
  ...
  (Tm.type = "grid"),
    (Tm.axisPointerEnabled = !0),
    (Tm.getRect = function () {
      return this._rect;
    }),
    (Tm.update = function (t, e) {
      var i = this._axesMap;
    ...
    (Tm.resize = function (t, e, i) {
      var r = lh(t.getBoxLayoutParams(), {
        width: e.getWidth(),
        height: e.getHeight(),
      });
      this._rect = r;
              ...
              var e = (function (t) {
                ...
                if (e.get("axisLabel.show") && !i.isBlank()) {
                  var n,
                    ...
                    o = "category" === t.type,
                    a = i.getExtent();
                  r = o ? i.count() : (n = i.getTicks()).length;
                  var s,
                    l,
                    h,
                    u,
                  ...
                  for (var _ = 0; _ < r; _ += y) {
                    var x = v(n ? n[_] : a[0] + _),
                      ...
                      b =
                        ...
                        (f = c.height),
                        (p =
                          d * Math.abs(Math.cos(u)) +
                          Math.abs(f * Math.sin(u))),
                        (g =
                          d * Math.abs(Math.sin(u)) +
                          Math.abs(f * Math.cos(u))),
                        new bi(c.x, c.y, p, g));
                    s ? s.union(b) : (s = b);
                  }
                  return s;
    ...
    (Tm.getCartesians = function () {
      return this._coordsList.slice();
    }),
    (Tm.convertToPixel = function (t, e, i) {
    ...
    (Tm.convertFromPixel = function (t, e, i) {
      var n = this._findConvertTarget(t, e);
      return n.cartesian
    ...
    (Tm._findConvertTarget = function (t, e) {
      var i,
        n,
        r = e.seriesModel,
      ...
      if (r) x(l, (i = r.coordinateSystem)) < 0 && (i = null);
        ...
        i = this.getCartesian(o.componentIndex, a.componentIndex);
    ...
    (Tm.containPoint = function (t) {
      var e = this._coordsList[0];
      if (e) return e.containPoint(t);
    }),
    (Tm._initCartesian = function (a, t, e) {
          ...
          if (Im(t, a)) {
            ...
            "x" === o
              ...
              : "left" !== i &&
                ...
                (i = s.left ? "right" : "left"),
              (s[i] = !0);
            var n = new vm(o, Wp(t), [0, 0], t.get("type"), i),
              r = "category" === n.type;
            (n.onBand = r && t.get("boundaryGap")),
    ...
    (Tm._updateScale = function (l, h) {
      function u(e, i) {
        D(e.mapDimension(i.dim, !0), function (t) {
          i.scale.unionExtentFromData(e, Kf(e, t));
        });
      }
        ...
        l.eachSeries(function (t) {
          if (Lm(t)) {
            var e = Pm(t, l),
              i = e[0],
              n = e[1];
            if (!Im(i, h) || !Im(n, h)) return;
            var r = this.getCartesian(i.componentIndex, n.componentIndex),
              o = t.getData(),
              a = r.getAxis("x"),
              s = r.getAxis("y");
            "list" === o.type && (u(o, a, t), u(o, s, t));
          }
        }, this);
    }),
    (Tm.getTooltipAxes = function (n) {
      var r = [],
        o = [];
      return (
        D(this.getCartesians(), function (t) {
          var e = null != n && "auto" !== n ? t.getAxis(n) : t.getBaseAxis(),
            i = t.getOtherAxis(e);
          x(r, e) < 0 && r.push(e), x(o, i) < 0 && o.push(i);
        }),
        { baseAxes: r, otherAxes: o }
      );
    });
  var km = ["xAxis", "yAxis"];
  function Pm(e) {
  ...
  (Cm.create = function (n, r) {
    ...
    (Cm.dimensions = Cm.prototype.dimensions = mm.prototype.dimensions),
    jh.register("cartesian2d", Cm);
  function Om(t, e) {
    (this.opt = e),
      (this.axisModel = t),
      A(e, {
      ...
      (this.group = new Si());
    var i = new Si({ position: e.position.slice(), rotation: e.rotation });
  ...
  var Em = {
        ...
        if (t.get("axisLine.show")) {
          ...
          this.group.add(
            new es({
              anid: "line",
              subPixelOptimize: !0,
              shape: { x1: a[0], y1: a[1], x2: n[0], y2: n[1] },
              style: s,
          ...
          if (("number" == typeof h && (h = [h, h]), null != l)) {
            "string" == typeof l && (l = [l, l]),
              ("string" != typeof r && "number" != typeof r) || (r = [r, r]);
            var u = r[0],
              c = r[1];
            D(
              [
                { rotate: o.rotation + Math.PI / 2, offset: h[0], r: 0 },
                {
              ...
              function (t, e) {
                if ("none" !== l[e] && null != l[e]) {
                  var i = ig(l[e], -u / 2, -c / 2, u, c, s.stroke, !0),
                    n = t.r + t.offset,
                    r = [
                      a[0] + n * Math.cos(o.rotation),
                      a[1] - n * Math.sin(o.rotation),
                    ];
                  i.attr({
                    rotation: t.rotate,
                    position: r,
      ...
      axisTickLabel: function () {
        var t = this.axisModel,
          ...
          i = (function (t, e, i) {
            ...
            if (!r.get("show") || n.scale.isBlank()) return;
            for (
              var o = r.getModel("lineStyle"),
                a = i.tickDirection * r.get("length"),
                s = Wm(
                  n.getTicksCoords(),
                  t._transform,
                  a,
        ...
        !(function (t, e, i) {
          ...
          !1 === n
            ? (Vm(o), Vm(h))
            : Fm(o, a) && (n ? (Vm(a), Vm(u)) : (Vm(o), Vm(h)));
          !1 === r
            ? (Vm(s), Vm(c))
            : Fm(l, s) && (r ? (Vm(l), Vm(d)) : (Vm(s), Vm(c)));
        })(
          t,
          (function (h, u, c) {
            var d = u.axis;
            if (
              !H(c.axisLabelShow, u.get("axisLabel.show")) ||
              d.scale.isBlank()
            )
              return;
            var f = u.getModel("axisLabel"),
              p = f.get("margin"),
              t = d.getViewLabels(),
              e = ((H(c.labelRotate, f.get("rotate")) || 0) * zm) / 180,
              g = Rm(c.rotation, e, c.labelDirection),
              m = u.getCategories && u.getCategories(!0),
              v = [],
              y = Bm(u),
            ...
            return (
              D(t, function (t, e) {
                ...
                m &&
                  m[i] &&
                  m[i].textStyle &&
                  (o = new _l(m[i].textStyle, f, u.ecModel));
                var a = o.getTextColor() || u.get("axisLine.lineStyle.color"),
                ...
                js(l.style, o, {
                  text: n,
                  textAlign: o.getShallow("align", !0) || g.textAlign,
                  textVerticalAlign:
          ...
          (function (t, e, i) {
            ...
            for (
              var a = r.getModel("lineStyle"),
                s = i.tickDirection * r.get("length"),
                l = A(
                  a.getLineStyle(),
              ...
              for (
                var u = Wm(o[h], t._transform, s, l, "minorticks_" + h), c = 0;
                c < u.length;
                c++
              )
                t.group.add(u[c]);
      ...
      axisName: function () {
        ...
        if (i) {
          var n,
            ...
            c = [
              "start" === o
                ...
                ? h[1] + u * l
                : (h[0] + h[1]) / 2,
              Hm(o) ? t.labelOffset + a * l : 0,
            ],
            d = e.get("nameRotate");
          null != d && (d = (d * zm) / 180),
            Hm(o)
              ? (n = Rm(t.rotation, null != d ? d : t.rotation, a))
              : ((n = (function (t, e, i, n) {
                  var r,
                    o,
                    a = Ol(i - t.rotation),
                  ...
                  r = zl(a - zm / 2)
                    ? ((o = l ? "bottom" : "top"), "center")
                    : zl(a - 1.5 * zm)
                    ? ((o = l ? "top" : "bottom"), "center")
                    : ((o = "middle"),
                      a < 1.5 * zm && zm / 2 < a
                        ? l
                          ? "left"
          ...
          var f = s.getFont(),
            ...
            g = p.ellipsis,
            m = H(t.nameTruncateMaxWidth, p.maxWidth, r),
            v =
              null != g && null != m
                ? th(i, m, f, g, { minChar: 2, placeholder: p.placeholder })
                : i,
            y = e.get("tooltip", !0),
            _ = e.mainType,
            x = { componentType: _, name: i, $vars: ["name"] };
    ...
    Nm = (Om.makeAxisEventDataBase = function (t) {
      var e = { componentType: t.mainType, componentIndex: t.componentIndex };
      return (e[t.mainType + "Index"] = t.componentIndex), e;
    }),
    Rm = (Om.innerTextLayout = function (t, e, i) {
      var n,
        r = Ol(e - t);
      return {
        rotation: r,
  ...
  var Bm = (Om.isLabelSilent = function (t) {
    var e = t.get("tooltip");
  ...
  function Fm(t, e) {
    ...
    if (i && n) {
      ...
      return (
        ae(r, r, -t.rotation),
        i.applyTransform(re([], r, t.getLocalTransform())),
        n.applyTransform(re([], r, e.getLocalTransform())),
        i.intersect(n)
      );
    }
  }
  ...
  function Um(t, e) {
    ...
    return (
      (function (p, g, t) {
        var o = g.getComponent("tooltip"),
          m = g.getComponent("axisPointer"),
          v = m.get("link", !0) || [],
          y = [];
        Gm(t.getCoordinateSystems(), function (c) {
          if (c.axisPointerEnabled) {
            var t = qm(c.model),
              d = (p.coordSysAxesInfo[t] = {}),
              f = (p.coordSysMap[t] = c).model.getModel("tooltip", o);
            if (
              (Gm(c.getAxes(), Zm(r, !1, null)),
              c.getTooltipAxes && o && f.get("show"))
            ) {
              var e = "axis" === f.get("trigger"),
                i = "cross" === f.get("axisPointer.type"),
                n = c.getTooltipAxes(f.get("axisPointer.axis"));
              (e || i) && Gm(n.baseAxes, Zm(r, !i || "cross", e)),
                i && Gm(n.otherAxes, Zm(r, "cross", !1));
            }
          }
          function r(t, e, i) {
            ...
            if (r && ("auto" !== r || t || jm(n))) {
              ...
              var o = (n = t
                  ? (function (t, e, i, n, r, o) {
                      ...
                      return t.model.getModel("axisPointer", new _l(s, i, n));
                    })(i, f, m, g, t, e)
                  : n).get("snap"),
                a = qm(i.model),
              ...
              (d[a] = l), (p.seriesInvolved |= s);
              var h = (function (t, e) {
                for (var i = e.model, n = e.dim, r = 0; r < t.length; r++) {
                  var o = t[r] || {};
                  if (
                    Xm(o[n + "AxisId"], i.id) ||
                    Xm(o[n + "AxisIndex"], i.componentIndex) ||
                    Xm(o[n + "AxisName"], i.name)
                  )
                    return r;
                }
              })(v, i);
              if (null != h) {
                var u = y[h] || (y[h] = { axesInfo: {} });
                (u.axesInfo[a] = l),
                  (u.mapper = v[h].mapper),
                  (l.linkGroup = u);
              }
        ...
        (function (r, t) {
          t.eachSeries(function (i) {
            ...
            n &&
              ...
              Gm(r.coordSysAxesInfo[qm(n.model)], function (t) {
                var e = t.axis;
                n.getAxis(e.dim) === e &&
  ...
  var $m = cf({
    ...
    render: function (t, e, i, n) {
      this.axisPointerClass &&
        ...
        $m.superApply(this, "render", arguments),
        Km(this, t, e, i, n, !0);
    },
    ...
    remove: function (t, e) {
      ...
      i && i.remove(e), $m.superApply(this, "remove", arguments);
    },
    dispose: function (t, e) {
      Qm(this, e), $m.superApply(this, "dispose", arguments);
    },
  });
  function Km(t, e, i, n, r, o) {
    var a = $m.getAxisPointerClass(t.axisPointerClass);
    if (a) {
      var s = (function (t) {
        var e = Ym(t);
      ...
      s
        ? (t._axisPointer || (t._axisPointer = new a())).render(e, s, n, o)
        : Qm(t, n);
    }
  }
  function Qm(t, e, i) {
  ...
  function tv(t, e, i) {
    ...
    (o.position = ["y" === h ? p[d[l]] : c[0], "x" === h ? p[d[l]] : c[3]]),
      (o.rotation = (Math.PI / 2) * ("x" === h ? 0 : 1));
    (o.labelDirection = o.tickDirection = o.nameDirection = {
      ...
      H(i.labelInside, e.get("axisLabel.inside")) &&
        (o.labelDirection = -o.labelDirection);
    var m = e.get("axisLabel.rotate");
    return (o.labelRotate = "top" === l ? -m : m), (o.z2 = 1), o;
  }
  ($m.registerAxisPointerClass = function (t, e) {
    Jm[t] = e;
  }),
    ($m.getAxisPointerClass = function (t) {
      return t && Jm[t];
    });
  var ev = ["axisLine", "axisTickLabel", "axisName"],
    iv = ["splitArea", "splitLine", "minorSplitLine"],
    nv = $m.extend({
      type: "cartesianAxis",
      ...
      render: function (e, t, i, n) {
        ...
        if (
          ((this._axisGroup = new Si()),
          this.group.add(this._axisGroup),
          e.get("show"))
        ) {
          var o = e.getCoordSysModel(),
            a = tv(o, e),
            s = new Om(e, a);
          D(ev, s.add, s),
            ...
            sl(r, this._axisGroup, e),
            nv.superCall(this, "render", e, t, i, n);
        }
      },
      remove: function () {
        !(function (t) {
      ...
      _splitLine: function (t, e) {
        ...
        if (!i.scale.isBlank()) {
          ...
          o = O(o) ? o : [o];
          for (
            var a = e.coordinateSystem.getRect(),
              s = i.isHorizontal(),
              l = 0,
            ...
            s
              ? ((u[0] = p), (u[1] = a.y), (c[0] = p), (c[1] = a.y + a.height))
              : ((u[0] = a.x), (u[1] = p), (c[0] = a.x + a.width), (c[1] = p));
            var g = l++ % o.length,
              m = h[f].tickValue;
            this._axisGroup.add(
              new es({
      ...
      _minorSplitLine: function (t, e) {
        var i = t.axis,
          ...
          o = i.isHorizontal(),
          a = i.getMinorTicksCoords();
        if (a.length)
          for (
            var s = [], l = [], h = n.getLineStyle(), u = 0;
            u < a.length;
            u++
          )
            for (var c = 0; c < a[u].length; c++) {
              var d = i.toGlobalCoord(a[u][c].coord);
              o
                ? ((s[0] = d),
                  (s[1] = r.y),
                  (l[0] = d),
      ...
      _splitArea: function (t, e) {
        !(function (t, e, i, n) {
          var r = i.axis;
          if (!r.scale.isBlank()) {
            var o = i.getModel("splitArea"),
              a = o.getModel("areaStyle"),
              s = a.get("color"),
              l = n.coordinateSystem.getRect(),
              h = r.getTicksCoords({ tickModel: o, clamp: !0 });
            if (h.length) {
              var u = s.length,
              ...
              for (p = 1; p < h.length; p++) {
                var y,
                  ...
                  x,
                  w,
                  b = r.toGlobalCoord(h[p].coord);
                m = r.isHorizontal()
                  ? ((y = m), (_ = l.y), (x = b - y), (w = l.height), y + x)
                  : ((y = l.x), (_ = m), (x = l.width), _ + (w = b - _));
                var S = h[p - 1].tickValue;
                null != S && d.set(S, f),
                  e.add(
                    new Ja({
                      anid: null != S ? "area_" + S : null,
                      shape: { x: y, y: _, width: x, height: w },
                      style: A({ fill: s[f] }, v),
                      silent: !0,
                    })
                  ),
  ...
  nv.extend({ type: "xAxis" }),
    nv.extend({ type: "yAxis" }),
    cf({
      type: "grid",
      render: function (t, e) {
        this.group.removeAll(),
    ...
    sf(um("line", "circle", "line")),
    af(cm("line")),
    rf(gd.PROCESSOR.STATISTIC, {
      seriesType: "line",
      modifyOutputEnd: !0,
      reset: function (t, e, i) {
        ...
        if ("cartesian2d" === o.type && r) {
          ...
          1 < c &&
            ...
            a && t.setData(n.downSample(n.mapDimension(l.dim), 1 / c, a, dm)));
        }
      },
    }),
    Yu.extend({
      ...
      getMarkerPosition: function (t) {
        ...
        if (e) {
          var i = e.dataToPoint(e.clampData(t)),
            ...
            o = n.getLayout("size");
          return (i[e.getBaseAxis().isHorizontal() ? 0 : 1] += r + o / 2), i;
        }
        return [NaN, NaN];
      },
      defaultOption: {
    ...
    sv = ws({
      ...
      buildPath: function (t, e) {
        ...
        (u ? h - l < 2 * Math.PI : l - h < 2 * Math.PI) &&
          ...
          t.arc(c * s + i, d * s + n, a, -Math.PI + l, l, !u)),
          t.arc(i, n, o, l, h, !u),
          t.moveTo(f * o + i, p * o + n),
          t.arc(f * s + i, p * s + n, a, h - 2 * Math.PI, h - Math.PI, !u),
          0 !== r && (t.arc(i, n, r, h, l, u), t.moveTo(c * r + i, p * r + n)),
          t.closePath();
      },
    }),
    lv = ["itemStyle", "barBorderWidth"],
    hv = [0, 0];
  k(_l.prototype, av),
    ff({
      type: "bar",
      ...
      _renderNormal: function (s, t, e) {
        ...
        function m(t) {
          ...
          return (
            i.useStyle(_.getBarItemStyle()),
            "cartesian2d" === d.type && i.setShape("r", x),
            (w[t] = i)
          );
        }
        var v = s.get("roundCap", !0),
          y = s.get("showBackground", !0),
          _ = s.getModel("backgroundStyle"),
          x = _.get("barBorderRadius") || 0,
          w = [],
        ...
        u.diff(c)
          .add(function (t) {
            var e = u.getItemModel(t),
              i = mv[d.type](u, t, e);
            if ((y && m(t), u.hasValue(t))) {
              if (p) if (dv[d.type](g, i)) return void h.remove(n);
              var n = fv[d.type](t, i, l, f, !1, v);
              u.setItemGraphicEl(t, n),
                h.add(n),
                yv(n, u, t, e, i, s, l, "polar" === d.type);
            }
          })
          .update(function (t, e) {
            ...
            if (y) {
              ...
              0 === b.length
                ? (r = m(e))
                : ((r = b[e]).useStyle(_.getBarItemStyle()),
                  "cartesian2d" === d.type && r.setShape("r", x),
                  (w[t] = r));
              var o = mv[d.type](u, t);
              il(r, { shape: bv(l, o, d) }, f, t);
            }
            var a = c.getItemGraphicEl(e);
            if (u.hasValue(t)) {
              if (p) if (dv[d.type](g, n)) return void h.remove(a);
              a
                ? il(a, { shape: n }, f, t)
                : (a = fv[d.type](t, n, l, f, !0, v)),
                u.setItemGraphicEl(t, a),
                h.add(a),
                yv(a, u, t, i, n, s, l, "polar" === d.type);
            } else h.remove(a);
          })
          .remove(function (t) {
            var e = c.getItemGraphicEl(t);
            "cartesian2d" === d.type ? e && pv(t, f, e) : e && gv(t, f, e);
          })
          .execute();
        var n = this._backgroundGroup || (this._backgroundGroup = new Si());
        n.removeAll();
        for (var r = 0; r < w.length; ++r) n.add(w[r]);
        h.add(n), (this._backgroundEls = w), (this._data = u);
      },
      _renderLarge: function (t, e, i) {
        this._clear(), xv(t, this.group);
        var n = t.get("clip", !0)
          ? (function (t, e, i) {
              return t
                ? "polar" === t.type
  ...
  var uv = Math.max,
    ...
    dv = {
      cartesian2d: function (t, e) {
        ...
        var r = uv(e.x, t.x),
          o = cv(e.x + e.width, t.x + t.width),
          a = uv(e.y, t.y),
          s = cv(e.y + e.height, t.y + t.height);
    ...
    fv = {
      cartesian2d: function (t, e, i, n, r) {
        var o = new Ja({ shape: k({}, e), z2: 1 });
        if (((o.name = "item"), n)) {
          var a = i ? "height" : "width",
            s = {};
          (o.shape[a] = 0),
            (s[a] = e[a]),
            dl[r ? "updateProps" : "initProps"](o, { shape: s }, n, t);
        }
        return o;
      },
      polar: function (t, e, i, n, r, o) {
        var a = e.startAngle < e.endAngle,
          s = new (!i && o ? sv : Wa)({ shape: A({ clockwise: a }, e), z2: 1 });
        if (((s.name = "item"), n)) {
          var l = i ? "r" : "endAngle",
            h = {};
          (s.shape[l] = i ? 0 : e.startAngle),
            (h[l] = e[l]),
            dl[r ? "updateProps" : "initProps"](s, { shape: h }, n, t);
        }
        return s;
      },
    };
  function pv(t, e, i) {
    (i.style.text = null),
      il(i, { shape: { width: 0 } }, e, t, function () {
        i.parent && i.parent.remove(i);
      });
  }
  function gv(t, e, i) {
    (i.style.text = null),
      il(i, { shape: { r: i.shape.r0 } }, e, t, function () {
        i.parent && i.parent.remove(i);
      });
  }
  var mv = {
  ...
  function yv(t, e, i, n, r, o, a, s) {
    ...
    s ||
      (function (t, e, i, n, r, o) {
        Ys(t, e, i.getModel("label"), i.getModel("emphasis.label"), {
          labelFetcher: r,
          labelDataIndex: o,
          defaultText: Cg(r.getData(), o),
          isRectText: !0,
          autoColor: n,
        }),
          rv(t),
  ...
  var _v = xa.extend({
    ...
    buildPath: function (t, e) {
      for (
        var i = e.points, n = this.__startPoint, r = this.__baseDimIdx, o = 0;
        o < i.length;
        o += 2
      )
        (n[r] = i[o + r]), t.moveTo(n[0], n[1]), t.lineTo(i[o], i[o + 1]);
    },
  });
  function xv(t, e, i) {
    var n = t.getData(),
    ...
    r[1 - o] = n.getLayout("valueAxisStart");
    ...
    if (t.get("showBackground", !0)) {
      var h = n.getLayout("largeBackgroundPoints"),
        u = [];
      u[1 - o] = n.getLayout("backgroundStart");
      var c = new _v({
        shape: { points: h },
        incremental: !!i,
        __startPoint: u,
    ...
    e.add(d),
      ...
      t.get("silent") || (d.on("mousedown", wv), d.on("mousemove", wv));
  }
  var wv = mc(
    function (t) {
  ...
  af(
        ...
        function (t) {
          ...
          for (
            ...
            var v,
              ...
              I = p;
            if (
              (d && (T[r][S] || (T[r][S] = { p: p, n: p }), (I = T[r][S][M])),
              f)
            )
              (v = I),
                (y = (w = i.dataToPoint([b, S]))[1] + a),
                (_ = w[0] - p),
                (x = s),
                Math.abs(_) < h && (_ = (_ < 0 ? -1 : 1) * h),
                isNaN(_) || (d && (T[r][S][M] += _));
            else
              (v = (w = i.dataToPoint([S, b]))[0] + a),
                (y = I),
                (_ = s),
                (x = w[1] - p),
                Math.abs(x) < h && (x = (x <= 0 ? -1 : 1) * h),
                isNaN(x) || (d && (T[r][S][M] += x));
            e.setItemLayout(g, { x: v, y: y, width: _, height: x });
          }
        },
        this
      );
    ...
    af(gd.VISUAL.PROGRESSIVE_LAYOUT, _p),
    sf({
      seriesType: "bar",
      reset: function (t) {
  ...
  var Iv = df({
    type: "series.pie",
    init: function (t) {
      Iv.superApply(this, "init", arguments),
        (this.legendVisualProvider = new Mv(
          C(this.getData, this),
          C(this.getRawData, this)
        )),
        this.updateSelectedMap(this._createSelectableList()),
        this._defaultLabelLine(t);
    },
    mergeOption: function (t) {
      Iv.superCall(this, "mergeOption", t),
        this.updateSelectedMap(this._createSelectableList());
    },
    getInitialData: function (t, e) {
      return (function (t, e, i) {
        e = (O(e) && { coordDimensions: e }) || k({}, e);
        var n = t.getSource(),
          r = Uf(n, e),
          o = new kf(r, t);
        return o.initData(n, i), o;
      })(this, { coordDimensions: ["value"], encodeDefaulter: T(Bh, this) });
    },
    _createSelectableList: function () {
      for (
        ...
        i.push({
          name: t.getName(n),
          value: t.get(e, n),
          selected: ku(t, n, "selected"),
        });
      return i;
    },
    getDataParams: function (t) {
      var e = this.getData(),
        i = Iv.superCall(this, "getDataParams", t),
        n = [];
      return (
        e.each(e.mapDimension("value"), function (t) {
          n.push(t);
        }),
        (i.percent = Ll(n, t, e.hostModel.get("percentPrecision"))),
        i.$vars.push("percent"),
        i
      );
    },
  ...
  function Tv(t, e, i, n, r) {
    var o = (e.startAngle + e.endAngle) / 2,
      a = i ? n : 0,
      s = [Math.cos(o) * a, Math.sin(o) * a];
    r
      ? t.animate().when(200, { position: s }).start("bounceOut")
      : t.attr("position", s);
  }
  function Av(t, e) {
    Si.call(this);
  ...
  (Dv.updateData = function (t, e, i) {
    var n = this.childAt(0),
      ...
      h = k({}, l);
    h.label = null;
    var u = a.getShallow("animationTypeUpdate");
    i
      ? (n.setShape(h),
        "scale" === a.getShallow("animationType")
          ? ((n.shape.r = l.r0), nl(n, { shape: { r: l.r } }, a, e))
          : ((n.shape.endAngle = l.startAngle),
            il(n, { shape: { endAngle: l.endAngle } }, a, e)))
      : "expansion" === u
      ? n.setShape(h)
      : il(n, { shape: h }, a, e);
    var c = t.getItemVisual(e, "color");
    n.useStyle(
      A({ lineJoin: "bevel", fill: c }, s.getModel("itemStyle").getItemStyle())
    ),
    ...
    d && n.attr("cursor", d),
      Tv(
        this,
        t.getItemLayout(e),
        a.isSelected(t.getName(e)),
        a.get("selectedOffset"),
        a.get("animation")
      );
    var f = !i && "transition" === u;
    this._updateLabel(t, e, f),
      (this.highDownOnUpdate = a.get("silent")
        ? null
        : function (t, e) {
            var i = a.isAnimationEnabled() && s.get("hoverAnimation");
            "emphasis" === e
    ...
    (Dv._updateLabel = function (t, e, i) {
      ...
      if (!s || isNaN(s.x) || isNaN(s.y))
        r.ignore = r.normalIgnore = r.hoverIgnore = n.ignore = n.normalIgnore = n.hoverIgnore = !0;
      else {
        var h = {
            points: s.linePoints || [
              [s.x, s.y],
          ...
          u = { x: s.x, y: s.y };
        i
          ? (il(n, { shape: h }, o, e), il(r, { style: u }, o, e))
          : (n.attr({ shape: h }), r.attr({ style: u })),
          r.attr({ rotation: s.rotation, origin: [s.x, s.y], z2: 10 });
        var c = a.getModel("label"),
          d = a.getModel("emphasis.label"),
          f = a.getModel("labelLine"),
          p = a.getModel("emphasis.labelLine");
        l = t.getItemVisual(e, "color");
        Ys(
          r.style,
          (r.hoverStyle = {}),
          ...
          (r.ignore = r.normalIgnore = !c.get("show")),
  ...
  ac.extend({
      ...
      if (!n || n.from !== this.uid) {
        ...
        if (
          (r
            ...
            .execute(),
          s && 0 < r.count() && (l ? "scale" !== h : "transition" !== u))
        ) {
          for (
            var f = r.getItemLayout(0), p = 1;
            isNaN(f.startAngle) && p < r.count();
            ++p
          )
            f = r.getItemLayout(p);
          var g = Math.max(i.getWidth(), i.getHeight()) / 2,
            m = C(a.removeClipPath, a);
          a.setClipPath(
    ...
    dispose: function () {},
    _createClipPath: function (t, e, i, n, r, o, a, s) {
      var l = new Wa({
        shape: {
          cx: t,
          cy: e,
      ...
      return (
        (s ? nl : il)(
          l,
          { shape: { endAngle: n + (r ? 1 : -1) * Math.PI * 2 } },
          a,
          o
        ),
        l
  ...
  var kv = Math.PI / 180;
  function Pv(r, t, e, i, n, o, a, s, l, h) {
    function u(t, e, i) {
      for (var n = t; n < e && !(r[n].y + i > l + a); n++)
        if (
          ((r[n].y += i),
          t < n && n + 1 < e && r[n + 1].y > r[n].y + r[n].height)
        )
          return void c(n, i / 2);
      c(e - 1, i / 2);
    }
    function c(t, e) {
      for (
        ...
        0 <= i &&
        !(r[i].y - e < l) &&
        ((r[i].y -= e), !(0 < i && r[i].y > r[i - 1].y + r[i - 1].height));
        i--
      );
    }
    ...
    for (var f, p = 0, g = r.length, m = [], v = [], y = 0; y < g; y++) {
      if ("outer" === r[y].position && "labelLine" === r[y].labelAlignTo) {
        var _ = r[y].x - h;
        (r[y].linePoints[1][0] += _), (r[y].x = h);
      }
      (f = r[y].y - p) < 0 && u(y, g, -f), (p = r[y].y + r[y].height);
    }
    a - p < 0 && c(g - 1, p - a);
    for (y = 0; y < g; y++) r[y].y >= e ? v.push(r[y]) : m.push(r[y]);
    d(m, !1, t, e, i, n), d(v, !0, t, e, i, n);
  }
  function Lv(t) {
    return "center" === t.position;
  }
  function Ov(k, P, L, t, O, e) {
    var z,
      E,
      N = k.getData(),
      R = [],
      B = !1,
      V = (k.get("minShowLabelAngle") || 0) * kv;
    N.each(function (t) {
      var e = N.getItemLayout(t),
        i = N.getItemModel(t),
        n = i.getModel("label"),
        r = n.get("position") || i.get("emphasis.label.position"),
        o = n.get("distanceToLabelLine"),
        a = n.get("alignTo"),
        s = Cl(n.get("margin"), L),
        l = n.get("bleedMargin"),
        h = n.getFont(),
        u = i.getModel("labelLine"),
        c = u.get("length");
      c = Cl(c, L);
      var d = u.get("length2");
      if (((d = Cl(d, L)), !(e.angle < V))) {
        var f,
          p,
          g,
          m,
        ...
        (z = e.cx), (E = e.cy);
        var x,
          w = k.getFormattedLabel(t, "normal") || N.getName(t),
          b = hn(w, h, m, "top"),
          S = "inside" === r || "inner" === r;
        if ("center" === r) (f = e.cx), (p = e.cy), (m = "center");
        else {
          var M = (S ? ((e.r + e.r0) / 2) * y : e.r * y) + z,
            I = (S ? ((e.r + e.r0) / 2) * _ : e.r * _) + E;
          if (((f = M + 3 * y), (p = I + 3 * _), !S)) {
            var C = M + y * (c + P - e.r),
              T = I + _ * (c + P - e.r),
              A = C + (y < 0 ? -1 : 1) * d;
            (f =
      ...
      !B &&
        ...
        (function (t, e, i, n, r, o, a, s) {
          for (
            ...
            Lv(t[d]) ||
              (t[d].x < e
                ? ((u = Math.min(u, t[d].x)), l.push(t[d]))
                : ((c = Math.max(c, t[d].x)), h.push(t[d])));
          for (
            Pv(h, e, i, n, 1, 0, o, 0, s, c),
              Pv(l, e, i, n, -1, 0, o, 0, s, u),
              d = 0;
            d < t.length;
            d++
          ) {
            ...
            if (!Lv(f)) {
              ...
              if (p) {
                ...
                (g = m
                  ? f.x < e
                    ? p[2][0] - f.labelDistance - a - f.labelMargin
                    : a + r - f.labelMargin - p[2][0] - f.labelDistance
                  : f.x < e
                  ? f.x - a - f.bleedMargin
                  : a + r - f.x - f.bleedMargin) < f.textRect.width &&
                  ((f.text = fn(f.text, g, f.font)),
                  "edge" === f.labelAlignTo && (v = ln(f.text, f.font)));
                var y = p[1][0] - p[2][0];
                m
                  ? f.x < e
                    ? (p[2][0] = a + f.labelMargin + v + f.labelDistance)
                    : (p[2][0] = a + r - f.labelMargin - v - f.labelDistance)
                  : (f.x < e
      ...
      function (o) {
        (o.update = "updateView"),
          of(o, function (t, e) {
            ...
            return (
              e.eachComponent(
                { mainType: "series", subType: Nv, query: t },
                function (i) {
              ...
              { name: t.name, selected: r, seriesId: t.seriesId }
            );
          });
      }
    ),
      ...
      ((Rv = "pie"),
      {
        getTargetSeries: function (t) {
          var e = {},
            i = Q();
          return (
            t.eachSeriesByType(Rv, function (t) {
          ...
          u.each(function (t) {
            ...
            l.each(function (t) {
              ...
              if (((n && r) || (e = l.getItemModel(t)), !n)) {
                ...
                null != i && u.setItemVisual(i, "color", o);
              }
              if (!r) {
                var a = e.get("itemStyle.borderColor");
                null != i && u.setItemVisual(i, "borderColor", a);
              }
            });
        },
      })
      ...
      T(function (t, e, T, i) {
        e.eachSeriesByType(t, function (t) {
          var r = t.getData(),
            ...
            o = (function (t, e) {
              return lh(t.getBoxLayoutParams(), {
                width: e.getWidth(),
                height: e.getHeight(),
              });
            })(t, T),
            ...
            n = t.get("radius");
          O(n) || (n = [0, n]), O(i) || (i = [i, i]);
          var a = Cl(o.width, T.getWidth()),
            s = Cl(o.height, T.getHeight()),
            l = Math.min(a, s),
            h = Cl(i[0], a) + o.x,
            u = Cl(i[1], s) + o.y,
            c = Cl(n[0], l / 2),
            d = Cl(n[1], l / 2),
            f = -t.get("startAngle") * Ev,
            p = t.get("minAngle") * Ev,
            g = 0;
          r.each(e, function (t) {
            isNaN(t) || g++;
            ...
            if (b <= 0.001) {
              ...
              r.each(e, function (t, e) {
                if (!isNaN(t)) {
                  ...
                  (i.angle = C),
                    (i.startAngle = f + I * e * C),
                    (i.endAngle = f + I * (e + 1) * C);
                }
              });
            } else
              (v = b / S),
          ...
          Ov(t, d, o.width, o.height, o.x, o.y);
        });
      }, "pie")
    ),
    rf({
    ...
    afterBrush: function (t) {
      ...
      if (n[0] < 4) {
        ...
        for (var r = 0; r < i.length; ) {
          ...
          isNaN(o) ||
            isNaN(a) ||
            (this.softClipShape && !this.softClipShape.contain(o, a)) ||
            t.fillRect(o - n[0] / 2, a - n[1] / 2, n[0], n[1]);
        }
        this.restoreTransform(t);
      }
    },
    findDataIndex: function (t, e) {
      for (
        ...
        var l = 2 * s,
          h = n[l] - o / 2,
          u = n[1 + l] - a / 2;
        if (h <= t && u <= e && t <= h + o && e <= u + a) return s;
      }
      return -1;
    },
  });
  ...
  var Fv = Vv.prototype;
  (Fv.isPersistent = function () {
    return !this._incremental;
  }),
    (Fv.updateData = function (t, e) {
      this.group.removeAll();
      var i = new Bv({ rectHover: !0, cursor: "default" });
      i.setShape({ points: t.getLayout("symbolPoints") }),
        this._setCommon(i, t, !1, e),
        this.group.add(i),
        (this._incremental = null);
    }),
    (Fv.updateLayout = function (t) {
    ...
    (Fv.incrementalPrepareUpdate = function (t) {
      this.group.removeAll(),
        this._clearIncremental(),
        2e6 < t.count()
          ? (this._incremental || (this._incremental = new us({ silent: !0 })),
            this.group.add(this._incremental))
          : (this._incremental = null);
    }),
    (Fv.incrementalUpdate = function (t, e, i) {
      var n;
      this._incremental
        ? ((n = new Bv()), this._incremental.addDisplayable(n, !0))
        : (((n = new Bv({
            rectHover: !0,
            cursor: "default",
            startIndex: t.start,
    ...
    (Fv._setCommon = function (i, t, e, n) {
      var r = t.hostModel;
      n = n || {};
      var o = t.getVisual("symbolSize");
      i.setShape("size", o instanceof Array ? o : [o, o]),
        (i.softClipShape = n.clipShape || null),
        (i.symbolProxy = ig(t.getVisual("symbol"), 0, 0, 0, 0)),
        (i.setColor = i.symbolProxy.setColor);
      var a = i.shape.size[0] < 4;
      i.useStyle(
        r
          .getModel("itemStyle")
      ...
      _updateSymbolDraw: function (t, e) {
        ...
        return (
          (i && n === this._isLargeDraw) ||
            (i && i.remove(),
            (i = this._symbolDraw = n ? new Vv() : new Rg()),
            (this._isLargeDraw = n),
            this.group.removeAll()),
    ...
    sf(um("scatter", "circle")),
    af(cm("scatter"));
  var Hv = { path: null, compoundPath: null, group: Si, image: Yn, text: Ba };
  nf(function (t) {
    var e = t.graphic;
    O(e)
      ? e[0] && e[0].elements
  ...
  var Wv = uf({
    ...
    mergeOption: function (t) {
      ...
      (this.option.elements = null),
        Wv.superApply(this, "mergeOption", arguments),
        ...
        function (t, e) {
          ...
          i &&
            ...
            (function (t, e, i) {
              ...
              "merge" === o
                ? r
                  ? (m(r, n, !0), uh(r, n, { ignoreSize: !0 }), dh(i, r))
                  : (t[e] = n)
                : "replace" === o
                ? (t[e] = n)
                : "remove" === o && r && (t[e] = null);
  ...
  function Gv(t, e, i, n) {
    var r = i.type,
      o = new (Hv.hasOwnProperty(r) ? Hv[r] : Ss(r))(i);
    ...
    _updateElements: function (h) {
      ...
      if (t) {
        ...
        D(t, function (t) {
          ...
          "text" === t.type &&
            a &&
            (t.hv && t.hv[1] && (a.textVerticalAlign = a.textBaseline = null),
            !a.hasOwnProperty("textFill") && a.fill && (a.textFill = a.fill),
            !a.hasOwnProperty("textStroke") &&
              a.stroke &&
              (a.textStroke = a.stroke));
          var s = (function (e) {
            return (
              (e = k({}, e)),
              D(
                ["id", "parentId", "$action", "hv", "bounding"].concat(rh),
                function (t) {
                  delete e[t];
                }
              ),
    ...
    _relocate: function (t, e) {
      for (
        ...
        if ((u = r.get(l.id)) && u.isGroup) {
          var h = (c = u.parent) === n;
          (u.__ecGraphicWidth =
            Cl(u.__ecGraphicWidthOption, h ? o : c.__ecGraphicWidth) || 0),
            (u.__ecGraphicHeight =
              Cl(u.__ecGraphicHeightOption, h ? a : c.__ecGraphicHeight) || 0);
        }
      }
  ...
  function Xv(t, e) {
    ...
    var o = i.getData(),
      a = Fr(o, t);
    if (null == a || a < 0 || O(a)) return { point: [] };
    var s = o.getItemGraphicEl(a),
      l = i.coordinateSystem;
    if (i.getTooltipPosition) n = i.getTooltipPosition(a) || [];
      ...
      if (t.involveSeries) {
        var a = (function (l, t) {
            var h = t.axis,
              ...
              p = -1;
            return (
              Yv(t.seriesModels, function (e, t) {
                var i,
                  n,
                  r = e.getData().mapDimension(u, !0);
                if (e.getAxisTooltipData) {
                  var o = e.getAxisTooltipData(r, l, h);
          ...
          s = a.payloadBatch,
          l = a.snapToValue;
        s[0] && null == r.seriesIndex && k(r, s[0]),
          !n && t.snap && o.containData(l) && null != l && (e = l),
  ...
  function ny(t, e, i) {
    if (!v.node) {
      var n = e.getZr();
      ey(n).records || (ey(n).records = {}),
        (function (r, o) {
          if (ey(r).initialized) return;
          function t(t, n) {
            r.on(t, function (e) {
              var i = (function (i) {
                var n = { showTip: [], hideTip: [] },
                  r = function (t) {
                    ...
                    e
                      ? e.push(t)
                      : ((t.dispatchAction = r), i.dispatchAction(t));
                  };
                return { dispatchAction: r, pendings: n };
              })(o);
              iy(ey(r).records, function (t) {
          ...
          (ey(r).initialized = !0),
            t("click", T(oy, "click")),
            t("mousemove", T(oy, "mousemove")),
            t("globalout", ry);
        })(n, e),
        ((ey(n).records[t] || (ey(n).records[t] = {})).handler = i);
    }
  }
  function ry(t, e, i) {
  ...
  function ay(t, e) {
    if (!v.node) {
      var i = e.getZr();
      (ey(i).records || {})[t] && (ey(i).records[t] = null);
    }
  }
  var sy = cf({
      type: "axisPointer",
      render: function (t, e, i) {
        var n = e.getComponent("tooltip"),
          r =
            ...
            (n && n.get("triggerOn")) ||
            "mousemove|click";
        ny("axisPointer", i, function (t, e, i) {
          "none" !== r &&
            ("leave" === t || 0 <= r.indexOf(t)) &&
            i({
      ...
      remove: function (t, e) {
        ay(e.getZr(), "axisPointer"),
          sy.superApply(this._model, "remove", arguments);
      },
      dispose: function (t, e) {
        ay("axisPointer", e), sy.superApply(this._model, "dispose", arguments);
      },
    }),
    ly = Hr(),
    hy = b,
  ...
  function dy(t, e, i, n) {
    !(function i(n, t) {
      ...
      ((ly(i).lastProp = n), e ? il(i, n, t) : (i.stopAnimation(), i.attr(n)));
  }
  function fy(t, e) {
  ...
  function my(t, e, i, n, r) {
    var o = vy(i.get("value"), e.axis, e.ecModel, i.get("seriesDataIndices"), {
        precision: i.get("label.precision"),
        formatter: i.get("label.formatter"),
      }),
      a = i.getModel("label"),
      s = Gl(a.get("padding") || 0),
      l = a.getFont(),
      h = hn(o, l),
      u = r.position,
      c = h.width + s[1] + s[3],
  ...
  function vy(t, e, r, i, n) {
    t = e.scale.parse(t);
    var o = e.scale.getLabel(t, { precision: n.precision }),
      a = n.formatter;
    if (a) {
      var s = {
        value: Zp(e, t),
      ...
      D(i, function (t) {
        ...
        E(a) ? (o = a.replace("{value}", o)) : z(a) && (o = a(s));
    }
    return o;
  }
  function yy(t, e, i) {
    ...
    ((cy.prototype = {
      ...
      render: function (t, e, i, n) {
        ...
        if (
          ...
          (this._api = i),
          n || this._lastValue !== r || this._lastStatus !== o)
        ) {
      ...
      createPointerEl: function (t, e, i, n) {
        var r = e.pointer;
        if (r) {
          var o = (ly(t).pointerEl = new dl[r.type](hy(e.pointer)));
          t.add(o);
        }
      },
      createLabelEl: function (t, e, i, n) {
        if (e.label) {
          var r = (ly(t).labelEl = new Ja(hy(e.label)));
          t.add(r), fy(r, n);
        }
      },
      updatePointerEl: function (t, e, i) {
        var n = ly(t).pointerEl;
        n &&
          e.pointer &&
      ...
      _renderHandle: function (t) {
        if (!this._dragging && this.updateHandleTransform) {
          ...
          this._handle ||
            ((e = !0),
            (r = this._handle = hl(o.get("icon"), {
              cursor: "move",
              draggable: !0,
              onmousemove: function (t) {
                Wt(t.event);
              },
              onmousedown: uy(this._onHandleDragMove, this, 0, 0),
              drift: uy(this._onHandleDragMove, this),
              ondragend: uy(this._onHandleDragEnd, this),
            })),
            n.add(r)),
            gy(r, i, !1);
          r.setStyle(
  ...
  var _y = cy.extend({
    makeElOption: function (t, e, i, n, r) {
      var o = i.axis,
        a = o.grid,
        s = n.get("type"),
        l = xy(a, o).getOtherAxis(o).getGlobalExtent(),
      ...
      !(function (t, e, i, n, r, o) {
        var a = Om.innerTextLayout(i.rotation, 0, i.labelDirection);
        (i.labelMargin = r.get("label.margin")),
          my(e, n, r, o, {
            position: yy(n.axis, t, i),
            align: a.textAlign,
            verticalAlign: a.textVerticalAlign,
          });
      })(e, t, tv(a.model, i), i, n, r);
    },
    getHandleTransform: function (t, e, i) {
      var n = tv(e.axis.grid.model, e, { labelInside: !1 });
      return (
        (n.labelMargin = i.get("handle.margin")),
        {
          position: yy(e.axis, t, n),
    ...
    updateHandleTransform: function (t, e, i, n) {
      var r = i.axis,
        ...
        s = xy(o, r).getOtherAxis(r).getGlobalExtent(),
        l = "x" === r.dim ? 0 : 1,
        h = t.position;
      (h[l] += e[l]),
  ...
  $m.registerAxisPointerClass("CartesianAxisPointer", _y),
    nf(function (t) {
      if (t) {
    ...
    rf(gd.PROCESSOR.STATISTIC, function (t, e) {
    ...
    of(
      ...
      function (t, e, i) {
        ...
        if (s) {
          ty(a) &&
            (a = Xv({ seriesIndex: r.seriesIndex, dataIndex: r.dataIndex }, e)
              .point);
          var l = ty(a),
            h = r.axesInfo,
            u = s.axesInfo,
            ...
            f = {},
            p = { list: [], map: {} },
            g = { showPointer: jv(Kv, f), showTooltip: jv(Qv, p) };
          Yv(s.coordSysMap, function (t, e) {
            var o = l || t.containPoint(a);
            Yv(s.coordSysAxesInfo[e], function (t, e) {
              var i = t.axis,
                n = (function (t, e) {
                  for (var i = 0; i < (t || []).length; i++) {
                    var n = t[i];
          ...
          return (
            Yv(u, function (r, t) {
              ...
              o &&
                !f[t] &&
                Yv(o.axesInfo, function (t, e) {
                  var i = f[e];
                  if (t !== r && i) {
                    var n = i.value;
                    o.mapper &&
                      (n = r.axis.scale.parse(o.mapper(n, Jv(t), Jv(r)))),
                      (m[r.key] = n);
                  }
                });
            }),
            ...
            (function (t, e, i, n) {
              if (ty(e) || !t.list.length) return n({ type: "hideTip" });
              var r =
            ...
            (function (t, e, i) {
              ...
              Yv(t, function (t, e) {
                var i = t.axisPointerModel.option;
                "show" === i.status &&
                  Yv(i.seriesDataIndices, function (t) {
  ...
  function Cy(r) {
    ...
    return (
      ...
      e &&
        (v.canvasSupported
          ? o.push("background-Color:" + e)
          : (o.push("background-Color:#" + Ve(e)),
            o.push("filter:alpha(opacity=70)"))),
      Sy(["width", "color", "radius"], function (t) {
        var e = "border-" + t,
          i = My(e),
          n = r.get(i);
      ...
      o.push(
        (function (i) {
          var n = [],
            t = i.get("fontSize"),
            e = i.getTextColor();
          e && n.push("color:" + e), n.push("font:" + i.getFont());
          var r = i.get("lineHeight");
          null == r && (r = Math.round((3 * t) / 2)),
            t && n.push("line-height:" + r + "px");
          var o = i.get("textShadowColor"),
            a = i.get("textShadowBlur") || 0,
            s = i.get("textShadowOffsetX") || 0,
            l = i.get("textShadowOffsetY") || 0;
          return (
            a && n.push("text-shadow:" + s + "px " + l + "px " + a + "px " + o),
            Sy(["decoration", "align"], function (t) {
              var e = i.get(t);
              e && n.push("text-" + t + ":" + e);
            }),
            n.join(";")
      ...
      null != n && o.push("padding:" + Gl(n).join("px ") + "px"),
      o.join(";") + ";"
    );
  }
  function Ty(t, e, i, n, r) {
    ...
    if (i) {
      ...
      a &&
        (function (t, e, i, n, r) {
          Lt(Pt, e, n, r, !0) && Lt(t, i, Pt[0], Pt[1]);
        })(t, a, document.body, n, r);
    } else {
      (t[0] = n), (t[1] = r);
  ...
  function Ay(t, e, i) {
    ...
    (this._styleCoord = [0, 0, 0, 0]),
      Ty(this._styleCoord, r, o, e.getWidth() / 2, e.getHeight() / 2),
    ...
    (n.onmouseenter = function () {
      ...
      (n.onmousemove = function (t) {
        if (((t = t || window.event), !a._enterable)) {
          var e = r.handler;
          Ft(r.painter.getViewportRoot(), t, !0), e.dispatch("mousemove", t);
        }
      }),
  ...
  function ky(t) {
    ...
    (this._styleCoord = [0, 0, 0, 0]),
      Dy(this._styleCoord, e, t.getWidth() / 2, t.getHeight() / 2),
      (this._show = !1),
      this._hideTimeout;
  }
  (Ay.prototype = {
    ...
    moveTo: function (t, e) {
      ...
      Ty(i, this._zr, this._appendToBody, t, e);
      var n = this.el.style;
    ...
    hideLater: function (t) {
      !this._show ||
        ...
        (t
          ? ((this._hideDelay = t),
            (this._show = !1),
            (this._hideTimeout = setTimeout(C(this.hide, this), t)))
          : this.hide());
    },
    isShow: function () {
      return this._show;
    ...
    (ky.prototype = {
      ...
      setContent: function (t, e, i) {
        ...
        for (var n = {}, r = t, o = "{marker", a = r.indexOf(o); 0 <= a; ) {
          var s = r.indexOf("|}"),
            l = r.substr(a + o.length, s - a - o.length);
          -1 < l.indexOf("sub")
            ? (n["marker" + l] = {
                textWidth: 4,
                textHeight: 4,
        ...
        this.el.on("mouseover", function () {
          d._enterable && (clearTimeout(d._hideTimeout), (d._show = !0)),
            (d._inContent = !0);
        }),
          this.el.on("mouseout", function () {
            d._enterable && d._show && d.hideLater(d._hideDelay),
              (d._inContent = !1);
          });
      },
      setEnterable: function (t) {
      ...
      moveTo: function (t, e) {
        if (this.el) {
          var i = this._styleCoord;
          Dy(i, this._zr, t, e), this.el.attr("position", [i[0], i[1]]);
        }
      },
      hide: function () {
  ...
  var Py = C,
    Ly = D,
    Oy = Cl,
    zy = new Ja({ shape: { x: -1, y: -1, width: 2, height: 2 } });
  function Ey(t) {
    for (var e = t.pop(); t.length; ) {
      var i = t.pop();
      i &&
        (_l.isInstance(i) && (i = i.get("tooltip", !0)),
        "string" == typeof i && (i = { formatter: i }),
        (e = new _l(i, e, e.ecModel)));
    }
    return e;
  }
  function Ny(t, e) {
  ...
  cf({
      ...
      if (n.from !== this.uid && !v.node) {
        ...
        if (n.tooltip && null != n.x && null != n.y) {
          ...
          (a.position = [n.x, n.y]),
            a.update(),
            (a.tooltip = n.tooltip),
            this._tryShow({ offsetX: n.x, offsetY: n.y, target: a }, r);
        } else if (o)
          this._tryShow(
            {
              offsetX: n.x,
          ...
          null != l &&
            null != h &&
            this._tryShow(
              { offsetX: l, offsetY: h, position: n.position, target: s.el },
              r
            );
        } else
          null != n.x &&
    ...
    manuallyHideTip: function (t, e, i, n) {
      ...
      !this._alwaysShowContent &&
        ...
        n.from !== this.uid && this._hide(Ny(n, i));
    },
    ...
    _showAxisTooltip: function (t, e) {
      ...
      Ly(
        t,
        function (t) {
          Ly(t.dataByAxis, function (s) {
            var l = d.getComponent(s.axisDim + "Axis", s.axisIndex),
              h = s.value,
              u = [];
            if (l && null != h) {
              var c = vy(h, l.axis, d, s.seriesDataIndices, s.valueLabelOpt);
              D(s.seriesDataIndices, function (t) {
                ...
                if (
                  ...
                  (n.axisId = s.axisId),
                  (n.axisValue = Zp(l.axis, h)),
                  (n.axisValueLabel = c),
                  n)
                ) {
                  f.push(n);
                  var r,
                    o = e.formatTooltip(i, !0, null, p);
                  if (N(o)) {
                    r = o.html;
                    var a = o.markers;
                    m(g, a);
      ...
      this._showOrMove(o, function () {
        this._updateContentNotChangedOnAxis(t)
          ? this._updatePosition(o, s, n[0], n[1], this._tooltipContent, f)
    ...
    _showComponentItemTooltip: function (t, e, i) {
      ...
      var r = new _l(n, this._tooltipModel, this._ecModel),
        o = r.get("content"),
        a = Math.random();
    ...
    _showTooltipContent: function (i, t, n, e, r, o, a, s, l) {
      if (((this._ticket = ""), i.get("showContent") && i.get("show"))) {
        var h = this._tooltipContent,
          u = i.get("formatter");
        a = a || i.get("position");
        var c = t;
        if (u && "string" == typeof u) c = ql(u, n, !0);
        else if ("function" == typeof u) {
          var d = Py(function (t, e) {
            t === this._ticket &&
              (h.setContent(e, l, i),
              this._updatePosition(i, a, r, o, h, n, s));
          }, this);
    ...
    _updatePosition: function (t, e, i, n, r, o, a) {
      ...
      if (
        ...
        (i = Oy(e[0], s)), (n = Oy(e[1], l));
      else if (N(e)) {
        (e.width = h[0]), (e.height = h[1]);
        var f = lh(e, { width: s, height: l });
        ...
        var p;
        (i = (p = (function (t, e, i, n, r, o, a) {
          var s = i.getOuterSize(),
            l = s.width,
            h = s.height;
          null != o && (n < t + l + o ? (t -= l + o) : (t += o));
          null != a && (r < e + h + a ? (e -= h + a) : (e += a));
          return [t, e];
        })(i, n, r, s, l, u ? null : 20, c ? null : 20))[0]),
          (n = p[1]);
      }
      u && (i -= Ry(u) ? h[0] / 2 : "right" === u ? h[0] : 0),
        c && (n -= Ry(c) ? h[1] / 2 : "bottom" === c ? h[1] : 0),
        t.get("confine") &&
          ((i = (p = (function (t, e, i, n, r) {
    ...
    dispose: function (t, e) {
      v.node || (this._tooltipContent.dispose(), ay("itemTooltip", e));
    },
  }),
    of(
  ...
  var By = xc.legend.selector,
    Vy = {
      all: { type: "all", title: b(By.all) },
      inverse: { type: "inverse", title: b(By.inverse) },
    },
    Fy = uf({
      type: "legend.plain",
      dependencies: ["series"],
      ...
      mergeOption: function (t) {
        Fy.superCall(this, "mergeOption", t), this._updateSelector(t);
      },
      _updateSelector: function (t) {
        ...
        !0 === i && (i = t.selector = ["all", "inverse"]),
          O(i) &&
            D(i, function (t, e) {
              E(t) && (t = { type: t }), (i[e] = m(t, Vy[t.type]));
            });
      },
      optionUpdated: function () {
      ...
      _updateData: function (r) {
        ...
        r.eachRawSeries(function (t) {
          var e,
            i = t.name;
          if ((a.push(i), t.legendVisualProvider)) {
            var n = t.legendVisualProvider.getAllNames();
            r.isSeriesFiltered(t) || (a = a.concat(n)),
              n.length ? (o = o.concat(n)) : (e = !0);
          } else e = !0;
          e && Br(t) && o.push(t.name);
        }),
      ...
      isSelected: function (t) {
        var e = this.option.selected;
        return (
          !(e.hasOwnProperty(t) && !e[t]) && 0 <= x(this._availableNames, t)
        );
      },
      getOrient: function () {
  ...
  function Hy(t, e, i) {
    ...
    return (
      i.eachComponent("legend", function (n) {
        a && null != r
          ? n[r ? "select" : "unSelect"](e.name)
          : "allSelect" === t || "inverseSelect" === t
          ? n[t]()
          : (n[t](e.name), (r = n.isSelected(e.name))),
  ...
  of("legendToggleSelect", "legendselectchanged", T(Hy, "toggleSelected")),
    of("legendAllSelect", "legendselectall", T(Hy, "allSelect")),
    of("legendInverseSelect", "legendinverseselect", T(Hy, "inverseSelect")),
    of("legendSelect", "legendselected", T(Hy, "select")),
    of("legendUnSelect", "legendunselected", T(Hy, "unSelect"));
  var Gy = T,
    Zy = D,
    Uy = Si,
    Xy = cf({
      ...
      newlineDisabled: !1,
      init: function () {
        this.group.add((this._contentGroup = new Uy())),
          this._backgroundEl,
          this.group.add((this._selectorGroup = new Uy())),
      ...
      render: function (t, e, i) {
        ...
        if (
          ...
          (r && "auto" !== r) ||
            (r =
              "right" === t.get("left") && "vertical" === o ? "right" : "left");
          var a = t.get("selector", !0),
            s = t.get("selectorPosition", !0);
          !a ||
            (s && "auto" !== s) ||
            (s = "horizontal" === o ? "end" : "start"),
            this.renderInner(r, t, e, i, a, o, s);
          var l = t.getBoxLayoutParams(),
            h = { width: i.getWidth(), height: i.getHeight() },
            u = t.get("padding"),
            c = lh(l, h, u),
            d = this.layoutInner(t, r, c, n, a, s),
            f = lh(A({ width: d.width, height: d.height }, l), h, u);
          this.group.attr("position", [f.x - d.x, f.y - d.y]),
            this.group.add((this._backgroundEl = Wy(d, t)));
        }
      },
      resetInner: function () {
              ...
              if (this.newlineDisabled || ("" !== s && "\n" !== s)) {
                ...
                if (!p.get(s))
                  if (t) {
                    ...
                    this._createItem(s, a, o, u, r, l, h, i, n, g)
                      .on("click", Gy(jy, s, null, d, m))
                      .on("mouseover", Gy(qy, t.name, null, d, m))
                      .on("mouseout", Gy($y, t.name, null, d, m)),
                      p.set(s, !0);
                  } else
                    c.eachRawSeries(function (t) {
                      if (!p.get(s) && t.legendVisualProvider) {
                        ...
                        this._createItem(
                          ...
                          .on("click", Gy(jy, null, s, d, m))
                          .on("mouseover", Gy(qy, null, s, d, m))
                          .on("mouseout", Gy($y, null, s, d, m)),
                          p.set(s, !0);
                      }
                    }, this);
              } else f.add(new Uy({ newline: !0 }));
            },
            this
          ),
          t && this._createSelector(t, u, d, e, i);
      },
      _createSelector: function (t, o, a, e, i) {
        ...
        Zy(t, function (t) {
          !(function (t) {
            ...
            s.add(i);
            var n = o.getModel("selectorLabel"),
              r = o.getModel("emphasis.selectorLabel");
            Ys(i.style, (i.hoverStyle = {}), n, r, {
              defaultText: t.title,
              isRectText: !1,
            }),
              Gs(i);
      ...
      _createItem: function (t, e, i, n, r, o, a, s, l, h) {
        var u = n.get("itemWidth"),
          ...
          w = x.parentModel,
          b = ig((r = _ || r), 0, 0, u, c, m ? s : d, null == p || p);
        if (
          (v.add(Yy(b, r, g, l, f, m)), !_ && o && (o !== r || "none" === o))
        ) {
          var S = 0.8 * c;
          "none" === o && (o = "circle");
          var M = ig(
      ...
      layoutInner: function (t, e, i, n, r, o) {
        var a = this.getContentGroup(),
          s = this.getSelectorGroup();
        sh(t.get("orient"), a, t.get("itemGap"), i.width, i.height);
        var l = a.getBoundingRect(),
          h = [-l.x, -l.y];
        if (r) {
          sh("horizontal", s, t.get("selectorItemGap", !0));
          ...
          return (
            (v[p] = l[p] + d + u[p]),
            (v[g] = Math.max(l[g], u[g])),
            (v[m] = Math.min(0, u[m] + c[1 - f])),
            v
          );
        }
  ...
  function Yy(t, e, i, n, r, o) {
    var a;
    return (
      "line" !== e && e.indexOf("empty") < 0
        ? ((a = i.getItemStyle()), (t.style.stroke = n), o || (a.stroke = r))
        : (a = i.getItemStyle(["borderWidth", "borderColor"])),
      t.setStyle(a)
    );
  }
  function jy(t, e, i, n) {
  ...
  rf(gd.PROCESSOR.SERIES_FILTER, function (t) {
    ...
    vh.registerSubTypeDefaulter("legend", function () {
      return "plain";
    });
  var Ky = Fy.extend({
    type: "legend.scroll",
    ...
    init: function (t, e, i, n) {
      var r = ch(t);
      Ky.superCall(this, "init", t, e, i, n), Qy(this, t, r);
    },
    mergeOption: function (t, e) {
      Ky.superCall(this, "mergeOption", t, e), Qy(this, this.option, t);
    },
  });
  function Qy(t, e, i) {
    var n = [1, 1];
    (n[t.getOrient().index] = 0), uh(e, i, { type: "box", ignoreSize: n });
  }
  var Jy = Si,
    t_ = ["width", "height"],
    e_ = ["x", "y"],
    i_ = Xy.extend({
      ...
      newlineDisabled: !0,
      init: function () {
        i_.superCall(this, "init"),
          (this._currentIndex = 0),
          this.group.add((this._containerGroup = new Jy())),
          this._containerGroup.add(this.getContentGroup()),
          this.group.add((this._controllerGroup = new Jy())),
          this._showController;
      },
      resetInner: function () {
        i_.superCall(this, "resetInner"),
          this._controllerGroup.removeAll(),
          this._containerGroup.removeClipPath(),
          (this._containerGroup.__rectSize = null);
      },
      renderInner: function (t, r, e, o, i, n, a) {
        var s = this;
        i_.superCall(this, "renderInner", t, r, e, o, i, n, a);
        ...
        function c(t, e) {
          var i = t + "DataIndex",
            n = hl(
              r.get("pageIcons", !0)[r.getOrient().name][e],
              { onclick: C(s._pageGo, s, i, r, o) },
      ...
      layoutInner: function (t, e, i, n, r, o) {
        var a = this.getSelectorGroup(),
          ...
          u = t_[1 - s],
          c = e_[1 - s];
        r && sh("horizontal", a, t.get("selectorItemGap", !0));
        var d = t.get("selectorButtonGap", !0),
          f = a.getBoundingRect(),
          p = [-f.x, -f.y],
          g = b(i);
        r && (g[l] = i[l] - f[l] - d);
        var m = this._layoutContentAndController(t, n, g, s, l, u, c);
        if (r) {
          if ("end" === o) p[s] += m[l] + d;
          else {
            var v = f[l] + d;
          ...
          (m[l] += f[l] + d),
            (p[1 - s] += m[c] + m[u] / 2 - f[u] / 2),
            (m[u] = Math.max(m[u], f[u])),
            (m[c] = Math.min(m[c], f[c] + p[1 - s])),
            a.attr("position", p);
        }
        return m;
      },
      _layoutContentAndController: function (t, e, i, n, r, o, a) {
        ...
        sh(
          ...
          sh("horizontal", h, t.get("pageButtonItemGap", !0));
        var u = s.getBoundingRect(),
          c = h.getBoundingRect(),
        ...
        var p = [0, 0],
          g = [-c.x, -c.y],
          m = W(t.get("pageButtonGap", !0), t.get("itemGap", !0));
        d &&
        ...
        if (
          ((v[r] = d ? i[r] : u[r]),
          (v[o] = Math.max(u[o], c[o])),
          (v[a] = Math.min(0, c[a] + g[1 - n])),
          (l.__rectSize = i[r]),
          d)
        ) {
          var y = { x: 0, y: 0 };
          (y[r] = Math.max(i[r] - c[r] - m, 0)),
            (y[o] = v[o]),
            l.setClipPath(new Ja({ shape: y })),
            (l.__rectSize = y[r]);
        } else
        ...
        return (
          null != _.pageIndex && il(s, { position: _.contentPosition }, d && t),
      ...
      _updatePageInfoView: function (n, r) {
        ...
        t &&
          ...
          t.setStyle(
            "text",
            E(e)
              ? e.replace("{current}", a).replace("{total}", s)
              : e({ current: a, total: s })
          );
      },
      _getPageInfo: function (t) {
        ...
        for (var p = s + 1, g = f, m = f, v = null; p <= u; ++p)
          ((!(v = y(l[p])) && m.e > g.s + n) || (v && !_(v, g.s))) &&
            (g = m.i > g.i ? m : v) &&
        ...
        function y(t) {
          if (t) {
            var e = t.getBoundingRect(),
              i = e[a] + t.position[r];
            return { s: i, e: i + e[o], i: t.__legendDataIndex };
          }
        }
        function _(t, e) {
  ...
  of("legendScroll", "legendscroll", function (t, e) {
      ...
      render: function (t, e, i) {
        if ((this.group.removeAll(), t.get("show"))) {
          var n = this.group,
            ...
            a = t.get("textAlign"),
            s = W(t.get("textBaseline"), t.get("textVerticalAlign")),
            l = new Ba({
              style: js(
                {},
                r,
  ...
  var a_ = uf({
        ...
        n.eachSeries(function (t) {
          ...
          e && e.data
            ? (i
                ...
                : (r && o_(e),
                  D(e.data, function (t) {
                    t instanceof Array ? (o_(t[0]), o_(t[1])) : o_(t);
                  }),
                  k((i = new o(e, this, n)), {
    ...
    formatTooltip: function (t, e, i, n) {
      var r = this.getData(),
        ...
        a = O(o) ? P(o, n_).join(", ") : n_(o),
        s = r.getName(t),
        l = r_(this.name);
      return (
        (null == o && !s) || (l += "html" === n ? "<br/>" : "\n"),
        s && ((l += r_(s)), null != o && (l += " : ")),
        null != o && (l += r_(a)),
        l
      );
  ...
  var s_ = x;
  function l_(t, e, i, n, r, o) {
    var a = [],
      s = $f(e, n) ? e.getCalculationInfo("stackResultDimension") : n,
      l = g_(e, s, t),
      h = e.indicesOfNearest(s, l)[0];
    (a[r] = e.get(i, h)), (a[o] = e.get(s, h));
    var u = e.get(n, h),
      c = Dl(e.get(n, h));
    return 0 <= (c = Math.min(c, 20)) && (a[o] = +a[o].toFixed(c)), [a, u];
  }
  var h_ = T,
    u_ = { min: h_(l_, "min"), max: h_(l_, "max"), average: h_(l_, "average") };
  function c_(t, e) {
    var i = t.getData(),
    ...
    if (
      ...
      var r = n.dimensions,
        o = d_(e, i, n, t);
      if ((e = b(e)).type && u_[e.type] && o.baseAxis && o.valueAxis) {
        var a = s_(r, o.baseAxis.dim),
          s = s_(r, o.valueAxis.dim),
          l = u_[e.type](i, o.baseDataDim, o.valueDataDim, a, s);
        ...
        for (
          ...
          u_[h[u]] && (h[u] = g_(i, i.mapDimension(r[u]), h[u]));
        e.coord = h;
      }
    }
    return e;
    ...
    return (
      null != t.valueIndex || null != t.valueDim
        ? ((r.valueDataDim =
          ...
          (r.valueAxis = i.getAxis(
            (function (t, e) {
              var i = t.getData(),
                n = i.dimensions;
              e = i.getDimension(e);
              for (var r = 0; r < n.length; r++) {
                var o = i.getDimensionInfo(n[r]);
  ...
  function v_(s, l, h) {
    ...
    s.each(function (t) {
      var e,
        i = s.getItemModel(t),
        n = Cl(i.get("x"), h.getWidth()),
        r = Cl(i.get("y"), h.getHeight());
      if (isNaN(n) || isNaN(r)) {
        if (l.getMarkerPosition)
          e = l.getMarkerPosition(s.getValues(s.dimensions, t));
        else if (u) {
          var o = s.get(u.dimensions[0], t),
            a = s.get(u.dimensions[1], t);
          e = u.dataToPoint([o, a]);
        }
      } else e = [n, r];
  ...
  m_.extend({
    ...
    renderSeries: function (t, u, e, i) {
      var n = t.coordinateSystem,
        r = t.id,
        c = t.getData(),
        o = this.markerGroupMap,
        a = o.get(r) || o.set(r, new Rg()),
        d = (function (t, e, i) {
          var n;
          n = t
      ...
      u.setData(d),
        ...
        d.each(function (t) {
          var e = d.getItemModel(t),
            ...
            s = z(r);
          if (o || a || s) {
            var l = u.getRawValue(t),
              h = u.getDataParams(t);
            o && (i = i(l, h)), a && (n = n(l, h)), s && (r = r(l, h));
          }
          d.setItemVisual(t, {
            symbol: i,
            symbolSize: n,
            symbolRotate: r,
            color: e.get("itemStyle.color") || c.getVisual("color"),
          });
        }),
        a.updateData(d),
        ...
        (a.__keep = !0),
        (a.group.silent = u.get("silent") || t.get("silent"));
    },
  }),
    nf(function (t) {
  ...
  var w_ = ws({
      ...
      buildPath: function (t, e) {
        this[x_(e) ? "_buildPathLine" : "_buildPathCurve"](t, e);
      },
      _buildPathLine: y_.buildPath,
      _buildPathCurve: __.buildPath,
      pointAt: function (t) {
        return this[x_(this.shape) ? "_pointAtLine" : "_pointAtCurve"](t);
      },
      _pointAtLine: y_.pointAt,
      _pointAtCurve: __.pointAt,
      tangentAt: function (t) {
        var e = this.shape,
          i = x_(e) ? [e.x2 - e.x1, e.y2 - e.y1] : this._tangentAtCurve(t);
        return ft(i, i);
      },
      _tangentAtCurve: __.tangentAt,
    }),
    b_ = ["fromSymbol", "toSymbol"];
  function S_(t) {
    return "_" + t + "Type";
  }
  function M_(t, e, i) {
    ...
    if (n && "none" !== n) {
      var r = e.getItemVisual(i, "color"),
        ...
        a = e.getItemVisual(i, t + "Rotate");
      O(o) || (o = [o, o]);
      var s = ig(n, -o[0] / 2, -o[1] / 2, o[0], o[1], r);
      return (
        (s.__specifiedRotation =
  ...
  function C_(t, e, i) {
    Si.call(this), this._createLine(t, e, i);
  }
  var T_ = C_.prototype;
  function A_(t) {
    (this._ctor = t || C_), (this.group = new Si());
  }
  (T_.beforeUpdate = function () {
    var t = this.childOfName("fromSymbol"),
      e = this.childOfName("toSymbol"),
      i = this.childOfName("label");
    if (t || e || !i.ignore) {
      for (var n = 1, r = this.parent; r; )
        r.scale && (n /= r.scale[0]), (r = r.parent);
      ...
      if (this.__dirty || o.__dirty) {
        ...
        if ((ft(h, h), t)) {
          if ((t.attr("position", s), null == (c = t.__specifiedRotation))) {
            var u = o.tangentAt(0);
            t.attr("rotation", Math.PI / 2 - Math.atan2(u[1], u[0]));
          } else t.attr("rotation", c);
          t.attr("scale", [n * a, n * a]);
        }
        if (e) {
          var c;
          if ((e.attr("position", l), null == (c = e.__specifiedRotation))) {
            u = o.tangentAt(1);
            e.attr("rotation", -Math.PI / 2 - Math.atan2(u[1], u[0]));
          } else e.attr("rotation", c);
          e.attr("scale", [n * a, n * a]);
        }
        if (!i.ignore) {
          var d, f, p, g;
          i.attr("position", l);
          var m = i.__labelDistance,
            v = m[0] * n,
            y = m[1] * n,
            _ = a / 2,
            x = [(u = o.tangentAt(_))[1], -u[0]],
            w = o.pointAt(_);
          0 < x[1] && ((x[0] = -x[0]), (x[1] = -x[1]));
          var b,
            S = u[0] < 0 ? -1 : 1;
          if ("start" !== i.__position && "end" !== i.__position) {
            var M = -Math.atan2(u[1], u[0]);
            l[0] < s[0] && (M = Math.PI + M), i.attr("rotation", M);
          }
          switch (i.__position) {
            case "insideStartTop":
          ...
          switch (i.__position) {
            case "end":
              (d = [h[0] * v + l[0], h[1] * y + l[1]]),
                (f = 0.8 < h[0] ? "left" : h[0] < -0.8 ? "right" : "center"),
                (p = 0.8 < h[1] ? "top" : h[1] < -0.8 ? "bottom" : "middle");
              break;
            case "start":
              (d = [-h[0] * v + s[0], -h[1] * y + s[1]]),
                (f = 0.8 < h[0] ? "right" : h[0] < -0.8 ? "left" : "center"),
                (p = 0.8 < h[1] ? "bottom" : h[1] < -0.8 ? "top" : "middle");
              break;
            case "insideStartTop":
            case "insideStart":
            case "insideStartBottom":
    ...
    (T_._createLine = function (i, n, t) {
      var e = i.hostModel,
        r = (function (t) {
          var e = new w_({ name: "line", subPixelOptimize: !0 });
          return I_(e.shape, t), e;
        })(i.getItemLayout(n));
      (r.shape.percent = 0),
        nl(r, { shape: { percent: 1 } }, e, n),
        this.add(r);
      var o = new Ba({ name: "label", lineLabelOriginalOpacity: 1 });
      this.add(o),
        D(
          b_,
          function (t) {
            var e = M_(t, i, n);
            this.add(e), (this[S_(t)] = i.getItemVisual(n, t));
          },
          this
        ),
        this._updateCommonStl(i, n, t);
    }),
    (T_.updateData = function (r, o, t) {
      var e = r.hostModel,
      ...
      I_(a.shape, n),
        ...
        this._updateCommonStl(r, o, t);
    }),
    (T_._updateCommonStl = function (t, e, i) {
      var n = t.hostModel,
      ...
      if (!i || t.hasItemOption) {
        ...
        (o = h.getModel("lineStyle").getLineStyle()),
          ...
          (s = h.getModel("label")),
          (l = h.getModel("emphasis.label"));
      }
      var u = t.getItemVisual(e, "color"),
        c = G(t.getItemVisual(e, "opacity"), o.opacity, 1);
      r.useStyle(
        A({ strokeNoScale: !0, fill: "none", stroke: u, opacity: c }, o)
      ),
        (r.hoverStyle = a),
        D(
          b_,
      ...
      if (
        ...
        f = null == v ? t.getName(e) : isFinite(v) ? Tl(v) : v;
      }
      var y = p ? f : null,
        _ = g ? W(n.getFormattedLabel(e, "emphasis", t.dataType), f) : null,
        x = m.style;
      if (null != y || null != _) {
        js(m.style, s, { text: y }, { autoColor: d }),
          (m.__textAlign = x.textAlign),
          (m.__verticalAlign = x.textVerticalAlign),
          (m.__position = s.get("position") || "middle");
        var w = s.get("distance");
        O(w) || (w = [w, w]), (m.__labelDistance = w);
      }
      (m.hoverStyle =
        null != _
          ? {
    ...
    (T_.highlight = function () {
      this.trigger("emphasis");
    }),
    (T_.downplay = function () {
      this.trigger("normal");
    }),
    (T_.updateLayout = function (t, e) {
      this.setLinePoints(t.getItemLayout(e));
    }),
    (T_.setLinePoints = function (t) {
      var e = this.childOfName("line");
      I_(e.shape, t), e.dirty();
    }),
    w(C_, Si);
  var D_ = A_.prototype;
  function k_(t) {
  ...
  function L_(t) {
    return !P_(t[0]) && !P_(t[1]);
  }
  (D_.isPersistent = function () {
    return !0;
  }),
    (D_.updateData = function (i) {
      var n = this,
        e = n.group,
        r = n._lineData;
      ...
      i.diff(r)
        .add(function (t) {
          !(function (t, e, i, n) {
            if (!L_(e.getItemLayout(i))) return;
        ...
        .update(function (t, e) {
          !(function (t, e, i, n, r, o) {
            ...
            if (!L_(i.getItemLayout(r))) return t.group.remove(a);
            a ? a.updateData(i, r, o) : (a = new t._ctor(i, r, o));
            i.setItemGraphicEl(r, a), t.group.add(a);
          })(n, r, i, e, t, o);
        })
        .remove(function (t) {
    ...
    (D_.incrementalPrepareUpdate = function (t) {
      (this._seriesScope = k_(t)),
        (this._lineData = null),
        this.group.removeAll();
    }),
    (D_.incrementalUpdate = function (t, e) {
      function i(t) {
        t.isGroup ||
          (function (t) {
  ...
  function O_(t, e, i, n) {
    ...
    if (
      ...
      if (null != n.yAxis || null != n.xAxis)
        (a = e.getAxis(null != n.yAxis ? "y" : "x")), (s = H(n.yAxis, n.xAxis));
      else {
        var l = d_(n, r, e, t);
        (a = l.valueAxis), (s = g_(r, Kf(r, l.valueDataDim), o));
      }
      var h = "x" === a.dim ? 0 : 1,
        u = 1 - h,
        c = b(n),
      ...
      0 <= f && "number" == typeof s && (s = +s.toFixed(Math.min(f, 20))),
        (c.coord[h] = d.coord[h] = s),
        (n = [c, d, { type: o, valueIndex: n.valueIndex, value: s }]);
    }
    return (
      ((n = [c_(t, n[0]), c_(t, n[1]), k({}, n[2])])[2].type = n[2].type || ""),
      m(n[2], n[0]),
      m(n[2], n[1]),
      n
    );
  ...
  function E_(t, e, i, n) {
    var r = 1 - t,
      o = n.dimensions[t];
    return (
      z_(e[r]) && z_(i[r]) && e[t] === i[t] && n.getAxis(o).containData(e[t])
    );
  }
  function N_(t, e) {
    if ("cartesian2d" === t.type) {
      var i = e[0].coord,
        n = e[1].coord;
      if (i && n && (E_(1, i, n, t) || E_(0, i, n, t))) return !0;
    }
    return f_(t, e[0]) && f_(t, e[1]);
  }
  function R_(t, e, i, n, r) {
    var o,
      a = n.coordinateSystem,
      s = t.getItemModel(e),
      l = Cl(s.get("x"), r.getWidth()),
      h = Cl(s.get("y"), r.getHeight());
    if (isNaN(l) || isNaN(h)) {
      if (n.getMarkerPosition)
        o = n.getMarkerPosition(t.getValues(t.dimensions, e));
      else {
        var u = a.dimensions,
          c = t.get(u[0], e),
          d = t.get(u[1], e);
      ...
      if ("cartesian2d" === a.type) {
        ...
        u = a.dimensions;
        z_(t.get(u[0], e))
          ? (o[0] = f.toGlobalCoord(f.getExtent()[i ? 0 : 1]))
          : z_(t.get(u[1], e)) &&
            (o[1] = p.toGlobalCoord(p.getExtent()[i ? 0 : 1]));
      }
  ...
  m_.extend({
    ...
    renderSeries: function (r, i, t, o) {
      var e = r.coordinateSystem,
        n = r.id,
        a = r.getData(),
        s = this.markerGroupMap,
        l = s.get(n) || s.set(n, new A_());
      ...
      O(f) || (f = [f, f]),
        ...
        d.each(function (t) {
          ...
          d.setItemVisual(t, { color: e || u.getItemVisual(t, "color") }),
            d.setItemLayout(t, [u.getItemLayout(t), c.getItemLayout(t)]),
            d.setItemVisual(t, {
              fromSymbolRotate: u.getItemVisual(t, "symbolRotate"),
        ...
        l.updateData(d),
        h.line.eachItemGraphicEl(function (t, e) {
          t.traverse(function (t) {
            t.dataModel = i;
          });
        }),
        (l.__keep = !0),
        (l.group.silent = i.get("silent") || r.get("silent"));
    },
  }),
    nf(function (t) {
  ...
  function H_(t, e) {
    ...
    return (
      ...
      f_(t, { coord: i, x: e.x0, y: e.y0 }) ||
      f_(t, { coord: n, x: e.x1, y: e.y1 })
    );
  }
  function W_(t, e, i, n, r) {
    var o,
      a = n.coordinateSystem,
      s = t.getItemModel(e),
      l = Cl(s.get(i[0]), r.getWidth()),
      h = Cl(s.get(i[1]), r.getHeight());
    if (isNaN(l) || isNaN(h)) {
      if (n.getMarkerPosition) o = n.getMarkerPosition(t.getValues(i, e));
      else {
      ...
      if ("cartesian2d" === a.type) {
        var c = a.getAxis("x"),
          ...
          p = t.get(i[1], e);
        V_(f)
          ? (o[0] = c.toGlobalCoord(c.getExtent()["x0" === i[0] ? 0 : 1]))
          : V_(p) &&
            (o[1] = d.toGlobalCoord(d.getExtent()["y0" === i[1] ? 0 : 1]));
      }
      isNaN(l) || (o[0] = l), isNaN(h) || (o[1] = h);
    } else o = [l, h];
    return o;
  ...
  m_.extend({
    ...
    renderSeries: function (e, a, t, i) {
      var o = e.coordinateSystem,
        n = e.id,
        s = e.getData(),
        r = this.markerGroupMap,
        l = r.get(n) || r.set(n, { group: new Si() });
      ...
      var h = (function (t, i, e) {
        ...
        r = t
          ? ((n = P(t && t.dimensions, function (t) {
            ...
            new kf(
              P(["x0", "y0", "x1", "y1"], function (t, e) {
                return { name: t, type: n[e % 2].type };
              }),
              e
            ))
          : new kf((n = [{ name: "value", type: "float" }]), e);
        var o = P(e.get("data"), T(B_, i, t, e));
        t && (o = I(o, T(H_, t)));
        var a = t
          ? function (t, e, i, n) {
      ...
      a.setData(h),
        h.each(function (n) {
          ...
          D(G_, function (t) {
            if (r) {
              var e = h.get(t[0], n),
                i = h.get(t[1], n);
              (V_(e) || o.getAxis("x").containData(e)) &&
                (V_(i) || o.getAxis("y").containData(i)) &&
                (r = !1);
            }
          }),
            h.setItemLayout(n, { points: t, allClipped: r }),
            h.setItemVisual(n, { color: s.getVisual("color") });
        }),
        h
          .diff(l.__data)
          .add(function (t) {
            ...
            if (!e.allClipped) {
              var i = new Xa({ shape: { points: e.points } });
              h.setItemGraphicEl(t, i), l.group.add(i);
            }
          })
          .update(function (t, e) {
            ...
            n.allClipped
              ? i && l.group.remove(i)
              : (i
                  ? il(i, { shape: { points: n.points } }, a, t)
                  : (i = new Xa({ shape: { points: n.points } })),
        ...
        (l.__data = h),
        (l.group.silent = a.get("silent") || e.get("silent"));
    },
  }),
    nf(function (t) {
      t.markArea = t.markArea || {};
    }),
    vh.registerSubTypeDefaulter("dataZoom", function () {
      return "slider";
    });
  var Z_ = ["cartesian2d", "polar", "singleAxis"];
  var U_,
    X_,
    Y_,
    j_,
    q_ =
      ((X_ = ["axisIndex", "axis", "index", "id"]),
      (Y_ = P(
        (U_ = (U_ = ["x", "y", "z", "radius", "angle", "single"]).slice()),
        Jl
      )),
      (j_ = P((X_ = (X_ || []).slice()), Jl)),
      function (r, o) {
        D(U_, function (t, e) {
          for (var i = { name: t, capital: Y_[e] }, n = 0; n < X_.length; n++)
            i[X_[n]] = t + j_[n];
          r.call(o, i);
        });
      });
  ...
  function K_(t, e, i, n, r, o) {
    ...
    if (
      ...
      (r = o = J_((s = J_(s, [0, a])), [r, o])), (n = 0);
    }
    (e[0] = J_(e[0], i)), (e[1] = J_(e[1], i));
    var l = Q_(e, n);
    e[n] += t;
    var h = r || 0,
      u = i.slice();
    l.sign < 0 ? (u[0] += h) : (u[1] -= h), (e[n] = J_(e[n], u));
    var c = Q_(e, n);
    return (
      null != r &&
        ...
        (e[1 - n] = e[n] + l.sign * r),
      (c = Q_(e, n)),
      null != o && c.span > o && (e[1 - n] = e[n] + c.sign * o),
      e
    );
  }
  function Q_(t, e) {
  ...
  tx.prototype = {
    ...
    calculateDataWindow: function (r) {
      var o,
        ...
        u = [],
        c = [];
      ex(["start", "end"], function (t, e) {
        var i = r[t],
          n = r[t + "Value"];
        "percent" === l[e]
          ? (null == i && (i = h[e]), (n = s.parse(Il(i, h, a))))
          : ((o = !0), (i = Il((n = null == n ? a[e] : s.parse(n)), a, h))),
          (c[e] = n),
          (u[e] = i);
      }),
        ix(c),
      ...
      function t(t, e, i, n, r) {
        ...
        K_(0, t, i, "all", d["min" + o], d["max" + o]);
        for (var a = 0; a < 2; a++)
          (e[a] = Il(t[a], i, n, !0)), r && (e[a] = s.parse(e[a]));
      }
      return (
        o ? t(c, u, a, h, !1) : t(u, c, h, a, !0),
        { valueWindow: c, percentWindow: u }
      );
    },
    reset: function (t) {
      if (t === this._dataZoomModel) {
        ...
        (this._dataExtent = (function (t, e, i) {
          ...
          ex(i, function (t) {
            var i = t.getData();
            i &&
              ex(i.mapDimension(e, !0), function (t) {
          ...
          (function (n) {
            var r = (n._minMaxSpan = {}),
              o = n._dataZoomModel,
              a = n._dataExtent;
            ex(["min", "max"], function (t) {
              var e = o.get(t + "Span"),
                i = o.get(t + "ValueSpan");
              null != i && (i = n.getAxisModel().axis.scale.parse(i)),
                null != i
                  ? (e = Il(a[0] + i, a, [0, 100], !0))
                  : null != e && (i = Il(e, [0, 100], a, !0) - a[0]),
                (r[t + "Span"] = e),
                (r[t + "ValueSpan"] = i);
            });
          })(this);
    ...
    restore: function (t) {
      t === this._dataZoomModel &&
        ((this._valueWindow = this._percentWindow = null), nx(this, !0));
    },
  ...
  var rx = D,
    ...
    ax = uf({
      ...
      _giveAxisProxies: function () {
        var a = this._axisProxies;
        this.eachTargetAxis(function (t, e, i, n) {
          var r = this.dependentModels[t.axis][e],
            o =
              r.__dzAxisProxy || (r.__dzAxisProxy = new tx(t.name, e, this, n));
          a[t.name + "_" + e] = o;
        }, this);
      },
      ...
      _autoSetAxisIndex: function () {
        ...
        if (o) {
          ...
          t[i + "Axis"].length
            ? ((a[i + "AxisIndex"] = [0]), (o = !1))
            : rx(t.singleAxis, function (t) {
                o &&
                  t.get("orient", !0) === e &&
                  ((a.singleAxisIndex = [t.componentIndex]), (o = !1));
              });
        }
        o &&
          ox(function (t) {
            if (o) {
              ...
              (a[t.axisIndex] = e).length && (o = !1);
            }
          }, this),
          o &&
            this.ecModel.eachSeries(function (r) {
              this._isSeriesHasAllAxesTypeOf(r, "value") &&
                ox(function (t) {
                  var e = a[t.axisIndex],
                    i = r.get(t.axisIndex),
                    n = r.get(t.axisId);
      ...
      setCalculatedRange: function (e) {
        var i = this.option;
        rx(["start", "startValue", "end", "endValue"], function (t) {
          i[t] = e[t];
        });
      },
  ...
  function sx(e) {
    var i = {};
    return (
      rx(["start", "end", "startValue", "endValue", "throttle"], function (t) {
  ...
  var hx = ec.extend({
            ...
            if (i) {
              ...
              n &&
                (function (t, e, i, n) {
                  ...
                  r ||
                    i.push((r = { model: t, axisModels: [], coordIndex: n }));
                  r.axisModels.push(e);
                })(
                  n,
                  i,
                  o[n.mainType] || (o[n.mainType] = []),
                  n.componentIndex
                );
            }
          }, this),
    ...
    gx = "horizontal",
    mx = "vertical",
    vx = ["line", "bar", "candlestick", "scatter"],
    yx = hx.extend({
      type: "dataZoom.slider",
      init: function (t, e) {
        (this._displayables = {}),
      ...
      render: function (t, e, i, n) {
        yx.superApply(this, "render", arguments),
          vc(
            this,
            "_dispatchZoomAction",
      ...
      remove: function () {
        yx.superApply(this, "remove", arguments),
          yc(this, "_dispatchZoomAction");
      },
      dispose: function () {
        yx.superApply(this, "dispose", arguments),
          yc(this, "_dispatchZoomAction");
      },
      _buildView: function () {
        var t = this.group;
        t.removeAll(), this._resetLocation(), this._resetInterval();
        var e = (this._displayables.barGroup = new Si());
      ...
      _resetLocation: function () {
        ...
        var a = lh(o, n, t.padding);
        (this._location = { x: a.x, y: a.y }),
          (this._size = [a.width, a.height]),
          this._orient === mx && this._size.reverse();
      },
          ...
          return (
            t.eachTargetAxis(function (o, a) {
              D(
                ...
                function (t) {
                  if (!(l || (!0 !== s && x(vx, t.get("type")) < 0))) {
                    var e,
                      i = h.getComponent(o.axis, a).axis,
                      n = (function (t) {
                        return {
                          x: "y",
                          y: "x",
      ...
      _renderHandle: function () {
        ...
        s.add(
          (t.filler = new ux({
            draggable: !0,
            cursor: _x(this._orient),
            drift: fx(this._onDragMove, this, "all"),
            ondragstart: fx(this._showDataInfo, this, !0),
            ondragend: fx(this._onDragEnd, this),
            onmouseover: fx(this._showDataInfo, this, !0),
            onmouseout: fx(this._showDataInfo, this, !1),
            ...
            function (t) {
              var e = hl(
                  l.get("handleIcon"),
                  {
                    cursor: _x(this._orient),
                    draggable: !0,
                    drift: fx(this._onDragMove, this, t),
                    ondragend: fx(this._onDragEnd, this),
                    onmouseover: fx(this._showDataInfo, this, !0),
                    onmouseout: fx(this._showDataInfo, this, !1),
                  },
                ...
                i = e.getBoundingRect();
              (this._handleHeight = Cl(l.get("handleSize"), this._size[1])),
      ...
      _updateInterval: function (t, e) {
        ...
        K_(
          ...
          null != o.minSpan ? cx(o.minSpan, a, r, !0) : null,
          null != o.maxSpan ? cx(o.maxSpan, a, r, !0) : null
        );
        var s = this._range,
          l = (this._range = dx([cx(n[0], r, a, !0), cx(n[1], r, a, !0)]));
        ...
        if (e.get("showDetail")) {
          ...
          if (i) {
            var n = i.getAxisModel().axis,
              r = this._range,
              h = t
                ? i.calculateDataWindow({ start: r[0], end: r[1] }).valueWindow
                : i.getDataValueWindow();
            l = [this._formatLabel(h[0], n), this._formatLabel(h[1], n)];
          }
        }
        var u = dx(this._handleEnds.slice());
        function c(t) {
          var e = rl(o.handles[t].parent, this.group),
            i = al(0 === t ? "right" : "left", e),
            n = this._handleWidth / 2 + 5,
            r = ol([u[t] + (0 === t ? -n : n), this._size[1] / 2], e);
          a[t].setStyle({
            x: r[0],
            y: r[1],
            textVerticalAlign: s === gx ? "middle" : i,
            textAlign: s === gx ? i : "center",
            text: l[t],
          });
        }
      ...
      _formatLabel: function (t, e) {
        ...
        return z(n) ? n(t, o) : E(n) ? n.replace("{value}", o) : o;
      },
      ...
      _onDragMove: function (t, e, i, n) {
        (this._dragging = !0), Wt(n.event);
        var r = ol([e, i], this._displayables.barGroup.getLocalTransform(), !0),
      ...
      _onClickPanelClick: function (t) {
        ...
        if (!(i[0] < 0 || i[0] > e[0] || i[1] < 0 || i[1] > e[1])) {
          var n = this._handleEnds,
            r = (n[0] + n[1]) / 2,
            o = this._updateInterval("all", i[0] - r);
      ...
      _findCoordRect: function () {
        var i;
        if (
          (px(this.getTargetCoordInfo(), function (t) {
            if (!i && t.length) {
  ...
  rf({
    ...
    of("dataZoom", function (i, t) {
      var n = $_(C(t.eachComponent, t, "dataZoom"), q_, function (t, e) {
    ...
    It.call(this),
      ...
      (this.enable = function (t, e) {
        this.disable(),
          ...
          null == t && (t = !0),
          (!0 !== t && "move" !== t && "pan" !== t) ||
            (i.on("mousedown", n), i.on("mousemove", r), i.on("mouseup", o)),
          (!0 !== t && "scale" !== t && "zoom" !== t) ||
            (i.on("mousewheel", a), i.on("pinch", s));
      }),
  ...
  function Ix(t) {
    if (!(Gt(t) || (t.target && t.target.draggable))) {
      var e = t.offsetX,
        i = t.offsetY;
      this.pointerChecker &&
  ...
  function Cx(t) {
    if (
      this._dragging &&
      Lx("moveOnMouseMove", t, this._opt) &&
      "pinch" !== t.gestureEvent &&
      !bx(this._zr, "globalPan")
    ) {
      var e = t.offsetX,
        i = t.offsetY,
        n = this._x,
      ...
      (this._x = e),
        (this._y = i),
        this._opt.preventDefaultMouseMove && Wt(t.event),
        Px(this, "pan", "moveOnMouseMove", t, {
          dx: o,
          dy: a,
          oldX: n,
          oldY: r,
  ...
  function Tx(t) {
    Gt(t) || (this._dragging = !1);
  }
  function Ax(t) {
    var e = Lx("zoomOnMouseWheel", t, this._opt),
      i = Lx("moveOnMouseWheel", t, this._opt),
      n = t.wheelDelta,
      r = Math.abs(n),
      o = t.offsetX,
      a = t.offsetY;
    if (0 !== n && (e || i)) {
      if (e) {
        ...
        kx(this, "zoom", "zoomOnMouseWheel", t, {
          scale: 0 < n ? s : 1 / s,
          originX: o,
          originY: a,
        });
      ...
      if (i) {
        var l = Math.abs(n);
        kx(this, "scrollMove", "moveOnMouseWheel", t, {
  ...
  function kx(t, e, i, n, r) {
    t.pointerChecker &&
      t.pointerChecker(n, r.originX, r.originY) &&
      (Wt(n.event), Px(t, e, i, n, r));
  }
  function Px(t, e, i, n, r) {
    (r.isAvailableBehavior = C(Lx, null, i, n)), t.trigger(e, r);
  }
  function Lx(t, e, i) {
    var n = i[t];
  ...
  function zx(t, n) {
    ...
    D(e, function (t, e) {
      ...
      i[r] && x(n.allCoordIds, o) < 0 && (delete i[r], t.count--);
    }),
      Rx(e);
    var i = e[o];
    i ||
      (((i = e[o] = {
        ...
        dataZoomInfos: {},
        count: 0,
      }).controller = (function (t, a) {
        var e = new Mx(t.getZr());
        return (
          D(["pan", "zoom", "scrollMove"], function (o) {
            e.on(o, function (n) {
              var r = [];
              D(a.dataZoomInfos, function (t) {
                if (n.isAvailableBehavior(t.dataZoomModel.option)) {
                  var e = (t.getRange || {})[o],
                    i = e && e(a.controller, n);
                ...
                r.length && a.dispatchAction(r);
            });
          }),
          e
        );
      })(t, i)),
      (i.dispatchAction = T(Bx, t))),
      i.dataZoomInfos[r] || i.count++,
      (i.dataZoomInfos[r] = n);
    var a = (function (t) {
      var n,
      ...
      return (
        D(t, function (t) {
          ...
          r["type_" + n] < r["type_" + i] && (n = i),
            (o &= e.get("preventDefaultMouseMove", !0));
        }),
        {
          controlType: n,
          opt: {
    ...
    i.controller.enable(a.controlType, a.opt),
      i.controller.setPointerChecker(n.containsPoint),
      vc(i, "dispatchAction", n.dataZoomModel.get("throttle", !0), "fixRate");
  }
  function Ex(t) {
  ...
  var Vx = C,
    Fx = hx.extend({
      ...
      render: function (a, t, s, e) {
        Fx.superApply(this, "render", arguments),
          (this._range = a.getPercentRange()),
          D(
      ...
      dispose: function () {
        !(function (t, i) {
          ...
          Fx.superApply(this, "dispose", arguments),
          (this._range = null);
      },
    }),
    Hx = {
      zoom: function (t, e, i, n) {
        var r = this._range,
          ...
          a = t.axisModels[0];
        if (a) {
          var s = Gx[e](null, [n.originX, n.originY], a, i, t),
            l =
              ((0 < s.signal
          ...
          var u = this.dataZoomModel
            ...
            .getMinMaxSpan();
          return (
            K_(0, o, [0, 100], 0, u.minSpan, u.maxSpan),
            (this._range = o),
            r[0] !== o[0] || r[1] !== o[1] ? o : void 0
          );
        }
      },
      pan: Wx(function (t, e, i, n, r, o) {
        var a = Gx[n]([o.oldX, o.oldY], [o.newX, o.newY], e, r, i);
        return (a.signal * (t[1] - t[0]) * a.pixel) / a.pixelLength;
      }),
      scrollMove: Wx(function (t, e, i, n, r, o) {
        return (
          Gx[n]([0, 0], [o.scrollDelta, o.scrollDelta], e, r, i).signal *
          (t[1] - t[0]) *
          o.scrollDelta
        );
      }),
  ...
  var Yx = uf({
    ...
    layoutMode: { type: "box", ignoreSize: !0 },
    optionUpdated: function () {
      Yx.superApply(this, "optionUpdated", arguments),
        ...
        D(h, function (t, e) {
          ...
          (function (t, e, i) {
            var n = e.getBoxLayoutParams(),
              ...
              a = lh(n, o, r);
            sh(e.get("orient"), t, e.get("itemGap"), a.width, a.height),
              hh(t, n, o, r);
          })(f, u, d),
          f.add(Wy(f.getBoundingRect(), u)),
          f.eachChild(function (t) {
            ...
            if (i && e) {
              ...
              t.position[1] + f.position[1] + p + n.height > d.getHeight() &&
                ((i.textPosition = "top"), (o = !0));
              var a = o ? -5 - n.height : p + 8;
              r + n.width / 2 > d.getWidth()
                ? ((i.textPosition = ["100%", a]), (i.textAlign = "right"))
                : r - n.width / 2 < 0 &&
                  ((i.textPosition = [0, a]), (i.textAlign = "left"));
            }
          });
      }
      function t(t, e) {
        ...
        if (
          ...
          if (
            ...
            i = { model: a, onclick: a.option.onclick, featureName: n };
          else {
            var s = Xx(n);
            if (!s) return;
            i = new s(a, c, d);
        ...
        n || !r
          ? a.get("show") && !i.unusable
            ? ((function (r, o, t) {
                var a = r.getModel("iconStyle"),
                  s = r.getModel("emphasis.iconStyle"),
                  e = o.getIcons ? o.getIcons() : r.get("icon"),
                  l = r.get("title") || {};
                if ("string" == typeof e) {
                  var i = e,
                    n = l;
                ...
                D(e, function (t, e) {
                  ...
                  n &&
                    ...
                    i.trigger(r.get("iconStatus." + e) || "normal"),
                    f.add(i),
                    i.on("click", C(o.onclick, o, c, d, e)),
                    (h[e] = i);
                });
              })(a, i, n),
              (a.setIconStatus = function (t, e) {
                var i = this.option,
                  n = this.iconPaths;
  ...
  (qx.defaultOption = {
    ...
    (qx.prototype.unusable = !v.canvasSupported),
    (qx.prototype.onclick = function (t, e) {
      var i = this.model,
      ...
      if ("function" != typeof MouseEvent || v.browser.ie || v.browser.edge)
        if (window.navigator.msSaveOrOpenBlob) {
          for (
            var a = atob(o.split(",")[1]), s = a.length, l = new Uint8Array(s);
            s--;
        ...
        (d.download = n + "." + r), (d.target = "_blank"), (d.href = o);
    ...
    Ux("saveAsImage", qx);
  var $x = xc.toolbox.magicType,
    Kx = "__ec_magicType_stack__";
  function Qx(t) {
    this.model = t;
  }
  Qx.defaultOption = {
  ...
  var Jx = Qx.prototype;
  Jx.getIcons = function () {
    var t = this.model,
      e = t.get("icon"),
      i = {};
    return (
      D(t.get("type"), function (t) {
        e[t] && (i[t] = e[t]);
      }),
      i
    );
  ...
  var tw = {
      ...
      stack: function (t, e, i, n) {
        var r = i.get("stack") === Kx;
        if ("line" === t || "bar" === t)
          return (
            n.setIconStatus("stack", r ? "normal" : "emphasis"),
            m({ id: e, stack: r ? "" : Kx }, n.get("option.stack") || {}, !0)
          );
      },
    },
    ew = [["line", "bar"], ["stack"]];
  (Jx.onclick = function (h, t, u) {
    var c = this.model,
    ...
    if (tw[u]) {
      ...
      if (
        ...
        h.eachComponent(
          ...
          function (t) {
            var e = t.subType,
              i = t.id,
              n = tw[u](e, i, t, c);
            n && (A(n, t.option), d.series.push(n));
            ...
            if (
              ...
              if (o) {
                ...
                d[a] = d[a] || [];
                for (var l = 0; l <= s; l++) d[a][s] = d[a][s] || {};
                d[a][s].boundaryGap = "bar" === u;
              }
            }
          }
        ),
        ...
        i =
          d.series && d.series[0] && d.series[0].stack === Kx
            ? m({ stack: $x.title.tiled }, $x.title)
            : b($x.title);
      t.dispatchAction({
    ...
    Ux("magicType", Qx);
  var iw = xc.toolbox.dataView,
    nw = new Array(60).join("-"),
    rw = "\t";
  function ow(t) {
    var e = (function (t) {
      var r = {},
      ...
      return (
        t.eachRawSeries(function (t) {
          var e = t.coordinateSystem;
          if (!e || ("cartesian2d" !== e.type && "polar" !== e.type)) o.push(t);
          else {
            var i = e.getBaseAxis();
            if ("category" === i.type) {
              ...
              r[n] ||
                ...
                a.push({ axisDim: i.dim, axisIndex: i.index })),
                r[n].series.push(t);
            } else o.push(t);
          }
        }),
        { seriesGroupByCategoryAxis: r, other: o, meta: a }
      );
    })(t);
    return {
      value: I(
            ...
            return (
              D(t, function (t, e) {
                ...
                D(t.series, function (t) {
                  var e = t.getRawData();
                  o.push(
                    t.getRawData().mapArray(e.mapDimension(n), function (t) {
                      return t;
                    })
                  );
                });
                for (var a = [r.join(rw)], s = 0; s < o[0].length; s++) {
        ...
        if (
          ...
          var i = (function (t) {
              for (
                var e = t.split(/\n+/g),
                  i = [],
                  n = P(aw(e.shift()).split(sw), function (t) {
                    return { name: t, data: [] };
                  }),
                  r = 0;
                r < e.length;
          ...
          n &&
            ((a[r] = a[r] || []),
            (a[r][n.axisIndex] = { data: i.categories }),
            (a.series = a.series.concat(i.series)));
        } else {
          i = (function (t) {
            for (
              var e = t.split(/\n+/g), i = aw(e.shift()), n = [], r = 0;
              r < e.length;
              r++
            ) {
              var o = aw(e[r]);
              if (o) {
                ...
                1 === a.length && (h ? (n[r].value = a[0]) : (n[r] = a[0]));
              }
            }
  ...
  (hw.defaultOption = {
    ...
    (hw.prototype.onclick = function (t, e) {
      var i = e.getDom(),
        n = this.model;
      ...
      (r.style.cssText =
        ...
        (r.style.backgroundColor = n.get("backgroundColor") || "#fff");
      var o = document.createElement("h4"),
        a = n.get("lang") || [];
      (o.innerHTML = a[0] || n.get("title")),
        (o.style.cssText = "margin: 10px 20px;"),
        (o.style.color = n.get("textColor"));
      ...
      Ht(m, "click", _),
        Ht(v, "click", function () {
          var t;
          try {
            t = "function" == typeof u ? u(s, e.getOption()) : lw(l.value, f);
          } catch (t) {
            ...
            r.push({
              ...
              data: (function (t, r) {
                return P(t, function (t, e) {
                  ...
                  if (!N(i) || O(i)) return t;
                  (N(t) && !O(t)) || (t = { value: t });
                  var n = null != i.name && null == t.name;
                  return (t = A(t, i)), n && delete t.name, t;
                });
              })(t.data, i),
            });
          } else r.push(k({ type: "scatter" }, t));
        }),
          n.mergeOption(A({ series: r }, t.newOption));
      }
    );
  var uw = T,
    cw = D,
  ...
  function Iw(t, e) {
    var i = Qw[e.brushType].createCover(t, e);
    return (i.__brushOption = e), Aw(i, e), t.group.add(i), i;
  }
  function Cw(t, e) {
    var i = kw(e);
    return i.endCreating && (i.endCreating(t, e), Aw(e, e.__brushOption)), e;
  }
  function Tw(t, e) {
    var i = e.__brushOption;
    kw(e).updateCoverShape(t, e, i.range, i);
  }
  function Aw(t, e) {
    var i = e.z;
    null == i && (i = mw),
  ...
  function Dw(t, e) {
    kw(e).updateCommon(t, e), Tw(t, e);
  }
  function kw(t) {
    return Qw[t.__brushOption.brushType];
  }
  function Pw(t, e, i) {
    var n,
      r = t._panels;
  ...
  function Bw(n, r) {
    var t = r.__brushOption,
      ...
      e = r.childAt(0);
    e.useStyle(Fw(t)),
      e.attr({ silent: !o, cursor: o ? "move" : "default" }),
      cw(["w", "e", "n", "s", "se", "sw", "ne", "nw"], function (t) {
          ...
          i = (function t(e, i) {
            {
              ...
              var r = { w: "left", e: "right", n: "top", s: "bottom" },
        ...
        e &&
          e.attr({
            silent: !o,
            invisible: !o,
            cursor: o ? ww[i] + "-resize" : null,
          });
      });
  }
  function Vw(t, e, i, n, r, o, a) {
    var s = e.childOfName(i);
    s &&
      s.setShape(
        (function (t) {
          var e = fw(t[0][0], t[1][0]),
            i = fw(t[0][1], t[1][1]),
            n = pw(t[0][0], t[1][0]),
            r = pw(t[0][1], t[1][1]);
  ...
  function Ww(t, e, i, n, r, o, a, s) {
    var l = n.__brushOption,
      h = t(l.range),
      u = Zw(i, o, a);
    cw(r.split(""), function (t) {
      var e = xw[t];
      h[e[0]][e[1]] += u[e[0]];
    }),
      (l.range = e(Hw(h[0][0], h[1][0], h[0][1], h[1][1]))),
      Dw(i, n),
      zw(i, { isEnd: !1 });
  }
  ...
  function jw(t, e, i, n) {
    ...
    if (
      ...
      if (a && !o) {
        "single" === s.brushMode && Ow(t);
        var l = b(s);
        (l.brushType = qw(l.brushType, a)),
          (l.panelId = !0 === a ? null : a.panelId),
          (o = t._creatingCover = Iw(t, l)),
          t._covers.push(o);
      }
      if (o) {
        var h = Qw[qw(t._brushType, a)];
        (o.__brushOption.range = h.getCreatingRange(Uw(t, o, t._track))),
          n && (Cw(t, o), h.updateCommon(t, o)),
          Tw(t, o),
          (r = { isEnd: n });
      }
    } else n && "single" === s.brushMode && s.removeOnClick && Pw(t, e, i) && Ow(t) && (r = { isEnd: n, removeOnClick: !0 });
    return r;
  }
  function qw(t, e) {
  ...
  (Mw.prototype = {
    ...
    updateCovers: function (r) {
      ...
      function t(t, e) {
        var i = r[t];
        if (null != e && o[e] === l) a[t] = o[e];
        else {
          var n = (a[t] =
            null != e ? ((o[e].__brushOption = i), o[e]) : Cw(s, Iw(s, i)));
          Dw(s, n);
        }
      }
    },
    unmount: function () {
      return this.enableBrush(!1), Ow(this), this._zr.remove(this.group), this;
    },
    dispose: function () {
            ...
            if (!t._dragging)
              for (var a = 0; a < r.length; a++) {
                ...
                if (
                  ...
                  Qw[s.brushType].contain(r[a], i[0], i[1])
                )
                  return;
              }
  ...
  function Kw(t, e) {
    if (t._dragging) {
      ...
      var i = e.offsetX,
        n = e.offsetY,
        r = t.group.transformCoordToLocal(i, n),
        o = jw(t, e, r, !0);
      (t._dragging = !1),
        (t._track = []),
  ...
  var Qw = {
    ...
    rect: {
      ...
      getCreatingRange: function (t) {
        var e = Ew(t);
        return Hw(e[1][0], e[1][1], e[0][0], e[0][1]);
      },
    ...
    polygon: {
      createCover: function (t, e) {
        var i = new Si();
        return i.add(new Ya({ name: "main", style: Fw(e), silent: !0 })), i;
      },
      getCreatingRange: function (t) {
        return t;
      },
        ...
        e.remove(e.childAt(0)),
          e.add(
            new Xa({
              ...
              draggable: !0,
              drift: uw(Gw, t, e),
              ondragend: uw(zw, t, { isEnd: !0 }),
            })
          );
      },
      updateCoverShape: function (t, e, i, n) {
        e.childAt(0).setShape({ points: Uw(t, e, i) });
      },
      updateCommon: Bw,
      contain: Yw,
    },
  ...
  function Jw(l) {
    return {
      ...
      getCreatingRange: function (t) {
        var e = Ew(t);
        return [fw(e[0][l], e[1][l]), pw(e[0][l], e[1][l])];
      },
      updateCoverShape: function (t, e, i, n) {
        var r,
          o = Lw(t, e);
        if (!0 !== o && o.getLinearBrushOtherExtent)
          r = o.getLinearBrushOtherExtent(l, t._transform);
        else {
          var a = t._zr;
          r = [0, [a.getWidth(), a.getHeight()][1 - l]];
        }
        var s = [i, r];
        l && s.reverse(), Rw(t, e, s, n);
      },
      updateCommon: Bw,
      contain: Yw,
    };
  }
  var tb = { axisPointer: 1, tooltip: 1, brush: 1 };
  function eb(n, r, o) {
    return (
      (n = ib(n)),
      function (t, e, i) {
        return (
          ...
          !(function (t, e, i) {
            ...
            return n && n !== i && !tb[n.mainType] && r && r.model !== i;
          })(t, r, o)
        );
      }
    );
  ...
  function lb(t, e, i) {
    var n = (this._targetInfoList = []),
      ...
      o = cb(e, t);
    nb(db, function (t, e) {
      (i && i.include && !(0 <= rb(i.include, e))) || t(o, n, r);
    });
  }
  var hb = lb.prototype;
  function ub(t) {
  ...
  function cb(t, e) {
    return Gr(t, e, { includeMainTypes: sb });
  }
  (hb.setOutputRanges = function (t, e) {
    this.matchOutputRanges(t, e, function (t, e, i) {
      if (((t.coordRanges || (t.coordRanges = [])).push(e), !t.coordRange)) {
        t.coordRange = e;
        var n = gb[t.brushType](0, i, e);
        t.__rangeOffset = {
          offset: vb[t.brushType](n.values, t.range, [1, 1]),
          xyMinMax: n.xyMinMax,
        };
      }
    });
  }),
    (hb.matchOutputRanges = function (t, n, r) {
      nb(
        t,
        function (i) {
          ...
          t &&
            !0 !== t &&
            D(t.coordSyses, function (t) {
              var e = gb[i.brushType](1, t, i.range);
              r(i, e.values, t, n);
            });
        },
        this
    ...
    (hb.setInputRanges = function (t, r) {
      nb(
        t,
        function (t) {
          ...
          if (((t.range = t.range || []), e && !0 !== e)) {
            t.panelId = e.panelId;
            var i = gb[t.brushType](0, e.coordSys, t.coordRange),
              n = t.__rangeOffset;
            t.range = n
              ? vb[t.brushType](
                  i.values,
                  ...
                  (function (t, e) {
                    var i = _b(t),
                      ...
                      r = [i[0] / n[0], i[1] / n[1]];
                    return (
                      isNaN(r[0]) && (r[0] = 1), isNaN(r[1]) && (r[1] = 1), r
                    );
    ...
    (hb.makePanelOpts = function (i, n) {
      return P(this._targetInfoList, function (t) {
        ...
        return {
          ...
          isTargetByCursor: eb(e, i, t.coordSysModel),
          getLinearBrushOtherExtent: (function (r, o) {
            return (
              (r = ib(r)),
              function (t) {
                var e = null != o ? o : t,
    ...
    (hb.controlSeries = function (t, e, i) {
      var n = this.findTargetInfo(t, i);
      return !0 === n || (n && 0 <= rb(n.coordSyses, e.coordinateSystem));
    }),
    (hb.findTargetInfo = function (t, e) {
      for (
        var i = this._targetInfoList, n = cb(e, t), r = 0;
        r < i.length;
        r++
      ) {
        var o = i[r],
        ...
        } else for (r = 0; r < fb.length; r++) if (fb[r](n, o)) return o;
      }
      return !0;
    });
  var db = {
      grid: function (t, n) {
        ...
        (r || o || e) &&
          ...
          nb(e, function (t) {
            i.set(t.id, t), (a[t.id] = !0), (s[t.id] = !0);
          }),
          i.each(function (t) {
            var e = t.coordinateSystem,
              i = [];
            nb(e.getCartesians(), function (t, e) {
              (0 <= rb(r, t.getAxis("x").model) ||
                0 <= rb(o, t.getAxis("y").model)) &&
                i.push(t);
            }),
              n.push({
                panelId: "grid--" + t.id,
    ...
    pb = {
      ...
      geo: function () {
        ...
        return e.applyTransform(rl(t)), e;
      },
    },
    gb = {
      lineX: ob(mb, 0),
      lineY: ob(mb, 1),
      rect: function (t, e, i) {
        var n = e[ab[t]]([i[0][0], i[1][0]]),
          r = e[ab[t]]([i[0][1], i[1][1]]),
          o = [ub([n[0], r[0]]), ub([n[1], r[1]])];
      ...
      polygon: function (i, n, t) {
        ...
        return {
          values: P(t, function (t) {
            var e = n[ab[i]](t);
            return (
              (r[0][0] = Math.min(r[0][0], e[0])),
              (r[1][0] = Math.min(r[1][0], e[1])),
              (r[0][1] = Math.max(r[0][1], e[0])),
              (r[1][1] = Math.max(r[1][1], e[1])),
              e
            );
          }),
          xyMinMax: r,
  ...
  function mb(t, e, i, n) {
    var r = i.getAxis(["x", "y"][t]),
      o = ub(
        P([0, 1], function (t) {
          return e
            ? r.coordToData(r.toLocalCoord(n[t]))
  ...
  ax.extend({ type: "dataZoom.select" }),
    hx.extend({ type: "dataZoom.select" });
  var Sb = xc.toolbox.dataZoom,
    Mb = D;
  function Ib(t, e, i) {
    (this._brushController = new Mw(i.getZr()))
      .on("brush", C(this._onBrush, this))
      .mount(),
      this._isZoomActive;
  }
  Ib.defaultOption = {
  ...
  (Cb.render = function (t, e, i, n) {
    (this.model = t),
      ...
      (function (t, e, i, n, r) {
        ...
        n &&
          ...
          (o = "dataZoomSelect" === n.key && n.dataZoomSelectActive);
        (i._isZoomActive = o),
          t.setIconStatus("zoom", o ? "emphasis" : "normal");
        var a = new lb(Ab(t.option), e, { include: ["grid"] });
        i._brushController
          .setPanels(
    ...
    (Cb.onclick = function (t, e, i) {
      Tb[i].call(this);
    }),
    (Cb.remove = function (t, e) {
      this._brushController.unmount();
    }),
    (Cb.dispose = function (t, e) {
  ...
  function Ab(e) {
    var i = {};
    return (
      D(["xAxisIndex", "yAxisIndex"], function (t) {
        (i[t] = e[t]),
          null == i[t] && (i[t] = "all"),
          (!1 !== i[t] && "none" !== i[t]) || (i[t] = []);
      }),
  ...
  (Cb._onBrush = function (t, e) {
    if (e.isEnd && t.length) {
      var s = {},
        l = this.ecModel;
      this._brushController.updateCovers([]),
        new lb(Ab(this.model.option), l, {
          include: ["grid"],
          ...
          xb(t, function (t, e) {
            ...
            if (i < 0) {
              ...
              if (n) {
                ...
                a[0][e] = { dataZoomId: e, start: r[0], end: r[1] };
              }
            }
          }),
            a.push(t);
    ...
    function r(t, e, i) {
      var n = e.getAxis(t),
        ...
        a = o.findRepresentativeAxisProxy(r).getMinMaxSpan();
      (null == a.minValueSpan && null == a.maxValueSpan) ||
        (i = K_(
          0,
          i.slice(),
          n.scale.getExtent(),
        ...
        o && (s[o.id] = { dataZoomId: o.id, startValue: i[0], endValue: i[1] });
    }
  }),
    (Cb._dispatchZoomAction = function (t) {
      var i = [];
      Mb(t, function (t, e) {
        i.push(b(t));
      }),
  ...
  (kb.defaultOption = {
    ...
    (kb.prototype.onclick = function (t, e, i) {
      !(function (t) {
        t[wb] = null;
      })(t),
  ...
  var Pb,
    Lb = "urn:schemas-microsoft-com:vml",
    Ob = "undefined" == typeof window ? null : window,
    zb = !1,
    Eb = Ob && Ob.document;
  function Nb(t) {
    return Pb(t);
  }
  if (Eb && !v.canvasSupported)
    try {
      Eb.namespaces.zrvml || Eb.namespaces.add("zrvml", Lb),
        (Pb = function (t) {
          return Eb.createElement("<zrvml:" + t + ' class="zrvml">');
        });
    } catch (t) {
      Pb = function (t) {
        return Eb.createElement("<" + t + ' xmlns="' + Lb + '" class="zrvml">');
      };
    }
  var Rb,
    Bb = Jo.CMD,
  ...
  if (!v.canvasSupported) {
    var Ub = ",",
      Xb = "progid:DXImageTransform.Microsoft",
      Yb = 21600,
      jb = Yb / 2,
      qb = function (t) {
        (t.style.cssText =
      ...
      eS = function (t, e, i) {
        ...
        (i = +i),
          isNaN(i) && (i = 1),
          n && ((t.color = $b(n[0], n[1], n[2])), (t.opacity = i * n[3]));
      },
      iS = function (t, e, i, n) {
        var r = "fill" === e,
          o = t.getElementsByTagName(e)[0];
        null != i[e] && "none" !== i[e] && (r || (!r && i.lineWidth))
          ? ((t[r ? "filled" : "stroked"] = "true"),
            i[e] instanceof rs && Qb(t, o),
            (o = o || Nb(e)),
            r
              ? (function (t, e, i) {
                  var n,
                  ...
                  if (null != o)
                    if (o instanceof rs) {
                      ...
                      if ("linear" === o.type) {
                        ...
                        a = "gradientradial";
                        (g = [o.x * d, o.y * f]), (p = i.transform);
                        var _ = i.scale,
                          x = d,
                          w = f;
                        (l = [(g[0] - c.x) / x, (g[1] - c.y) / w]),
                          p && yt(g, g, p),
                          (x /= _[0] * Yb),
                          (w /= _[1] * Yb);
                        var b = Zb(x, w);
                      ...
                      "radial" === a && (t.focusposition = l.join(","));
                    } else eS(t, o, e.opacity);
                })(o, i, n)
              : (function (t, e) {
                  e.lineDash && (t.dashstyle = e.lineDash.join(" ")),
                    null == e.stroke ||
                      e.stroke instanceof rs ||
                      eS(t, e.stroke, e.opacity);
                })(o, i),
            Kb(t, o))
          : ((t[r ? "filled" : "stroked"] = "false"), Qb(t, o));
      },
      nS = [[], [], []];
    (xa.prototype.brushVML = function (t) {
      var e = this.style,
        i = this._vmlEl;
      i || ((i = Nb("shape")), qb(i), (this._vmlEl = i)),
        iS(i, "fill", e, this),
        iS(i, "stroke", e, this);
      ...
      var l = this.path || (this.path = new Jo());
      this.__dirtyPath &&
        (l.beginPath(),
            ...
            switch (((n = ""), (i = 0), (r = p[o++]))) {
              ...
              case c:
                ...
                e &&
                  ((b = e[4]),
                  (S = e[5]),
                  (M = Fb(e[0] * e[0] + e[1] * e[1])),
                  (I = Fb(e[2] * e[2] + e[3] * e[3])),
                  (C = Math.atan2(-e[1] / I, e[0] / M)));
                var T = p[o++],
                  A = p[o++],
                  D = p[o++],
                  k = p[o++],
        ...
        (i.style.zIndex = Jb(this.zlevel, this.z, this.z2)),
        Kb(t, i),
        null != e.text
          ? this.drawRectText(t, this.getBoundingRect())
          : this.removeRectText(t);
    }),
      (xa.prototype.onRemove = function (t) {
        Qb(t, this._vmlEl), this.removeRectText(t);
      }),
      (xa.prototype.onAdd = function (t) {
        Kb(t, this._vmlEl), this.appendRectText(t);
      });
    (Yn.prototype.brushVML = function (t) {
      ...
      if (r) {
        var h = n.x || 0,
          ...
          v = f && p,
          y = this._vmlEl;
        y || ((y = Eb.createElement("div")), qb(y), (this._vmlEl = y));
        var _,
          x = y.style,
          w = !1,
          b = 1,
        ...
        if (
          (this.transform &&
            ((_ = this.transform),
            (b = Fb(_[0] * _[0] + _[1] * _[1])),
            (S = Fb(_[2] * _[2] + _[3] * _[3])),
            (w = _[1] || _[2])),
          w)
        ) {
          var M = [h, u],
            ...
            C = [h, u + d],
            T = [h + c, u + d];
          yt(M, M, _), yt(I, I, _), yt(C, C, _), yt(T, T, _);
          var A = Zb(M[0], I[0], C[0], T[0]),
            D = Zb(M[1], I[1], C[1], T[1]),
            k = [];
          k.push(
            "M11=",
            _[0] / b,
            ...
            (x.padding = "0 " + Vb(A) + "px " + Vb(D) + "px 0"),
            (x.filter = Xb + ".Matrix(" + k.join("") + ", SizingMethod=clip)");
        } else
          _ && ((h = h * b + _[4]), (u = u * S + _[5])),
            (x.filter = ""),
            (x.left = Vb(h) + "px"),
            (x.top = Vb(u) + "px");
        var P = this._imageEl,
          L = this._cropEl;
        P || ((P = Eb.createElement("div")), (this._imageEl = P));
        var O = P.style;
        if (v) {
          if (e && i)
            (O.width = Vb((b * e * c) / f) + "px"),
              (O.height = Vb((S * i * d) / p) + "px");
          else {
            var z = new Image(),
              E = this;
            (z.onload = function () {
          ...
          L ||
            (((L = Eb.createElement("div")).style.overflow = "hidden"),
            (this._cropEl = L));
          var N = L.style;
          (N.width = Vb((c + (g * c) / f) * b)),
            (N.height = Vb((d + (m * d) / p) * S)),
            (N.filter =
              Xb +
              ".Matrix(Dx=" +
              ((-g * c) / f) * b +
        ...
        var R = "",
          B = n.opacity;
        B < 1 && (R += ".Alpha(opacity=" + Vb(100 * B) + ") "),
          (R += Xb + ".AlphaImageLoader(src=" + r + ", SizingMethod=scale)"),
          (O.filter = R),
          (y.style.zIndex = Jb(this.zlevel, this.z, this.z2)),
          Kb(t, y),
    ...
    for (
        ...
        uS = function (t, e, i, n) {
          ...
          if ((null != o && (o += ""), o)) {
            ...
            var c,
              ...
              g = (function (t) {
                ...
                if (!e) {
                  ...
                  (e = {
                    style: n.fontStyle || oS,
                    variant: n.fontVariant || oS,
                    weight: n.fontWeight || oS,
              ...
              m =
                ...
                g.family +
                '"';
            i = i || hn(o, m, f, p, r.textPadding, r.textLineHeight);
            var v = this.transform;
            if ((v && !n && (hS.copy(e), hS.applyTransform(v), (e = hS)), n))
              (c = e.x), (d = e.y);
            else {
              var y = r.textPosition;
              if (y instanceof Array)
                (c = e.x + tS(y[0], e.width)),
                  (d = e.y + tS(y[1], e.height)),
                  (f = f || "left");
              else {
                var _ = this.calculateTextPosition
                  ? this.calculateTextPosition({}, r, e)
                  : dn({}, r, e);
                (c = _.x),
                  (d = _.y),
                  (f = f || _.textAlign),
            ...
            var x,
              ...
              M = this._textVmlEl;
            M
              ? (w = (x = (b = M.firstChild).nextSibling).nextSibling)
              : ((M = S("line")),
                (x = S("path")),
                (w = S("textpath")),
                (b = S("skew")),
            ...
            v && n
              ? (yt(I, I, v),
                ...
                (b.matrix =
                  ...
                  v[3].toFixed(3) +
                  ",0,0"),
                (b.offset = (Vb(I[0]) || 0) + "," + (Vb(I[1]) || 0)),
                (b.origin = "0 0"),
                (C.left = "0px"),
                (C.top = "0px"))
              : ((b.on = !1), (C.left = Vb(c) + "px"), (C.top = Vb(d) + "px")),
              (w.string = (function (t) {
            ...
            iS(M, "fill", { fill: r.textFill, opacity: r.opacity }, this),
              iS(
                M,
                "stroke",
                {
              ...
              (M.style.zIndex = Jb(this.zlevel, this.z, this.z2)),
              Kb(t, M);
          }
        },
        cS = function (t) {
          Qb(t, this._textVmlEl), (this._textVmlEl = null);
        },
        dS = function (t) {
          Kb(t, this._textVmlEl);
        },
        fS = [Zn, Xn, Yn, xa, Ba],
        pS = 0;
      pS < fS.length;
      ...
      var gS = fS[pS].prototype;
      (gS.drawRectText = uS),
        (gS.removeRectText = cS),
        (gS.appendRectText = dS);
    }
    (Ba.prototype.brushVML = function (t) {
      var e = this.style;
      null != e.text
        ? this.drawRectText(
            t,
      ...
      (Ba.prototype.onRemove = function (t) {
        this.removeRectText(t);
      }),
      (Ba.prototype.onAdd = function (t) {
  ...
  function vS(t, e) {
    !(function () {
      if (!zb && Eb) {
        zb = !0;
        var t = Eb.styleSheets;
        t.length < 31
          ? Eb.createStyleSheet().addRule(
              ".zrvml",
  ...
  (vS.prototype = {
    ...
    D(
      ...
      function (t) {
        vS.prototype[t] = (function (t) {
          return function () {
            ci('In IE8.0 VML mode painter not support method "' + t + '"');
          };
        })(t);
      }
    ),
  ...
  function PS(t, e) {
    e && LS(t, "transform", "matrix(" + xS.call(e, ",") + ")");
  }
  function LS(t, e, i) {
  ...
  function OS(t, e, i, n) {
    if (
      ...
      LS(t, "fill", (r = "transparent" === r ? wS : r)),
        LS(
          t,
          "fill-opacity",
    ...
    if (
      ...
      LS(t, "stroke", (o = "transparent" === o ? wS : o)),
        LS(
          t,
          "stroke-width",
        ...
        LS(t, "paint-order", i ? "stroke" : "fill"),
        LS(
          t,
          "stroke-opacity",
        ...
        e.lineDash
          ? (LS(t, "stroke-dasharray", e.lineDash.join(",")),
            LS(t, "stroke-dashoffset", bS(e.lineDashOffset || 0)))
          : LS(t, "stroke-dasharray", ""),
        e.lineCap && LS(t, "stroke-linecap", e.lineCap),
        e.lineJoin && LS(t, "stroke-linejoin", e.lineJoin),
        e.miterLimit && LS(t, "stroke-miterlimit", e.miterLimit);
    } else LS(t, "stroke", wS);
  }
  var zS = {};
  zS.brush = function (t) {
    var e = t.style,
      i = t.__svgEl;
    i || ((i = yS("path")), (t.__svgEl = i)), t.path || t.createPathProxy();
    var n = t.path;
    if (t.__dirtyPath) {
      n.beginPath(),
        ...
        for (var e = [], i = t.data, n = t.len(), r = 0; r < n; ) {
          ...
          switch (i[r++]) {
            ...
            case _S.A:
              ...
              var w = DS(s + h * MS(c + d)),
                b = DS(l + u * SS(c + d));
              e.push("A", DS(h), DS(u), bS(f * TS), +y, +p, w, b);
              break;
            case _S.Z:
              o = "Z";
              break;
          ...
          o && e.push(o);
          for (var I = 0; I < a; I++) e.push(DS(i[r++]));
        }
        return e.join(" ");
      })(n);
      r.indexOf("NaN") < 0 && LS(i, "d", r);
    }
    OS(i, e, !1, t),
      PS(i, t.transform),
      null != e.text ? HS(t, t.getBoundingRect()) : GS(t);
  };
  var ES = {
      brush: function (t) {
        var e = t.style,
    ...
    BS = {},
    VS = [],
    FS = { left: "start", right: "end", center: "middle", middle: "middle" },
    HS = function (t, e) {
      var i = t.style,
        n = t.transform,
        r = t instanceof Ba || i.transformText;
      t.__dirty && Dn(i);
      var o = i.text;
      if ((null != o && (o += ""), Gn(o, i))) {
        null == o && (o = ""),
          !r && n && (RS.copy(e), RS.applyTransform(n), (e = RS));
        var a = t.__textSvgEl;
        a || ((a = yS("text")), (t.__textSvgEl = a));
        var s = a.style,
          l = i.font || an,
          h = a.__computedFont;
        l !== a.__styleFont &&
          ((s.font = a.__styleFont = l), (h = a.__computedFont = s.font));
        var u = i.textPadding,
          c = i.textLineHeight,
          d = t.__textCotentBlock;
        (d && !t.__dirtyText) ||
          (d = t.__textCotentBlock = yn(o, h, u, c, i.truncate));
        var f = d.outerHeight,
          p = d.lineHeight;
        Rn(BS, t, i, e);
        var g = BS.baseX,
        ...
        !(function (t, e, i, n, r, o, a) {
          ...
          if (r && s) {
            var l = n.textOrigin;
            "center" === l
              ? ((o = r.width / 2 + r.x), (a = r.height / 2 + r.y))
              : l && ((o = l[0] + r.x), (a = l[1] + r.y)),
              (VS[4] -= o),
              (VS[5] -= a),
              ae(VS, VS, s),
              (VS[4] += o),
        ...
        var w = d.canCacheByTextString,
          ...
          S = b.length;
        if (w && t.__canCacheByTextString && t.__text === o) {
          if (t.__dirtyText && S)
            for (var M = 0; M < S; ++M) WS(b[M], v, _, x + M * p);
        } else {
          (t.__text = o), (t.__canCacheByTextString = w);
          var I = d.lines,
            C = I.length;
          for (M = 0; M < C; M++) {
            var T = b[M],
            ...
            T
              ? T.__zrText !== A &&
                ((T.innerHTML = ""), T.appendChild(document.createTextNode(A)))
              : ((T = b[M] = yS("tspan")),
                a.appendChild(T),
  ...
  function WS(t, e, i, n) {
    LS(t, "dominant-baseline", "middle"),
      LS(t, "text-anchor", FS[e]),
      LS(t, "x", i),
      LS(t, "y", n);
  }
  function GS(t) {
  ...
  function ZS() {}
  function US(t, e) {
    for (var i = 0, n = e.length, r = 0, o = 0; i < n; i++) {
      var a = e[i];
      if (a.removed) {
        for (s = [], l = o; l < o + a.count; l++) s.push(l);
        (a.indices = s), (o += a.count);
      } else {
        for (var s = [], l = r; l < r + a.count; l++) s.push(l);
        (a.indices = s), (r += a.count), a.added || (o += a.count);
      }
    }
    return e;
  }
    ...
    (ZS.prototype = {
      diff: function (l, h, t) {
        ...
        if (p[0].newPos + 1 >= c && d <= i + 1) {
          ...
          return [{ indices: n, count: h.length }];
        }
        function o() {
          for (var t = -1 * f; t <= f; t += 2) {
            var e,
              ...
              r = (n ? n.newPos : 0) - t;
            i && (p[t - 1] = void 0);
            var o = i && i.newPos + 1 < c,
              a = n && 0 <= r && r < d;
            if (o || a) {
              if (
                (!o || (a && i.newPos < n.newPos)
                  ? ((e = {
                      newPos: (s = n).newPos,
                  ...
                  : ((e = i).newPos++,
                    u.pushComponent(e.components, !0, void 0)),
                (r = u.extractCommon(e, h, l, t)),
                e.newPos + 1 >= c && d <= r + 1)
              )
                return US(u, e.components, h, l);
              p[t] = e;
            } else p[t] = void 0;
          }
          var s;
      ...
      extractCommon: function (t, e, i, n) {
        for (
          var r = e.length, o = i.length, a = t.newPos, s = a - n, l = 0;
          a + 1 < r && s + 1 < o && this.equals(e[a + 1], i[s + 1]);
  ...
  function qS(t, e) {
    YS.call(this, t, e, "clipPath", "__clippath_in_use__");
  }
  function $S(t, e) {
    YS.call(this, t, e, ["filter"], "__filter_in_use__", "_shadowDom");
  }
  function KS(t) {
    return (
      t &&
  ...
  (YS.prototype.createElement = yS),
    (YS.prototype.getDefs = function (t) {
      var e = this._svgRoot,
    ...
    (YS.prototype.removeDom = function (t) {
      var e = this.getDefs(!1);
      e &&
        t[this._domName] &&
        (e.removeChild(t[this._domName]), (t[this._domName] = null));
    }),
    (YS.prototype.getDoms = function () {
      var i = this.getDefs(!1);
      if (!i) return [];
      var n = [];
      return (
        D(this._tagNames, function (t) {
    ...
    (YS.prototype.markAllUnused = function () {
      var t = this.getDoms(),
        e = this;
      D(t, function (t) {
        t[e._markLabel] = "0";
    ...
    (YS.prototype.removeUnused = function () {
      var e = this.getDefs(!1);
      if (e) {
        var t = this.getDoms(),
          i = this;
    ...
    (YS.prototype.getSvgProxy = function (t) {
    ...
    (YS.prototype.getTextSvgElement = function (t) {
      return t.__textSvgEl;
    }),
    (YS.prototype.getSvgElement = function (t) {
      return t.__svgEl;
    }),
    w(jS, YS),
    (jS.prototype.addWithoutUpdate = function (o, a) {
      if (a && a.style) {
        var s = this;
        D(["fill", "stroke"], function (t) {
          if (
            a.style[t] &&
            ("linear" === a.style[t].type || "radial" === a.style[t].type)
          ) {
            var e,
              i = a.style[t],
              n = s.getDefs(!0);
    ...
    (jS.prototype.add = function (t) {
      ...
      if ("linear" === t.type) e = this.createElement("linearGradient");
        ...
        if ("radial" !== t.type) return ci("Illegal gradient type."), null;
    ...
    (jS.prototype.update = function (i) {
      var n = this;
      YS.prototype.update.call(this, i, function () {
        var t = i.type,
          e = i._dom.tagName;
    ...
    (jS.prototype.updateDom = function (t, e) {
      if ("linear" === t.type)
        ...
        if ("radial" !== t.type) return void ci("Illegal gradient type.");
      ...
      for (var i = t.colorStops, n = 0, r = i.length; n < r; ++n) {
        ...
        o.setAttribute("offset", 100 * i[n].offset + "%");
        var a = i[n].color;
        if (-1 < a.indexOf("rgba")) {
          var s = Ne(a)[3],
            l = Ve(a);
          o.setAttribute("stop-color", "#" + l),
            o.setAttribute("stop-opacity", s);
        } else o.setAttribute("stop-color", i[n].color);
        e.appendChild(o);
      }
      t._dom = e;
    }),
    (jS.prototype.markUsed = function (t) {
      if (t.style) {
        var e = t.style.fill;
        e && e._dom && YS.prototype.markUsed.call(this, e._dom),
          (e = t.style.stroke) &&
            e._dom &&
            YS.prototype.markUsed.call(this, e._dom);
      }
    }),
    w(qS, YS),
    ...
    (qS.prototype.updateDom = function (t, e, i) {
      if (e && 0 < e.length) {
        var n,
          r,
          o = this.getDefs(!0),
          ...
          s = i ? "_textDom" : "_dom";
        a[s]
          ? ((r = a[s].getAttribute("id")),
            (n = a[s]),
            o.contains(n) || o.appendChild(n))
          : ((r = "zr" + this._zrId + "-clip-" + this.nextId),
            ++this.nextId,
            (n = this.createElement("clipPath")).setAttribute("id", r),
            o.appendChild(n),
            (a[s] = n));
        var l = this.getSvgProxy(a);
        if (a.transform && a.parent.invTransform && !i) {
          var h = Array.prototype.slice.call(a.transform);
          re(a.transform, a.parent.invTransform, a.transform),
            l.brush(a),
            (a.transform = h);
        } else l.brush(a);
    ...
    (qS.prototype.markUsed = function (t) {
      var e = this;
      t.__clipPaths &&
        D(t.__clipPaths, function (t) {
          t._dom && YS.prototype.markUsed.call(e, t._dom),
            t._textDom && YS.prototype.markUsed.call(e, t._textDom);
        });
    }),
    w($S, YS),
    ...
    ($S.prototype.update = function (t, e) {
      if (KS(e.style)) {
        var i = this;
        YS.prototype.update.call(this, e, function () {
    ...
    ($S.prototype.updateDom = function (t, e) {
      ...
      if (s.shadowBlur || s.shadowOffsetX || s.shadowOffsetY)
        ...
        (n = s.textShadowOffsetX || 0),
          (r = s.textShadowOffsetY || 0),
          (o = s.textShadowBlur),
          (a = s.textShadowColor);
      }
      i.setAttribute("dx", n / l),
        i.setAttribute("dy", r / h),
    ...
    ($S.prototype.markUsed = function (t) {
      t._shadowDom && YS.prototype.markUsed.call(this, t._shadowDom);
    });
  function oM(t, e, i, n) {
    ...
    r.setAttribute("xmlns", "http://www.w3.org/2000/svg"),
      ...
      r.setAttribute("baseProfile", "full"),
      (r.style.cssText = "user-select:none;position:absolute;left:0;top:0;");
    var o = yS("g");
    r.appendChild(o);
    var a = yS("g");
    r.appendChild(a),
      (this.gradientManager = new jS(n, a)),
      (this.clipPathManager = new qS(n, a)),
      (this.shadowManager = new $S(n, a));
    var s = document.createElement("div");
    (s.style.cssText = "overflow:hidden;position:relative"),
      (this._svgDom = r),
      (this._svgRoot = a),
      (this._backgroundRoot = o),
      (this._viewport = s),
      t.appendChild(s),
      s.appendChild(r),
  ...
  (oM.prototype = {
    ...
    _paintList: function (t) {
        ...
        s.invisible ||
          (s.__dirty &&
            ...
            s.style &&
              ...
              this.shadowManager.update(h, s)),
            (s.__dirty = !1)),
          a.push(s));
      }
      var u,
        c = (function (t, e, i) {
          return XS.diff(t, e, i);
        })(r, a);
      for (e = 0; e < c.length; e++) {
        if ((p = c[e]).removed)
          for (var d = 0; d < p.count; d++) {
            h = rM((s = r[p.indices[d]]));
            var f = nM(s);
            iM(n, h), iM(n, f);
          }
      }
      for (e = 0; e < c.length; e++) {
        ...
        if ((p = c[e]).added)
          for (d = 0; d < p.count; d++) {
            (h = rM((s = a[p.indices[d]]))), (f = nM(s));
            u ? tM(n, h, u) : eM(n, h),
              h ? tM(n, f, h) : u ? tM(n, f, u) : eM(n, f),
              tM(n, f, h),
              (u = f || h || u),
              this.gradientManager.addWithoutUpdate(h || f, s),
              this.shadowManager.addWithoutUpdate(h || f, s),
              this.clipPathManager.markUsed(s);
          }
        else if (!p.removed)
          for (d = 0; d < p.count; d++) {
            (h = rM((s = a[p.indices[d]]))),
              (f = nM(s)),
              (h = rM(s)),
              (f = nM(s));
    ...
    _getDefs: function (t) {
      ...
      return 0 !== (n = e.getElementsByTagName("defs")).length
        ? n[0]
        : t
        ? ((n = e.insertBefore(yS("defs"), e.firstChild)).contains ||
            (n.contains = function (t) {
              var e = n.children;
              if (!e) return !1;
    ...
    D(
      ...
      function (t) {
        oM.prototype[t] = (function (t) {
          return function () {
            ci('In SVG mode painter not support method "' + t + '"');
          };
        })(t);
      }
    ),
    ...
    (t.dispose = function (t) {
      "string" == typeof t ? (t = Yd[t]) : t instanceof wd || (t = tf(t)),
        t instanceof wd && !t.isDisposed() && t.dispose();
    }),
    (t.getInstanceByDom = tf),
    (t.getInstanceById = function (t) {
      return Yd[t];
    }),
    (t.registerTheme = ef),
    (t.registerPreprocessor = nf),
    (t.registerProcessor = rf),
    ...
    (t.registerLayout = af),
    (t.registerVisual = sf),
    (t.registerLoading = hf),
    (t.extendComponentModel = uf),
    (t.extendComponentView = cf),
    (t.extendSeriesModel = df),
    (t.extendChartView = ff),
