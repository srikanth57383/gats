...
(function (e) {
  "function" === typeof define && define.amd
    ...
    ? (module.exports = function (i, m) {
        i || (i = window);
        if (!m || !m.fn.dataTable) m = require("datatables.net")(i, m).$;
        return e(m, i, i.document);
      })
  ...
  function t(a) {
    ...
    e("body").off("click.dtSelect" + z(a.table().node()));
  }
  function A(a) {
    ...
    c.on("mousedown.dtSelect", d, function (b) {
      ...
      .on("click.dtSelect", d, function (b) {
        ...
        var d = a.settings()[0],
          k = a.settings()[0].oClasses.sWrapper.trim().replace(/ +/g, ".");
        if (
          e(b.target).closest("div." + k)[0] == a.table().container() &&
          ((k = a.cell(e(b.target).closest("td, th"))), k.any())
        ) {
          ...
          g.isDefaultPrevented() ||
            ((g = k.index()),
            "row" === c
              ? ((c = g.row), u(b, a, d, "row", c))
              : "column" === c
              ? ((c = k.index().column), u(b, a, d, "column", c))
              : "cell" === c && ((c = k.index()), u(b, a, d, "cell", c)),
            (d._select_lastCell = g));
        }
      });
    e("body").on("click.dtSelect" + z(a.table().node()), function (c) {
      b._select.blurable &&
  ...
  function u(a, c, b, d, f) {
    var e = c.select.style(),
      g = c.select.toggleable(),
      j = c[d](f, { selected: !0 }).any();
    if (!j || g)
      "os" === e
        ? a.ctrlKey || a.metaKey
          ? c[d](f).select(!j)
          : a.shiftKey
          ? "cell" === d
            ? x(c, f, b._select_lastCell || null)
            : B(c, d, f, b._select_lastCell ? b._select_lastCell[d] : null)
          : ((a = c[d + "s"]({ selected: !0 })),
            j && 1 === a.flatten().length
              ? c[d](f).deselect()
  ...
  g.select.init = function (a) {
    ...
    c._select = {};
    if (!0 === b) (f = "os"), (s = !0);
    else if ("string" === typeof b) (f = b), (s = !0);
    else if (
      e.isPlainObject(b) &&
      (b.blurable !== h && (n = b.blurable),
      b.toggleable !== h && (y = b.toggleable),
      b.info !== h && (j = b.info),
      b.items !== h && (d = b.items),
    ...
    !s && e(a.table().node()).hasClass("selectable") && a.select.style("os");
  };
  e.each(
    [
  ...
  var o = g.Api.register,
    p = g.Api.registerPlural;
  o("select()", function () {
  ...
  o("select.toggleable()", function (a) {
    return a === h
      ? this.context[0]._select.toggleable
      : this.iterator("table", function (c) {
          c._select.toggleable = a;
        });
  });
    ...
    return a === h
      ...
      : this.iterator("table", function (c) {
          ...
          if (!c._select_init) {
            ...
            b.on("preXhr.dt.dtSelect", function (c, a) {
              if (a === b.settings()[0]) {
                var d = b
                    .rows({ selected: !0 })
                    .ids(!0)
            ...
            b.on(
              ...
              function () {
                ...
                if (
                  ...
                  var c = b.rows({ selected: !0 }).flatten().length,
                    d = b.columns({ selected: !0 }).flatten().length,
                    g = b.cells({ selected: !0 }).flatten().length,
                    h = function (a, c, d) {
                      a.append(
                  ...
                  e.each(a.aanFeatures.i, function (b, a) {
                    var a = e(a),
                      f = e('<span class="select-info"/>');
                    h(f, "row", c);
                    h(f, "column", d);
                    h(f, "cell", g);
                    var i = a.children("span.select-info");
                    i.length && i.remove();
                    "" !== f.text() && a.append(f);
                  });
                }
          ...
          t(d);
          "api" !== a && A(d);
          l(new g.Api(c), "selectStyle", [a]);
        });
  });
  o("select.selector()", function (a) {
    return a === h
      ? this.context[0]._select.selector
      : this.iterator("table", function (c) {
          t(new g.Api(c));
          c._select.selector = a;
          "api" !== c._select.style && A(new g.Api(c));
        });
  });
  p("rows().select()", "row().select()", function (a) {
    ...
    this.iterator("table", function (b, a) {
      l(c, "select", ["row", c[a]], !0);
    });
    return this;
  });
  p("columns().select()", "column().select()", function (a) {
    var c = this;
    if (!1 === a) return this.deselect();
  ...
  p("cells().select()", "cell().select()", function (a) {
    ...
    this.iterator("table", function (a, d) {
      l(c, "select", ["cell", c.cells(c[d]).indexes().toArray()], !0);
    });
    return this;
  });
