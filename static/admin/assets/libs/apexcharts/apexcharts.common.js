            ...
            value: function (t, e) {
              ...
              if ("true" === t.node.getAttribute("selected")) {
                ...
                if (
                  ...
                  var l = i.globals.dom.Paper.select(".apexcharts-series path")
                      .members,
...
var A = {
          ...
          value: function (t, e) {
            ...
            return (
                ...
                }),
              {
                ...
                pointStrokeWidth: Array.isArray(n.strokeWidth)
                  ? n.strokeWidth[e]
                  : n.strokeWidth,
          ...
          value: function (t, e, i, a, s, r, n) {
            ...
            if (!this.initialAnim || l.globals.dataChanged || l.globals.resized)
              ...
              c.animateMarker(
                o,
                0,
                "circle" === m.shape ? a : { width: m.width, height: m.height },
                w,
                l.globals.easing,
                function () {
            ...
            if (l.globals.dataChanged && "circle" === m.shape)
              if (this.dynamicAnim) {
                ...
                for (var z = 0; z < l.globals.collapsedSeries.length; z++)
                  l.globals.collapsedSeries[z].index === s &&
                    ((T = 1), (a = 0));
                0 === t && 0 === e && (a = 0),
                  c.animateCircle(
                    o,
            ...
            return (
              o.attr({ rel: r, j: r, index: s, "default-marker-size": a }),
              d.setSelectionFilter(o, s, r),
              u.addEvents(o),
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.ctx,
              ...
              u = { w: n, seriesIndex: i, dataPointIndex: a, start: o, end: l };
            ...
            if ("array" === t)
              ...
              for (var g = 0; g < e[i].data.length; g++)
                Array.isArray(e[i].data[g].y) &&
                  ...
                  n.push(e[i].data[g].y[1]),
                  s
                    ? (o.push(e[i].data[g].y[2]),
  ...
  V = (function () {
    function t(i) {
      e(this, t),
        s(this, "scaleSvgNode", function (t, e) {
                        ...
                        for (var s = 0; s < t.data.length; s++) {
                          ...
                          ("candlestick" === n.config.chart.type ||
                            ...
                            ("boxPlot" === n.config.chart.type ||
                              ...
                              o.push(n.globals.seriesCandleO[e][s]),
                              o.push(n.globals.seriesCandleH[e][s]),
                              o.push(n.globals.seriesCandleM[e][s]),
                              o.push(n.globals.seriesCandleL[e][s]),
                              o.push(n.globals.seriesCandleC[e][s])),
            ...
            if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
              for (
                ...
                i.config.grid.xaxis.lines.show &&
                  ...
                  new _(this.ctx).drawXaxisTicks(s, this.elg),
          ...
          value: function (t) {
            ...
            for (var d = t; d < a; d++) {
              ...
              for (var g = 0; g < r.series[d].length; g++) {
                var u = l[d][g];
                null !== u && f.isNumber(u)
                  ? (void 0 !== c[d][g] && (n = Math.max(n, c[d][g])),
                    void 0 !== h[d][g] &&
                    ...
                    ("candlestick" !== this.w.config.chart.type &&
                      ...
                      (void 0 !== r.seriesCandleC[d][g] &&
                        ...
                        (n = Math.max(n, r.seriesCandleC[d][g])),
                        "boxPlot" === this.w.config.chart.type &&
                          (n = Math.max(n, r.seriesCandleM[d][g]))),
                      !s.series[d].type ||
                        ("candlestick" === s.series[d].type &&
                          "boxPlot" === s.series[d].type) ||
                        ((n = Math.max(n, r.series[d][g])),
                  ...
                  var l = e.globals.yLabelFormatters[n],
                    ...
                    c =
                      String(h).length > String(o.niceMax).length
                        ? h
                        : o.niceMax,
                    d = l(c, { seriesIndex: n, dataPointIndex: -1, w: e }),
                    g = d;
                  if (
                    ((void 0 !== d && 0 !== d.length) || (d = c),
                    e.globals.isBarHorizontal)
                  ) {
                    a = 0;
            ...
            if (
              ...
              a.globals.isBarHorizontal
                ...
                : (n.ttHeight / 2 + h > a.globals.gridHeight &&
                    (h =
                      a.globals.gridHeight - n.ttHeight + a.globals.translateY),
                  h < 0 && (h = 0));
            isNaN(l) ||
        ...
        },
        {
          ...
          value: function (t) {
            var e = this.w,
              ...
              s =
                a >= 2 && a % 2 == 0
                  ...
                  : Math.floor(a / 2) + 1;
            e.globals.isBarHorizontal &&
              (s = new M(this.ctx).getActiveConfigSeriesIndex(!1, "desc") + 1);
            var r = e.globals.dom.baseEl.querySelector(
            ...
            if (
              ...
              e.globals.isBarHorizontal
                ? (o += h / 3)
                : (o = i.e.clientY - c.top - i.tooltipRect.ttHeight / 2),
      ...
      a(t, [
          ...
          value: function (t) {
            ...
            if (e.target.classList.contains("apexcharts-".concat(r, "-rect"))) {
              ...
              if (
                ...
                (a = o.globals.clientX - f.left - n.tooltipRect.ttWidth / 2),
                  (s = o.globals.clientY - f.top - n.tooltipRect.ttHeight - 5);
              }
            }
            return { x: a, y: s };
          },
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (
              (h + n.tooltipRect.ttWidth > r.globals.gridWidth && !p
        ...
        },
        {
          ...
          value: function (t, e, i, a) {
            ...
            r.hoverX < 0 || r.hoverX > s.globals.gridWidth
              ...
              : (this.tooltipUtil.isXoverlap(n) || s.globals.isBarHorizontal) &&
            ...
            for (
              var o = s.group({
                ...
                l = function (n) {
                  i.isBoxPlot =
                    "boxPlot" === a.config.chart.type ||
                    "boxPlot" === a.config.series[n].type;
                  var l,
                    h,
                    c = void 0,
                    d = void 0,
                    ...
                    var y = s.group({
                      ...
                      w = function (e) {
                        ...
                        (d = o.y),
                          ...
                          e > 0 && u.push(c + m / 2),
                          g.push(d),
                          o.pathTo.forEach(function (l, h) {
                            var g =
                                !i.isBoxPlot &&
                                i.candlestickOptions.wick.useFillColor
                                  ? o.color[h]
                                  : a.globals.stroke.colors[n],
                              u = r.fillPath({
                                seriesNumber: p,
                                dataPointIndex: e,
                                color: o.color[h],
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (s.comboCharts) {
              if (
                (n.series.length > 0 && x.push(g.draw(n.series, "area", n.i)),
                h.series.length > 0)
              )
