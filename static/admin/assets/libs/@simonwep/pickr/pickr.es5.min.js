    ...
    function (t, e, r) {
      ...
      var n = r(0),
        ...
        ut = function (t) {
          ...
          return (
            !(this === G && f(q, e) && !f(J, e)) &&
            (!(r || !f(this, e) || !f(q, e) || (f(this, B) && this[B][e])) || r)
          );
        },
        st = function (t, e) {
          var r = g(t),
          ...
          if (r !== G || !f(q, n) || f(J, n)) {
            var o = z(r, n);
            return (
              !o || !f(q, n) || (f(r, B) && r[B][n]) || (o.enumerable = !0), o
            );
          }
        },
        lt = function (t) {
            ...
            [
              ...
              function (t, o) {
                ...
                for (var w = 0, x = 0, S = []; x < v.length; ) {
                  ...
                  if (
                    null === O ||
                    (_ = h(s(b.lastIndex + (p ? x : 0)), v.length)) === w
                  )
                    x = u(v, x, g);
                  else {
                    if ((S.push(v.slice(w, x)), S.length === m)) return S;
                    for (var A = 1; A <= O.length - 1; A++)
                      if ((S.push(O[A]), S.length === m)) return S;
                    x = w = _;
                  }
                }
        ...
        if (
          (C &&
            ...
            h !== Object.prototype &&
              ...
              (f ||
                i(w) === h ||
                (a ? a(w, h) : "function" != typeof w[g] && u(w, g, y)),
              c(w, O, !0, !0),
              f && (p[O] = y))),
          "values" == v &&
            j &&
          ...
          if (
            ...
            for (S in x) (d || A || !(S in E)) && s(E, S, x[S]);
    ...
    function (t, e, r) {
      ...
      t.exports =
        ...
        o(function () {
          ...
          ? function (t, e) {
              for (
                var r = u(t), o = arguments.length, l = 1, f = a.f, p = c.f;
                o > l;
                ...
                for (
                  var v,
                    h = s(arguments[l++]),
                    d = f ? i(h).concat(f(h)) : i(h),
                    g = d.length,
                    y = 0;
                  g > y;

                )
                  (v = d[y++]), (n && !p.call(h, v)) || (r[v] = h[v]);
              return r;
            }
          : l;
    },
      ...
      n(
        { target: "Array", proto: !0, forced: !l },
        {
          splice: function (t, e) {
            ...
            if (((l.length = n), r < n)) {
              for (v = b; v < y - n; v++)
                (d = v + r), (h = v + n) in g ? (g[d] = g[h]) : delete g[d];
      ...
      t.exports = function (t) {
        ...
        if (
          ...
          for (r = new d((e = c(h.length))); e > w; w++)
            (v = b ? y(h[w], w) : h[w]), u(r, w, v);
        else
          for (
            p = (f = m.call(h)).next, r = new d();
            !(l = p.call(f)).done;
            w++
          )
            (v = b ? i(f, y, [l.value, w], !0) : l.value), u(r, w, v);
        return (r.length = w), r;
      };
    },
    function (t, e, r) {
            ...
            switch (o) {
              ...
              case "hexa":
                ...
                return (
                  ...
                  { values: [].concat(P(y), [b]), a: b, type: o }
                );
              case "hsla":
                var m = n(e),
                  w = m[3],
        ...
        var e = {
            ...
            _tapmove: function (t) {
              ...
              if (t) {
                ...
                (c = t ? (s || t).clientX : 0),
                  ...
                  u < a.top
                    ? (u = a.top)
                    : u > a.top + a.height && (u = a.top + a.height),
                  (c -= a.left),
                  (u -= a.top);
            ...
            destroy: function () {
              ...
              f(document, ["keydown", "keyup"], n),
                ...
                f([t.wrapper, t.element], "touchstart", r, { passive: !1 });
            },
          },
          r = e.options,
          n = e._tapstart,
          o = e._keyboard;
        return (
          l([r.wrapper, r.element], "mousedown", n),
          l([r.wrapper, r.element], "touchstart", n, { passive: !1 }),
      ...
      var W = (function () {
        function t(e) {
          ...
          (this._nanopop =
            ...
            (g = { margin: s }),
            (y =
              "object" != typeof (h = m) || h instanceof HTMLElement
                ? D({ reference: h, popper: d }, g)
                : h),
            {
              update: function () {
                var t =
          ...
          this._setupAnimationFrame = requestAnimationFrame(function t() {
            ...
            x.setColor(e.default),
              ...
              e.defaultRepresentation &&
                ((x._representation = e.defaultRepresentation),
                    ...
                    if (r.palette) {
                      ...
                      (this.element.style.background = f),
                        ...
                        a.comparison
                          ? a.useAsButton ||
                            e._lastColor ||
                            s.style.setProperty("--pcr-color", f)
                          : ((i.button.style.color = f),
